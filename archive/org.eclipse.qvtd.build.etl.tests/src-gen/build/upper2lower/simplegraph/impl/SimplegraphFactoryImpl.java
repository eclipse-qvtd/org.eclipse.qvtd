...
public class SimplegraphFactoryImpl extends EFactoryImpl implements SimplegraphFactory {
	...
	public static SimplegraphFactory init() {
		try {
			SimplegraphFactory theSimplegraphFactory = (SimplegraphFactory)EPackage.Registry.INSTANCE.getEFactory(SimplegraphPackage.eNS_URI);
			if (theSimplegraphFactory != null) {
				return theSimplegraphFactory;
			}
		}
