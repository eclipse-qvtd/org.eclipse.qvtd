 ...
 *******************************************************************************/
package org.eclipse.qvt.declarative.test.modelregistry;
...
public abstract class ModelRegistryTestCase extends TestCase
{
	...
	{
		private TestModelFileResolver(ProjectHandle projectHandle, File file) throws IOException {
	...
	protected ProjectHandle getProjectFileHandle(String projectName) throws IOException {
	...
	protected ModelFileResolver getModelFileResolver(String projectName, String resourceName) throws IOException {
		ProjectHandle projectHandle = getProjectFileHandle(projectName);
