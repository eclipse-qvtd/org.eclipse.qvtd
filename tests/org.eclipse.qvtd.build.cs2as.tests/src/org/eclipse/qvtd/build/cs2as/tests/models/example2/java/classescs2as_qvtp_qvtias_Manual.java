...
package org.eclipse.qvtd.build.cs2as.tests.models.example2.java;
...
public class classescs2as_qvtp_qvtias_Manual extends AbstractTransformationExecutor
{
    ...
    public classescs2as_qvtp_qvtias_Manual(final @NonNull Evaluator evaluator) {
    ...
    public @NonNull /*@NonInvalid*/ example2.classes.Class lookupClass(final @NonNull /*@NonInvalid*/ Environment self_2, final @NonNull /*@NonInvalid*/ PathElementCS path) {
        ...
        while (true) {
            ...
            @Nullable /*@NonInvalid*/ example2.classes.Class _1 = (example2.classes.Class)ITERATOR__1.next();
            /**
             * name = path.name
             */
            if (_1 == null) {
        ...
        if (isEmpty) {
            ...
            if (symbol_0) {
                ...
                final @NonNull /*@Thrown*/ example2.classes.Class lookupClass = this.lookupClass(parentEnv_0, path);
                symbol_1 = lookupClass;
            }
            symbol_2 = symbol_1;
        }
        else {
            final @Nullable /*@Thrown*/ example2.classes.Class first = (example2.classes.Class)OrderedCollectionFirstOperation.INSTANCE.evaluate(foundClasses);
            symbol_2 = first;
        }
        if (symbol_2 == null) {
     ...
     * endif
     */
    public @NonNull /*@NonInvalid*/ Package lookupPackage(Visitable visitable, final @NonNull /*@NonInvalid*/ List<PathElementCS> pathSeq) {
        final @NonNull /*@NonInvalid*/ IdResolver idResolver = evaluator.getIdResolver();
        ...
        if (eq) {
            ...
            final @NonNull /*@Thrown*/ Package self_5 = this.lookupPackage(visitable, UNBOXED_subOrderedSet);
            // ASBH The environment should not be computed
    ...
    protected boolean uClass_superClass(final @NonNull /*@NonInvalid*/ ClassCS classCS_1) {
        ...
        if (eq) {
            ...
            if (eq_0) {
                ...
                final List<PathElementCS> UNBOXED_subOrderedSet = subOrderedSet.asEcoreObjects(idResolver, PathElementCS.class);
                assert UNBOXED_subOrderedSet != null;
                final @NonNull /*@Thrown*/ Package self_6 = this.lookupPackage(oclAsType_0, UNBOXED_subOrderedSet);
                // ASBH The environment should not be computed
