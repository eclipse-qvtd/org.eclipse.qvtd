...
/_QVTd_ATLExampleTests__testATL2QVTr_Families2Persons_CG/models/Families2Persons_CG.qvtras.

Copy it to this folder and diff.

To eliminate gratuitous errors replace all "../org.eclipse.qvtd.atl.tests/models/families2persons/" by
