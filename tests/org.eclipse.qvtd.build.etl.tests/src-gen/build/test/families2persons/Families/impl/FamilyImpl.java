 ...
 * </p>
 * <ul>
 *   <li>{@link build.test.families2persons.Families.impl.FamilyImpl#getLastName <em>Last Name</em>}</li>
 *   <li>{@link build.test.families2persons.Families.impl.FamilyImpl#getFather <em>Father</em>}</li>
 *   <li>{@link build.test.families2persons.Families.impl.FamilyImpl#getMother <em>Mother</em>}</li>
 *   <li>{@link build.test.families2persons.Families.impl.FamilyImpl#getSons <em>Sons</em>}</li>
 *   <li>{@link build.test.families2persons.Families.impl.FamilyImpl#getDaughters <em>Daughters</em>}</li>
 * </ul>
 *
 * @generated
 */
