/**
 */
package build.test.families2persons.Families.impl;
 ...
 * </p>
 * <ul>
 *   <li>{@link build.test.families2persons.Families.impl.MemberImpl#getFirstName <em>First Name</em>}</li>
 *   <li>{@link build.test.families2persons.Families.impl.MemberImpl#getFamilyFather <em>Family Father</em>}</li>
 *   <li>{@link build.test.families2persons.Families.impl.MemberImpl#getFamilyMother <em>Family Mother</em>}</li>
 *   <li>{@link build.test.families2persons.Families.impl.MemberImpl#getFamilySon <em>Family Son</em>}</li>
 *   <li>{@link build.test.families2persons.Families.impl.MemberImpl#getFamilyDaughter <em>Family Daughter</em>}</li>
 * </ul>
 *
 * @generated
 */
