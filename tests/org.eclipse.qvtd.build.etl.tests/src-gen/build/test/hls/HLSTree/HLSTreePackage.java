 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see build.test.hls.HLSTree.HLSTreeFactory
 * @model kind="package"
 * @generated
 */
public interface HLSTreePackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.eclipse.org/qvtd/test/compiler/0.1/HLSTree";
	 ...
	 * @generated
	 */
	HLSTreePackage eINSTANCE = build.test.hls.HLSTree.impl.HLSTreePackageImpl.init();

	/**
	 * The meta object id for the '{@link build.test.hls.HLSTree.impl.HLSNodeImpl <em>HLS Node</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see build.test.hls.HLSTree.impl.HLSNodeImpl
	 * @see build.test.hls.HLSTree.impl.HLSTreePackageImpl#getHLSNode()
	 * @generated
	 */
	int HLS_NODE = 0;
	 ...
	 * @see build.test.hls.HLSTree.impl.HLSTreePackageImpl#getHLS()
	 * @generated
	 */
	int HLS = 1;
	...
	/**
	 * Returns the meta object for class '{@link build.test.hls.HLSTree.HLSNode <em>HLS Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>HLS Node</em>'.
	 * @see build.test.hls.HLSTree.HLSNode
	 * @generated
	 */
	EClass getHLSNode();

	/**
	 * Returns the meta object for the container reference '{@link build.test.hls.HLSTree.HLSNode#getParent <em>Parent</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link build.test.hls.HLSTree.HLSNode#getChildren <em>Children</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link build.test.hls.HLSTree.HLSNode#getHls <em>Hls</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Hls</em>'.
	 * @see build.test.hls.HLSTree.HLSNode#getHls()
	 * @see #getHLSNode()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link build.test.hls.HLSTree.HLSNode#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see build.test.hls.HLSTree.HLSNode#getName()
	 * @see #getHLSNode()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link build.test.hls.HLSTree.impl.HLSNodeImpl <em>HLS Node</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see build.test.hls.HLSTree.impl.HLSNodeImpl
		 * @see build.test.hls.HLSTree.impl.HLSTreePackageImpl#getHLSNode()
