 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see build.test.hsv.HSVTree.HSVTreeFactory
 * @model kind="package"
 * @generated
 */
public interface HSVTreePackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.eclipse.org/qvtd/test/compiler/0.1/HSVTree";
	 ...
	 * @generated
	 */
	HSVTreePackage eINSTANCE = build.test.hsv.HSVTree.impl.HSVTreePackageImpl.init();

	/**
	 * The meta object id for the '{@link build.test.hsv.HSVTree.impl.HSVNodeImpl <em>HSV Node</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see build.test.hsv.HSVTree.impl.HSVNodeImpl
	 * @see build.test.hsv.HSVTree.impl.HSVTreePackageImpl#getHSVNode()
	 * @generated
	 */
	int HSV_NODE = 0;
	 ...
	 * @see build.test.hsv.HSVTree.impl.HSVTreePackageImpl#getHSV()
	 * @generated
	 */
	int HSV = 1;
	...
	/**
	 * Returns the meta object for class '{@link build.test.hsv.HSVTree.HSVNode <em>HSV Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>HSV Node</em>'.
	 * @see build.test.hsv.HSVTree.HSVNode
	 * @generated
	 */
	EClass getHSVNode();

	/**
	 * Returns the meta object for the container reference '{@link build.test.hsv.HSVTree.HSVNode#getParent <em>Parent</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link build.test.hsv.HSVTree.HSVNode#getChildren <em>Children</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link build.test.hsv.HSVTree.HSVNode#getHsv <em>Hsv</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Hsv</em>'.
	 * @see build.test.hsv.HSVTree.HSVNode#getHsv()
	 * @see #getHSVNode()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link build.test.hsv.HSVTree.HSVNode#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see build.test.hsv.HSVTree.HSVNode#getName()
	 * @see #getHSVNode()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link build.test.hsv.HSVTree.impl.HSVNodeImpl <em>HSV Node</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see build.test.hsv.HSVTree.impl.HSVNodeImpl
		 * @see build.test.hsv.HSVTree.impl.HSVTreePackageImpl#getHSVNode()
