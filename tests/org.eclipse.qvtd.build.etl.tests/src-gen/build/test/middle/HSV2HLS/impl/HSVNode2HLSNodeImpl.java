 ...
 * </p>
 * <ul>
 *   <li>{@link build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl#getHsv <em>Hsv</em>}</li>
 *   <li>{@link build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl#getHls <em>Hls</em>}</li>
 *   <li>{@link build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl#getRgb <em>Rgb</em>}</li>
 *   <li>{@link build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
