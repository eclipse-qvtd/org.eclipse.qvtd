 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see build.test.middle.HSV2HLS.HSV2HLSFactory
 * @model kind="package"
 * @generated
 */
public interface HSV2HLSPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://http://www.eclipse.org/qvtd/test/compiler/0.1/HSVtoHLS";
	 ...
	 * @generated
	 */
	HSV2HLSPackage eINSTANCE = build.test.middle.HSV2HLS.impl.HSV2HLSPackageImpl.init();

	/**
	 * The meta object id for the '{@link build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl <em>HSV Node2 HLS Node</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl
	 * @see build.test.middle.HSV2HLS.impl.HSV2HLSPackageImpl#getHSVNode2HLSNode()
	 * @generated
	 */
	 ...
	 * @see build.test.middle.HSV2HLS.impl.HSV2HLSPackageImpl#getRGB()
	 * @generated
	 */
	int RGB = 1;
	...
	/**
	 * Returns the meta object for class '{@link build.test.middle.HSV2HLS.HSVNode2HLSNode <em>HSV Node2 HLS Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>HSV Node2 HLS Node</em>'.
	 * @see build.test.middle.HSV2HLS.HSVNode2HLSNode
	 * @generated
	 */
	EClass getHSVNode2HLSNode();

	/**
	 * Returns the meta object for the container reference '{@link build.test.middle.HSV2HLS.HSVNode2HLSNode#getParent <em>Parent</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link build.test.middle.HSV2HLS.HSVNode2HLSNode#getChildren <em>Children</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link build.test.middle.HSV2HLS.HSVNode2HLSNode#getHsv <em>Hsv</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Hsv</em>'.
	 * @see build.test.middle.HSV2HLS.HSVNode2HLSNode#getHsv()
	 * @see #getHSVNode2HLSNode()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link build.test.middle.HSV2HLS.HSVNode2HLSNode#getHls <em>Hls</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Hls</em>'.
	 * @see build.test.middle.HSV2HLS.HSVNode2HLSNode#getHls()
	 * @see #getHSVNode2HLSNode()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link build.test.middle.HSV2HLS.HSVNode2HLSNode#getRgb <em>Rgb</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Rgb</em>'.
	 * @see build.test.middle.HSV2HLS.HSVNode2HLSNode#getRgb()
	 * @see #getHSVNode2HLSNode()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link build.test.middle.HSV2HLS.HSVNode2HLSNode#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see build.test.middle.HSV2HLS.HSVNode2HLSNode#getName()
	 * @see #getHSVNode2HLSNode()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl <em>HSV Node2 HLS Node</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see build.test.middle.HSV2HLS.impl.HSVNode2HLSNodeImpl
		 * @see build.test.middle.HSV2HLS.impl.HSV2HLSPackageImpl#getHSVNode2HLSNode()
