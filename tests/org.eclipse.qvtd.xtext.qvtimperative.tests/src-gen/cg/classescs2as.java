...
public class classescs2as extends AbstractTransformation
{
    ...
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass = TypeId.METACLASS.getSpecializedId(CLSSid_PackageCS);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_0 = TypeId.METACLASS.getSpecializedId(CLSSid_PackageCS2Package);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_1 = TypeId.METACLASS.getSpecializedId(CLSSid_Package);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_2 = TypeId.METACLASS.getSpecializedId(CLSSid_ClassCS);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_3 = TypeId.METACLASS.getSpecializedId(CLSSid_ClassCS2Class);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_4 = TypeId.METACLASS.getSpecializedId(CLSSid_Class);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_5 = TypeId.METACLASS.getSpecializedId(CLSSid_RootCS);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_6 = TypeId.METACLASS.getSpecializedId(CLSSid_RootCS2Root);
    public static final @NonNull /*@NonInvalid*/ MetaclassId METAid_Metaclass_7 = TypeId.METACLASS.getSpecializedId(CLSSid_Root);
    ...
    protected boolean __root__() {
        try {
            ...
            final @NonNull /*@NonInvalid*/ DomainType TYP_classescs_c_c_ClassCS_1 = idResolver.getType(CLSSid_ClassCS, null);
            final @NonNull /*@NonInvalid*/ DomainType TYP_classescs_c_c_PackageCS_0 = idResolver.getType(CLSSid_PackageCS, null);
            final @NonNull /*@NonInvalid*/ DomainType TYP_classescs_c_c_RootCS_1 = idResolver.getType(CLSSid_RootCS, null);
