...
public class ManualUML2RDBMS extends AbstractTransformer
{
    ...
    public static final @NonNull /*@NonInvalid*/ CollectionTypeId SET_NF_CLSSid_NonLeafAttribute = TypeId.SET.getSpecializedId(CLSSid_NonLeafAttribute, ValueId.TRUE_ID);
    ...
    protected boolean MAP___root__() throws ReflectiveOperationException {
        ...
        // mapping statements
        final @NonNull /*@NonInvalid*/ SetValue allInstances = ClassifierAllInstancesOperation.INSTANCE.evaluate(executor, SET_NF_CLSSid_Package, TYP_uml_c_c_Package_0);
    ...
    protected boolean MAP_associationToForeignKeyMR_1(final @NonNull /*@NonInvalid*/ Table dt_0, final @NonNull /*@NonInvalid*/ Column fc, final @NonNull /*@NonInvalid*/ ForeignKey fk, final @NonNull /*@NonInvalid*/ Key rk_0) throws ReflectiveOperationException {
        ...
        // property assignments
        fk.setRefersTo(rk_0);
        final @NonNull /*@NonInvalid*/ OrderedSetValue OrderedSet = ValueUtil.createOrderedSetOfEach(ORD_NF_1_1_CLSSid_ForeignKey, fk);
    ...
    protected boolean MAP_classPrimitiveAttributesLM(final @NonNull /*@NonInvalid*/ Attribute a_0, final @NonNull /*@NonInvalid*/ manualuml2rdbms.uml.Class c_0, final @NonNull /*@NonInvalid*/ ClassToTable fao) throws ReflectiveOperationException {
        ...
        atc.setKind(kind);
        atc.setName(name);
        final @NonNull /*@Thrown*/ SetValue Set = ValueUtil.createSetOfEach(SET_NF_1_1_CLSSid_AttributeToColumn, atc);
