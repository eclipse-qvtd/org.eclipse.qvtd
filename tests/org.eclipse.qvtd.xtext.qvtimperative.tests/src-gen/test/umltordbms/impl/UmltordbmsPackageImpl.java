 ...
 * @generated
 */
public class UmltordbmsPackageImpl extends EPackageImpl implements UmltordbmsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see test.umltordbms.UmltordbmsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private UmltordbmsPackageImpl() {
		super(eNS_URI, UmltordbmsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link UmltordbmsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static UmltordbmsPackage init() {
		if (isInited) return (UmltordbmsPackage)EPackage.Registry.INSTANCE.getEPackage(UmltordbmsPackage.eNS_URI);

		// Obtain or create and register package
		UmltordbmsPackageImpl theUmltordbmsPackage = (UmltordbmsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof UmltordbmsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new UmltordbmsPackageImpl());
		...
		theUmltordbmsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(UmltordbmsPackage.eNS_URI, theUmltordbmsPackage);
		return theUmltordbmsPackage;
	}
	 ...
	 * @generated
	 */
	public UmltordbmsFactory getUmltordbmsFactory() {
		return (UmltordbmsFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getToColumn_Column(), theSimplerdbmsPackage.getColumn(), null, "column", null, 0, 1, ToColumn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //UmltordbmsPackageImpl
