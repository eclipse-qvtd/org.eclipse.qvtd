...
public class SimpleumlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SimpleumlPackage.CLASS: {
				test.simpleuml.Class class_ = (test.simpleuml.Class)theEObject;
			...
			case SimpleumlPackage.PACKAGE: {
				test.simpleuml.Package package_ = (test.simpleuml.Package)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(test.simpleuml.Class object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePackage(test.simpleuml.Package object) {
		return null;
	}
