...
public class AttributeImpl extends UMLModelElementImpl implements Attribute {
	 ...
	 * @generated
	 */
	public test.simpleuml.Class getOwner() {
		if (eContainerFeatureID() != SimpleumlPackage.ATTRIBUTE__OWNER) return null;
		return (test.simpleuml.Class)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwner(test.simpleuml.Class newOwner, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setOwner(test.simpleuml.Class newOwner) {
		if (newOwner != eInternalContainer() || (eContainerFeatureID() != SimpleumlPackage.ATTRIBUTE__OWNER && newOwner != null)) {
			...
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, SimpleumlPackage.CLASS__ATTRIBUTES, test.simpleuml.Class.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimpleumlPackage.ATTRIBUTE__OWNER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetOwner((test.simpleuml.Class)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SimpleumlPackage.ATTRIBUTE__OWNER:
				return eInternalContainer().eInverseRemove(this, SimpleumlPackage.CLASS__ATTRIBUTES, test.simpleuml.Class.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SimpleumlPackage.ATTRIBUTE__TYPE:
				...
				return;
			case SimpleumlPackage.ATTRIBUTE__OWNER:
				setOwner((test.simpleuml.Class)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case SimpleumlPackage.ATTRIBUTE__TYPE:
				...
				return;
			case SimpleumlPackage.ATTRIBUTE__OWNER:
				setOwner((test.simpleuml.Class)null);
				return;
		}
