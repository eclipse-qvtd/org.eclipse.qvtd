 ...
 *   <li>{@link test.simpleuml.impl.ClassImpl#getAttributes <em>Attributes</em>}</li>
 ...
 * @generated
 */
public class ClassImpl extends ClassifierImpl implements test.simpleuml.Class {
	/**
	 ...
	 * @ordered
	 */
	protected EList<test.simpleuml.Class> general;
	 ...
	 * @ordered
	 */
	protected EList<test.simpleuml.Class> generalOpposite;
	 ...
	 * @generated
	 */
	public EList<test.simpleuml.Class> getGeneral() {
		if (general == null) {
			general = new EObjectWithInverseResolvingEList.ManyInverse<test.simpleuml.Class>(test.simpleuml.Class.class, this, SimpleumlPackage.CLASS__GENERAL, SimpleumlPackage.CLASS__GENERAL_OPPOSITE);
		}
		return general;
	}
	...
	public EList<Association> getReverse() {
		if (reverse == null) {
			reverse = new EObjectResolvingEList<Association>(Association.class, this, SimpleumlPackage.CLASS__REVERSE);
		}
		return reverse;
	}
	 ...
	 * @generated
	 */
	public EList<test.simpleuml.Class> getGeneralOpposite() {
		if (generalOpposite == null) {
			generalOpposite = new EObjectWithInverseResolvingEList.ManyInverse<test.simpleuml.Class>(test.simpleuml.Class.class, this, SimpleumlPackage.CLASS__GENERAL_OPPOSITE, SimpleumlPackage.CLASS__GENERAL);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SimpleumlPackage.CLASS__GENERAL:
				getGeneral().clear();
				getGeneral().addAll((Collection<? extends test.simpleuml.Class>)newValue);
				return;
			case SimpleumlPackage.CLASS__FORWARD:
				getForward().clear();
			...
			case SimpleumlPackage.CLASS__GENERAL_OPPOSITE:
				...
				getGeneralOpposite().addAll((Collection<? extends test.simpleuml.Class>)newValue);
				return;
		}
