...
public class TalltreeAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected TalltreeSwitch<@Nullable Adapter> modelSwitch =
		new TalltreeSwitch<@Nullable Adapter>() {
			@Override
			public Adapter caseTallNode(TallNode object) {
				return createTallNodeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link tree2talltree.talltree.TallNode <em>Tall Node</em>}'.
	 * <!-- begin-user-doc -->
