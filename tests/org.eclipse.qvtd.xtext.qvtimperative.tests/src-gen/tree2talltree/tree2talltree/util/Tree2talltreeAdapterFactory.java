...
public class Tree2talltreeAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Tree2talltreeSwitch<@Nullable Adapter> modelSwitch =
		new Tree2talltreeSwitch<@Nullable Adapter>() {
			@Override
			public Adapter caseNode2TallNode(Node2TallNode object) {
				return createNode2TallNodeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link tree2talltree.tree2talltree.Node2TallNode <em>Node2 Tall Node</em>}'.
	 * <!-- begin-user-doc -->
