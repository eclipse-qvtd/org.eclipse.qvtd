 ...
 * </p>
 * <ul>
 *   <li>{@link simpleuml2rdbms.rdbms.impl.ColumnImpl#getType <em>Type</em>}</li>
 *   <li>{@link simpleuml2rdbms.rdbms.impl.ColumnImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link simpleuml2rdbms.rdbms.impl.ColumnImpl#getForeignKeys <em>Foreign Keys</em>}</li>
 *   <li>{@link simpleuml2rdbms.rdbms.impl.ColumnImpl#getKeys <em>Keys</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends RModelElementImpl implements Column {
	...
	public void setOwner(Table newOwner) {
		if (newOwner != eInternalContainer() || (eContainerFeatureID() != RDBMSPackage.COLUMN__OWNER && newOwner != null)) {
			...
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, RDBMSPackage.TABLE__COLUMNS, Table.class, msgs);
	...
	public EList<ForeignKey> getForeignKeys() {
		if (foreignKeys == null) {
			foreignKeys = new EObjectWithInverseResolvingEList.ManyInverse<ForeignKey>(ForeignKey.class, this, RDBMSPackage.COLUMN__FOREIGN_KEYS, RDBMSPackage.FOREIGN_KEY__COLUMNS);
		}
		return foreignKeys;
	}
	...
	public EList<Key> getKeys() {
		if (keys == null) {
			keys = new EObjectWithInverseResolvingEList.ManyInverse<Key>(Key.class, this, RDBMSPackage.COLUMN__KEYS, RDBMSPackage.KEY__COLUMN);
		}
		return keys;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RDBMSPackage.COLUMN__KEYS:
