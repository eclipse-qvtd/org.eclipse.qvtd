 ...
 * </p>
 * <ul>
 *   <li>{@link simpleuml2rdbms.uml2rdbms.impl.UmlToRdbmsModelElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UmlToRdbmsModelElementImpl extends MinimalEObjectImpl.Container implements UmlToRdbmsModelElement {
	...
	protected EClass eStaticClass() {
		return UML2RDBMSPackage.Literals.UML_TO_RDBMS_MODEL_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2RDBMSPackage.UML_TO_RDBMS_MODEL_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2RDBMSPackage.UML_TO_RDBMS_MODEL_ELEMENT__NAME:
				return getName();
		}
