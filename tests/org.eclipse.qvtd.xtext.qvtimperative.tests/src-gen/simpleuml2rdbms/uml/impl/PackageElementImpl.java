...
public abstract class PackageElementImpl extends UMLModelElementImpl implements PackageElement {
	...
	public void setNamespace(simpleuml2rdbms.uml.Package newNamespace) {
		if (newNamespace != eInternalContainer() || (eContainerFeatureID() != (2) && newNamespace != null)) {
			...
			if (newNamespace != null)
				msgs = ((InternalEObject)newNamespace).eInverseAdd(this, 2, simpleuml2rdbms.uml.Package.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case 2:
				return eInternalContainer().eInverseRemove(this, 2, simpleuml2rdbms.uml.Package.class, msgs);
		}
