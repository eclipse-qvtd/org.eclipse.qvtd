 ...
 * </p>
 * <ul>
 *   <li>{@link simpleuml2rdbms.uml.impl.PackageElementImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PackageElementImpl extends UMLModelElementImpl implements PackageElement {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNamespace(simpleuml2rdbms.uml.Package newNamespace, NotificationChain msgs) {
	...
	public void setNamespace(simpleuml2rdbms.uml.Package newNamespace) {
		if (newNamespace != eInternalContainer() || (eContainerFeatureID() != UMLPackage.PACKAGE_ELEMENT__NAMESPACE && newNamespace != null)) {
			...
			if (newNamespace != null)
				msgs = ((InternalEObject)newNamespace).eInverseAdd(this, UMLPackage.PACKAGE__ELEMENTS, simpleuml2rdbms.uml.Package.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UMLPackage.PACKAGE_ELEMENT__NAMESPACE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetNamespace((simpleuml2rdbms.uml.Package)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UMLPackage.PACKAGE_ELEMENT__NAMESPACE:
				return eInternalContainer().eInverseRemove(this, UMLPackage.PACKAGE__ELEMENTS, simpleuml2rdbms.uml.Package.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case UMLPackage.PACKAGE_ELEMENT__NAMESPACE:
				setNamespace((simpleuml2rdbms.uml.Package)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case UMLPackage.PACKAGE_ELEMENT__NAMESPACE:
				setNamespace((simpleuml2rdbms.uml.Package)null);
				return;
		}
