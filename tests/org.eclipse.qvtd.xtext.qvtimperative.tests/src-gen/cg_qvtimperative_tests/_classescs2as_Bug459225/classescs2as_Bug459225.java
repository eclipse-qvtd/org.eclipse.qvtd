...
package cg_qvtimperative_tests._classescs2as_Bug459225;
...
public class classescs2as_Bug459225 extends AbstractTransformer
{
    ...
    public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_NamedElementCS = PACKid_http_c_s_s_ocldependencyanalysis_s_classescs_s_1_0.getClassId("NamedElementCS", 0);
    ...
    public static final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull String STR__c_c = "::";
    public static final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull String STR_unnamed = "unnamed";
     ...
     *   endif
     */
    public /*@NonInvalid*/ String computeName(final /*@NonInvalid*/ classescs.@org.eclipse.jdt.annotation.NonNull NamedElementCS self_0) {
        ...
        final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable String name_0 = self_0.getName();
        ...
        final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable Boolean and = BooleanAndOperation.INSTANCE.evaluate(not, CAUGHT_oclIsKindOf);
        if (and == null) {
            throw new InvalidValueException("Null if condition");
        }
        /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable String symbol_1;
        if (and) {
     ...
     * 
     */
    protected boolean MAP_createPackage(final /*@NonInvalid*/ classescs.@org.eclipse.jdt.annotation.NonNull PackageCS packageCS) throws ReflectiveOperationException {
        // predicates
        // variable assignments
        /*@Caught*/ @Nullable Object CAUGHT_name;
        try {
            final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable String name = packageCS.getName();
            CAUGHT_name = name;
        }
        catch (Exception e) {
        ...
        final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable Boolean not = BooleanNotOperation.INSTANCE.evaluate(symbol_1);
        if (not == null) {
            throw new InvalidValueException("Null if condition");
        }
        /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable String symbol_2;
        if (not) {
            final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable String computeName = this.computeName(packageCS);
        ...
        // creations
        final /*@Thrown*/ classes.@org.eclipse.jdt.annotation.Nullable Package symbol_0 = ClassesFactory.eINSTANCE.createPackage();
