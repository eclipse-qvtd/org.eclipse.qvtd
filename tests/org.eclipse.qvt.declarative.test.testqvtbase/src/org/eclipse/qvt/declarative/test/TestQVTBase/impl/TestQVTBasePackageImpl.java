 ...
 * </copyright>
 *
 * $Id: TestQVTBasePackageImpl.java,v 1.1 2008/12/31 18:11:04 ewillink Exp $
 */
...
public class TestQVTBasePackageImpl extends EPackageImpl implements TestQVTBasePackage {
	...
	public static TestQVTBasePackage init() {
		...
		TestQVTBasePackageImpl theTestQVTBasePackage = (TestQVTBasePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof TestQVTBasePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new TestQVTBasePackageImpl());
