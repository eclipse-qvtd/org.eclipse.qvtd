 ...
 * @generated
 */
public class SeqMMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SeqMMPackage.DUMMY: {
				Dummy dummy = (Dummy)theEObject;
				T result = caseDummy(dummy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeqMMPackage.INTERACTION: {
				Interaction interaction = (Interaction)theEObject;
				T result = caseInteraction(interaction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeqMMPackage.LIFE_LINE: {
				LifeLine lifeLine = (LifeLine)theEObject;
				T result = caseLifeLine(lifeLine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeqMMPackage.MESSAGE: {
				Message message = (Message)theEObject;
				T result = caseMessage(message);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeqMMPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeqMMPackage.EVENT: {
				Event event = (Event)theEObject;
				T result = caseEvent(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SeqMMPackage.MESSAGE_EVENT: {
