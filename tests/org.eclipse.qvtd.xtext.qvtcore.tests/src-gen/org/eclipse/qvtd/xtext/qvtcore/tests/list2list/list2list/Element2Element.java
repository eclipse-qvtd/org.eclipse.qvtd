 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.Element2Element#getElement1 <em>Element1</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.Element2Element#getElement2 <em>Element2</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.Element2Element#getList2list <em>List2list</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.Element2Element#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.List2listPackage#getElement2Element()
 * @model
 * @generated
 */
public interface Element2Element extends EObject {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.Element2Element#getElement1 <em>Element1</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.Element2Element#getElement2 <em>Element2</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.List2List#getElement2Element <em>Element2 Element</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.List2listPackage#getElement2Element_List2list()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.Element2Element#getList2list <em>List2list</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.List2listPackage#getElement2Element_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.qvtd.xtext.qvtcore.tests.list2list.list2list.Element2Element#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
