	...
	implements Visitor<LookupEnvironment>
{
    ...
    public @Nullable /*@NonInvalid*/ LookupEnvironment visitClass(final @NonNull /*@NonInvalid*/ Class element) {
        ...
        @SuppressWarnings("null")
        final @NonNull /*@Thrown*/ LookupEnvironment inner = addElements.addElements((EList<Property>)ownedProperties);
     ...
     */
    @Override
    public @Nullable /*@NonInvalid*/ LookupEnvironment visitOperation(final @NonNull /*@NonInvalid*/ Operation element_0) {
     ...
     */
    @Override
    public @Nullable /*@NonInvalid*/ LookupEnvironment visitPackage(final @NonNull /*@NonInvalid*/ Package element_1) {
        @SuppressWarnings("null")
        ...
        @SuppressWarnings("null")
        final @NonNull /*@Thrown*/ List<Class> ownedClasses = element_1.getOwnedClasses();
        @SuppressWarnings("null")
        final @NonNull /*@Thrown*/ LookupEnvironment inner = addElements.addElements((EList<Class>)ownedClasses);
        final /*@Thrown*/ boolean hasFinalResult = inner.hasFinalResult();
        @Nullable /*@Thrown*/ LookupEnvironment symbol_0;
        if (hasFinalResult) {
            symbol_0 = inner;
     ...
     */
    @Override
    public @Nullable /*@NonInvalid*/ LookupEnvironment visitProperty(final @NonNull /*@NonInvalid*/ Property element_2) {
     ...
     */
    @Override
    public @Nullable /*@NonInvalid*/ LookupEnvironment visitRoot(final @NonNull /*@NonInvalid*/ Root element_3) {
        ...
        @SuppressWarnings("null")
        final @NonNull /*@Thrown*/ List<Package> ownedPackages = element_3.getOwnedPackages();
        @SuppressWarnings("null")
        final @NonNull /*@Thrown*/ LookupEnvironment addElements = parentEnv.addElements((EList<Package>)ownedPackages);
        return addElements;
    }
}
