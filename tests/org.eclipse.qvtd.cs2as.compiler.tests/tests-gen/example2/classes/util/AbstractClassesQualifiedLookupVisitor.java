	...
	implements Visitor<LookupEnvironment>
{
    ...
    public /*@NonInvalid*/ LookupEnvironment visitPackage(final /*@NonInvalid*/ example2.classes.@org.eclipse.jdt.annotation.NonNull Package element_5) {
        ...
        @SuppressWarnings("null")
        final /*@Thrown*/ List<Class> ownedClasses = element_5.getOwnedClasses();
        @SuppressWarnings("null")
        final /*@Thrown*/ example2.classes.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment addElements_0 = addElements.addElements((EList<Class>)ownedClasses);
        return addElements_0;
    }
}
