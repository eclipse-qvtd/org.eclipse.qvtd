...
public class KiamacsAdapterFactory extends AdapterFactoryImpl {
	...
	protected KiamacsSwitch<@Nullable Adapter> modelSwitch =
		new KiamacsSwitch<@Nullable Adapter>() {
			...
			@Override
			public Adapter caseCompositeCS(CompositeCS object) {
				return createCompositeCSAdapter();
			}
			@Override
			public Adapter caseLeafCS(LeafCS object) {
				return createLeafCSAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link example4.kiamacs.TopCS <em>Top CS</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link example4.kiamacs.NodeCS <em>Node CS</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link example4.kiamacs.CompositeCS <em>Composite CS</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link example4.kiamacs.LeafCS <em>Leaf CS</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link example4.kiamacs.BaseCS <em>Base CS</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
