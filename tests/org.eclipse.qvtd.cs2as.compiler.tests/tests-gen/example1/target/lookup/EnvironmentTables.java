...
public class EnvironmentTables
{
    ...
    public static final @NonNull /*@NonInvalid*/ ClassId CLSSid_LookupEnvironment = EnvironmentTables.PACKid_http_c_s_s_cs2as_s_tests_s_example1_s_env_s_1_0.getClassId("LookupEnvironment", 0);
