	...
	extends AbstractTargetCommonLookupVisitor
{
    ...
    protected final @NonNull CACHE_TargetQualifiedCLookupVisitor_visitA2 INST_TargetQualifiedCLookupVisitor_visitA2 = new CACHE_TargetQualifiedCLookupVisitor_visitA2();
}
