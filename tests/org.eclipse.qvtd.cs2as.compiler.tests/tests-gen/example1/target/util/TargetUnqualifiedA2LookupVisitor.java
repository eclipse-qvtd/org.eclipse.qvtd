	...
	extends AbstractTargetCommonLookupVisitor
{
    ...
    public /*@NonInvalid*/ LookupEnvironment visitTRoot(final /*@NonInvalid*/ example1.target.@org.eclipse.jdt.annotation.NonNull TRoot element) {
        ...
        final /*@NonInvalid*/ example1.target.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment env = (LookupEnvironment)TYP_lookup_c_c_LookupEnvironment_0.createInstance();
        @SuppressWarnings("null")
        final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<A> ownedA = element.getOwnedA();
        @SuppressWarnings("null")
        final /*@Thrown*/ example1.target.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment addElements = env.addElements(ownedA);
        return addElements;
    }
}
