	...
	extends AbstractTargetCommonLookupVisitor
{
    ...
    protected final @NonNull CACHE_TargetUnqualifiedA1LookupVisitor_visitTRoot INST_TargetUnqualifiedA1LookupVisitor_visitTRoot = new CACHE_TargetUnqualifiedA1LookupVisitor_visitTRoot();
}
