...
public class SbaseAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SbaseSwitch<@Nullable Adapter> modelSwitch =
		new SbaseSwitch<@Nullable Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link example5.sbase.Z <em>Z</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link example5.sbase.SRoot <em>SRoot</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
