 ...
 * @generated
 */
public class SderivedSwitch<@Nullable T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SderivedPackage.X2: {
				...
				if (result == null) result = caseSElement(x2);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>X2</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>X2</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseX2(X2 object) {
		return null;
	}
