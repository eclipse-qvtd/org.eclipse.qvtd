package org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.parser.antlr.internal;
...
public class InternalDelphiLexer extends Lexer {
    ...
    public final void mRULE_SLASH() throws RecognitionException {
        try {
            // InternalDelphi.g:10621:21: ( '\\\\' )
            // InternalDelphi.g:10621:23: '\\\\'
            {
            match('\\'); 
    ...
    public final void mRULE_QUOTE() throws RecognitionException {
        try {
            // InternalDelphi.g:10623:21: ( '\\'' )
            // InternalDelphi.g:10623:23: '\\''
            {
            match('\''); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10625:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '$' | '#' | RULE_SLASH | '-' )* )
            // InternalDelphi.g:10625:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '$' | '#' | RULE_SLASH | '-' )*
            {
            ...
            // InternalDelphi.g:10625:35: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '$' | '#' | RULE_SLASH | '-' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_DOUBLEQUOTE() throws RecognitionException {
        try {
            // InternalDelphi.g:10627:27: ( '\"' )
            // InternalDelphi.g:10627:29: '\"'
            {
            match('\"'); 
    ...
    public final void mRULE_DQVALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10629:14: ( RULE_DOUBLEQUOTE (~ ( RULE_DOUBLEQUOTE ) )* RULE_DOUBLEQUOTE )
            // InternalDelphi.g:10629:16: RULE_DOUBLEQUOTE (~ ( RULE_DOUBLEQUOTE ) )* RULE_DOUBLEQUOTE
            {
            mRULE_DOUBLEQUOTE(); 
            // InternalDelphi.g:10629:33: (~ ( RULE_DOUBLEQUOTE ) )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_QVALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10631:13: ( RULE_QUOTE (~ ( RULE_QUOTE ) )* RULE_QUOTE )
            // InternalDelphi.g:10631:15: RULE_QUOTE (~ ( RULE_QUOTE ) )* RULE_QUOTE
            {
            mRULE_QUOTE(); 
            // InternalDelphi.g:10631:26: (~ ( RULE_QUOTE ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_HEX() throws RecognitionException {
        try {
            int _type = RULE_HEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10633:10: ( ( '+' | '-' )? '0' ( 'x' | 'X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ )
            // InternalDelphi.g:10633:12: ( '+' | '-' )? '0' ( 'x' | 'X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
            {
            // InternalDelphi.g:10633:12: ( '+' | '-' )?
            int alt4=2;
            ...
            // InternalDelphi.g:10633:37: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10635:10: ( ( '+' | '-' )? ( '0' .. '9' )+ )
            // InternalDelphi.g:10635:12: ( '+' | '-' )? ( '0' .. '9' )+
            {
            // InternalDelphi.g:10635:12: ( '+' | '-' )?
            int alt6=2;
    ...
    public final void mRULE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10637:14: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalDelphi.g:10637:16: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalDelphi.g:10637:21: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_MORECOMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10639:18: ( '{' ( options {greedy=false; } : . )* '}' )
            // InternalDelphi.g:10639:20: '{' ( options {greedy=false; } : . )* '}'
            {
            match('{'); 
            // InternalDelphi.g:10639:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10641:19: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalDelphi.g:10641:21: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalDelphi.g:10641:26: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10643:9: ( ( ' ' | '\\r' | '\\t' | '\\f' | '\\n' ) )
            // InternalDelphi.g:10643:11: ( ' ' | '\\r' | '\\t' | '\\f' | '\\n' )
            {
