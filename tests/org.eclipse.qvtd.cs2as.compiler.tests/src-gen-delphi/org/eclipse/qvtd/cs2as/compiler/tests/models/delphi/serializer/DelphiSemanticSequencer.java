 ...
 */
package org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.serializer;
...
public class DelphiSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DelphiPackage.eINSTANCE)
			...
			case DelphiPackage.ADD_OP:
				sequence_addOp(context, (addOp) semanticObject); 
				return; 
	 ...
	 *     (op='+' | op='-' | op='or' | op='xor')
	 */
	protected void sequence_addOp(ISerializationContext context, addOp semanticObject) {
