...
import org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.services.DelphiGrammarAccess;
		...
		(
			...
			lv_file_0_0=rulefile
			{
				...
				set(
					...
					"file",
					lv_file_0_0,
					"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.file");
				...
				(
					...
					lv_id_1_0=ruleident
					{
						...
						set(
							...
							"id",
							lv_id_1_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.ident");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_paramsList_3_0=ruleidentList
						{
							...
							set(
								...
								"paramsList",
								lv_paramsList_3_0,
								"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.identList");
							afterParserOrEnumRuleCall();
						}
					)
				)
			...
			(
				...
				lv_block_6_0=ruleprogramBlock
				{
					...
					set(
						...
						"block",
						lv_block_6_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.programBlock");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_port_2_0=ruleportabilityDirective
				{
					...
					set(
						...
						"port",
						lv_port_2_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.portabilityDirective");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_interfaceSect_4_0=ruleinterfaceSection
				{
					...
					set(
						...
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.interfaceSection");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_implementationSect_5_0=ruleimplementationSection
				{
					...
					set(
						...
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.implementationSection");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_initSect_6_0=ruleinitSection
				{
					...
					set(
						...
						"initSect",
						lv_initSect_6_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.initSection");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_requires_3_0=rulerequiresClause
				{
					...
					set(
						...
						"requires",
						lv_requires_3_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.requiresClause");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_contains_4_0=rulecontainsClause
				{
					...
					set(
						...
						"contains",
						lv_contains_4_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.containsClause");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_uses_0_0=ruleusesClause
				{
					...
					set(
						...
						"uses",
						lv_uses_0_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.usesClause");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_block_1_0=ruleblock
				{
					...
					set(
						...
						"block",
						lv_block_1_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.block");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_interfaceDecl_3_0=ruleinterfaceDecl
				{
					...
					add(
						...
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.interfaceDecl");
					afterParserOrEnumRuleCall();
				}
			)
		)*
				...
				(
					...
					lv_pHeading_0_0=ruleprocedureHeading
					{
						...
						set(
							...
							"pHeading",
							lv_pHeading_0_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.procedureHeading");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_directive_2_0=ruledirective
					{
						...
						set(
							...
							"directive",
							lv_directive_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.directive");
						afterParserOrEnumRuleCall();
					}
				)
			)?
				...
				(
					...
					lv_fHeading_3_0=rulefunctionHeading
					{
						...
						set(
							...
							"fHeading",
							lv_fHeading_3_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.functionHeading");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_declSect_3_0=ruledeclSection
				{
					...
					add(
						...
						"declSect",
						lv_declSect_3_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.declSection");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_exports_4_0=ruleexportsStmt
				{
					...
					add(
						...
						"exports",
						lv_exports_4_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.exportsStmt");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_compound_2_0=rulecompoundStmt
				{
					...
					set(
						...
						"compound",
						lv_compound_2_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.compoundStmt");
					afterParserOrEnumRuleCall();
				}
			)
		)
					...
					(
						...
						lv_constExp_4_0=ruleconstExpr
						{
							...
							add(
								...
								"constExp",
								lv_constExp_4_0,
								"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.constExpr");
							afterParserOrEnumRuleCall();
						}
					)
				)
			...
			(
				...
				lv_items_1_0=ruleexportsItem
				{
					...
					add(
						...
						"items",
						lv_items_1_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.exportsItem");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_id_1_0=rulelabelId
				{
					...
					set(
						...
						"id",
						lv_id_1_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.labelId");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_constantDecl_2_0=ruleconstantDecl
					{
						...
						add(
							...
							"constantDecl",
							lv_constantDecl_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.constantDecl");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_typeRef_6_0=ruletypeId
					{
						...
						set(
							...
							"typeRef",
							lv_typeRef_6_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.typeId");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_typedConstat_8_0=ruletypedConstant
					{
						...
						set(
							...
							"typedConstat",
							lv_typedConstat_8_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.typedConstant");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_typeDecl_2_0=ruletypeDecl
					{
						...
						add(
							...
							"typeDecl",
							lv_typeDecl_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.typeDecl");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_type_3_0=ruletype
					{
						...
						set(
							...
							"type",
							lv_type_3_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.type");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_restrictedType_8_0=rulerestrictedType
					{
						...
						set(
							...
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.restrictedType");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_array_2_0=rulearrayConstant
					{
						...
						set(
							...
							"array",
							lv_array_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.arrayConstant");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_record_3_0=rulerecordConstant
					{
						...
						set(
							...
							"record",
							lv_record_3_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.recordConstant");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_recordField_2_0=rulerecordFieldConstant
					{
						...
						add(
							...
							"recordField",
							lv_recordField_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.recordFieldConstant");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_element_2_0=ruleenumeratedTypeElement
					{
						...
						add(
							...
							"element",
							lv_element_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.enumeratedTypeElement");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_ordinalType_2_0=ruleordinalType
					{
						...
						add(
							...
							"ordinalType",
							lv_ordinalType_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.ordinalType");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_fields_2_0=rulefieldList
				{
					...
					set(
						...
						"fields",
						lv_fields_2_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.fieldList");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					lv_field_0_0=rulefieldDecl
					{
						...
						add(
							...
							"field",
							lv_field_0_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.fieldDecl");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_variantSect_2_0=rulevariantSection
				{
					...
					set(
						...
						"variantSect",
						lv_variantSect_2_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.variantSection");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					lv_recVariants_5_0=rulerecVariant
					{
						...
						add(
							...
							"recVariants",
							lv_recVariants_5_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.recVariant");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_varDecls_1_0=rulevarDecl
					{
						...
						add(
							...
							"varDecls",
							lv_varDecls_1_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.varDecl");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_relOp_2_0=rulerelOp
					{
						...
						set(
							...
							"relOp",
							lv_relOp_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.relOp");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=rulesimpleExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.simpleExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_addOp_4_0=ruleaddOp
					{
						...
						set(
							...
							"addOp",
							lv_addOp_4_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.addOp");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_5_0=ruleterm
					{
						...
						set(
							...
							"right",
							lv_right_5_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.term");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_multOp_2_0=rulemulOp
					{
						...
						set(
							...
							"multOp",
							lv_multOp_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.mulOp");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=rulefactor
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.factor");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_designator_0_0=ruledesignator
					{
						...
						set(
							...
							"designator",
							lv_designator_0_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.designator");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_expList_2_0=ruleexprList
					{
						...
						set(
							...
							"expList",
							lv_expList_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.exprList");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_number_9_0=rulenumber
				{
					...
					set(
						...
						"number",
						lv_number_9_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.number");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_string_10_0=rulestring
				{
					...
					set(
						...
						"string",
						lv_string_10_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.string");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_nestedExp_14_0=ruleexpression
					{
						...
						set(
							...
							"nestedExp",
							lv_nestedExp_14_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.expression");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_setConstuctor_18_0=rulesetConstructor
				{
					...
					set(
						...
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.setConstructor");
					afterParserOrEnumRuleCall();
				}
			)
		)
...
@after {
	...
	(
		(
			...
			{
				$current = forceCreateModelElement(
					grammarAccess.getAddOpAccess().getAddOpAction_0(),
					$current);
			}
		)
		(
			...
			(
				...
				lv_subpart_0_0=ruledesignatorSubPart
				{
					...
					set(
						...
						"subpart",
						lv_subpart_0_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.designatorSubPart");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_part_0_0=ruledesignatorPart
				{
					...
					set(
						...
						"part",
						lv_part_0_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.designatorPart");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"id",
						lv_id_0_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.ID");
				}
			)
		)
		    |
				...
				(
					...
					lv_reservedWord_2_0=rulereservedWord
					{
						...
						set(
							...
							"reservedWord",
							lv_reservedWord_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.reservedWord");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_element_1_0=rulesetElement
					{
						...
						add(
							...
							"element",
							lv_element_1_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.setElement");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_statments_1_0=rulestatement
					{
						...
						add(
							...
							"statments",
							lv_statments_1_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.statement");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_statement_2_0=ruleunlabelledStatement
				{
					...
					set(
						...
						"statement",
						lv_statement_2_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.unlabelledStatement");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_stamtList_1_0=rulestmtList
				{
					...
					set(
						...
						"stamtList",
						lv_stamtList_1_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.stmtList");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_cases_3_0=rulecaseSelector
				{
					...
					add(
						...
						"cases",
						lv_cases_3_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.caseSelector");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_labels_0_0=rulecaseLabel
				{
					...
					add(
						...
						"labels",
						lv_labels_0_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.caseLabel");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_varId_1_0=rulequalId
				{
					...
					set(
						...
						"varId",
						lv_varId_1_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.qualId");
					afterParserOrEnumRuleCall();
				}
			)
		)
					...
					(
						...
						lv_exception_4_0=ruleexceptionBlock
						{
							...
							set(
								...
								"exception",
								lv_exception_4_0,
								"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.exceptionBlock");
							afterParserOrEnumRuleCall();
						}
					)
				)
			...
			(
				...
				lv_formalParams_3_0=ruleformalParameters
				{
					...
					set(
						...
						"formalParams",
						lv_formalParams_3_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.formalParameters");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					lv_params_1_0=ruleformalParm
					{
						...
						add(
							...
							"params",
							lv_params_1_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.formalParm");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_param_3_0=ruleparameter
				{
					...
					set(
						...
						"param",
						lv_param_3_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.parameter");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_heritage_2_0=ruleobjHeritage
				{
					...
					set(
						...
						"heritage",
						lv_heritage_2_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.objHeritage");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_fieldList_3_0=ruleobjFieldList
				{
					...
					set(
						...
						"fieldList",
						lv_fieldList_3_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.objFieldList");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_methodList_4_0=rulemethodList
				{
					...
					set(
						...
						"methodList",
						lv_methodList_4_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.methodList");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					lv_heading_0_0=rulemethodHeading
					{
						...
						set(
							...
							"heading",
							lv_heading_0_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.methodHeading");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_heritage_2_0=ruleclassHeritage
				{
					...
					set(
						...
						"heritage",
						lv_heritage_2_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.classHeritage");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_visibility_3_0=ruleclassVisibility
				{
					...
					set(
						...
						"visibility",
						lv_visibility_3_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.classVisibility");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_fieldList_4_0=ruleclassFieldList
				{
					...
					set(
						...
						"fieldList",
						lv_fieldList_4_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.classFieldList");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_methodList_5_0=ruleclassMethodList
				{
					...
					set(
						...
						"methodList",
						lv_methodList_5_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.classMethodList");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_propList_6_0=ruleclassPropertyList
				{
					...
					set(
						...
						"propList",
						lv_propList_6_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.classPropertyList");
					afterParserOrEnumRuleCall();
				}
			)
		)?
		...
		(
			...
			lv_field_0_0=ruleclassField
			{
				...
				add(
					...
					"field",
					lv_field_0_0,
					"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.classField");
				afterParserOrEnumRuleCall();
			}
		)
	)+
		...
		(
			...
			lv_metod_0_0=ruleclassMethod
			{
				...
				add(
					...
					"metod",
					lv_metod_0_0,
					"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.classMethod");
				afterParserOrEnumRuleCall();
			}
		)
	)+
		...
		(
			...
			lv_property_0_0=ruleclassProperty
			{
				...
				add(
					...
					"property",
					lv_property_0_0,
					"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.classProperty");
				afterParserOrEnumRuleCall();
			}
		)
	)+
				...
				(
					...
					lv_propList_2_0=rulepropertyList
					{
						...
						set(
							...
							"propList",
							lv_propList_2_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.propertyList");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_interface_2_0=rulepropertyInterface
				{
					...
					set(
						...
						"interface",
						lv_interface_2_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.propertyInterface");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_specifiers_3_0=rulepropertySpecifiers
				{
					...
					set(
						...
						"specifiers",
						lv_specifiers_3_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.propertySpecifiers");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_paramList_0_0=rulepropertyParameterList
				{
					...
					set(
						...
						"paramList",
						lv_paramList_0_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.propertyParameterList");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_heritage_1_0=ruleinterfaceHeritage
				{
					...
					set(
						...
						"heritage",
						lv_heritage_1_0,
						"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.interfaceHeritage");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_unitId_0_0=ruleunitId
					{
						...
						set(
							...
							"unitId",
							lv_unitId_0_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.unitId");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_exps_10_0=rulerecordConstExpr
					{
						...
						add(
							...
							"exps",
							lv_exps_10_0,
							"org.eclipse.qvtd.cs2as.compiler.tests.models.delphi.Delphi.recordConstExpr");
						afterParserOrEnumRuleCall();
					}
				)
			)
