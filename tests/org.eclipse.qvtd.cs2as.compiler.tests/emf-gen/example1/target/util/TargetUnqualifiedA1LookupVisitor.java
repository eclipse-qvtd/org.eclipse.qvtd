	...
	extends AbstractTargetCommonLookupVisitor
{
	...
	protected class CACHE_TargetUnqualifiedA1LookupVisitor_visitTRoot extends AbstractEvaluationOperation
	{
		...
		public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
			...
			final /*@NonInvalid*/ example1.target.lookup.@org.eclipse.jdt.annotation.Nullable LookupEnvironment parentEnv_0 = TargetUnqualifiedA1LookupVisitor.this.parentEnv(element_0);
			if (parentEnv_0 == null) {
