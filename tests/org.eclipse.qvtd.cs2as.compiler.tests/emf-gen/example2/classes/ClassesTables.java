...
public class ClassesTables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final @NonNull Property _Class__ownedOperations = LIBRARY.createProperty(Types._Class, ClassesPackage.Literals.CLASS__OWNED_OPERATIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Operation, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Class__ownedProperties = LIBRARY.createProperty(Types._Class, ClassesPackage.Literals.CLASS__OWNED_PROPERTIES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Property, false), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Class__Class__superClass = LIBRARY.createOppositeProperty(Types._Class, "Class", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Class, false), 3 | IsImplicit | IsRequired | IsResolveProxies, ClassesPackage.Literals.CLASS__SUPER_CLASS);
		...
		public static final @NonNull Property _Class__TypedElement__type = LIBRARY.createOppositeProperty(Types._Class, "TypedElement", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._TypedElement, false), 5 | IsImplicit | IsRequired | IsResolveProxies, ClassesPackage.Literals.TYPED_ELEMENT__TYPE);
		...
		public static final @NonNull Property _Operation__ownedExpressions = LIBRARY.createProperty(Types._Operation, ClassesPackage.Literals.OPERATION__OWNED_EXPRESSIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._CallExp, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Operation__ownedParameters = LIBRARY.createProperty(Types._Operation, ClassesPackage.Literals.OPERATION__OWNED_PARAMETERS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Parameter, false), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Operation__OperationCallExp__referredOperation = LIBRARY.createOppositeProperty(Types._Operation, "OperationCallExp", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._OperationCallExp, false), 3 | IsImplicit | IsRequired | IsResolveProxies, ClassesPackage.Literals.OPERATION_CALL_EXP__REFERRED_OPERATION);

		public static final @NonNull Property _OperationCallExp__ownedArguments = LIBRARY.createProperty(Types._OperationCallExp, ClassesPackage.Literals.OPERATION_CALL_EXP__OWNED_ARGUMENTS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Argument, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Package__ownedClasses = LIBRARY.createProperty(Types._Package, ClassesPackage.Literals.PACKAGE__OWNED_CLASSES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Class, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Package__ownedPackages = LIBRARY.createProperty(Types._Package, ClassesPackage.Literals.PACKAGE__OWNED_PACKAGES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Package, false), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Property__PropertyCallExp__referredProperty = LIBRARY.createOppositeProperty(Types._Property, "PropertyCallExp", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._PropertyCallExp, false), 1 | IsImplicit | IsRequired | IsResolveProxies, ClassesPackage.Literals.PROPERTY_CALL_EXP__REFERRED_PROPERTY);
		...
		public static final @NonNull Property _Root__ownedPackages = LIBRARY.createProperty(Types._Root, ClassesPackage.Literals.ROOT__OWNED_PACKAGES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Package, false), 0 | IsComposite | IsRequired | IsResolveProxies);
