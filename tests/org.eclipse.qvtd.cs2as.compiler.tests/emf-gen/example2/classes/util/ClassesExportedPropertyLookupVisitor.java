	...
	extends AbstractClassesCommonLookupVisitor
{
	...
	/**
	 * _'example2.classes.util'::ClassesExportedPropertyLookupVisitor::visitClass(element : classes::Class[1]) : lookup::LookupEnvironment[?]
	 *
	 * _'null' : lookup::LookupEnvironment[1]
	 */
	protected class CACHE_ClassesExportedPropertyLookupVisitor_visitClass extends AbstractEvaluationOperation
	{
		@Override
		public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
			...
			@SuppressWarnings("null")
			final /*@NonInvalid*/ example2.classes.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment addElements = context.addElements(ownedProperties);
			return addElements;
		}
	...
	protected final @NonNull CACHE_ClassesExportedPropertyLookupVisitor_visitClass INSTANCE_ClassesExportedPropertyLookupVisitor_visitClass = new CACHE_ClassesExportedPropertyLookupVisitor_visitClass();
}
