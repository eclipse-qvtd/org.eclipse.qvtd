	...
	extends AbstractClassesCommonLookupVisitor
{
	...
	/**
	 * _'example2.classes.util'::ClassesQualifiedPropertyLookupVisitor::visitClass(element : classes::Class[1]) : lookup::LookupEnvironment[?]
	 *
	...
	protected final @NonNull CACHE_ClassesQualifiedPropertyLookupVisitor_visitClass INSTANCE_ClassesQualifiedPropertyLookupVisitor_visitClass = new CACHE_ClassesQualifiedPropertyLookupVisitor_visitClass();
}
