	...
	extends AbstractClassesCommonLookupVisitor
{
	...
	protected class CACHE_ClassesQualifiedPackageLookupVisitor_visitPackage extends AbstractEvaluationOperation
	{
		...
		public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
			...
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull LookupEnvironment addElements = context.addElements(ownedPackages);
			return addElements;
		}
	...
	protected final @NonNull CACHE_ClassesQualifiedPackageLookupVisitor_visitPackage INSTANCE_ClassesQualifiedPackageLookupVisitor_visitPackage = new CACHE_ClassesQualifiedPackageLookupVisitor_visitPackage();
}
