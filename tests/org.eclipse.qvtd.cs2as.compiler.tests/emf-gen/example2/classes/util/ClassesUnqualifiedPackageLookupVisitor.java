	...
	extends AbstractClassesCommonLookupVisitor
{
	...
	public static final /*@NonInvalid*/ @NonNull NsURIPackageId PACKid_java_c_s_s_example2_classes_util = IdManager.getNsURIPackageId("java://example2.classes.util", "viz", null);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Env4CG = PACKid_http_c_s_s_cs2as_s_tests_s_example2_s_env_s_1_0.getClassId("Env4CG", 0);
	...
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId ORD_CLSSid_Package = TypeId.ORDERED_SET.getSpecializedId(CLSSid_Package, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	protected class CACHE_ClassesUnqualifiedPackageLookupVisitor_visitPackage extends AbstractEvaluationOperation
	{
		...
		public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
			...
			/*@NonInvalid*/ @Nullable LookupEnvironment IF_hasFinalResult_0;
			if (hasFinalResult_0) {
				...
				IF_hasFinalResult_0 = parentEnv_Package;
			}
			return IF_hasFinalResult_0;
		}
