	...
	protected class CACHE_ClassesUnqualifiedOperationLookupVisitor_visitClass extends AbstractEvaluationOperation
	{
		...
		public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
			...
			if (hasFinalResult_0) {
				...
				/*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull MutableIterable accumulator = ValueUtil.createCollectionAccumulatorValue(BAG_CLSSid_Operation);
				...
				while (true) {
					...
					final /*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull CollectionValue BOXED_ownedOperations_0 = idResolver.createOrderedSetOfAll(ORD_CLSSid_Operation, ownedOperations_0);
					//
