 ...
 * </p>
 * <ul>
 *   <li>{@link astm.ConstructedType#getBaseType <em>Base Type</em>}</li>
 * </ul>
 *
 * @see astm.AstmPackage#getConstructedType()
 * @model abstract="true"
 * @generated
 */
public interface ConstructedType extends DataType {
	 ...
	 * @see astm.AstmPackage#getConstructedType_BaseType()
	 * @model containment="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://cs2as/tests/delphi/AS/1.0!ConstructedType!baseType'"
	 * @generated
	 */
	TypeReference getBaseType();

	/**
	 * Sets the value of the '{@link astm.ConstructedType#getBaseType <em>Base Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
