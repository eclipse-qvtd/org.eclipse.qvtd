 ...
 * </p>
 * <ul>
 *   <li>{@link astm.impl.TypesCatchBlockImpl#getExceptions <em>Exceptions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypesCatchBlockImpl extends CatchBlockImpl implements TypesCatchBlock {
	...
	protected EClass eStaticClass() {
		return AstmPackage.Literals.TYPES_CATCH_BLOCK;
	}
	...
	public EList<Type> getExceptions() {
		if (exceptions == null) {
			exceptions = new EObjectContainmentEList<Type>(Type.class, this, AstmPackage.TYPES_CATCH_BLOCK__EXCEPTIONS);
		}
		return exceptions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AstmPackage.TYPES_CATCH_BLOCK__EXCEPTIONS:
	...
	public <R> R accept(@NonNull Visitor<R> visitor) {
		return visitor.visitTypesCatchBlock(this);
	}
