 ...
 * from:
 *   /org.eclipse.qvtd.cs2as.compiler.tests/src/org/eclipse/qvtd/cs2as/compiler/tests/models/delphi/Lookup.ecore
 * using:
 *   /org.eclipse.qvtd.cs2as.compiler.tests/src/org/eclipse/qvtd/cs2as/compiler/tests/models/delphi/Lookup.genmodel
...
import astm.AstmTables;
import astm.lookup.LookupTables;
...
public class LookupTables
{
	...
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull NsURIPackageId PACKid_http_c_s_s_cs2as_s_tests_s_delphi_s_AS_s_1_0 = org.eclipse.ocl.pivot.ids.IdManager.getNsURIPackageId("http://cs2as/tests/delphi/AS/1.0", null, astm.AstmPackage.eINSTANCE);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull NsURIPackageId PACKid_http_c_s_s_cs2as_s_tests_s_delphi_s_lookup_s_1_0 = org.eclipse.ocl.pivot.ids.IdManager.getNsURIPackageId("http://cs2as/tests/delphi/lookup/1.0", null, astm.lookup.LookupPackage.eINSTANCE);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_Definition = astm.lookup.LookupTables.PACKid_http_c_s_s_cs2as_s_tests_s_delphi_s_AS_s_1_0.getClassId("Definition", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_Executor = astm.lookup.LookupTables.PACKid_http_c_s_s_cs2as_s_tests_s_delphi_s_lookup_s_1_0.getClassId("Executor", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_LookupEnvironment = astm.lookup.LookupTables.PACKid_http_c_s_s_cs2as_s_tests_s_delphi_s_lookup_s_1_0.getClassId("LookupEnvironment", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull CollectionTypeId BAG_CLSSid_LookupEnvironment = org.eclipse.ocl.pivot.ids.TypeId.BAG.getSpecializedId(astm.lookup.LookupTables.CLSSid_LookupEnvironment);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull CollectionTypeId ORD_CLSSid_Definition = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(astm.lookup.LookupTables.CLSSid_Definition);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull PropertyId PROPid_namedElements = astm.lookup.LookupTables.CLSSid_LookupEnvironment.getPropertyId("namedElements");
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull PropertyId PROPid_parentEnv = astm.lookup.LookupTables.CLSSid_LookupEnvironment.getPropertyId("parentEnv");
	...
	public static class Operations {
		...
		public static final @NonNull ExecutorOperation _LookupEnvironment__addElement = new ExecutorOperation("addElement", Parameters._Definition, Types._LookupEnvironment,
	...
	public static class FragmentOperations {
		...
		private static final @NonNull ExecutorOperation @NonNull [] _LookupEnvironment__LookupEnvironment = {
			LookupTables.Operations._LookupEnvironment__addElement /* addElement(Definition[?]) */,
