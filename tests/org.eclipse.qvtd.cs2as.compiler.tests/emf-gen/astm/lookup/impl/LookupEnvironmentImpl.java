...
import astm.lookup.LookupEnvironment;
import astm.lookup.LookupPackage;
 ...
 * </p>
 * <ul>
 *   <li>{@link astm.lookup.impl.LookupEnvironmentImpl#getNamedElements <em>Named Elements</em>}</li>
 *   <li>{@link astm.lookup.impl.LookupEnvironmentImpl#getParentEnv <em>Parent Env</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LookupEnvironmentImpl extends MinimalEObjectImpl.Container implements LookupEnvironment {
	 ...
	 * @generated
	 */
	public <NE extends Definition> LookupEnvironment addElements(final Collection<NE> elements) {
		/**
		 *
		 * LookupEnvironment{
		...
		final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Property CTORid_parentEnv = idResolver.getProperty(LookupTables.PROPid_parentEnv);
		...
		final /*@Thrown*/ astm.lookup.@NonNull LookupEnvironment symbol_0 = (LookupEnvironment)TYP_lookup_c_c_LookupEnvironment_0.createInstance();
		@SuppressWarnings("null")
		final /*@Thrown*/ java.util.@NonNull List<Definition> namedElements = this.getNamedElements();
		final /*@Thrown*/ org.eclipse.ocl.pivot.values.@NonNull OrderedSetValue BOXED_namedElements = idResolver.createOrderedSetOfAll(LookupTables.ORD_CLSSid_Definition, namedElements);
		...
		final /*@Thrown*/ astm.lookup.@Nullable LookupEnvironment parentEnv = this.getParentEnv();
	 ...
	 * @generated
	 */
	public LookupEnvironment addElement(final Definition element) {
		/**
		 *
		 * LookupEnvironment{
		...
		final List<Definition> UNBOXED_including = including.asEcoreObjects(idResolver, astm.Definition.class);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case LookupPackage.LOOKUP_ENVIRONMENT___ADD_ELEMENT__DEFINITION:
				return addElement((Definition)arguments.get(0));
