...
import org.eclipse.qvtd.doc.ide.contentassist.antlr.PartialMiniOCLCSContentAssistParser;
...
/**
 * Manual modifications go to {@link MiniOCLCSUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractMiniOCLCSUiModule extends DefaultUiModule {

	public AbstractMiniOCLCSUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.eclipse.qvtd.doc.parser.antlr.internal.InternalMiniOCLCSLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalMiniOCLCSLexer.class).toProvider(LexerProvider.create(InternalMiniOCLCSLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return MiniOCLCSLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(MiniOCLCSDescriptionLabelProvider.class);
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return MiniOCLCSQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return MiniOCLCSProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialMiniOCLCSContentAssistParser.class;
	}
