 ...
 * from 
 *     ..\..\plugins\org.eclipse.qvtd.runtime\src\org\eclipse\qvtd\runtime\evaluation\AbstractObjectManager.java
 *
...
import org.eclipse.qvtd.doc.minioclcs.xtext.tx.SlotState.Speculating;
import org.eclipse.qvtd.doc.minioclcs.xtext.internal.tx.AbstractObjectState;
import org.eclipse.qvtd.doc.minioclcs.xtext.internal.tx.EOppositeReferenceImpl;
...
public abstract class AbstractObjectManager<SS extends SlotState> implements ObjectManager
{
	 ...
	 */
	private @NonNull Map<@NonNull Object, org.eclipse.qvtd.doc.minioclcs.xtext.internal.tx.AbstractObjectState<@NonNull SS>> object2objectState = new HashMap<>();
	 ...
	 */
	private @NonNull Map<@NonNull EReference, org.eclipse.qvtd.doc.minioclcs.xtext.internal.tx.EOppositeReferenceImpl> eReference2eOppositeReference = new HashMap<>();
