...
public class MiniOCLTables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final @NonNull Property _Class__ownedOperations = LIBRARY.createProperty(Types._Class, MiniOCLPackage.Literals.CLASS__OWNED_OPERATIONS, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Operation), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Class__ownedProperties = LIBRARY.createProperty(Types._Class, MiniOCLPackage.Literals.CLASS__OWNED_PROPERTIES, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Property), 1 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Class__superClasses = LIBRARY.createProperty(Types._Class, MiniOCLPackage.Literals.CLASS__SUPER_CLASSES, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Class), 2 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Class__Class__superClasses = LIBRARY.createOppositeProperty(Types._Class, "Class", LIBRARY.getCollectionType(OCLstdlibTables.Types._Bag, Types._Class), 3 | IsImplicit | IsRequired | IsResolveProxies, MiniOCLPackage.Literals.CLASS__SUPER_CLASSES);
		public static final @NonNull Property _Class__Constraint__constrainedElement = LIBRARY.createOppositeProperty(Types._Class, "Constraint", LIBRARY.getCollectionType(OCLstdlibTables.Types._Bag, Types._Constraint), 4 | IsImplicit | IsRequired | IsResolveProxies, MiniOCLPackage.Literals.CONSTRAINT__CONSTRAINED_ELEMENT);
		...
		public static final @NonNull Property _Class__TypedElement__type = LIBRARY.createOppositeProperty(Types._Class, "TypedElement", LIBRARY.getCollectionType(OCLstdlibTables.Types._Bag, Types._TypedElement), 6 | IsImplicit | IsRequired | IsResolveProxies, MiniOCLPackage.Literals.TYPED_ELEMENT__TYPE);
		...
		public static final @NonNull Property _CollectionLiteralExp__ownedParts = LIBRARY.createProperty(Types._CollectionLiteralExp, MiniOCLPackage.Literals.COLLECTION_LITERAL_EXP__OWNED_PARTS, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._CollectionLiteralPart), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _OCLExpression__LoopExp__ownedBody = LIBRARY.createOppositeProperty(Types._OCLExpression, "LoopExp", LIBRARY.getCollectionType(OCLstdlibTables.Types._Bag, Types._LoopExp), 6 | IsImplicit | IsRequired | IsResolveProxies, MiniOCLPackage.Literals.LOOP_EXP__OWNED_BODY);
		...
		public static final @NonNull Property _Operation__ownedParameters = LIBRARY.createProperty(Types._Operation, MiniOCLPackage.Literals.OPERATION__OWNED_PARAMETERS, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Parameter), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Operation__OperationCallExp__referredOperation = LIBRARY.createOppositeProperty(Types._Operation, "OperationCallExp", LIBRARY.getCollectionType(OCLstdlibTables.Types._Bag, Types._OperationCallExp), 3 | IsImplicit | IsRequired | IsResolveProxies, MiniOCLPackage.Literals.OPERATION_CALL_EXP__REFERRED_OPERATION);

		public static final @NonNull Property _OperationCallExp__ownedArguments = LIBRARY.createProperty(Types._OperationCallExp, MiniOCLPackage.Literals.OPERATION_CALL_EXP__OWNED_ARGUMENTS, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._OCLExpression), 0 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Package__ownedClasses = LIBRARY.createProperty(Types._Package, MiniOCLPackage.Literals.PACKAGE__OWNED_CLASSES, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Class), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Package__ownedPackages = LIBRARY.createProperty(Types._Package, MiniOCLPackage.Literals.PACKAGE__OWNED_PACKAGES, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Package), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Property__PropertyCallExp__referredProperty = LIBRARY.createOppositeProperty(Types._Property, "PropertyCallExp", LIBRARY.getCollectionType(OCLstdlibTables.Types._Bag, Types._PropertyCallExp), 3 | IsImplicit | IsRequired | IsResolveProxies, MiniOCLPackage.Literals.PROPERTY_CALL_EXP__REFERRED_PROPERTY);
		...
		public static final @NonNull Property _Root__ownedConstraints = LIBRARY.createProperty(Types._Root, MiniOCLPackage.Literals.ROOT__OWNED_CONSTRAINTS, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Constraint), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Root__ownedImports = LIBRARY.createProperty(Types._Root, MiniOCLPackage.Literals.ROOT__OWNED_IMPORTS, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Import), 1 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Root__ownedPackages = LIBRARY.createProperty(Types._Root, MiniOCLPackage.Literals.ROOT__OWNED_PACKAGES, LIBRARY.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Package), 2 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Variable__VariableExp__referredVariable = LIBRARY.createOppositeProperty(Types._Variable, "VariableExp", LIBRARY.getCollectionType(OCLstdlibTables.Types._Bag, Types._VariableExp), 5 | IsImplicit | IsRequired | IsResolveProxies, MiniOCLPackage.Literals.VARIABLE_EXP__REFERRED_VARIABLE);
