...
public class MiniOCLQualifiedClassLookupVisitor
	extends AbstractMiniOCLCommonLookupVisitor
{
    ...
    public MiniOCLQualifiedClassLookupVisitor(@NonNull LookupEnvironment context) {
        super(context);
    ...
    public /*@NonInvalid*/ LookupEnvironment visitPackage(final /*@NonInvalid*/ org.eclipse.qvtd.doc.miniocl.@org.eclipse.jdt.annotation.NonNull Package element) {
        ...
        @SuppressWarnings("null")
        final /*@Thrown*/ org.eclipse.qvtd.doc.miniocl.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment addElements = context.addElements(ownedClasses);
        return addElements;
    }
}
