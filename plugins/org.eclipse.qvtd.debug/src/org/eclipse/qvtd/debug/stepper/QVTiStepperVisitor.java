...
import org.eclipse.ocl.debug.stepper.NonStepper;
...
public class QVTiStepperVisitor extends AbstractQVTimperativeStepperVisitor
{
	...
	@Override
	public @Nullable IStepper visitEntryPoint(@NonNull EntryPoint asEntryPoint) {
		return PreStepper.INSTANCE;
	}
	...
	@Override
	public @Nullable IStepper visitNewStatementPart(@NonNull NewStatementPart object) {
		return visiting(object);
	}
	...
	@Override
	public @Nullable IStepper visitTypedModel(@NonNull TypedModel object) {
		return NonStepper.INSTANCE;
	}
}
