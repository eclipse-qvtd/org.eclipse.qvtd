...
public class QVTiVMEvaluationVisitor extends AbstractQVTiVMEvaluationVisitor 
{
...
//	private final List<UnitLocation> fLocationStack;
	...
	public QVTiVMEvaluationVisitor(@NonNull QVTiEvaluationVisitor evaluationVisitor, @NonNull IVMContext vmContext) {
...
//			fCurrentLocation = fCurrentStepMode == VMSuspension.STEP_INTO ? null : getCurrentLocation();
	...
	public @NonNull UnitLocation getCurrentLocation() {
		AbstractQVTiVMEvaluationVisitor currentVisitor = this;
		VMEvaluationEnvironment evaluationEnvironment = currentVisitor.getVMEvaluationEnvironment();
...
//		return fCurrentLocation;
	...
	@Override
	public @NonNull QVTiVMEvaluationEnvironment getEvaluationEnvironment() {
		return (QVTiVMEvaluationEnvironment) super.getEvaluationEnvironment();
	}
	...
	public @NonNull QVTiVMEvaluationVisitor getRootEvaluationVisitor() {
		return this;
	}
...
//		setCurrentLocation(transformation, newLocation, false);
	...
	private void terminate() throws VMInterruptedExecutionException {
		VMEvaluationEnvironment evalEnv = getEvaluationEnvironment();
