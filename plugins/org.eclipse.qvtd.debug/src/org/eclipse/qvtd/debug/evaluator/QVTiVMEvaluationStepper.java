...
public class QVTiVMEvaluationStepper implements VMEvaluationStepper
{
	protected final @NonNull QVTiEvaluationVisitor evaluationVisitor;
	protected final @NonNull VMExecutor executor;
...
//	private final List<UnitLocation> fLocationStack;
	...
	public QVTiVMEvaluationStepper(@NonNull QVTiEvaluationVisitor evaluationVisitor, @NonNull IVMContext vmContext) {
		...
		this.executor = (VMExecutor) evaluationVisitor.getEvaluator();
...
//		fLocationStack = new ArrayList<UnitLocation>();
		...
		invalidVariable.setType(executor.getEnvironmentFactory().getMetamodelManager().getASClass(typeName));
	}
...
//		return fCurrentLocation;
	...
	@Override
	public @NonNull QVTiVMEvaluationEnvironment getVMEvaluationEnvironment() {
		return (QVTiVMEvaluationEnvironment) executor.getEvaluationEnvironment();
	}
...
//		setCurrentLocation(transformation, newLocation, false);
	...
	@Override
	@Nullable
	public Object visiting(@NonNull Element element) {
		{
