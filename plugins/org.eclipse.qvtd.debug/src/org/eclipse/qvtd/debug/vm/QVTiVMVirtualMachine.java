...
public class QVTiVMVirtualMachine extends VMVirtualMachine
{
	...
	public static @NonNull VMStackFrameData @NonNull [] createStackFrame(List<UnitLocation> stack) {
		...
		@NonNull VMStackFrameData @NonNull [] varsArray = result.toArray(new @NonNull VMStackFrameData[result.size()]);
		return varsArray;
	}
	...
	public @NonNull VMBreakpoint createBreakpoint(@NonNull Element element, @NonNull VMNewBreakpointData data, boolean isTemporary) {
		return new QVTiBreakpoint(element, data, isTemporary);
	}
	...
	public @NonNull VMBreakpoint createBreakpoint(@NonNull Element element, long id, int line, @NonNull String targetURI, boolean isTemporary) {
		return new QVTiBreakpoint(element, id, line, targetURI, isTemporary);
	}
