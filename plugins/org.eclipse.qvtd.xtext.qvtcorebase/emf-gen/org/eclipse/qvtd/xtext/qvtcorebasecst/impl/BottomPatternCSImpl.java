 ...
 * <ul>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcorebasecst.impl.BottomPatternCSImpl#getEnforcementOperations <em>Enforcement Operations</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcorebasecst.impl.BottomPatternCSImpl#getRealizedVariables <em>Realized Variables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BottomPatternCSImpl extends PatternCSImpl implements BottomPatternCS {
	...
	protected EClass eStaticClass() {
		return QVTcoreBaseCSTPackage.Literals.BOTTOM_PATTERN_CS;
	}
	...
	public EList<EnforcementOperationCS> getEnforcementOperations() {
		if (enforcementOperations == null) {
			enforcementOperations = new EObjectContainmentEList<EnforcementOperationCS>(EnforcementOperationCS.class, this, QVTcoreBaseCSTPackage.BOTTOM_PATTERN_CS__ENFORCEMENT_OPERATIONS);
		}
	...
	public EList<RealizedVariableCS> getRealizedVariables() {
		if (realizedVariables == null) {
			realizedVariables = new EObjectContainmentEList<RealizedVariableCS>(RealizedVariableCS.class, this, QVTcoreBaseCSTPackage.BOTTOM_PATTERN_CS__REALIZED_VARIABLES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QVTcoreBaseCSTPackage.BOTTOM_PATTERN_CS__ENFORCEMENT_OPERATIONS:
				return ((InternalEList<?>)getEnforcementOperations()).basicRemove(otherEnd, msgs);
			case QVTcoreBaseCSTPackage.BOTTOM_PATTERN_CS__REALIZED_VARIABLES:
	...
	public <R> R accept(@NonNull BaseCSVisitor<R> visitor) {
		return ((QVTcoreBaseCSVisitor<R>)visitor).visitBottomPatternCS(this);
	}
} //BottomPatternCSImpl
