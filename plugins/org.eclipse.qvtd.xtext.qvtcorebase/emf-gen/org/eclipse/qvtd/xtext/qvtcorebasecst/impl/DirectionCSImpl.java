 ...
 * <ul>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcorebasecst.impl.DirectionCSImpl#getImports <em>Imports</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcorebasecst.impl.DirectionCSImpl#getUses <em>Uses</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DirectionCSImpl extends NamedElementCSImpl implements DirectionCS {
	...
	protected EClass eStaticClass() {
		return QVTcoreBaseCSTPackage.Literals.DIRECTION_CS;
	}
	...
	public EList<org.eclipse.ocl.examples.pivot.Package> getImports() {
		if (imports == null) {
			imports = new EObjectResolvingEList<org.eclipse.ocl.examples.pivot.Package>(org.eclipse.ocl.examples.pivot.Package.class, this, QVTcoreBaseCSTPackage.DIRECTION_CS__IMPORTS);
		}
		return imports;
	}
	...
	public EList<CoreDomain> getUses() {
		if (uses == null) {
			uses = new EObjectResolvingEList<CoreDomain>(CoreDomain.class, this, QVTcoreBaseCSTPackage.DIRECTION_CS__USES);
		}
		return uses;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QVTcoreBaseCSTPackage.DIRECTION_CS__IMPORTS:
				return getImports();
			case QVTcoreBaseCSTPackage.DIRECTION_CS__USES:
				return getUses();
		}
