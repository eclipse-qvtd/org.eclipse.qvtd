 ...
 * <ul>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcorebasecst.impl.DomainCSImpl#isCheck <em>Check</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcorebasecst.impl.DomainCSImpl#isEnforce <em>Enforce</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcorebasecst.impl.DomainCSImpl#getDirection <em>Direction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DomainCSImpl extends AreaCSImpl implements DomainCS {
	...
	protected EClass eStaticClass() {
		return QVTcoreBaseCSTPackage.Literals.DOMAIN_CS;
	}
	...
	public void setCheck(boolean newCheck) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTcoreBaseCSTPackage.DOMAIN_CS__CHECK, oldCheck, check));
	}
	...
	public void setEnforce(boolean newEnforce) {
		...
		enforce = newEnforce;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTcoreBaseCSTPackage.DOMAIN_CS__ENFORCE, oldEnforce, enforce));
	}
	...
	public TypedModel getDirection() {
		if (direction != null && direction.eIsProxy()) {
			...
			if (direction != oldDirection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QVTcoreBaseCSTPackage.DOMAIN_CS__DIRECTION, oldDirection, direction));
			}
		}
		return direction;
	}
	...
	public void setDirection(TypedModel newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTcoreBaseCSTPackage.DOMAIN_CS__DIRECTION, oldDirection, direction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QVTcoreBaseCSTPackage.DOMAIN_CS__CHECK:
				return isCheck();
			case QVTcoreBaseCSTPackage.DOMAIN_CS__ENFORCE:
				return isEnforce();
			case QVTcoreBaseCSTPackage.DOMAIN_CS__DIRECTION:
