...
public class AbstractQVTcoreBaseContainmentVisitor extends EssentialOCLContainmentVisitor implements QVTcoreBaseCSVisitor<Continuation<?>>
{
	//
	//	This file is maintained by copying from AbstractExtendingQVTcoreCSVisitor and changing R to Continuation<?>.
	//
	public AbstractQVTcoreBaseContainmentVisitor(@NonNull CS2PivotConversion context) {
		super(context);
	}	
