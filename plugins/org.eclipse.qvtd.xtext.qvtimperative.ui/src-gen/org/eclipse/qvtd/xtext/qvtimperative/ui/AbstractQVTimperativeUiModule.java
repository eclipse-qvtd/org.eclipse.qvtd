...
import org.eclipse.qvtd.xtext.qvtimperative.ide.contentassist.antlr.PartialQVTimperativeContentAssistParser;
import org.eclipse.qvtd.xtext.qvtimperative.ide.contentassist.antlr.QVTimperativeParser;
import org.eclipse.qvtd.xtext.qvtimperative.ide.contentassist.antlr.internal.InternalQVTimperativeLexer;
import org.eclipse.qvtd.xtext.qvtimperative.ui.contentassist.QVTimperativeProposalProvider;
import org.eclipse.qvtd.xtext.qvtimperative.ui.labeling.QVTimperativeDescriptionLabelProvider;
import org.eclipse.qvtd.xtext.qvtimperative.ui.labeling.QVTimperativeLabelProvider;
import org.eclipse.qvtd.xtext.qvtimperative.ui.outline.QVTimperativeOutlineTreeProvider;
import org.eclipse.qvtd.xtext.qvtimperative.ui.quickfix.QVTimperativeQuickfixProvider;
...
/**
 * Manual modifications go to {@link QVTimperativeUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractQVTimperativeUiModule extends DefaultUiModule {
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalQVTimperativeLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.eclipse.qvtd.xtext.qvtimperative.parser.antlr.internal.InternalQVTimperativeLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return QVTimperativeParser.class;
	}

	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalQVTimperativeLexer.class).toProvider(LexerProvider.create(InternalQVTimperativeLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return QVTimperativeLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(QVTimperativeDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return QVTimperativeOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return QVTimperativeQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return QVTimperativeProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialQVTimperativeContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("QVTimperative Compare");
	}
