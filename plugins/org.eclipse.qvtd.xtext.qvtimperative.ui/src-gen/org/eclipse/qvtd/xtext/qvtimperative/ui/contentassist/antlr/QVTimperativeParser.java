		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMiddleBottomPatternCSAccess().getOwnedConstraintsAssignment_2(), "rule__MiddleBottomPatternCS__OwnedConstraintsAssignment_2");
					...
					put(grammarAccess.getTargetBottomPatternCSAccess().getOwnedUnrealizedVariablesAssignment_2_0_0(), "rule__TargetBottomPatternCS__OwnedUnrealizedVariablesAssignment_2_0_0");
					put(grammarAccess.getTargetBottomPatternCSAccess().getOwnedRealizedVariablesAssignment_2_0_1(), "rule__TargetBottomPatternCS__OwnedRealizedVariablesAssignment_2_0_1");
					put(grammarAccess.getTargetBottomPatternCSAccess().getOwnedUnrealizedVariablesAssignment_2_1_1_0(), "rule__TargetBottomPatternCS__OwnedUnrealizedVariablesAssignment_2_1_1_0");
					put(grammarAccess.getTargetBottomPatternCSAccess().getOwnedRealizedVariablesAssignment_2_1_1_1(), "rule__TargetBottomPatternCS__OwnedRealizedVariablesAssignment_2_1_1_1");
