		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBottomPatternCSAccess().getAlternatives_2_0_0(), "rule__BottomPatternCS__Alternatives_2_0_0");
					put(grammarAccess.getBottomPatternCSAccess().getAlternatives_2_0_1_1(), "rule__BottomPatternCS__Alternatives_2_0_1_1");
					...
					put(grammarAccess.getMiddleBottomPatternCSAccess().getGroup(), "rule__MiddleBottomPatternCS__Group__0");
					put(grammarAccess.getMiddleGuardPatternCSAccess().getGroup(), "rule__MiddleGuardPatternCS__Group__0");
					...
					put(grammarAccess.getBottomPatternCSAccess().getGroup_2_0(), "rule__BottomPatternCS__Group_2_0__0");
					put(grammarAccess.getBottomPatternCSAccess().getGroup_2_0_1(), "rule__BottomPatternCS__Group_2_0_1__0");
					put(grammarAccess.getBottomPatternCSAccess().getGroup_2_0_2(), "rule__BottomPatternCS__Group_2_0_2__0");
					...
					put(grammarAccess.getGuardPatternCSAccess().getGroup_2_0(), "rule__GuardPatternCS__Group_2_0__0");
					put(grammarAccess.getGuardPatternCSAccess().getGroup_2_0_1(), "rule__GuardPatternCS__Group_2_0_1__0");
					put(grammarAccess.getGuardPatternCSAccess().getGroup_2_0_2(), "rule__GuardPatternCS__Group_2_0_2__0");
					...
					put(grammarAccess.getMappingLoopCSAccess().getInExpressionAssignment_3(), "rule__MappingLoopCS__InExpressionAssignment_3");
					put(grammarAccess.getMappingLoopCSAccess().getMappingSequenceAssignment_5(), "rule__MappingLoopCS__MappingSequenceAssignment_5");
					...
					put(grammarAccess.getMappingSequenceCSAccess().getMappingStatementsAssignment(), "rule__MappingSequenceCS__MappingStatementsAssignment");
					put(grammarAccess.getSourceDomainCSAccess().getCheckAssignment_0(), "rule__SourceDomainCS__CheckAssignment_0");
					put(grammarAccess.getSourceDomainCSAccess().getDirectionAssignment_1(), "rule__SourceDomainCS__DirectionAssignment_1");
					put(grammarAccess.getSourceDomainCSAccess().getGuardPatternAssignment_2(), "rule__SourceDomainCS__GuardPatternAssignment_2");
					put(grammarAccess.getSourceDomainCSAccess().getBottomPatternAssignment_3(), "rule__SourceDomainCS__BottomPatternAssignment_3");
					put(grammarAccess.getSourceGuardPatternCSAccess().getUnrealizedVariablesAssignment_2_0(), "rule__SourceGuardPatternCS__UnrealizedVariablesAssignment_2_0");
					put(grammarAccess.getSourceGuardPatternCSAccess().getUnrealizedVariablesAssignment_2_1_1(), "rule__SourceGuardPatternCS__UnrealizedVariablesAssignment_2_1_1");
					put(grammarAccess.getMiddleDomainCSAccess().getGuardPatternAssignment_1(), "rule__MiddleDomainCS__GuardPatternAssignment_1");
					put(grammarAccess.getMiddleDomainCSAccess().getBottomPatternAssignment_2(), "rule__MiddleDomainCS__BottomPatternAssignment_2");
					put(grammarAccess.getMiddleBottomPatternCSAccess().getConstraintsAssignment_2(), "rule__MiddleBottomPatternCS__ConstraintsAssignment_2");
					put(grammarAccess.getMiddleGuardPatternCSAccess().getConstraintsAssignment_2(), "rule__MiddleGuardPatternCS__ConstraintsAssignment_2");
					put(grammarAccess.getTargetDomainCSAccess().getEnforceAssignment_0(), "rule__TargetDomainCS__EnforceAssignment_0");
					put(grammarAccess.getTargetDomainCSAccess().getDirectionAssignment_1(), "rule__TargetDomainCS__DirectionAssignment_1");
					put(grammarAccess.getTargetDomainCSAccess().getGuardPatternAssignment_2(), "rule__TargetDomainCS__GuardPatternAssignment_2");
					put(grammarAccess.getTargetDomainCSAccess().getBottomPatternAssignment_3(), "rule__TargetDomainCS__BottomPatternAssignment_3");
					put(grammarAccess.getTargetBottomPatternCSAccess().getUnrealizedVariablesAssignment_2_0_0(), "rule__TargetBottomPatternCS__UnrealizedVariablesAssignment_2_0_0");
					put(grammarAccess.getTargetBottomPatternCSAccess().getRealizedVariablesAssignment_2_0_1(), "rule__TargetBottomPatternCS__RealizedVariablesAssignment_2_0_1");
					put(grammarAccess.getTargetBottomPatternCSAccess().getUnrealizedVariablesAssignment_2_1_1_0(), "rule__TargetBottomPatternCS__UnrealizedVariablesAssignment_2_1_1_0");
					put(grammarAccess.getTargetBottomPatternCSAccess().getRealizedVariablesAssignment_2_1_1_1(), "rule__TargetBottomPatternCS__RealizedVariablesAssignment_2_1_1_1");
					put(grammarAccess.getTargetGuardPatternCSAccess().getUnrealizedVariablesAssignment_2_0(), "rule__TargetGuardPatternCS__UnrealizedVariablesAssignment_2_0");
					put(grammarAccess.getTargetGuardPatternCSAccess().getUnrealizedVariablesAssignment_2_1_1(), "rule__TargetGuardPatternCS__UnrealizedVariablesAssignment_2_1_1");
					put(grammarAccess.getBottomPatternCSAccess().getUnrealizedVariablesAssignment_2_0_0_0(), "rule__BottomPatternCS__UnrealizedVariablesAssignment_2_0_0_0");
					put(grammarAccess.getBottomPatternCSAccess().getRealizedVariablesAssignment_2_0_0_1(), "rule__BottomPatternCS__RealizedVariablesAssignment_2_0_0_1");
					put(grammarAccess.getBottomPatternCSAccess().getUnrealizedVariablesAssignment_2_0_1_1_0(), "rule__BottomPatternCS__UnrealizedVariablesAssignment_2_0_1_1_0");
					put(grammarAccess.getBottomPatternCSAccess().getRealizedVariablesAssignment_2_0_1_1_1(), "rule__BottomPatternCS__RealizedVariablesAssignment_2_0_1_1_1");
					put(grammarAccess.getBottomPatternCSAccess().getConstraintsAssignment_2_0_2_1(), "rule__BottomPatternCS__ConstraintsAssignment_2_0_2_1");
					put(grammarAccess.getBottomPatternCSAccess().getConstraintsAssignment_2_1(), "rule__BottomPatternCS__ConstraintsAssignment_2_1");
					...
					put(grammarAccess.getGuardPatternCSAccess().getUnrealizedVariablesAssignment_2_0_0(), "rule__GuardPatternCS__UnrealizedVariablesAssignment_2_0_0");
					put(grammarAccess.getGuardPatternCSAccess().getUnrealizedVariablesAssignment_2_0_1_1(), "rule__GuardPatternCS__UnrealizedVariablesAssignment_2_0_1_1");
					put(grammarAccess.getGuardPatternCSAccess().getConstraintsAssignment_2_0_2_1(), "rule__GuardPatternCS__ConstraintsAssignment_2_0_2_1");
					put(grammarAccess.getGuardPatternCSAccess().getConstraintsAssignment_2_1(), "rule__GuardPatternCS__ConstraintsAssignment_2_1");
