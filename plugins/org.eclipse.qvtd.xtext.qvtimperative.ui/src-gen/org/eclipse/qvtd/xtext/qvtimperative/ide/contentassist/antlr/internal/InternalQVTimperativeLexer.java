...
public class InternalQVTimperativeLexer extends Lexer {
    ...
    public final void mRULE_UNQUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31952:22: ( '\\u00A3$%^\\u00A3$%^' )
            // InternalQVTimperative.g:31952:24: '\\u00A3$%^\\u00A3$%^'
            {
            match("\u00A3$%^\u00A3$%^");
    ...
    public final void mRULE_ESCAPED_CHARACTER() throws RecognitionException {
        try {
            // InternalQVTimperative.g:31954:33: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) )
            // InternalQVTimperative.g:31954:35: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
            {
            match('\\');
    ...
    public final void mRULE_LETTER_CHARACTER() throws RecognitionException {
        try {
            // InternalQVTimperative.g:31956:32: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) )
            // InternalQVTimperative.g:31956:34: ( 'a' .. 'z' | 'A' .. 'Z' | '_' )
            {
    ...
    public final void mRULE_DOUBLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31958:27: ( '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalQVTimperative.g:31958:29: '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"');
            // InternalQVTimperative.g:31958:33: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )*
            loop1:
            do {
                int alt1=3;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalQVTimperative.g:31958:34: RULE_ESCAPED_CHARACTER
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // InternalQVTimperative.g:31958:57: ~ ( ( '\\\\' | '\"' ) )
            	    {
    ...
    public final void mRULE_SINGLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31960:27: ( '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalQVTimperative.g:31960:29: '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\'');
            // InternalQVTimperative.g:31960:34: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop2:
            do {
                int alt2=3;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalQVTimperative.g:31960:35: RULE_ESCAPED_CHARACTER
            	    {
            	    mRULE_ESCAPED_CHARACTER();
            	    ...
            	    break;
            	case 2 :
            	    // InternalQVTimperative.g:31960:58: ~ ( ( '\\\\' | '\\'' ) )
            	    {
            	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
            	        input.consume();
    ...
    public final void mRULE_ML_SINGLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31962:30: ( '/\\'' ( options {greedy=false; } : . )* '\\'/' )
            // InternalQVTimperative.g:31962:32: '/\\'' ( options {greedy=false; } : . )* '\\'/'
            {
            match("/'");

            // InternalQVTimperative.g:31962:38: ( options {greedy=false; } : . )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalQVTimperative.g:31962:66: .
            	    {
            	    matchAny();
    ...
    public final void mRULE_SIMPLE_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31964:16: ( RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )* )
            // InternalQVTimperative.g:31964:18: RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )*
            {
            mRULE_LETTER_CHARACTER();
            // InternalQVTimperative.g:31964:40: ( RULE_LETTER_CHARACTER | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_ESCAPED_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31966:17: ( '_' RULE_SINGLE_QUOTED_STRING )
            // InternalQVTimperative.g:31966:19: '_' RULE_SINGLE_QUOTED_STRING
            {
            match('_');
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31968:10: ( ( '0' .. '9' )+ )
            // InternalQVTimperative.g:31968:12: ( '0' .. '9' )+
            {
            // InternalQVTimperative.g:31968:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalQVTimperative.g:31968:13: '0' .. '9'
            	    {
            	    matchRange('0','9');
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31970:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalQVTimperative.g:31970:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*");

            // InternalQVTimperative.g:31970:24: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalQVTimperative.g:31970:52: .
            	    {
            	    matchAny();
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31972:17: ( '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalQVTimperative.g:31972:19: '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("--");

            // InternalQVTimperative.g:31972:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop7:
            do {
                int alt7=2;
            ...
            // InternalQVTimperative.g:31972:40: ( ( '\\r' )? '\\n' )?
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalQVTimperative.g:31972:41: ( '\\r' )? '\\n'
                    {
                    // InternalQVTimperative.g:31972:41: ( '\\r' )?
                    int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31974:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalQVTimperative.g:31974:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalQVTimperative.g:31974:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTimperative.g:31976:16: ( . )
            // InternalQVTimperative.g:31976:18: .
            {
            matchAny();
