...
import org.eclipse.qvtd.xtext.qvtimperative.ide.contentassist.antlr.internal.InternalQVTimperativeParser;
...
public class QVTimperativeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(QVTimperativeGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, QVTimperativeGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getTopLevelCSAccess().getAlternatives_1(), "rule__TopLevelCS__Alternatives_1");
			builder.put(grammarAccess.getCommitStatementCSAccess().getAlternatives(), "rule__CommitStatementCS__Alternatives");
			builder.put(grammarAccess.getControlStatementCSAccess().getAlternatives(), "rule__ControlStatementCS__Alternatives");
			builder.put(grammarAccess.getGuardStatementCSAccess().getAlternatives(), "rule__GuardStatementCS__Alternatives");
			builder.put(grammarAccess.getMappingCallCSAccess().getAlternatives_1(), "rule__MappingCallCS__Alternatives_1");
			builder.put(grammarAccess.getMappingParameterBindingCSAccess().getAlternatives(), "rule__MappingParameterBindingCS__Alternatives");
			builder.put(grammarAccess.getMappingParameterCSAccess().getAlternatives(), "rule__MappingParameterCS__Alternatives");
			...
			builder.put(grammarAccess.getQueryCSAccess().getAlternatives_8(), "rule__QueryCS__Alternatives_8");
			builder.put(grammarAccess.getSetStatementCSAccess().getAlternatives_6(), "rule__SetStatementCS__Alternatives_6");
			builder.put(grammarAccess.getTransformationCSAccess().getAlternatives_6(), "rule__TransformationCS__Alternatives_6");
			builder.put(grammarAccess.getTransformationCSAccess().getOwnedMappingsAlternatives_6_0_0(), "rule__TransformationCS__OwnedMappingsAlternatives_6_0_0");
			builder.put(grammarAccess.getQVTimperativeUnrestrictedNameAccess().getAlternatives(), "rule__QVTimperativeUnrestrictedName__Alternatives");
			...
			builder.put(grammarAccess.getAddStatementCSAccess().getGroup(), "rule__AddStatementCS__Group__0");
			builder.put(grammarAccess.getAddStatementCSAccess().getGroup_0(), "rule__AddStatementCS__Group_0__0");
			builder.put(grammarAccess.getAddStatementCSAccess().getGroup_0_2(), "rule__AddStatementCS__Group_0_2__0");
			builder.put(grammarAccess.getAppendParameterBindingCSAccess().getGroup(), "rule__AppendParameterBindingCS__Group__0");
			builder.put(grammarAccess.getAppendParameterCSAccess().getGroup(), "rule__AppendParameterCS__Group__0");
			builder.put(grammarAccess.getBufferStatementCSAccess().getGroup(), "rule__BufferStatementCS__Group__0");
			builder.put(grammarAccess.getBufferStatementCSAccess().getGroup_2(), "rule__BufferStatementCS__Group_2__0");
			builder.put(grammarAccess.getBufferStatementCSAccess().getGroup_2_2(), "rule__BufferStatementCS__Group_2_2__0");
			builder.put(grammarAccess.getBufferStatementCSAccess().getGroup_4(), "rule__BufferStatementCS__Group_4__0");
			builder.put(grammarAccess.getBufferStatementCSAccess().getGroup_5(), "rule__BufferStatementCS__Group_5__0");
			builder.put(grammarAccess.getCheckStatementCSAccess().getGroup(), "rule__CheckStatementCS__Group__0");
			builder.put(grammarAccess.getCheckStatementCSAccess().getGroup_0(), "rule__CheckStatementCS__Group_0__0");
			builder.put(grammarAccess.getCheckStatementCSAccess().getGroup_0_2(), "rule__CheckStatementCS__Group_0_2__0");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getGroup(), "rule__DeclareStatementCS__Group__0");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getGroup_0(), "rule__DeclareStatementCS__Group_0__0");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getGroup_0_2(), "rule__DeclareStatementCS__Group_0_2__0");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getGroup_4(), "rule__DeclareStatementCS__Group_4__0");
			builder.put(grammarAccess.getDirectionCSAccess().getGroup(), "rule__DirectionCS__Group__0");
			builder.put(grammarAccess.getDirectionCSAccess().getGroup_2(), "rule__DirectionCS__Group_2__0");
			builder.put(grammarAccess.getDirectionCSAccess().getGroup_2_2(), "rule__DirectionCS__Group_2_2__0");
			builder.put(grammarAccess.getEntryPointCSAccess().getGroup(), "rule__EntryPointCS__Group__0");
			builder.put(grammarAccess.getEntryPointCSAccess().getGroup_3(), "rule__EntryPointCS__Group_3__0");
			builder.put(grammarAccess.getEntryPointCSAccess().getGroup_5(), "rule__EntryPointCS__Group_5__0");
			builder.put(grammarAccess.getEntryPointCSAccess().getGroup_5_2(), "rule__EntryPointCS__Group_5_2__0");
			builder.put(grammarAccess.getEntryPointCSAccess().getGroup_6(), "rule__EntryPointCS__Group_6__0");
			builder.put(grammarAccess.getEntryPointCSAccess().getGroup_6_2(), "rule__EntryPointCS__Group_6_2__0");
			builder.put(grammarAccess.getGuardParameterBindingCSAccess().getGroup(), "rule__GuardParameterBindingCS__Group__0");
			builder.put(grammarAccess.getGuardParameterCSAccess().getGroup(), "rule__GuardParameterCS__Group__0");
			builder.put(grammarAccess.getGuardParameterCSAccess().getGroup_6(), "rule__GuardParameterCS__Group_6__0");
			...
			builder.put(grammarAccess.getLoopParameterBindingCSAccess().getGroup(), "rule__LoopParameterBindingCS__Group__0");
			builder.put(grammarAccess.getMappingCSAccess().getGroup(), "rule__MappingCS__Group__0");
			builder.put(grammarAccess.getMappingCSAccess().getGroup_3(), "rule__MappingCS__Group_3__0");
			builder.put(grammarAccess.getMappingCSAccess().getGroup_3_2(), "rule__MappingCS__Group_3_2__0");
			builder.put(grammarAccess.getMappingCallCSAccess().getGroup(), "rule__MappingCallCS__Group__0");
			builder.put(grammarAccess.getMappingLoopCSAccess().getGroup(), "rule__MappingLoopCS__Group__0");
			builder.put(grammarAccess.getMappingLoopCSAccess().getGroup_0(), "rule__MappingLoopCS__Group_0__0");
			builder.put(grammarAccess.getMappingLoopCSAccess().getGroup_0_2(), "rule__MappingLoopCS__Group_0_2__0");
			builder.put(grammarAccess.getMappingIteratorCSAccess().getGroup(), "rule__MappingIteratorCS__Group__0");
			builder.put(grammarAccess.getMappingIteratorCSAccess().getGroup_1(), "rule__MappingIteratorCS__Group_1__0");
			builder.put(grammarAccess.getNewStatementCSAccess().getGroup(), "rule__NewStatementCS__Group__0");
			builder.put(grammarAccess.getNewStatementCSAccess().getGroup_0(), "rule__NewStatementCS__Group_0__0");
			builder.put(grammarAccess.getNewStatementCSAccess().getGroup_0_2(), "rule__NewStatementCS__Group_0_2__0");
			builder.put(grammarAccess.getNewStatementCSAccess().getGroup_8(), "rule__NewStatementCS__Group_8__0");
			...
			builder.put(grammarAccess.getQueryCSAccess().getGroup_4(), "rule__QueryCS__Group_4__0");
			builder.put(grammarAccess.getQueryCSAccess().getGroup_4_1(), "rule__QueryCS__Group_4_1__0");
			builder.put(grammarAccess.getQueryCSAccess().getGroup_8_1(), "rule__QueryCS__Group_8_1__0");
			builder.put(grammarAccess.getQueryCSAccess().getGroup_8_2(), "rule__QueryCS__Group_8_2__0");
			...
			builder.put(grammarAccess.getSetStatementCSAccess().getGroup(), "rule__SetStatementCS__Group__0");
			builder.put(grammarAccess.getSetStatementCSAccess().getGroup_0(), "rule__SetStatementCS__Group_0__0");
			builder.put(grammarAccess.getSetStatementCSAccess().getGroup_0_2(), "rule__SetStatementCS__Group_0_2__0");
			builder.put(grammarAccess.getSimpleParameterBindingCSAccess().getGroup(), "rule__SimpleParameterBindingCS__Group__0");
			builder.put(grammarAccess.getSimpleParameterCSAccess().getGroup(), "rule__SimpleParameterCS__Group__0");
			builder.put(grammarAccess.getSpeculateStatementCSAccess().getGroup(), "rule__SpeculateStatementCS__Group__0");
			...
			builder.put(grammarAccess.getAddStatementCSAccess().getObservedPropertiesAssignment_0_1(), "rule__AddStatementCS__ObservedPropertiesAssignment_0_1");
			builder.put(grammarAccess.getAddStatementCSAccess().getObservedPropertiesAssignment_0_2_1(), "rule__AddStatementCS__ObservedPropertiesAssignment_0_2_1");
			builder.put(grammarAccess.getAddStatementCSAccess().getTargetVariableAssignment_2(), "rule__AddStatementCS__TargetVariableAssignment_2");
			builder.put(grammarAccess.getAddStatementCSAccess().getOwnedExpressionAssignment_4(), "rule__AddStatementCS__OwnedExpressionAssignment_4");
			builder.put(grammarAccess.getAppendParameterBindingCSAccess().getReferredVariableAssignment_0(), "rule__AppendParameterBindingCS__ReferredVariableAssignment_0");
			builder.put(grammarAccess.getAppendParameterBindingCSAccess().getValueAssignment_2(), "rule__AppendParameterBindingCS__ValueAssignment_2");
			builder.put(grammarAccess.getAppendParameterCSAccess().getNameAssignment_1(), "rule__AppendParameterCS__NameAssignment_1");
			builder.put(grammarAccess.getAppendParameterCSAccess().getOwnedTypeAssignment_3(), "rule__AppendParameterCS__OwnedTypeAssignment_3");
			builder.put(grammarAccess.getBufferStatementCSAccess().getIsStrictAssignment_0(), "rule__BufferStatementCS__IsStrictAssignment_0");
			builder.put(grammarAccess.getBufferStatementCSAccess().getFirstPassAssignment_2_1(), "rule__BufferStatementCS__FirstPassAssignment_2_1");
			builder.put(grammarAccess.getBufferStatementCSAccess().getLastPassAssignment_2_2_1(), "rule__BufferStatementCS__LastPassAssignment_2_2_1");
			builder.put(grammarAccess.getBufferStatementCSAccess().getNameAssignment_3(), "rule__BufferStatementCS__NameAssignment_3");
			builder.put(grammarAccess.getBufferStatementCSAccess().getOwnedTypeAssignment_4_1(), "rule__BufferStatementCS__OwnedTypeAssignment_4_1");
			builder.put(grammarAccess.getBufferStatementCSAccess().getOwnedExpressionAssignment_5_1(), "rule__BufferStatementCS__OwnedExpressionAssignment_5_1");
			builder.put(grammarAccess.getCheckStatementCSAccess().getObservedPropertiesAssignment_0_1(), "rule__CheckStatementCS__ObservedPropertiesAssignment_0_1");
			builder.put(grammarAccess.getCheckStatementCSAccess().getObservedPropertiesAssignment_0_2_1(), "rule__CheckStatementCS__ObservedPropertiesAssignment_0_2_1");
			builder.put(grammarAccess.getCheckStatementCSAccess().getOwnedConditionAssignment_2(), "rule__CheckStatementCS__OwnedConditionAssignment_2");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getObservedPropertiesAssignment_0_1(), "rule__DeclareStatementCS__ObservedPropertiesAssignment_0_1");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getObservedPropertiesAssignment_0_2_1(), "rule__DeclareStatementCS__ObservedPropertiesAssignment_0_2_1");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getIsCheckAssignment_1(), "rule__DeclareStatementCS__IsCheckAssignment_1");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getNameAssignment_3(), "rule__DeclareStatementCS__NameAssignment_3");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getOwnedTypeAssignment_4_1(), "rule__DeclareStatementCS__OwnedTypeAssignment_4_1");
			builder.put(grammarAccess.getDeclareStatementCSAccess().getOwnedExpressionAssignment_6(), "rule__DeclareStatementCS__OwnedExpressionAssignment_6");
			builder.put(grammarAccess.getDirectionCSAccess().getNameAssignment_1(), "rule__DirectionCS__NameAssignment_1");
			builder.put(grammarAccess.getDirectionCSAccess().getImportsAssignment_2_1(), "rule__DirectionCS__ImportsAssignment_2_1");
			builder.put(grammarAccess.getDirectionCSAccess().getImportsAssignment_2_2_1(), "rule__DirectionCS__ImportsAssignment_2_2_1");
			builder.put(grammarAccess.getEntryPointCSAccess().getIsStrictAssignment_1(), "rule__EntryPointCS__IsStrictAssignment_1");
			builder.put(grammarAccess.getEntryPointCSAccess().getTargetNameAssignment_3_1(), "rule__EntryPointCS__TargetNameAssignment_3_1");
			builder.put(grammarAccess.getEntryPointCSAccess().getNameAssignment_4(), "rule__EntryPointCS__NameAssignment_4");
			builder.put(grammarAccess.getEntryPointCSAccess().getInputTypedModelsAssignment_5_1(), "rule__EntryPointCS__InputTypedModelsAssignment_5_1");
			builder.put(grammarAccess.getEntryPointCSAccess().getInputTypedModelsAssignment_5_2_1(), "rule__EntryPointCS__InputTypedModelsAssignment_5_2_1");
			builder.put(grammarAccess.getEntryPointCSAccess().getOutputTypedModelsAssignment_6_1(), "rule__EntryPointCS__OutputTypedModelsAssignment_6_1");
			builder.put(grammarAccess.getEntryPointCSAccess().getOutputTypedModelsAssignment_6_2_1(), "rule__EntryPointCS__OutputTypedModelsAssignment_6_2_1");
			builder.put(grammarAccess.getEntryPointCSAccess().getOwnedParametersAssignment_8(), "rule__EntryPointCS__OwnedParametersAssignment_8");
			builder.put(grammarAccess.getEntryPointCSAccess().getOwnedStatementsAssignment_9(), "rule__EntryPointCS__OwnedStatementsAssignment_9");
			builder.put(grammarAccess.getEntryPointCSAccess().getOwnedStatementsAssignment_10(), "rule__EntryPointCS__OwnedStatementsAssignment_10");
			builder.put(grammarAccess.getEntryPointCSAccess().getOwnedStatementsAssignment_11(), "rule__EntryPointCS__OwnedStatementsAssignment_11");
			builder.put(grammarAccess.getGuardParameterBindingCSAccess().getIsCheckAssignment_0(), "rule__GuardParameterBindingCS__IsCheckAssignment_0");
			builder.put(grammarAccess.getGuardParameterBindingCSAccess().getReferredVariableAssignment_1(), "rule__GuardParameterBindingCS__ReferredVariableAssignment_1");
			builder.put(grammarAccess.getGuardParameterBindingCSAccess().getValueAssignment_3(), "rule__GuardParameterBindingCS__ValueAssignment_3");
			builder.put(grammarAccess.getGuardParameterCSAccess().getReferredTypedModelAssignment_2(), "rule__GuardParameterCS__ReferredTypedModelAssignment_2");
			builder.put(grammarAccess.getGuardParameterCSAccess().getNameAssignment_3(), "rule__GuardParameterCS__NameAssignment_3");
			builder.put(grammarAccess.getGuardParameterCSAccess().getOwnedTypeAssignment_5(), "rule__GuardParameterCS__OwnedTypeAssignment_5");
			builder.put(grammarAccess.getGuardParameterCSAccess().getSuccessPropertyAssignment_6_1(), "rule__GuardParameterCS__SuccessPropertyAssignment_6_1");
			...
			builder.put(grammarAccess.getLoopParameterBindingCSAccess().getIsCheckAssignment_0(), "rule__LoopParameterBindingCS__IsCheckAssignment_0");
			builder.put(grammarAccess.getLoopParameterBindingCSAccess().getReferredVariableAssignment_1(), "rule__LoopParameterBindingCS__ReferredVariableAssignment_1");
			builder.put(grammarAccess.getLoopParameterBindingCSAccess().getValueAssignment_3(), "rule__LoopParameterBindingCS__ValueAssignment_3");
			builder.put(grammarAccess.getMappingCSAccess().getIsStrictAssignment_1(), "rule__MappingCS__IsStrictAssignment_1");
			builder.put(grammarAccess.getMappingCSAccess().getFirstPassAssignment_3_1(), "rule__MappingCS__FirstPassAssignment_3_1");
			builder.put(grammarAccess.getMappingCSAccess().getLastPassAssignment_3_2_1(), "rule__MappingCS__LastPassAssignment_3_2_1");
			builder.put(grammarAccess.getMappingCSAccess().getNameAssignment_4(), "rule__MappingCS__NameAssignment_4");
			builder.put(grammarAccess.getMappingCSAccess().getOwnedParametersAssignment_6(), "rule__MappingCS__OwnedParametersAssignment_6");
			builder.put(grammarAccess.getMappingCSAccess().getOwnedStatementsAssignment_7(), "rule__MappingCS__OwnedStatementsAssignment_7");
			builder.put(grammarAccess.getMappingCSAccess().getOwnedStatementsAssignment_8(), "rule__MappingCS__OwnedStatementsAssignment_8");
			builder.put(grammarAccess.getMappingCSAccess().getOwnedStatementsAssignment_9(), "rule__MappingCS__OwnedStatementsAssignment_9");
			builder.put(grammarAccess.getMappingCallCSAccess().getIsInstallAssignment_1_1(), "rule__MappingCallCS__IsInstallAssignment_1_1");
			builder.put(grammarAccess.getMappingCallCSAccess().getIsInvokeAssignment_1_2(), "rule__MappingCallCS__IsInvokeAssignment_1_2");
			builder.put(grammarAccess.getMappingCallCSAccess().getOwnedPathNameAssignment_2(), "rule__MappingCallCS__OwnedPathNameAssignment_2");
			builder.put(grammarAccess.getMappingCallCSAccess().getOwnedBindingsAssignment_4(), "rule__MappingCallCS__OwnedBindingsAssignment_4");
			builder.put(grammarAccess.getMappingLoopCSAccess().getObservedPropertiesAssignment_0_1(), "rule__MappingLoopCS__ObservedPropertiesAssignment_0_1");
			builder.put(grammarAccess.getMappingLoopCSAccess().getObservedPropertiesAssignment_0_2_1(), "rule__MappingLoopCS__ObservedPropertiesAssignment_0_2_1");
			builder.put(grammarAccess.getMappingLoopCSAccess().getOwnedIteratorAssignment_2(), "rule__MappingLoopCS__OwnedIteratorAssignment_2");
			builder.put(grammarAccess.getMappingLoopCSAccess().getOwnedInExpressionAssignment_4(), "rule__MappingLoopCS__OwnedInExpressionAssignment_4");
			builder.put(grammarAccess.getMappingLoopCSAccess().getOwnedMappingStatementsAssignment_6(), "rule__MappingLoopCS__OwnedMappingStatementsAssignment_6");
			builder.put(grammarAccess.getMappingIteratorCSAccess().getNameAssignment_0(), "rule__MappingIteratorCS__NameAssignment_0");
			builder.put(grammarAccess.getMappingIteratorCSAccess().getOwnedTypeAssignment_1_1(), "rule__MappingIteratorCS__OwnedTypeAssignment_1_1");
			builder.put(grammarAccess.getNewStatementCSAccess().getObservedPropertiesAssignment_0_1(), "rule__NewStatementCS__ObservedPropertiesAssignment_0_1");
			builder.put(grammarAccess.getNewStatementCSAccess().getObservedPropertiesAssignment_0_2_1(), "rule__NewStatementCS__ObservedPropertiesAssignment_0_2_1");
			builder.put(grammarAccess.getNewStatementCSAccess().getIsContainedAssignment_1(), "rule__NewStatementCS__IsContainedAssignment_1");
			builder.put(grammarAccess.getNewStatementCSAccess().getReferredTypedModelAssignment_4(), "rule__NewStatementCS__ReferredTypedModelAssignment_4");
			builder.put(grammarAccess.getNewStatementCSAccess().getNameAssignment_5(), "rule__NewStatementCS__NameAssignment_5");
			builder.put(grammarAccess.getNewStatementCSAccess().getOwnedTypeAssignment_7(), "rule__NewStatementCS__OwnedTypeAssignment_7");
			builder.put(grammarAccess.getNewStatementCSAccess().getOwnedExpressionAssignment_8_1(), "rule__NewStatementCS__OwnedExpressionAssignment_8_1");
			...
			builder.put(grammarAccess.getQueryCSAccess().getNameAssignment_2(), "rule__QueryCS__NameAssignment_2");
			builder.put(grammarAccess.getQueryCSAccess().getOwnedParametersAssignment_4_0(), "rule__QueryCS__OwnedParametersAssignment_4_0");
			builder.put(grammarAccess.getQueryCSAccess().getOwnedParametersAssignment_4_1_1(), "rule__QueryCS__OwnedParametersAssignment_4_1_1");
			builder.put(grammarAccess.getQueryCSAccess().getOwnedTypeAssignment_7(), "rule__QueryCS__OwnedTypeAssignment_7");
			builder.put(grammarAccess.getQueryCSAccess().getOwnedExpressionAssignment_8_1_1(), "rule__QueryCS__OwnedExpressionAssignment_8_1_1");
			builder.put(grammarAccess.getQueryCSAccess().getImplementationAssignment_8_2_1(), "rule__QueryCS__ImplementationAssignment_8_2_1");
			...
			builder.put(grammarAccess.getSetStatementCSAccess().getObservedPropertiesAssignment_0_1(), "rule__SetStatementCS__ObservedPropertiesAssignment_0_1");
			builder.put(grammarAccess.getSetStatementCSAccess().getObservedPropertiesAssignment_0_2_1(), "rule__SetStatementCS__ObservedPropertiesAssignment_0_2_1");
			builder.put(grammarAccess.getSetStatementCSAccess().getIsNotifyAssignment_1(), "rule__SetStatementCS__IsNotifyAssignment_1");
			builder.put(grammarAccess.getSetStatementCSAccess().getReferredVariableAssignment_3(), "rule__SetStatementCS__ReferredVariableAssignment_3");
			builder.put(grammarAccess.getSetStatementCSAccess().getReferredPropertyAssignment_5(), "rule__SetStatementCS__ReferredPropertyAssignment_5");
			builder.put(grammarAccess.getSetStatementCSAccess().getIsPartialAssignment_6_1(), "rule__SetStatementCS__IsPartialAssignment_6_1");
			builder.put(grammarAccess.getSetStatementCSAccess().getOwnedExpressionAssignment_7(), "rule__SetStatementCS__OwnedExpressionAssignment_7");
			builder.put(grammarAccess.getSimpleParameterBindingCSAccess().getIsCheckAssignment_0(), "rule__SimpleParameterBindingCS__IsCheckAssignment_0");
			builder.put(grammarAccess.getSimpleParameterBindingCSAccess().getReferredVariableAssignment_1(), "rule__SimpleParameterBindingCS__ReferredVariableAssignment_1");
			builder.put(grammarAccess.getSimpleParameterBindingCSAccess().getOwnedValueAssignment_3(), "rule__SimpleParameterBindingCS__OwnedValueAssignment_3");
			builder.put(grammarAccess.getSimpleParameterCSAccess().getReferredTypedModelAssignment_2(), "rule__SimpleParameterCS__ReferredTypedModelAssignment_2");
			builder.put(grammarAccess.getSimpleParameterCSAccess().getNameAssignment_3(), "rule__SimpleParameterCS__NameAssignment_3");
			builder.put(grammarAccess.getSimpleParameterCSAccess().getOwnedTypeAssignment_5(), "rule__SimpleParameterCS__OwnedTypeAssignment_5");
			builder.put(grammarAccess.getSpeculateStatementCSAccess().getOwnedConditionsAssignment_1(), "rule__SpeculateStatementCS__OwnedConditionsAssignment_1");
			builder.put(grammarAccess.getSpeculateStatementCSAccess().getOwnedConditionsAssignment_2_1(), "rule__SpeculateStatementCS__OwnedConditionsAssignment_2_1");
	...
	@Override
	protected InternalQVTimperativeParser createParser() {
		InternalQVTimperativeParser result = new InternalQVTimperativeParser(null);
