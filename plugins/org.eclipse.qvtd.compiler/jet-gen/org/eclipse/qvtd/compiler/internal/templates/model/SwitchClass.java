...
public class SwitchClass
{
  ...
  protected final String TEXT_8 = "<@Nullable ";
  protected final String TEXT_9 = " extends Switch";
  ...
  protected final String TEXT_18 = ".eINSTANCE;" + NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_19 = NL + "\t/**" + NL + "\t * Checks whether this is a switch for the given package." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param ePackage the package in question." + NL + "\t * @return whether this is a switch for the given package." + NL + "\t * @generated" + NL + "\t */" + NL + "\t@Override" + NL + "\tprotected boolean isSwitchFor(EPackage ePackage)" + NL + "\t{" + NL + "\t\treturn ePackage == modelPackage;" + NL + "\t}";
  protected final String TEXT_20 = NL + "\t/**" + NL + "\t * Calls <code>caseXXX</code> for each class of the model until one returns a non null result; it yields that result." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the first non-null result returned by a <code>caseXXX</code> call." + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_21 = " doSwitch(EObject theEObject)" + NL + "\t{" + NL + "\t\treturn doSwitch(theEObject.eClass(), theEObject);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Calls <code>caseXXX</code> for each class of the model until one returns a non null result; it yields that result." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the first non-null result returned by a <code>caseXXX</code> call." + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_22 = " doSwitch(EClass theEClass, EObject theEObject)" + NL + "\t{" + NL + "\t\tif (theEClass.eContainer() == modelPackage)" + NL + "\t\t{" + NL + "\t\t\treturn doSwitch(theEClass.getClassifierID(), theEObject);" + NL + "\t\t}";
  protected final String TEXT_23 = NL + "\t\telse" + NL + "\t\t{";
  protected final String TEXT_24 = NL + "\t\t";
  protected final String TEXT_25 = "<";
  protected final String TEXT_26 = ">";
  protected final String TEXT_27 = " eSuperTypes = theEClass.getESuperTypes();" + NL + "\t\t";
  protected final String TEXT_28 = "return" + NL + "\t\t";
  protected final String TEXT_29 = "\teSuperTypes.isEmpty() ?" + NL + "\t\t";
  protected final String TEXT_30 = "\t\tdefaultCase(theEObject) :" + NL + "\t\t";
  protected final String TEXT_31 = "\t\tdoSwitch(";
  protected final String TEXT_32 = "(EClass)";
  protected final String TEXT_33 = "eSuperTypes.get(0), theEObject);";
  protected final String TEXT_34 = NL + "\t\t}";
  protected final String TEXT_35 = NL + "\t}";
  protected final String TEXT_36 = NL + NL + "\t/**" + NL + "\t * Calls <code>caseXXX</code> for each class of the model until one returns a non null result; it yields that result." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the first non-null result returned by a <code>caseXXX</code> call." + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_37 = NL + "\t@Override";
  protected final String TEXT_38 = NL + "\tprotected ";
  protected final String TEXT_39 = " doSwitch(int classifierID, EObject theEObject)" + NL + "\t{" + NL + "\t\tswitch (classifierID)" + NL + "\t\t{";
  protected final String TEXT_40 = NL + "\t\t\tcase ";
  protected final String TEXT_41 = ".";
  protected final String TEXT_42 = ":" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_43 = "@SuppressWarnings(\"unchecked\") ";
  protected final String TEXT_44 = " ";
  protected final String TEXT_45 = " = (";
  protected final String TEXT_46 = ")theEObject;" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_63 = " = defaultCase(theEObject);" + NL + "\t\t\t\treturn ";
  protected final String TEXT_64 = ";" + NL + "\t\t\t}";
  protected final String TEXT_65 = NL + "\t\t\tdefault: return defaultCase(theEObject);" + NL + "\t\t}" + NL + "\t}";
  protected final String TEXT_66 = NL + NL + "\t/**" + NL + "\t * Returns the result of interpreting the object as an instance of '<em>";
  protected final String TEXT_67 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * This implementation returns null;" + NL + "\t * returning a non-null result will terminate the switch." + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param object the target of the switch." + NL + "\t * @return the result of interpreting the object as an instance of '<em>";
  protected final String TEXT_68 = "</em>'." + NL + "\t * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_69 = " case";
  protected final String TEXT_70 = "(";
  protected final String TEXT_71 = " object)" + NL + "\t{" + NL + "\t\treturn null;" + NL + "\t}";
  protected final String TEXT_72 = NL + NL + "\t/**" + NL + "\t * Returns the result of interpreting the object as an instance of '<em>EObject</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * This implementation returns null;" + NL + "\t * returning a non-null result will terminate the switch, but this is the last case anyway." + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param object the target of the switch." + NL + "\t * @return the result of interpreting the object as an instance of '<em>EObject</em>'." + NL + "\t * @see #doSwitch(org.eclipse.emf.ecore.EObject)" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_73 = NL + "\t@Override";
  protected final String TEXT_74 = NL + "\tpublic ";
  protected final String TEXT_75 = " defaultCase(EObject object)" + NL + "\t{" + NL + "\t\treturn null;" + NL + "\t}" + NL + "" + NL + "} //";
