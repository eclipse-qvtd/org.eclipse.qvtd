...
public class PackageClass
{
  ...
  protected final String TEXT_75 = NL + "\t\t// Obtain or create and register package" + NL + "\t\tObject ePackage = ";
  protected final String TEXT_76 = ".Registry.INSTANCE.get(eNS_URI);" + NL + "\t\t";
  protected final String TEXT_77 = " the";
  protected final String TEXT_78 = " = (";
  protected final String TEXT_79 = ")(ePackage instanceof ";
  protected final String TEXT_80 = " ? ePackage : new ";
  ...
  protected final String TEXT_89 = ".eNS_URI) : ";
  protected final String TEXT_90 = ".eINSTANCE);";
  protected final String TEXT_91 = NL + "\t\t// Load packages";
  protected final String TEXT_92 = NL + "\t\tthe";
  protected final String TEXT_93 = ".loadPackage();";
  protected final String TEXT_94 = NL + "\t\t// Create package meta-data objects";
  protected final String TEXT_95 = ".createPackageContents();";
  protected final String TEXT_96 = NL + NL + "\t\t// Initialize created meta-data";
  protected final String TEXT_97 = ".initializePackageContents();";
  protected final String TEXT_98 = NL + "\t\t// Fix loaded packages";
  protected final String TEXT_99 = ".fixPackageContents();";
  protected final String TEXT_100 = NL + "\t\t// Register package validator" + NL + "\t\t";
  protected final String TEXT_101 = ".Registry.INSTANCE.put" + NL + "\t\t\t(the";
  protected final String TEXT_102 = ", " + NL + "\t\t\t new ";
  protected final String TEXT_103 = ".Descriptor()" + NL + "\t\t\t {" + NL + "\t\t\t\t public ";
  protected final String TEXT_104 = " getEValidator()" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return ";
  protected final String TEXT_105 = ".INSTANCE;" + NL + "\t\t\t\t }" + NL + "\t\t\t });" + NL;
  protected final String TEXT_106 = NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\tthe";
  protected final String TEXT_107 = ".freeze();" + NL;
  protected final String TEXT_108 = NL + "  " + NL + "\t\t// Update the registry and return the package" + NL + "\t\t";
  protected final String TEXT_109 = ".Registry.INSTANCE.put(";
  protected final String TEXT_110 = ".eNS_URI, the";
  protected final String TEXT_111 = ");" + NL + "\t\treturn the";
  protected final String TEXT_112 = ";" + NL + "\t}";
  protected final String TEXT_113 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static void initializeRegistryHelpers()" + NL + "\t{";
  protected final String TEXT_114 = ".register" + NL + "\t\t\t(";
  protected final String TEXT_115 = ".class, " + NL + "\t\t\t new ";
  protected final String TEXT_116 = ".Helper() " + NL + "\t\t\t {" + NL + "\t\t\t\t public boolean isInstance(Object instance)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return instance instanceof ";
  protected final String TEXT_117 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return new ";
  protected final String TEXT_118 = "[size];" + NL + "\t\t\t\t }" + NL + "\t\t\t });";
  protected final String TEXT_119 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {";
  ...
  protected final String TEXT_124 = NL + "\t}" + NL + "" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class WhiteList implements ";
  protected final String TEXT_125 = ", EBasicWhiteList" + NL + "\t{";
  protected final String TEXT_126 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tprotected ";
  protected final String TEXT_127 = NL + "\t}";
  protected final String TEXT_128 = NL + "\t * Returns the meta object for class '{@link ";
  protected final String TEXT_129 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for class '<em>";
  protected final String TEXT_130 = "</em>'." + NL + "\t * @see ";
  protected final String TEXT_131 = NL + "\t * @model ";
  protected final String TEXT_132 = NL + "\t *        ";
  protected final String TEXT_133 = NL + "\t * @model";
  protected final String TEXT_134 = NL + "\t * Returns the meta object for enum '{@link ";
  protected final String TEXT_135 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for enum '<em>";
  protected final String TEXT_136 = NL + "\t * Returns the meta object for data type '<em>";
  protected final String TEXT_137 = "</em>'.";
  protected final String TEXT_138 = NL + "\t * Returns the meta object for data type '{@link ";
  protected final String TEXT_139 = "</em>}'.";
  protected final String TEXT_140 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_143 = NL + "\tpublic ";
  protected final String TEXT_144 = " get";
  protected final String TEXT_145 = "()" + NL + "\t{";
  protected final String TEXT_146 = NL + "\t\tif (";
  protected final String TEXT_147 = " == null)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_148 = ".eNS_URI).getEClassifiers().get(";
  protected final String TEXT_149 = ");" + NL + "\t\t}";
  protected final String TEXT_150 = NL + "\t\treturn ";
  protected final String TEXT_151 = ";" + NL + "\t}" + NL;
  protected final String TEXT_152 = NL + "\t";
  protected final String TEXT_153 = "();" + NL;
  protected final String TEXT_154 = NL + "\t/**" + NL + "\t * Returns the meta object for the ";
  protected final String TEXT_155 = " '{@link ";
  protected final String TEXT_156 = "#";
  protected final String TEXT_157 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the ";
  protected final String TEXT_158 = " '<em>";
  protected final String TEXT_159 = "()";
  protected final String TEXT_160 = NL + "\t * @see #get";
  protected final String TEXT_161 = "()" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_162 = NL + "\t\treturn (";
  protected final String TEXT_163 = ".getEStructuralFeatures().get(";
  ...
  protected final String TEXT_169 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_170 = "(";
  protected final String TEXT_171 = ") <em>";
  protected final String TEXT_172 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_173 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_174 = ")" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_175 = ".getEOperations().get(";
  protected final String TEXT_176 = NL + "        return get";
  protected final String TEXT_177 = "().getEOperations().get(";
  protected final String TEXT_178 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_179 = "()" + NL + "\t{" + NL + "\t\treturn (";
  protected final String TEXT_180 = ")getEFactoryInstance();" + NL + "\t}";
  ...
  protected final String TEXT_182 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_183 = " = create";
  protected final String TEXT_184 = NL + "\t\tcreate";
  protected final String TEXT_185 = ", ";
  protected final String TEXT_186 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_187 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_188 = " = createEEnum(";
  protected final String TEXT_189 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_190 = " = createEDataType(";
  protected final String TEXT_191 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_192 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_193 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_194 = ".eNS_URI);";
  protected final String TEXT_195 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_196 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_197 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_198 = "_";
  protected final String TEXT_199 = " = addETypeParameter(";
  protected final String TEXT_200 = ", \"";
  protected final String TEXT_201 = "\");";
  protected final String TEXT_202 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_203 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_204 = "g";
  protected final String TEXT_205 = " = createEGenericType(";
  protected final String TEXT_206 = NL + "\t\tg";
  protected final String TEXT_207 = ".";
  protected final String TEXT_208 = "(g";
  protected final String TEXT_209 = ".getEBounds().add(g1);";
  protected final String TEXT_210 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_211 = ".getESuperTypes().add(";
  protected final String TEXT_212 = ".get";
  protected final String TEXT_213 = "());";
  protected final String TEXT_214 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_215 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_216 = ", features, and operations; add parameters";
  protected final String TEXT_217 = " and features; add operations and parameters";
  protected final String TEXT_218 = NL + "\t\tinitEClass(";
  protected final String TEXT_219 = "null";
  protected final String TEXT_220 = ".class";
  protected final String TEXT_221 = "\", ";
  protected final String TEXT_222 = "\"";
  protected final String TEXT_223 = NL + "\t\tinitEReference(get";
  protected final String TEXT_224 = "(), ";
  protected final String TEXT_225 = "g1";
  protected final String TEXT_226 = NL + "\t\tget";
  protected final String TEXT_227 = "().getEKeys().add(";
  protected final String TEXT_228 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_229 = "initEOperation(get";
  protected final String TEXT_230 = "addEOperation(";
  protected final String TEXT_231 = "(), \"";
  protected final String TEXT_232 = ", null, \"";
  protected final String TEXT_233 = "addETypeParameter(op, \"";
  protected final String TEXT_234 = NL + "\t\tt";
  protected final String TEXT_235 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_236 = NL + "\t\taddEException(op, g";
  protected final String TEXT_237 = NL + "\t\taddEException(op, ";
  protected final String TEXT_238 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_239 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_240 = NL + "\t\tinitEEnum(";
  protected final String TEXT_241 = ".class, \"";
  protected final String TEXT_242 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_243 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_244 = NL + "\t\tinitEDataType(";
  protected final String TEXT_245 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_246 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_247 = NL + "\t\t// ";
  protected final String TEXT_248 = "Annotations();";
  protected final String TEXT_249 = NL + "\t}" + NL;
  protected final String TEXT_250 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_251 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_252 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_253 = "null;";
  protected final String TEXT_254 = "\t" + NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_255 = ", " + NL + "\t\t   source, " + NL + "\t\t   new String[] " + NL + "\t\t   {";
  protected final String TEXT_256 = NL + "\t\t\t ";
  protected final String TEXT_257 = NL + "\t\t   }";
  protected final String TEXT_258 = ",";
  protected final String TEXT_259 = NL + "\t\t   new ";
  protected final String TEXT_260 = "[] " + NL + "\t\t   {";
  protected final String TEXT_261 = ".createURI(";
  protected final String TEXT_262 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_263 = "\")";
  protected final String TEXT_264 = NL + "\t\t   });";
  protected final String TEXT_265 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_266 = ", " + NL + "\t\t   ";
  protected final String TEXT_267 = "new boolean[] { ";
  protected final String TEXT_268 = " }";
  protected final String TEXT_269 = "," + NL + "\t\t   ";
  protected final String TEXT_270 = "null,";
  protected final String TEXT_271 = "\",";
  protected final String TEXT_272 = NL + "\t\t   new String[] " + NL + "\t\t   {";
  protected final String TEXT_273 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_274 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_275 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_276 = " uri = ";
  protected final String TEXT_277 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_278 = " resource = new ";
  protected final String TEXT_279 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_280 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_281 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_282 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_283 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_284 = NL + "\t@Override";
  protected final String TEXT_285 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_286 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_287 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_288 = ".\" + eClassifier.getName());";
  protected final String TEXT_289 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_290 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_291 = NL + "\t\t\t\tcase ";
  protected final String TEXT_292 = ":";
  protected final String TEXT_293 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_294 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_295 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_296 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_297 = " addEOperation(";
  protected final String TEXT_298 = " owner, ";
  protected final String TEXT_299 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_300 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_301 = " addEParameter(";
  protected final String TEXT_302 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_303 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_304 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_305 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_306 = "public ";
  protected final String TEXT_307 = "interface Literals" + NL + "\t{";
  protected final String TEXT_308 = NL + "\t\t/**";
  protected final String TEXT_309 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_310 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_311 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_312 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_313 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_314 = NL + "\t\t * @see ";
  protected final String TEXT_315 = "()" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t";
  protected final String TEXT_316 = " = eINSTANCE.get";
  protected final String TEXT_317 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_318 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t";
  protected final String TEXT_319 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t";
