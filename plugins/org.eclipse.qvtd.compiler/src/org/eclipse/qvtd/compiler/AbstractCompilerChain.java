...
public abstract class AbstractCompilerChain extends CompilerUtil implements CompilerChain
{
	...
	protected static class QVTi2JavaCompilerStep extends AbstractCompilerStep
	{
		...
		protected @NonNull JavaResult execute(@NonNull QVTimperativeEnvironmentFactory environmentFactory, @NonNull URI txURI, @NonNull ImperativeTransformation iTransformation, @NonNull String ... genModelFiles) throws Exception {
	...
	protected static class QVTs2QVTiCompilerStep extends AbstractCompilerStep
	{
		...
		public @NonNull ImperativeTransformation execute(@NonNull QVTimperativeEnvironmentFactory environmentFactory, @NonNull ScheduleManager scheduleManager) throws IOException {
	...
	public @NonNull Class<? extends Transformer> build(@NonNull TypedModelsConfigurations typedModelsConfigurations, @NonNull String ... genModelFiles) throws Exception {
		...
		//		return generate(PivotUtilInternal.getEnvironmentFactory(asTransformation), asTransformation, genModelFiles);		// XXX
	...
	public <@NonNull EF extends QVTimperativeEnvironmentFactory, O extends QVTbase> @NonNull Class<? extends Transformer> generate(final @NonNull AbstractEnvironmentThread<?, EF, O> compileThread, @NonNull ImperativeTransformation asTransformation, @NonNull String... genModelFiles) throws Exception {
		...
		AbstractEnvironmentThread<@NonNull Class<? extends Transformer>, ?, ?> thread = new AbstractEnvironmentThread<@NonNull Class<? extends Transformer>, @NonNull EF, O>(environmentThreadFactory, "model-generate")
		{
			...
			protected @NonNull EF createEnvironmentFactory() {
				EF environmentFactory = compileThread.getEnvironmentFactory();
	...
	protected @NonNull ProjectManager getProjectManager() {
	...
	protected @NonNull Resource qvtc2qvtm(@NonNull QVTimperativeEnvironmentFactory environmentFactory, @NonNull Resource cResource, @NonNull TypedModelsConfiguration typedModelsConfiguration) throws IOException {
	...
	protected @NonNull JavaResult qvti2java(@NonNull QVTimperativeEnvironmentFactory environmentFactory, @NonNull ImperativeTransformation iTransformation, @NonNull String ... genModelFiles) throws Exception {
