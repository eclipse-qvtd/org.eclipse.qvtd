...
public abstract class Element2MiddleProperty implements Nameable
{
	...
	protected Element2MiddleProperty(@NonNull RuleAnalysis2MiddleType relation2middleType, @NonNull String name, org.eclipse.ocl.pivot.@NonNull Class type, boolean isRequired) {
