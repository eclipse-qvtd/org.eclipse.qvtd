...
public class Edges
{
	protected abstract static class AbstractComputationEdgeRole extends AbstractEdgeRole implements EdgeRole.Simple
	{
		...
		@Override
		public @NonNull SimpleEdge createEdge(@NonNull Region region, @NonNull Node sourceNode, @Nullable String name, @NonNull Node targetNode) {
	...
	public static final class ArgumentEdgeRoleFactory
	{
		...
		public @NonNull SimpleEdge createSimpleEdge(@NonNull Region region, @NonNull Node sourceNode, @Nullable String name, @NonNull Node targetNode) {
	...
	public static final class CastEdgeRoleFactory
	{
		...
		public @NonNull SimpleEdge createSimpleEdge(@NonNull Region region, @NonNull Node sourceNode, @NonNull Property source2targetProperty, @NonNull Node targetNode) {
	...
	public static final class IteratedEdgeRoleFactory
	{
		...
		public @NonNull SimpleEdge createSimpleEdge(@NonNull Region region, @NonNull Node sourceNode, @NonNull Node targetNode) {
	...
	private static final class RecursionEdgeRole extends AbstractEdgeRole implements EdgeRole.Recursion
	{
		...
		public @NonNull Edge createEdge(@NonNull Region region, @NonNull Node sourceNode, @NonNull Node targetNode) {
			return new BasicSimpleEdge(this, region, (Node)sourceNode, null, (Node)targetNode);
		}
