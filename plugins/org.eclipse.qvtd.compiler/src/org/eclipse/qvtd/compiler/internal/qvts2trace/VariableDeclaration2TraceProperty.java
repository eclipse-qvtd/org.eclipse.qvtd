...
public class VariableDeclaration2TraceProperty extends Element2MiddleProperty
{
	...
	public VariableDeclaration2TraceProperty(@NonNull RuleAnalysis2MiddleType relation2middleType, @Nullable TypedModel rTypedModel, @NonNull VariableDeclaration variable, boolean unitOpposite) {
