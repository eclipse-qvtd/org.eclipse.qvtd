...
public abstract class AbstractQVTm2QVTs extends ScheduleManager
{
	...
	public AbstractQVTm2QVTs(@NonNull ProblemHandler problemHandler, @NonNull EnvironmentFactory environmentFactory, @NonNull Transformation asTransformation,
