...
public class Region2Depth
{
	...
	public void addRegion(@NonNull Region region) {
		...
		QVTs2QVTs.REGION_DEPTH.println(getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(this)) + " <reset> : " + region.getName());
	}
	...
	public int getRegionDepth(@NonNull Region region) {
		...
		if (depth == null) {
			if (region2depth.containsKey(region)) {
				QVTs2QVTs.REGION_DEPTH.println(getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(this)) + " <loop> : " + region.getName());
				return 0;
			}
			...
			QVTs2QVTs.REGION_DEPTH.println(getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(this)) + " " + depth + " : " + region.getName());
		}
