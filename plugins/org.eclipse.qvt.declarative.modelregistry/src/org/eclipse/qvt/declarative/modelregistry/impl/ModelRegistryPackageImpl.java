...
public class ModelRegistryPackageImpl extends EPackageImpl implements ModelRegistryPackage {
	 ...
	 * @see org.eclipse.qvt.declarative.modelregistry.ModelRegistryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ModelRegistryPackage init() {
		...
		ModelRegistryPackageImpl theModelRegistryPackage = (ModelRegistryPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ModelRegistryPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ModelRegistryPackageImpl());
