 ...
 * </copyright>
 *
 * $Id: LabelBehaviorImpl.java,v 1.1 2008/08/08 16:39:55 ewillink Exp $
 */
...
public class LabelBehaviorImpl extends BehaviorImpl implements LabelBehavior {
	 ...
	 * @ordered
	 */
	protected EList<LabelElement> elements;
	 ...
	 * @generated
	 */
	public EList<LabelElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<LabelElement>(LabelElement.class, this, EditorPackage.LABEL_BEHAVIOR__ELEMENTS);
		}
		return elements;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EditorPackage.LABEL_BEHAVIOR__ELEMENTS:
				getElements().clear();
				getElements().addAll((Collection<? extends LabelElement>)newValue);
				return;
		}
