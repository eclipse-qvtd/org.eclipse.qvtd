...
/**
 * An AbstractCS2ASCGCG2JavaNameVisitor provides a default implementation for each
 * visitXxx method that delegates to the visitYyy method of the first
 * super class, (or transitively its first super class' first super class
 * until a non-interface super-class is found). In the absence of any
 * suitable first super class, the method delegates to visiting().
 */
public abstract class AbstractCS2ASCGCG2JavaNameVisitor
	extends QVTiCGModelCG2JavaNameVisitor
	implements CS2ASCGModelVisitor<@Nullable Object>
{
	protected AbstractCS2ASCGCG2JavaNameVisitor(@NonNull JavaCodeGenerator codeGenerator) {
		super(codeGenerator);
	}
