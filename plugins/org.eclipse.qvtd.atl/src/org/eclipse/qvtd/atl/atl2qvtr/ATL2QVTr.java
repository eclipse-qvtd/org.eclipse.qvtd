...
public class ATL2QVTr extends AbstractTransformer
{
	...
	private static final @NonNull PropertyId @NonNull [] oppositeIndex2propertyId = new @NonNull PropertyId[]{
		...
		PROPid_t1oclMetamodel_1,		// 2 => t1oclMetamodel
	...
	private static final @NonNull ClassId @NonNull [] classIndex2classId = new @NonNull ClassId[]{
		...
		CLSSid_OutPattern,                    // 9 => OutPattern
		CLSSid_SimpleInPatternElement,        // 10 => SimpleInPatternElement
		CLSSid_SimpleOutPatternElement,       // 11 => SimpleOutPatternElement
		CLSSid_VariableExp                    // 12 => VariableExp
	};
	...
	private final static int @NonNull [] @NonNull [] classIndex2allClassIndexes = new int @NonNull [] @NonNull [] {
		...
		{9},                          // 9 : OutPattern -> {OutPattern}
		{10},                         // 10 : SimpleInPatternElement -> {SimpleInPatternElement}
		{11},                         // 11 : SimpleOutPatternElement -> {SimpleOutPatternElement}
		{12,6}                        // 12 : VariableExp -> {VariableExp,OclExpression}
	};
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperationCallExp__Operation__qvtr__local__ = new AbstractInvocationConstructor(invocationManager, "mmapOperationCallExp__Operation__qvtr__local__", false, lazyCreateInterval(3))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapNavigationOrAttributeCallExp__Helper__qvtr__loc = new AbstractInvocationConstructor(invocationManager, "mmapNavigationOrAttributeCallExp__Helper__qvtr__loc", false, lazyCreateInterval(3))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapNavigationOrAttributeCallExp__Property__qvtr__l = new AbstractInvocationConstructor(invocationManager, "mmapNavigationOrAttributeCallExp__Property__qvtr__l", false, lazyCreateInterval(3))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperationCallExp__Helper__qvtr__local__ = new AbstractInvocationConstructor(invocationManager, "mmapOperationCallExp__Helper__qvtr__local__", false, lazyCreateInterval(3))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapIfExp__qvtr__local__ = new AbstractInvocationConstructor(invocationManager, "mmapIfExp__qvtr__local__", false, lazyCreateInterval(3))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperatorCallExp__qvtr__local__ = new AbstractInvocationConstructor(invocationManager, "mmapOperatorCallExp__qvtr__local__", false, lazyCreateInterval(3))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapHelper__Operation__qvtr__local__ = new AbstractInvocationConstructor(invocationManager, "mmapHelper__Operation__qvtr__local__", false, lazyCreateInterval(3))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapHelper__Attribute__qvtr__local__ = new AbstractInvocationConstructor(invocationManager, "mmapHelper__Attribute__qvtr__local__", false, lazyCreateInterval(3))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperationCallExp__Operation__qvtr__speculated__ = new AbstractInvocationConstructor(invocationManager, "mmapOperationCallExp__Operation__qvtr__speculated__", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapIfExp__qvtr__speculated__ = new AbstractInvocationConstructor(invocationManager, "mmapIfExp__qvtr__speculated__", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperationCallExp__Helper__qvtr__speculated__ = new AbstractInvocationConstructor(invocationManager, "mmapOperationCallExp__Helper__qvtr__speculated__", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapHelper__verdict__qvtr = new AbstractInvocationConstructor(invocationManager, "mmapHelper__verdict__qvtr", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperatorCallExp__qvtr__speculated__ = new AbstractInvocationConstructor(invocationManager, "mmapOperatorCallExp__qvtr__speculated__", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOclExpression__verdict__qvtr = new AbstractInvocationConstructor(invocationManager, "mmapOclExpression__verdict__qvtr", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapHelper__Attribute__qvtr__speculated__ = new AbstractInvocationConstructor(invocationManager, "mmapHelper__Attribute__qvtr__speculated__", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapNavigationOrAttributeCallExp__Property__qvtr__s = new AbstractInvocationConstructor(invocationManager, "mmapNavigationOrAttributeCallExp__Property__qvtr__s", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapHelper__Operation__qvtr__speculated__ = new AbstractInvocationConstructor(invocationManager, "mmapHelper__Operation__qvtr__speculated__", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapNavigationOrAttributeCallExp__Helper__qvtr__spe = new AbstractInvocationConstructor(invocationManager, "mmapNavigationOrAttributeCallExp__Helper__qvtr__spe", false, lazyCreateInterval(4))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperatorCallExp__qvtr__edge5__referredOperation = new AbstractInvocationConstructor(invocationManager, "mmapOperatorCallExp__qvtr__edge5__referredOperation", false, lazyCreateInterval(9))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapNavigationOrAttributeCallExp__Property__qvtr__e_1 = new AbstractInvocationConstructor(invocationManager, "mmapNavigationOrAttributeCallExp__Property__qvtr__e_1", false, lazyCreateInterval(9))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapIfExp__qvtr__edge7__type__ = new AbstractInvocationConstructor(invocationManager, "mmapIfExp__qvtr__edge7__type__", false, lazyCreateInterval(9))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperationCallExp__Operation__qvtr__edge5__refer = new AbstractInvocationConstructor(invocationManager, "mmapOperationCallExp__Operation__qvtr__edge5__refer", false, lazyCreateInterval(9))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperatorCallExp__qvtr__edge6__type__ = new AbstractInvocationConstructor(invocationManager, "mmapOperatorCallExp__qvtr__edge6__type__", false, lazyCreateInterval(10))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapOperationCallExp__Operation__qvtr__edge6__type_ = new AbstractInvocationConstructor(invocationManager, "mmapOperationCallExp__Operation__qvtr__edge6__type_", false, lazyCreateInterval(10))
	{
		@Override
	...
	protected final @NonNull AbstractInvocationConstructor CTOR_mmapNavigationOrAttributeCallExp__Property__qvtr__e_2 = new AbstractInvocationConstructor(invocationManager, "mmapNavigationOrAttributeCallExp__Property__qvtr__e_2", false, lazyCreateInterval(10))
	{
		@Override
	...
	public boolean run() {
		...
		final @NonNull Connection ji_OutPattern = models[0/*atl*/].getConnection(9/*ATL::OutPattern*/);
		final @NonNull Connection ji_SimpleInPatternElement = models[0/*atl*/].getConnection(10/*ATL::SimpleInPatternElement*/);
		final @NonNull Connection ji_SimpleOutPatternElement = models[0/*atl*/].getConnection(11/*ATL::SimpleOutPatternElement*/);
		final @NonNull Connection ji_VariableExp = models[0/*atl*/].getConnection(12/*OCL::VariableExp*/);
		CTOR_r_atl2qvtr____load__.invoke(ji_Binding, ji_Helper, ji_InPattern, ji_MatchedRule, ji_Module, ji_NavigationOrAttributeCallExp, ji_OclExpression, ji_OclModel, ji_OperationCallExp, ji_OutPattern, ji_SimpleInPatternElement, ji_SimpleOutPatternElement, ji_VariableExp);
	...
	protected class FUN_getHelper extends AbstractComputation
	{
		...
		public FUN_getHelper(/*Nullable*/ Object @NonNull [] boundValues) {
			...
			final /*@Thrown*/ @NonNull SetValue selectByKind = (@Nullable SetValue)CollectionSelectByKindOperation.INSTANCE.evaluate(executor, closure, TYP_ATL_c_c_Helper_0);
	 ...
	 * }
	 *   install mmapInPattern__filter__qvtr__activator__ {
	 * atlPattern consumes append ji_InPattern  : ATL::InPattern[1];
	 * ;
	 ...
	 * ;
	 * }
	 *   install mmapOutPattern__qvtr__activator__ {
	 ...
	 * trace consumes ::jm_TmapHelper__Attribute : trace_ATL2QVTr::TmapHelper_Attribute[1];
	 * }
	 *   install mmapOutPattern__qvtr__residue__ {
	 * trace consumes ::jm_TmapOutPattern : trace_ATL2QVTr::TmapOutPattern[1];
	 * }
	 *   install mmapOperatorCallExp__qvtr__edge7__t2qvtrTransformat {
	 * trace consumes ::jm_TmapOperatorCallExp : trace_ATL2QVTr::TmapOperatorCallExp[1];
	 * }
	 ...
	 * trace consumes ::jm_TmapOperationCallExp__Operation : trace_ATL2QVTr::TmapOperationCallExp_Operation[1];
	 * }
	 *   install mmapOperationCallExp__Helper__qvtr__edge5__type__ed {
	 * trace consumes ::jm_TmapOperationCallExp__Helper : trace_ATL2QVTr::TmapOperationCallExp_Helper[1];
	 * }
	 *   install mmapOperationCallExp__Helper__qvtr__edge5__type__ed {
	 * trace consumes ::jm_TmapOperationCallExp__Helper : trace_ATL2QVTr::TmapOperationCallExp_Helper[1];
	...
	protected class MAP_r_atl2qvtr____load__ extends AbstractInvocation
	{
		...
		public MAP_r_atl2qvtr____load__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			...
			ji_OutPattern = (Connection)boundValues[9];
			ji_SimpleInPatternElement = (Connection)boundValues[10];
			ji_SimpleOutPatternElement = (Connection)boundValues[11];
			ji_VariableExp = (Connection)boundValues[12];
		}
		...
		public boolean execute()  {
			...
			final @NonNull Connection jm_TmapOutPattern_1 = rootInterval.createConnection("jm_TmapOutPattern", CLSSid_TmapOutPattern, false, modeFactory);
			...
			new AbstractSimpleInvocation(lazyCreateInterval(1/*..null*/), "mmapSimpleInPatternElement__qvtr__activator__") {
				...
				public boolean execute() {
					for (@NonNull SimpleInPatternElement atlElement_1 : ji_SimpleInPatternElement.typedIterable(SimpleInPatternElement.class)) {
						MAP_mmapSimpleInPatternElement__qvtr__activator__(atlElement_1, jm_TmapSimpleInPatternElement_1);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(1/*..null*/), "mmapSimpleOutPatternElement__qvtr__activator__") {
				...
				public boolean execute() {
					for (@NonNull SimpleOutPatternElement atlElement_2 : ji_SimpleOutPatternElement.typedIterable(SimpleOutPatternElement.class)) {
						MAP_mmapSimpleOutPatternElement__qvtr__activator__(atlElement_2, jm_TmapSimpleOutPatternElement_1);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(1/*..null*/), "mmapInPattern__filter__qvtr__activator__") {
				@Override
				public boolean execute() {
					for (@NonNull InPattern atlPattern_3 : ji_InPattern.typedIterable(InPattern.class)) {
						MAP_mmapInPattern__filter__qvtr__activator__(atlPattern_3, jm_TmapInPattern__filter_1);
					}
					return true;
				}
			};
			...
			new AbstractSimpleInvocation(lazyCreateInterval(1/*..null*/), "mmapOutPattern__qvtr__activator__") {
				@Override
				public boolean execute() {
					for (@NonNull OutPattern atlPattern_4 : ji_OutPattern.typedIterable(OutPattern.class)) {
						MAP_mmapOutPattern__qvtr__activator__(atlPattern_4, jm_TmapOutPattern_1);
					}
					return true;
				}
			};
			...
			new AbstractSimpleInvocation(lazyCreateInterval(2/*..null*/), "mmapBooleanExp__qvtr") {
				@Override
				public boolean execute() {
					for (@NonNull TmapBooleanExp trace_71 : jm_TmapBooleanExp_1.typedIterable(TmapBooleanExp.class)) {
						MAP_mmapBooleanExp__qvtr(trace_71);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(2/*..null*/), "mmapModule__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapModule trace_72 : jm_TmapModule_1.typedIterable(TmapModule.class)) {
						MAP_mmapModule__qvtr__residue__(trace_72);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(2/*..null*/), "mmapStringExp__qvtr") {
				@Override
				public boolean execute() {
					for (@NonNull TmapStringExp trace_73 : jm_TmapStringExp_1.typedIterable(TmapStringExp.class)) {
						MAP_mmapStringExp__qvtr(trace_73);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(2/*..null*/), "mmapVariableExp__qvtr") {
				@Override
				public boolean execute() {
					for (@NonNull TmapVariableExp trace_74 : jm_TmapVariableExp_1.typedIterable(TmapVariableExp.class)) {
						MAP_mmapVariableExp__qvtr(jm_DmapVariableExp__referredVariable_1, jo_VariableExp_5, trace_74);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(2/*..null*/), "mmapOclMetamodel__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOclMetamodel trace_75 : jm_TmapOclMetamodel_1.typedIterable(TmapOclMetamodel.class)) {
						MAP_mmapOclMetamodel__qvtr__residue__(trace_75);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(3/*..5*/), "mmapOclModel__OUT__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOclModel_OUT trace_76 : jm_TmapOclModel__OUT_1.typedIterable(TmapOclModel_OUT.class)) {
						MAP_mmapOclModel__OUT__qvtr__residue__(trace_76);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(3/*..5*/), "mmapOclModel__IN__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOclModel_IN trace_77 : jm_TmapOclModel__IN_1.typedIterable(TmapOclModel_IN.class)) {
						MAP_mmapOclModel__IN__qvtr__residue__(trace_77);
					}
					return true;
				}
			};
			...
			new AbstractSimpleInvocation(lazyCreateInterval(3/*..5*/), "mmapVariableExp__referredVariable__dispatch__qvtr") {
				@Override
				public boolean execute() {
			...
			new AbstractSimpleInvocation(lazyCreateInterval(3/*..5*/), "mmapMatchedRule__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapMatchedRule trace_86 : jm_TmapMatchedRule_1.typedIterable(TmapMatchedRule.class)) {
						MAP_mmapMatchedRule__qvtr__residue__(trace_86);
					}
					return true;
				}
			};
			...
			new AbstractSimpleInvocation(lazyCreateInterval(6/*..null*/), "mmapOperationCallExp__Helper__qvtr__edge8__referred") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperationCallExp_Helper trace_103 : jm_TmapOperationCallExp__Helper_1.typedIterable(TmapOperationCallExp_Helper.class)) {
						MAP_mmapOperationCallExp__Helper__qvtr__edge8__referred(trace_103);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(6/*..null*/), "mmapHelper__Attribute__qvtr__edge4__type__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapHelper_Attribute trace_104 : jm_TmapHelper__Attribute_1.typedIterable(TmapHelper_Attribute.class)) {
						MAP_mmapHelper__Attribute__qvtr__edge4__type__(trace_104);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(6/*..null*/), "mmapOutPattern__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOutPattern trace_105 : jm_TmapOutPattern_1.typedIterable(TmapOutPattern.class)) {
						MAP_mmapOutPattern__qvtr__residue__(trace_105);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(6/*..null*/), "mmapOperatorCallExp__qvtr__edge7__t2qvtrTransformat") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperatorCallExp trace_106 : jm_TmapOperatorCallExp_1.typedIterable(TmapOperatorCallExp.class)) {
						MAP_mmapOperatorCallExp__qvtr__edge7__t2qvtrTransformat(trace_106);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(6/*..null*/), "mmapInPattern__qvtr__residue__") {
				@Override
				public boolean execute() {
			...
			new AbstractSimpleInvocation(lazyCreateInterval(6/*..null*/), "mmapNavigationOrAttributeCallExp__Helper__qvtr__edg") {
				@Override
				public boolean execute() {
					for (@NonNull TmapNavigationOrAttributeCallExp_Helper trace_108 : jm_TmapNavigationOrAttributeCallExp__Helper_1.typedIterable(TmapNavigationOrAttributeCallExp_Helper.class)) {
						MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg(trace_108);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(6/*..null*/), "mmapHelper__Operation__qvtr__edge4__type__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapHelper_Operation trace_109 : jm_TmapHelper__Operation_1.typedIterable(TmapHelper_Operation.class)) {
						MAP_mmapHelper__Operation__qvtr__edge4__type__(trace_109);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(6/*..null*/), "mmapMatchedRule__super__qvtr__residue__") {
				@Override
				public boolean execute() {
			...
			new AbstractSimpleInvocation(lazyCreateInterval(6/*..null*/), "mmapHelper__Context__qvtr") {
				@Override
				public boolean execute() {
					for (@NonNull TmapHelper_Context trace_111 : jm_TmapHelper__Context_3.typedIterable(TmapHelper_Context.class)) {
						MAP_mmapHelper__Context__qvtr(jm_TmapVariable_5, trace_111);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(7/*..null*/), "mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_1") {
				@Override
				public boolean execute() {
					for (@NonNull TmapNavigationOrAttributeCallExp_Helper trace_112 : jm_TmapNavigationOrAttributeCallExp__Helper_1.typedIterable(TmapNavigationOrAttributeCallExp_Helper.class)) {
						MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_1(trace_112);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(7/*..null*/), "mmapSimpleOutPatternElement__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapSimpleOutPatternElement trace_113 : jm_TmapSimpleOutPatternElement_1.typedIterable(TmapSimpleOutPatternElement.class)) {
						MAP_mmapSimpleOutPatternElement__qvtr__residue__(jm_TmapVariable_5, trace_113);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(7/*..null*/), "mmapSimpleInPatternElement__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapSimpleInPatternElement trace_114 : jm_TmapSimpleInPatternElement_1.typedIterable(TmapSimpleInPatternElement.class)) {
						MAP_mmapSimpleInPatternElement__qvtr__residue__(jm_TmapVariable_5, trace_114);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(7/*..null*/), "mmapOperationCallExp__Helper__qvtr__edge9__type__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperationCallExp_Helper trace_115 : jm_TmapOperationCallExp__Helper_1.typedIterable(TmapOperationCallExp_Helper.class)) {
						MAP_mmapOperationCallExp__Helper__qvtr__edge9__type__(trace_115);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapOperationCallExp__Helper__qvtr__edge7__ownedArg") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperationCallExp_Helper trace_116 : jm_TmapOperationCallExp__Helper_1.typedIterable(TmapOperationCallExp_Helper.class)) {
						MAP_mmapOperationCallExp__Helper__qvtr__edge7__ownedArg(trace_116);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapHelper__Attribute__qvtr__edge5__queryExpression") {
				@Override
				public boolean execute() {
					for (@NonNull TmapHelper_Attribute trace_117 : jm_TmapHelper__Attribute_1.typedIterable(TmapHelper_Attribute.class)) {
						MAP_mmapHelper__Attribute__qvtr__edge5__queryExpression(trace_117);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapNavigationOrAttributeCallExp__Property__qvtr__e") {
				@Override
				public boolean execute() {
					for (@NonNull TmapNavigationOrAttributeCallExp_Property trace_118 : jm_TmapNavigationOrAttributeCallExp__Property_1.typedIterable(TmapNavigationOrAttributeCallExp_Property.class)) {
						MAP_mmapNavigationOrAttributeCallExp__Property__qvtr__e(trace_118);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapIfExp__qvtr__edge5__ownedThen__edge4__ownedCond") {
				@Override
				public boolean execute() {
					for (@NonNull TmapIfExp trace_119 : jm_TmapIfExp_1.typedIterable(TmapIfExp.class)) {
						MAP_mmapIfExp__qvtr__edge5__ownedThen__edge4__ownedCond(trace_119);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapInPattern__filter__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapInPattern_filter trace_120 : jm_TmapInPattern__filter_1.typedIterable(TmapInPattern_filter.class)) {
						MAP_mmapInPattern__filter__qvtr__residue__(trace_120);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapVariable__qvtr") {
				@Override
				public boolean execute() {
					for (@NonNull TmapVariable trace_121 : jm_TmapVariable_5.typedIterable(TmapVariable.class)) {
						MAP_mmapVariable__qvtr(trace_121);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_3") {
				@Override
				public boolean execute() {
					for (@NonNull TmapNavigationOrAttributeCallExp_Helper trace_122 : jm_TmapNavigationOrAttributeCallExp__Helper_1.typedIterable(TmapNavigationOrAttributeCallExp_Helper.class)) {
						MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_3(trace_122);
					}
					return true;
				}
			};
			...
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_2") {
				@Override
				public boolean execute() {
					for (@NonNull TmapNavigationOrAttributeCallExp_Helper trace_124 : jm_TmapNavigationOrAttributeCallExp__Helper_1.typedIterable(TmapNavigationOrAttributeCallExp_Helper.class)) {
						MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_2(trace_124);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapOperationCallExp__argument__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperationCallExp_argument trace_125 : jm_TmapOperationCallExp__argument_1.typedIterable(TmapOperationCallExp_argument.class)) {
						MAP_mmapOperationCallExp__argument__qvtr__residue__(trace_125);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapIfExp__qvtr__edge5__ownedThen__edge4__ownedCond") {
				...
				public boolean execute() {
					for (@NonNull TmapIfExp trace_126 : jm_TmapIfExp_1.typedIterable(TmapIfExp.class)) {
						MAP_mmapIfExp__qvtr__edge5__ownedThen__edge4__ownedCond(trace_126);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapBinding__qvtr__residue__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapBinding trace_127 : jm_TmapBinding_1.typedIterable(TmapBinding.class)) {
						MAP_mmapBinding__qvtr__residue__(trace_127);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapOperationCallExp__Helper__qvtr__edge4__referred") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperationCallExp_Helper trace_128 : jm_TmapOperationCallExp__Helper_1.typedIterable(TmapOperationCallExp_Helper.class)) {
						MAP_mmapOperationCallExp__Helper__qvtr__edge4__referred(trace_128);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapHelper__Operation__qvtr__edge5__queryExpression") {
				@Override
				public boolean execute() {
					for (@NonNull TmapHelper_Operation trace_129 : jm_TmapHelper__Operation_1.typedIterable(TmapHelper_Operation.class)) {
						MAP_mmapHelper__Operation__qvtr__edge5__queryExpression(trace_129);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapOperationCallExp__Operation__qvtr__edge4__owned") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperationCallExp_Operation trace_130 : jm_TmapOperationCallExp__Operation_1.typedIterable(TmapOperationCallExp_Operation.class)) {
						MAP_mmapOperationCallExp__Operation__qvtr__edge4__owned(trace_130);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(8/*..null*/), "mmapOperatorCallExp__qvtr__edge4__ownedSource__") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperatorCallExp trace_131 : jm_TmapOperatorCallExp_1.typedIterable(TmapOperatorCallExp.class)) {
						MAP_mmapOperatorCallExp__qvtr__edge4__ownedSource__(trace_131);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(9/*..null*/), "mmapVariableExp__referredVariable__VariableDeclarat") {
				@Override
				public boolean execute() {
					for (@NonNull TmapVariableExp_referredVariable_VariableDeclaration trace_132 : jm_TmapVariableExp__referredVariable__VariableDecl_1.typedIterable(TmapVariableExp_referredVariable_VariableDeclaration.class)) {
						MAP_mmapVariableExp__referredVariable__VariableDeclarat(trace_132);
					}
					return true;
				}
			};
			CTOR_mmapIfExp__qvtr__edge7__type__.addConsumedConnection(jm_TmapIfExp_1);
			new AbstractSimpleInvocation(lazyCreateInterval(9/*..null*/), "mmapVariableExp__referredVariable__Helper__qvtr") {
				@Override
				public boolean execute() {
					for (@NonNull TmapVariableExp_referredVariable_Helper trace_134 : jm_TmapVariableExp__referredVariable__Helper_1.typedIterable(TmapVariableExp_referredVariable_Helper.class)) {
						MAP_mmapVariableExp__referredVariable__Helper__qvtr(trace_134);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(9/*..null*/), "mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_4") {
				@Override
				public boolean execute() {
					for (@NonNull TmapNavigationOrAttributeCallExp_Helper trace_135 : jm_TmapNavigationOrAttributeCallExp__Helper_1.typedIterable(TmapNavigationOrAttributeCallExp_Helper.class)) {
						MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_4(trace_135);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(9/*..null*/), "mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_4") {
				@Override
				public boolean execute() {
					for (@NonNull TmapNavigationOrAttributeCallExp_Helper trace_136 : jm_TmapNavigationOrAttributeCallExp__Helper_1.typedIterable(TmapNavigationOrAttributeCallExp_Helper.class)) {
						MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_4(trace_136);
					}
					return true;
				}
			};
			...
			new AbstractSimpleInvocation(lazyCreateInterval(10/*..null*/), "mmapOperationCallExp__Helper__qvtr__edge5__type__ed") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperationCallExp_Helper trace_141 : jm_TmapOperationCallExp__Helper_1.typedIterable(TmapOperationCallExp_Helper.class)) {
						MAP_mmapOperationCallExp__Helper__qvtr__edge5__type__ed(trace_141);
					}
					return true;
				}
			};
			new AbstractSimpleInvocation(lazyCreateInterval(10/*..null*/), "mmapOperationCallExp__Helper__qvtr__edge5__type__ed") {
				@Override
				public boolean execute() {
					for (@NonNull TmapOperationCallExp_Helper trace_142 : jm_TmapOperationCallExp__Helper_1.typedIterable(TmapOperationCallExp_Helper.class)) {
						MAP_mmapOperationCallExp__Helper__qvtr__edge5__type__ed(trace_142);
					}
					return true;
				}
			};
		...
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(ji_Binding, thoseValues[0])
					...
					&& idResolver.oclEquals(ji_OutPattern, thoseValues[9])
					&& idResolver.oclEquals(ji_SimpleInPatternElement, thoseValues[10])
					&& idResolver.oclEquals(ji_SimpleOutPatternElement, thoseValues[11])
					&& idResolver.oclEquals(ji_VariableExp, thoseValues[12]);
		}
	}
	...
	protected boolean MAP_mmapOperationCallExp__argument__qvtr__activator__(final /*@NonInvalid*/ @NonNull OclExpression atlArgument, final @NonNull Connection jm_TmapOperationCallExp__argument)  {
		...
		// creations
		final @SuppressWarnings("null")@NonNull TmapOperationCallExp_argument trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapOperationCallExp_argument();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		trace_70.setT1atlArgument(atlArgument);
		jm_TmapOperationCallExp__argument.appendElement(trace_70);
	 ...
	 *
	 */
	protected boolean MAP_mmapOclExpression__dispatch__qvtr(final /*@NonInvalid*/ @NonNull OclExpression atlExpression, final @NonNull Connection jm_DmapOclExpression, final @NonNull Connection jm_TmapBooleanExp, final @NonNull Connection jm_TmapIfExp, final @NonNull Connection jm_TmapIntegerExp, final @NonNull Connection jm_TmapNavigationOrAttributeCallExp__Helper, final @NonNull Connection jm_TmapNavigationOrAttributeCallExp__Property, final @NonNull Connection jm_TmapOperationCallExp__Helper, final @NonNull Connection jm_TmapOperationCallExp__Operation, final @NonNull Connection jm_TmapOperatorCallExp, final @NonNull Connection jm_TmapStringExp, final @NonNull Connection jm_TmapVariableExp)  {
		if (debugInvocations) {
	 ...
	 *
	 */
	protected boolean MAP_mmapOclModel__OUT__qvtr__activator__(final @NonNull Connection jm_TmapOclModel__OUT, final /*@NonInvalid*/ @NonNull OclModel oclModel)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOclModel__OUT__qvtr__activator__" +
					"\n\t\"oclModel\":" + toDebugString(oclModel));
		}
		// creations
		final @SuppressWarnings("null")@NonNull TmapOclModel_OUT trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapOclModel_OUT();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		trace_70.setT1oclModel(oclModel);
		jm_TmapOclModel__OUT.appendElement(trace_70);
	...
	protected boolean MAP_mmapOclMetamodel__qvtr__activator__(final @NonNull Connection jm_TmapOclMetamodel, final /*@NonInvalid*/ @NonNull OclModel oclMetamodel)  {
		...
		// creations
		final @SuppressWarnings("null")@NonNull TmapOclMetamodel trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapOclMetamodel();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		OPPOSITE_OF_TmapOclMetamodel_t1oclMetamodel.put(oclMetamodel, trace_70);
		trace_70.setT1oclMetamodel(oclMetamodel);
		jm_TmapOclMetamodel.appendElement(trace_70);
	 ...
	 *
	 */
	protected boolean MAP_mmapSimpleInPatternElement__qvtr__activator__(final /*@NonInvalid*/ @NonNull SimpleInPatternElement atlElement, final @NonNull Connection jm_TmapSimpleInPatternElement)  {
		if (debugInvocations) {
		...
		// creations
		final @SuppressWarnings("null")@NonNull TmapSimpleInPatternElement trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapSimpleInPatternElement();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		trace_70.setT1atlElement(atlElement);
		jm_TmapSimpleInPatternElement.appendElement(trace_70);
	...
	protected boolean MAP_mmapInPattern__filter__qvtr__activator__(final /*@NonInvalid*/ @NonNull InPattern atlPattern, final @NonNull Connection jm_TmapInPattern__filter)  {
		...
		// creations
		final @SuppressWarnings("null")@NonNull TmapInPattern_filter trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapInPattern_filter();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		trace_70.setT1atlPattern(atlPattern);
		jm_TmapInPattern__filter.appendElement(trace_70);
	 ...
	 *
	 */
	protected boolean MAP_mmapOclModel__IN__qvtr__activator__(final @NonNull Connection jm_TmapOclModel__IN, final /*@NonInvalid*/ @NonNull OclModel oclModel_0)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOclModel__IN__qvtr__activator__" +
					"\n\t\"oclModel\":" + toDebugString(oclModel_0));
		}
		// creations
		final @SuppressWarnings("null")@NonNull TmapOclModel_IN trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapOclModel_IN();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		trace_70.setT1oclModel(oclModel_0);
		jm_TmapOclModel__IN.appendElement(trace_70);
	...
	/**
	 *
	 * map mmapOutPattern__qvtr__activator__ in ATL2QVTr {
	 ...
	 *
	 */
	protected boolean MAP_mmapOutPattern__qvtr__activator__(final /*@NonInvalid*/ @NonNull OutPattern atlPattern_0, final @NonNull Connection jm_TmapOutPattern)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOutPattern__qvtr__activator__" +
					"\n\t\"atlPattern\":" + toDebugString(atlPattern_0));
		}
		// creations
		final @SuppressWarnings("null")@NonNull TmapOutPattern trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapOutPattern();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		OPPOSITE_OF_TmapOutPattern_t1atlPattern.put(atlPattern_0, trace_70);
		trace_70.setT1atlPattern(atlPattern_0);
		jm_TmapOutPattern.appendElement(trace_70);
		final /*@Thrown*/ @Nullable Boolean mmapOutPattern__qvtr__activator__ = ValueUtil.TRUE_VALUE;
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((mmapOutPattern__qvtr__activator__ ? "done "  : "fail ") + "MAP_mmapOutPattern__qvtr__activator__");
		}
		return mmapOutPattern__qvtr__activator__;
	}
	...
	protected boolean MAP_mmapModule__qvtr__activator__(final /*@NonInvalid*/ @NonNull Module atlModule, final @NonNull Connection jm_TmapModule)  {
		...
		// creations
		final @SuppressWarnings("null")@NonNull TmapModule trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapModule();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		OPPOSITE_OF_TmapModule_t1atlModule.put(atlModule, trace_70);
		trace_70.setT1atlModule(atlModule);
		jm_TmapModule.appendElement(trace_70);
	 ...
	 *
	 */
	protected boolean MAP_mmapSimpleOutPatternElement__qvtr__activator__(final /*@NonInvalid*/ @NonNull SimpleOutPatternElement atlElement_0, final @NonNull Connection jm_TmapSimpleOutPatternElement)  {
		if (debugInvocations) {
		...
		// creations
		final @SuppressWarnings("null")@NonNull TmapSimpleOutPatternElement trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapSimpleOutPatternElement();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		OPPOSITE_OF_TmapSimpleOutPatternElement_t1atlElement.put(atlElement_0, trace_70);
		trace_70.setT1atlElement(atlElement_0);
		jm_TmapSimpleOutPatternElement.appendElement(trace_70);
	...
	protected boolean MAP_mmapMatchedRule__super__qvtr__activator__(final /*@NonInvalid*/ @NonNull MatchedRule atlChildRule, final @NonNull Connection jm_TmapMatchedRule__super)  {
		...
		// creations
		final @SuppressWarnings("null")@NonNull TmapMatchedRule_super trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapMatchedRule_super();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		trace_70.setT1atlChildRule(atlChildRule);
		jm_TmapMatchedRule__super.appendElement(trace_70);
	...
	protected boolean MAP_mmapMatchedRule__qvtr__activator__(final @NonNull Connection jm_TmapMatchedRule, final /*@NonInvalid*/ @NonNull MatchedRule matchedRule)  {
		...
		// creations
		final @SuppressWarnings("null")@NonNull TmapMatchedRule trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapMatchedRule();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		OPPOSITE_OF_TmapMatchedRule_t1matchedRule.put(matchedRule, trace_70);
		trace_70.setT1matchedRule(matchedRule);
		jm_TmapMatchedRule.appendElement(trace_70);
	 ...
	 *
	 */
	protected boolean MAP_mmapInPattern__qvtr__activator__(final /*@NonInvalid*/ @NonNull InPattern atlPattern_1, final @NonNull Connection jm_TmapInPattern)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapInPattern__qvtr__activator__" +
					"\n\t\"atlPattern\":" + toDebugString(atlPattern_1));
		}
		// creations
		final @SuppressWarnings("null")@NonNull TmapInPattern trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapInPattern();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		OPPOSITE_OF_TmapInPattern_t1atlPattern.put(atlPattern_1, trace_70);
		trace_70.setT1atlPattern(atlPattern_1);
		jm_TmapInPattern.appendElement(trace_70);
	...
	protected boolean MAP_mmapBinding__qvtr__activator__(final /*@NonInvalid*/ @NonNull Binding atlBinding, final @NonNull Connection jm_TmapBinding)  {
		...
		// creations
		final @SuppressWarnings("null")@NonNull TmapBinding trace_70 = trace_ATL2QVTrFactory.eINSTANCE.createTmapBinding();
		models[2/*middle*/].add(trace_70, false);
		if (debugCreations) {
			AbstractTransformer.CREATIONS.println("created " + toDebugString(trace_70));
		}
		// mapping statements
		trace_70.setT1atlBinding(atlBinding);
		jm_TmapBinding.appendElement(trace_70);
	 ...
	 *
	 */
	protected boolean MAP_mmapOclMetamodel__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapOclMetamodel trace_0)  {
		if (debugInvocations) {
		...
		final /*@NonInvalid*/ @NonNull IdResolver idResolver = executor.getIdResolver();
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull OclModel t1oclMetamodel = trace_0.getT1oclMetamodel();
		@SuppressWarnings("null")
		...
		if (notEmpty) {
			...
			trace_0.setT0tmName(name_2);
			trace_0.setT2qvtrTypedModel(qvtrTypedModel);
	 ...
	 *
	 */
	protected boolean MAP_mmapIntegerExp__qvtr(final /*@NonInvalid*/ @NonNull TmapIntegerExp trace_1)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapIntegerExp__qvtr" +
					...
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_1.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_1.getDispatcher().getD2qvtrExpression()));
		}
		final /*@NonInvalid*/ @NonNull IdResolver idResolver = executor.getIdResolver();
		@SuppressWarnings("null")
		...
		if (eq) {
			...
			if (symbol_0) {
				...
				// mapping statements
				trace_1.setT0symbol(ValueUtil.bigIntegerValueOf(integerSymbol));
		...
		trace_1.setSuccess(symbol_10);
		objectManager.assigned(trace_1, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, symbol_10);
		if (debugInvocations) {
	 ...
	 *
	 */
	protected boolean MAP_mmapStringExp__qvtr(final /*@NonInvalid*/ @NonNull TmapStringExp trace_2)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapStringExp__qvtr" +
					"\n\t\"trace\":" + toDebugString(trace_2) +
					"\n\t\"dispatcher\":" + toDebugString(trace_2.getDispatcher()) +
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_2.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_2.getDispatcher().getD2qvtrExpression()));
		}
		final /*@NonInvalid*/ @NonNull IdResolver idResolver = executor.getIdResolver();
		@SuppressWarnings("null")
		...
		final /*@NonInvalid*/ boolean eq = trace_2.equals(domapStringExp);
		/*@Thrown*/ @Nullable Boolean symbol_10;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
			...
			if (symbol_0) {
				...
				// mapping statements
				trace_2.setT0symbol(stringSymbol);
				qvtrExpression.setStringSymbol(stringSymbol);
				dispatcher_0.setSuccess(ValueUtil.TRUE_VALUE);
				objectManager.assigned(dispatcher_0, QVTtracePackage.Literals.DISPATCH__SUCCESS, ValueUtil.TRUE_VALUE);
				dispatcher_0.setD2qvtrExpression(qvtrExpression);
				dispatcher_0.setResult(trace_2);
		...
		trace_2.setSuccess(symbol_10);
		objectManager.assigned(trace_2, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, symbol_10);
		if (debugInvocations) {
	 ...
	 *
	 */
	protected boolean MAP_mmapVariableExp__qvtr(final @NonNull Connection jm_DmapVariableExp__referredVariable, final @NonNull Connection jo_VariableExp, final /*@NonInvalid*/ @NonNull TmapVariableExp trace_3)  {
		if (debugInvocations) {
		...
		final /*@NonInvalid*/ boolean eq = trace_3.equals(domapVariableExp);
		...
		if (eq) {
			...
			if (symbol_0) {
				...
				// mapping statements
				trace_3.setT0varName(varName);
				qvtrExpression.setName(varName);
				dispatcher_0.setSuccess(ValueUtil.TRUE_VALUE);
				objectManager.assigned(dispatcher_0, QVTtracePackage.Literals.DISPATCH__SUCCESS, ValueUtil.TRUE_VALUE);
				dispatcher_0.setD2qvtrExpression(qvtrExpression);
				dispatcher_0.setResult(trace_3);
				trace_3.setT1atlVariable(referredVariable);
				trace_3.setWmapVariableExp_referredVariable(where_mapVariableExp_referredVariable);
		...
		trace_3.setSuccess(symbol_15);
		objectManager.assigned(trace_3, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, symbol_15);
		if (debugInvocations) {
	 ...
	 *
	 */
	protected boolean MAP_mmapModule__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapModule trace_4)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapModule__qvtr__residue__" +
					"\n\t\"trace\":" + toDebugString(trace_4));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull Module t1atlModule = trace_4.getT1atlModule();
		@SuppressWarnings("null")
		...
		trace_4.setT2_5(_5);
		trace_4.setT2_6(_6);
		trace_4.setT2qvtrTransformation(qvtrTransformation);
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Operation trace_5;
		...
		public MAP_mmapOperationCallExp__Operation__qvtr__local__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_5 = (@NonNull TmapOperationCallExp_Operation)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ boolean eq = trace_5.equals(domapOperationCallExp_Operation);
			/*@Thrown*/ @Nullable Boolean symbol_9;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					...
					if (symbol_2) {
						...
						if (success) {
							...
							// mapping statements
							trace_5.setT0operationName(operationName);
							objectManager.assigned(trace_5, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_OPERATION__T0OPERATION_NAME, operationName);
							trace_5.setT1atlSource(source);
							trace_5.setWmapOclExpression(DmapOclExpression);
							objectManager.assigned(trace_5, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_OPERATION__WMAP_OCL_EXPRESSION, DmapOclExpression);
							final /*@Thrown*/ @Nullable Boolean mmapOperationCallExp__Operation__qvtr__local__ = ValueUtil.TRUE_VALUE;
							symbol_7 = mmapOperationCallExp__Operation__qvtr__local__;
						}
						else {
			...
			trace_5.setLocalSuccess(symbol_9);
			objectManager.assigned(trace_5, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_OPERATION__LOCAL_SUCCESS, symbol_9);
			return symbol_9;
		}

		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_5, thoseValues[0]);
		}
	}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Helper trace_6;
		...
		public MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__loc(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_6 = (@NonNull TmapNavigationOrAttributeCallExp_Helper)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ boolean eq = trace_6.equals(domapNavigationOrAttributeCallExp_Helper);
			/*@Thrown*/ @Nullable Boolean symbol_9;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					...
					if (symbol_2) {
						...
						if (success) {
							...
							objectManager.assigned(trace_6, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_HELPER__T0PROPERTY_NAME, name_2);
							trace_6.setT1atlSource(source);
							trace_6.setWmapOclExpression(DmapOclExpression);
							objectManager.assigned(trace_6, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_HELPER__WMAP_OCL_EXPRESSION, DmapOclExpression);
			...
			trace_6.setLocalSuccess(symbol_9);
			objectManager.assigned(trace_6, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_HELPER__LOCAL_SUCCESS, symbol_9);
			return symbol_9;
		}

		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_6, thoseValues[0]);
		}
	}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Property trace_7;
		...
		public MAP_mmapNavigationOrAttributeCallExp__Property__qvtr__l(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_7 = (@NonNull TmapNavigationOrAttributeCallExp_Property)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ boolean eq = trace_7.equals(domapNavigationOrAttributeCallExp_Property);
			/*@Thrown*/ @Nullable Boolean symbol_9;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					...
					if (symbol_2) {
						...
						if (success) {
							...
							final /*@NonInvalid*/ @NonNull String name_2 = symbol_1.getName();
							// mapping statements
							trace_7.setT0propertyName(name_2);
							objectManager.assigned(trace_7, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_PROPERTY__T0PROPERTY_NAME, name_2);
							trace_7.setT1atlSource(source);
							trace_7.setWmapOclExpression(DmapOclExpression);
							objectManager.assigned(trace_7, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_PROPERTY__WMAP_OCL_EXPRESSION, DmapOclExpression);
			...
			trace_7.setLocalSuccess(symbol_9);
			objectManager.assigned(trace_7, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_PROPERTY__LOCAL_SUCCESS, symbol_9);
			return symbol_9;
		}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Helper trace_8;
		...
		public MAP_mmapOperationCallExp__Helper__qvtr__local__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_8 = (@NonNull TmapOperationCallExp_Helper)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ boolean eq = trace_8.equals(domapOperationCallExp_Helper);
			/*@Thrown*/ @Nullable Boolean symbol_9;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					...
					if (symbol_2) {
						...
						if (success) {
							...
							final /*@NonInvalid*/ @NonNull String operationName = symbol_1.getOperationName();
							// mapping statements
							trace_8.setT0operationName(operationName);
							objectManager.assigned(trace_8, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_HELPER__T0OPERATION_NAME, operationName);
							trace_8.setT1atlSource(source);
							trace_8.setWmapOclExpression(DmapOclExpression);
							objectManager.assigned(trace_8, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_HELPER__WMAP_OCL_EXPRESSION, DmapOclExpression);
			...
			trace_8.setLocalSuccess(symbol_9);
			objectManager.assigned(trace_8, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_HELPER__LOCAL_SUCCESS, symbol_9);
			return symbol_9;
		}

		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_8, thoseValues[0]);
		}
	}
	...
	protected class MAP_mmapIfExp__qvtr__local__ extends AbstractInvocation
	{
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ boolean eq = trace_9.equals(domapIfExp);
							...
							if (symbol_3) {
								...
								if (success_0) {
									...
									if (symbol_4) {
										...
										if (success_1) {
											// mapping statements
											trace_9.setT1atlCondition(condition);
											trace_9.setT1atlElse(elseExpression);
											trace_9.setT1atlThen(thenExpression);
											trace_9.setWmapOclExpression1(DmapOclExpression_0);
											objectManager.assigned(trace_9, trace_ATL2QVTrPackage.Literals.TMAP_IF_EXP__WMAP_OCL_EXPRESSION1, DmapOclExpression_0);
											trace_9.setWmapOclExpression2(DmapOclExpression_1);
											objectManager.assigned(trace_9, trace_ATL2QVTrPackage.Literals.TMAP_IF_EXP__WMAP_OCL_EXPRESSION2, DmapOclExpression_1);
											trace_9.setWmapOclExpression(DmapOclExpression);
											objectManager.assigned(trace_9, trace_ATL2QVTrPackage.Literals.TMAP_IF_EXP__WMAP_OCL_EXPRESSION, DmapOclExpression);
			...
			trace_9.setLocalSuccess(symbol_16);
			objectManager.assigned(trace_9, trace_ATL2QVTrPackage.Literals.TMAP_IF_EXP__LOCAL_SUCCESS, symbol_16);
			return symbol_16;
		}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperatorCallExp trace_10;
		...
		public MAP_mmapOperatorCallExp__qvtr__local__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_10 = (@NonNull TmapOperatorCallExp)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ boolean eq = trace_10.equals(domapOperatorCallExp);
			/*@Thrown*/ @Nullable Boolean symbol_9;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					...
					if (symbol_2) {
						...
						if (success) {
							...
							objectManager.assigned(trace_10, trace_ATL2QVTrPackage.Literals.TMAP_OPERATOR_CALL_EXP__T0OPERATION_NAME, operationName);
							trace_10.setT1atlSource(source);
							trace_10.setWmapOclExpression(DmapOclExpression);
							objectManager.assigned(trace_10, trace_ATL2QVTrPackage.Literals.TMAP_OPERATOR_CALL_EXP__WMAP_OCL_EXPRESSION, DmapOclExpression);
			...
			trace_10.setLocalSuccess(symbol_9);
			objectManager.assigned(trace_10, trace_ATL2QVTrPackage.Literals.TMAP_OPERATOR_CALL_EXP__LOCAL_SUCCESS, symbol_9);
			return symbol_9;
		}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapHelper_Attribute trace_12;
		...
		public MAP_mmapHelper__Attribute__qvtr__local__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_12 = (@NonNull TmapHelper_Attribute)boundValues[0];
		}
		...
		public boolean execute()  {
						...
						if (success) {
							...
							if (symbol_3) {
								...
								if (symbol_4) {
									...
									final /*@Thrown*/ @NonNull RelationalTransformation t2qvtrTransformation = TmapModule.getT2qvtrTransformation();
									// mapping statements
									trace_12.setT0attributeName(name_2);
									objectManager.assigned(trace_12, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_ATTRIBUTE__T0ATTRIBUTE_NAME, name_2);
									trace_12.setT1atlDefinition(definition);
									trace_12.setT1atlExpression(initExpression);
									trace_12.setT1atlFeature(symbol_1);
									trace_12.setT1atlModule(module);
									trace_12.setT1atlType(type_2);
									trace_12.setT2qvtrTransformation(t2qvtrTransformation);
									objectManager.assigned(trace_12, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_ATTRIBUTE__T2QVTR_TRANSFORMATION, t2qvtrTransformation);
									trace_12.setWmapModule(TmapModule);
									trace_12.setWmapOclExpression(DmapOclExpression);
									objectManager.assigned(trace_12, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_ATTRIBUTE__WMAP_OCL_EXPRESSION, DmapOclExpression);
			...
			trace_12.setLocalSuccess(symbol_17);
			objectManager.assigned(trace_12, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_ATTRIBUTE__LOCAL_SUCCESS, symbol_17);
			return symbol_17;
		}
	 ...
	 *
	 */
	protected boolean MAP_mmapOclModel__OUT__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapOclModel_OUT trace_13)  {
		if (debugInvocations) {
		...
		final /*@NonInvalid*/ @NonNull IdResolver idResolver = executor.getIdResolver();
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull OclModel t1oclModel = trace_13.getT1oclModel();
			...
			if (symbol_1) {
				...
				if (symbol_2) {
					...
					if (symbol_3) {
						...
						trace_13.setT1atlModule(Module);
						trace_13.setT1oclMetamodel(metamodel);
						trace_13.setT2qvtrTransformation(t2qvtrTransformation);
						trace_13.setT2qvtrTypedModel(t2qvtrTypedModel);
						trace_13.setWmapModule(TmapModule);
						trace_13.setWmapOclMetamodel(TmapOclMetamodel);
						final /*@Thrown*/ @Nullable Boolean mmapOclModel__OUT__qvtr__residue__ = ValueUtil.TRUE_VALUE;
						raw_when_mapOclMetamodel = mmapOclModel__OUT__qvtr__residue__;
					}
					else {
		...
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((raw_atlModule ? "done "  : "fail ") + "MAP_mmapOclModel__OUT__qvtr__residue__");
		}
	 ...
	 * new:qvtr _5 : qvtrelation::SharedVariable[1];
	 * new:qvtr qvtrRelation : qvtrelation::Relation[1];
	 * set _5.isImplicit := true;
	 * set _5.name := 'trace';
	 ...
	 * set _5.type := _'qvttrace::TraceElement';
	 * set qvtrRelation.transformation := qvtrTransformation;
	 * set qvtrRelation.variable := _5;
	 * set trace.t1atlModule := atlModule;
	 * set trace.t2_5 := _5;
	 ...
	 *
	 */
	protected boolean MAP_mmapMatchedRule__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapMatchedRule trace_14)  {
		if (debugInvocations) {
		...
		final /*@NonInvalid*/ @NonNull IdResolver idResolver = executor.getIdResolver();
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull MatchedRule t1matchedRule = trace_14.getT1matchedRule();
		...
		if (symbol_0) {
			...
			if (symbol_1) {
				...
				// creations
				final @NonNull SharedVariable _5 = QVTrelationFactory.eINSTANCE.createSharedVariable();
				models[1/*qvtr*/].add(_5, false);
				if (debugCreations) {
					AbstractTransformer.CREATIONS.println("created " + toDebugString(_5));
				}
				...
				// mapping statements
				_5.setIsImplicit(ValueUtil.TRUE_VALUE);
				_5.setName(STR_trace);
				qvtrRelation.setIsAbstract(isAbstract);
				qvtrRelation.setIsTopLevel(ValueUtil.TRUE_VALUE);
				qvtrRelation.setName(name_2);
				trace_14.setT0ruleName(name_2);
				_5.setType(TYP_qvttrace_c_c_TraceElement_0);
				qvtrRelation.setTransformation(t2qvtrTransformation);
				qvtrRelation.getVariable().add(_5);
				trace_14.setT1atlModule(module);
				trace_14.setT2_5(_5);
				trace_14.setT2qvtrRelation(qvtrRelation);
				trace_14.setT2qvtrTransformation(t2qvtrTransformation);
				trace_14.setWmapModule(TmapModule);
		...
		trace_14.setSuccess(raw_atlModule);
		objectManager.assigned(trace_14, trace_ATL2QVTrPackage.Literals.TMAP_MATCHED_RULE__SUCCESS, raw_atlModule);
		if (debugInvocations) {
	 ...
	 *
	 */
	protected boolean MAP_mmapOclModel__IN__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapOclModel_IN trace_15)  {
		if (debugInvocations) {
		...
		final /*@NonInvalid*/ @NonNull IdResolver idResolver = executor.getIdResolver();
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull OclModel t1oclModel = trace_15.getT1oclModel();
			...
			if (symbol_1) {
				...
				if (symbol_2) {
					...
					if (symbol_3) {
						...
						final /*@Thrown*/ @NonNull SetValue oclAsSet = OclAnyOclAsSetOperation.INSTANCE.evaluate(executor, SET_CLSSid_Package, getPackage_0);
						// mapping statements
						trace_15.setT0tmName(name_2);
						final /*@Thrown*/ @NonNull List<org.eclipse.ocl.pivot.Package> ECORE_oclAsSet = ((IdResolver.IdResolverExtension)idResolver).ecoreValueOfAll(org.eclipse.ocl.pivot.Package.class, oclAsSet);
						t2qvtrTypedModel.getUsedPackage().addAll(ECORE_oclAsSet);
						t2qvtrTypedModel.setTransformation(t2qvtrTransformation);
						trace_15.setT1atlModule(Module);
						trace_15.setT1oclMetamodel(metamodel);
						trace_15.setT2qvtrTransformation(t2qvtrTransformation);
						trace_15.setT2qvtrTypedModel(t2qvtrTypedModel);
						trace_15.setWmapModule(TmapModule);
						trace_15.setWmapOclMetamodel(TmapOclMetamodel);
						final /*@Thrown*/ @Nullable Boolean mmapOclModel__IN__qvtr__residue__ = ValueUtil.TRUE_VALUE;
						raw_when_mapOclMetamodel = mmapOclModel__IN__qvtr__residue__;
					}
					else {
						raw_when_mapOclMetamodel = ValueUtil.FALSE_VALUE;
					}
		...
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((raw_atlModule ? "done "  : "fail ") + "MAP_mmapOclModel__IN__qvtr__residue__");
		}
		return raw_atlModule;
	}
	...
	protected class MAP_mmapOperationCallExp__Operation__qvtr__speculated__ extends AbstractInvocation
	{
		...
		public boolean execute()  {
			...
			if (eq) {
				objectManager.getting(trace_16, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_OPERATION__LOCAL_SUCCESS, false);
				final /*@NonInvalid*/ @Nullable Boolean localSuccess = trace_16.getLocalSuccess();
				if (localSuccess == null) {
					throw new InvalidEvaluationException("Null if condition");
				}
				/*@Thrown*/ @Nullable Boolean symbol_5;
				if (localSuccess) {
					objectManager.getting(trace_16, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, false);
					final /*@NonInvalid*/ @Nullable Boolean success = trace_16.getSuccess();
					if (success == null) {
						throw new InvalidEvaluationException("Null if condition");
					}
					/*@Thrown*/ @Nullable Boolean symbol_4;
					if (success) {
						objectManager.getting(trace_16, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_OPERATION__T0OPERATION_NAME, false);
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull String t0operationName = trace_16.getT0operationName();
						// creations
						...
						symbol_4 = mmapOperationCallExp__Operation__qvtr__speculated__;
					}
					else {
						symbol_4 = ValueUtil.FALSE_VALUE;
					}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapIfExp trace_17;

		public MAP_mmapIfExp__qvtr__speculated__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_17 = (@NonNull TmapIfExp)boundValues[0];
		}

		@Override
		public boolean execute()  {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_17.getDispatcher();
			final /*@NonInvalid*/ @Nullable TmapIfExp domapIfExp = dispatcher_0.getDomapIfExp();
			final /*@NonInvalid*/ boolean eq = trace_17.equals(domapIfExp);
			/*@Thrown*/ @Nullable Boolean symbol_5;
			if (eq) {
				objectManager.getting(trace_17, trace_ATL2QVTrPackage.Literals.TMAP_IF_EXP__LOCAL_SUCCESS, false);
				...
				/*@Thrown*/ @Nullable Boolean symbol_4;
				if (localSuccess) {
					objectManager.getting(trace_17, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, false);
					final /*@NonInvalid*/ @Nullable Boolean success = trace_17.getSuccess();
					if (success == null) {
						throw new InvalidEvaluationException("Null if condition");
					}
	...
	protected class MAP_mmapOperationCallExp__Helper__qvtr__speculated__ extends AbstractInvocation
	{
		...
		protected final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Helper trace_18;
		...
		public MAP_mmapOperationCallExp__Helper__qvtr__speculated__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			jo_VariableExp_0 = (Connection)boundValues[0];
			trace_18 = (@NonNull TmapOperationCallExp_Helper)boundValues[1];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapOperationCallExp_Helper domapOperationCallExp_Helper = dispatcher_0.getDomapOperationCallExp_Helper();
			final /*@NonInvalid*/ boolean eq = trace_18.equals(domapOperationCallExp_Helper);
			/*@Thrown*/ @Nullable Boolean symbol_9;
			if (eq) {
				objectManager.getting(trace_18, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_HELPER__LOCAL_SUCCESS, false);
				...
				/*@Thrown*/ @Nullable Boolean symbol_8;
				if (localSuccess) {
					objectManager.getting(trace_18, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, false);
					final /*@NonInvalid*/ @Nullable Boolean success = trace_18.getSuccess();
					if (success == null) {
						throw new InvalidEvaluationException("Null if condition");
					}
					/*@Thrown*/ @Nullable Boolean symbol_7;
					if (success) {
						objectManager.getting(trace_18, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_HELPER__T0OPERATION_NAME, false);
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull String t0operationName = trace_18.getT0operationName();
						// creations
						final org.eclipse.ocl.pivot.@NonNull OperationCallExp qvtrExpression = PivotFactory.eINSTANCE.createOperationCallExp();
						models[1/*qvtr*/].add(qvtrExpression, false);
						if (debugCreations) {
						...
						objectManager.assigned(dispatcher_0, QVTtracePackage.Literals.DISPATCH__SUCCESS, ValueUtil.TRUE_VALUE);
						dispatcher_0.setD2qvtrExpression(qvtrExpression);
						trace_18.setT2qvtrSource(qvtrSource);
						...
						symbol_7 = mmapOperationCallExp__Helper__qvtr__speculated__;
					}
					else {
						symbol_7 = ValueUtil.FALSE_VALUE;
					}
		...
		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(jo_VariableExp_0, thoseValues[0])
					&& idResolver.oclEquals(trace_18, thoseValues[1]);
		}
	}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperatorCallExp trace_19;
		...
		public MAP_mmapOperatorCallExp__qvtr__speculated__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_19 = (@NonNull TmapOperatorCallExp)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapOperatorCallExp domapOperatorCallExp = dispatcher_0.getDomapOperatorCallExp();
			final /*@NonInvalid*/ boolean eq = trace_19.equals(domapOperatorCallExp);
			/*@Thrown*/ @Nullable Boolean symbol_6;
			if (eq) {
				objectManager.getting(trace_19, trace_ATL2QVTrPackage.Literals.TMAP_OPERATOR_CALL_EXP__LOCAL_SUCCESS, false);
				...
				/*@Thrown*/ @Nullable Boolean symbol_5;
				if (localSuccess) {
					objectManager.getting(trace_19, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, false);
					final /*@NonInvalid*/ @Nullable Boolean success = trace_19.getSuccess();
					if (success == null) {
						throw new InvalidEvaluationException("Null if condition");
					}
					/*@Thrown*/ @Nullable Boolean symbol_4;
					if (success) {
						objectManager.getting(trace_19, trace_ATL2QVTrPackage.Literals.TMAP_OPERATOR_CALL_EXP__T0OPERATION_NAME, false);
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull String t0operationName = trace_19.getT0operationName();
						// creations
						final org.eclipse.ocl.pivot.@NonNull OperationCallExp qvtrExpression = PivotFactory.eINSTANCE.createOperationCallExp();
						models[1/*qvtr*/].add(qvtrExpression, false);
						if (debugCreations) {
						...
						symbol_4 = mmapOperatorCallExp__qvtr__speculated__;
					}
					else {
						symbol_4 = ValueUtil.FALSE_VALUE;
					}
		...
		public boolean execute()  {
			...
			if (symbol_0) {
				...
				if (eq) {
					...
					final /*@NonInvalid*/ boolean symbol_1 = domapOperationCallExp_Helper != null;
					...
					if (symbol_1) {
						...
						final /*@Thrown*/ @Nullable Boolean success_0 = domapOperationCallExp_Helper.getSuccess();
						final /*@Thrown*/ boolean eq_0 = success_0 == Boolean.FALSE;
						...
						if (eq_0) {
							...
							if (symbol_2) {
								...
								if (eq_1) {
									...
									final /*@NonInvalid*/ boolean symbol_3 = domapStringExp != null;
									...
									if (symbol_3) {
										...
										final /*@Thrown*/ @Nullable Boolean success_2 = domapStringExp.getSuccess();
										...
										if (eq_2) {
											...
											final /*@NonInvalid*/ boolean symbol_4 = domapVariableExp != null;
											...
											if (symbol_4) {
												...
												final /*@Thrown*/ @Nullable Boolean success_3 = domapVariableExp.getSuccess();
												...
												if (eq_3) {
													...
													final /*@NonInvalid*/ boolean symbol_5 = domapBooleanExp != null;
													...
													if (symbol_5) {
														...
														final /*@Thrown*/ @Nullable Boolean success_4 = domapBooleanExp.getSuccess();
														...
														if (eq_4) {
															...
															final /*@NonInvalid*/ boolean symbol_6 = domapIntegerExp != null;
															...
															if (symbol_6) {
																...
																final /*@Thrown*/ @Nullable Boolean success_5 = domapIntegerExp.getSuccess();
																...
																if (eq_5) {
																	...
																	final /*@NonInvalid*/ boolean symbol_7 = domapIfExp != null;
																	...
																	if (symbol_7) {
																		...
																		final /*@Thrown*/ @Nullable Boolean success_6 = domapIfExp.getSuccess();
																		...
																		if (eq_6) {
																			...
																			final /*@NonInvalid*/ boolean symbol_8 = domapNavigationOrAttributeCallExp_Property != null;
																			...
																			if (symbol_8) {
																				...
																				final /*@Thrown*/ @Nullable Boolean success_7 = domapNavigationOrAttributeCallExp_Property.getSuccess();
																				...
																				if (eq_7) {
																					...
																					final /*@NonInvalid*/ boolean symbol_9 = domapNavigationOrAttributeCallExp_Helper != null;
																					...
																					if (symbol_9) {
																						...
																						final /*@Thrown*/ @Nullable Boolean success_8 = domapNavigationOrAttributeCallExp_Helper.getSuccess();
																						...
																						if (eq_8) {
																							...
																							symbol_12 = mmapOclExpression__verdict__qvtr;
																						}
																						else {
																							symbol_12 = ValueUtil.FALSE_VALUE;
																						}
																						raw_mapNavigationOrAttributeCallExp_Helper = symbol_12;
																					}
																					else {
																						raw_mapNavigationOrAttributeCallExp_Helper = ValueUtil.FALSE_VALUE;
																					}
																					symbol_13 = raw_mapNavigationOrAttributeCallExp_Helper;
																				}
																				else {
																					symbol_13 = ValueUtil.FALSE_VALUE;
																				}
																				raw_mapNavigationOrAttributeCallExp_Property = symbol_13;
																			}
																			else {
																				raw_mapNavigationOrAttributeCallExp_Property = ValueUtil.FALSE_VALUE;
																			}
																			symbol_14 = raw_mapNavigationOrAttributeCallExp_Property;
																		}
																		else {
																			symbol_14 = ValueUtil.FALSE_VALUE;
																		}
																		raw_mapIfExp = symbol_14;
																	}
																	else {
																		raw_mapIfExp = ValueUtil.FALSE_VALUE;
																	}
																	symbol_15 = raw_mapIfExp;
																}
																else {
																	symbol_15 = ValueUtil.FALSE_VALUE;
																}
																raw_mapIntegerExp = symbol_15;
															}
															else {
																raw_mapIntegerExp = ValueUtil.FALSE_VALUE;
															}
															symbol_16 = raw_mapIntegerExp;
														}
														else {
															symbol_16 = ValueUtil.FALSE_VALUE;
														}
										...
										raw_mapStringExp = symbol_18;
									}
									else {
										raw_mapStringExp = ValueUtil.FALSE_VALUE;
									}
									symbol_19 = raw_mapStringExp;
								}
								else {
						...
						raw_mapOperationCallExp_Helper = symbol_20;
					}
					else {
						raw_mapOperationCallExp_Helper = ValueUtil.FALSE_VALUE;
					}
					symbol_21 = raw_mapOperationCallExp_Helper;
				}
				else {
					symbol_21 = ValueUtil.FALSE_VALUE;
				}
				raw_mapOperatorCallExp = symbol_21;
			}
			else {
				raw_mapOperatorCallExp = ValueUtil.FALSE_VALUE;
			}
			return raw_mapOperatorCallExp;
		}
	...
	protected class MAP_mmapHelper__Attribute__qvtr__speculated__ extends AbstractInvocation
	{
		...
		protected final /*@NonInvalid*/ @NonNull TmapHelper_Attribute trace_20;
		...
		public MAP_mmapHelper__Attribute__qvtr__speculated__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			...
			trace_20 = (@NonNull TmapHelper_Attribute)boundValues[1];
		}

		@Override
		public boolean execute()  {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull DmapHelper dispatcher_0 = trace_20.getDispatcher();
			final /*@NonInvalid*/ @Nullable TmapHelper_Attribute domapHelper_Attribute = dispatcher_0.getDomapHelper_Attribute();
			final /*@NonInvalid*/ boolean eq = trace_20.equals(domapHelper_Attribute);
			/*@Thrown*/ @Nullable Boolean symbol_11;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull Helper d1atlHelper = dispatcher_0.getD1atlHelper();
				objectManager.getting(trace_20, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_ATTRIBUTE__LOCAL_SUCCESS, false);
				...
				/*@Thrown*/ @Nullable Boolean symbol_10;
				if (localSuccess) {
					objectManager.getting(trace_20, trace_ATL2QVTrPackage.Literals.IMAP_HELPER__SUCCESS, false);
					final /*@NonInvalid*/ @Nullable Boolean success = trace_20.getSuccess();
					if (success == null) {
						throw new InvalidEvaluationException("Null if condition");
					}
					/*@Thrown*/ @Nullable Boolean symbol_9;
					if (success) {
						objectManager.getting(trace_20, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_ATTRIBUTE__T0ATTRIBUTE_NAME, false);
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull String t0attributeName = trace_20.getT0attributeName();
						objectManager.getting(trace_20, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_ATTRIBUTE__T2QVTR_TRANSFORMATION, false);
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull RelationalTransformation t2qvtrTransformation = trace_20.getT2qvtrTransformation();
						// creations
						...
						trace_20.setWmapHelper_Context(where_mapHelper_Context);
		...
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(jm_TmapHelper__Context, thoseValues[0])
					&& idResolver.oclEquals(trace_20, thoseValues[1]);
		}
	}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Property trace_21;
		...
		public MAP_mmapNavigationOrAttributeCallExp__Property__qvtr__s(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_21 = (@NonNull TmapNavigationOrAttributeCallExp_Property)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapNavigationOrAttributeCallExp_Property domapNavigationOrAttributeCallExp_Property = dispatcher_0.getDomapNavigationOrAttributeCallExp_Property();
			final /*@NonInvalid*/ boolean eq = trace_21.equals(domapNavigationOrAttributeCallExp_Property);
			/*@Thrown*/ @Nullable Boolean symbol_6;
			if (eq) {
				objectManager.getting(trace_21, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_PROPERTY__LOCAL_SUCCESS, false);
				...
				/*@Thrown*/ @Nullable Boolean symbol_5;
				if (localSuccess) {
					objectManager.getting(trace_21, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, false);
					...
					/*@Thrown*/ @Nullable Boolean symbol_4;
					if (success) {
						objectManager.getting(trace_21, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_PROPERTY__T0PROPERTY_NAME, false);
						@SuppressWarnings("null")
						...
						symbol_4 = mmapNavigationOrAttributeCallExp__Property__qvtr__s;
					}
					else {
						symbol_4 = ValueUtil.FALSE_VALUE;
					}
	...
	protected class MAP_mmapHelper__Operation__qvtr__speculated__ extends AbstractInvocation
	{
		...
		protected final /*@NonInvalid*/ @NonNull TmapHelper_Operation trace_22;
		...
		public MAP_mmapHelper__Operation__qvtr__speculated__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			...
			trace_22 = (@NonNull TmapHelper_Operation)boundValues[1];
		}

		@Override
		public boolean execute()  {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull DmapHelper dispatcher_0 = trace_22.getDispatcher();
			final /*@NonInvalid*/ @Nullable TmapHelper_Operation domapHelper_Operation = dispatcher_0.getDomapHelper_Operation();
			final /*@NonInvalid*/ boolean eq = trace_22.equals(domapHelper_Operation);
			/*@Thrown*/ @Nullable Boolean symbol_11;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull Helper d1atlHelper = dispatcher_0.getD1atlHelper();
				objectManager.getting(trace_22, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_OPERATION__LOCAL_SUCCESS, false);
				...
				/*@Thrown*/ @Nullable Boolean symbol_10;
				if (localSuccess) {
					objectManager.getting(trace_22, trace_ATL2QVTrPackage.Literals.IMAP_HELPER__SUCCESS, false);
					final /*@NonInvalid*/ @Nullable Boolean success = trace_22.getSuccess();
					if (success == null) {
						throw new InvalidEvaluationException("Null if condition");
					}
					/*@Thrown*/ @Nullable Boolean symbol_9;
					if (success) {
						objectManager.getting(trace_22, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_OPERATION__T0OPERATION_NAME, false);
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull String t0operationName = trace_22.getT0operationName();
						objectManager.getting(trace_22, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_OPERATION__T2QVTR_TRANSFORMATION, false);
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull RelationalTransformation t2qvtrTransformation = trace_22.getT2qvtrTransformation();
						// creations
						final @NonNull Function qvtrFunction = QVTbaseFactory.eINSTANCE.createFunction();
						models[1/*qvtr*/].add(qvtrFunction, false);
						if (debugCreations) {
						...
						objectManager.assigned(dispatcher_0, QVTtracePackage.Literals.DISPATCH__SUCCESS, ValueUtil.TRUE_VALUE);
						dispatcher_0.setD2qvtrFunction(qvtrFunction);
						trace_22.setWmapHelper_Context(where_mapHelper_Context);
						qvtrFunction.setOwningClass(t2qvtrTransformation);
						where_mapHelper_Context.setT1atlHelper(d1atlHelper);
						where_mapHelper_Context.setT2qvtrFunction(qvtrFunction);
		...
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(jm_TmapHelper__Context_0, thoseValues[0])
					&& idResolver.oclEquals(trace_22, thoseValues[1]);
		}
	}
	...
	protected class MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__spe extends AbstractInvocation
	{
		...
		public MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__spe(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			jo_VariableExp_1 = (Connection)boundValues[0];
			trace_23 = (@NonNull TmapNavigationOrAttributeCallExp_Helper)boundValues[1];
		}
		...
		public boolean execute()  {
			...
			if (eq) {
				...
				/*@Thrown*/ @Nullable Boolean symbol_8;
				if (localSuccess) {
					objectManager.getting(trace_23, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, false);
					...
					if (success) {
						...
						symbol_7 = mmapNavigationOrAttributeCallExp__Helper__qvtr__spe;
					}
					else {
						symbol_7 = ValueUtil.FALSE_VALUE;
					}
		...
		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(jo_VariableExp_1, thoseValues[0])
					&& idResolver.oclEquals(trace_23, thoseValues[1]);
		}
	}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapHelper_Attribute trace_24;
		...
		public MAP_mmapHelper__Attribute__qvtr__global__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_24 = (@NonNull TmapHelper_Attribute)boundValues[0];
		}

		@Override
		public boolean execute()  {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull DmapHelper dispatcher_0 = trace_24.getDispatcher();
			final /*@NonInvalid*/ @Nullable TmapHelper_Attribute domapHelper_Attribute = dispatcher_0.getDomapHelper_Attribute();
			final /*@NonInvalid*/ boolean eq = trace_24.equals(domapHelper_Attribute);
			/*@Thrown*/ @Nullable Boolean symbol_4;
			if (eq) {
				objectManager.getting(trace_24, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_ATTRIBUTE__LOCAL_SUCCESS, false);
				...
				/*@Thrown*/ @Nullable Boolean symbol_3;
				if (localSuccess) {
					objectManager.getting(trace_24, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_ATTRIBUTE__WMAP_OCL_EXPRESSION, false);
			...
			trace_24.setSuccess(symbol_4);
			objectManager.assigned(trace_24, trace_ATL2QVTrPackage.Literals.IMAP_HELPER__SUCCESS, symbol_4);
			return symbol_4;
		}
	 ...
	 * observe trace_ATL2QVTr::TmapIfExp::wmapOclExpression1 var when_mapOclExpression1 : trace_ATL2QVTr::DmapOclExpression[1] := trace.wmapOclExpression1;
	 * observe trace_ATL2QVTr::TmapIfExp::wmapOclExpression2 var when_mapOclExpression2 : trace_ATL2QVTr::DmapOclExpression[1] := trace.wmapOclExpression2;
	 * set dispatcher.result := trace;
	 *
	 */
	protected class MAP_mmapIfExp__qvtr__global__ extends AbstractInvocation
	{
		protected final /*@NonInvalid*/ @NonNull TmapIfExp trace_25;

		public MAP_mmapIfExp__qvtr__global__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_25 = (@NonNull TmapIfExp)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapIfExp domapIfExp = dispatcher_0.getDomapIfExp();
			final /*@NonInvalid*/ boolean eq = trace_25.equals(domapIfExp);
			/*@Thrown*/ @Nullable Boolean symbol_6;
			if (eq) {
				objectManager.getting(trace_25, trace_ATL2QVTrPackage.Literals.TMAP_IF_EXP__LOCAL_SUCCESS, false);
				...
				/*@Thrown*/ @Nullable Boolean symbol_5;
				if (localSuccess) {
					objectManager.getting(trace_25, trace_ATL2QVTrPackage.Literals.TMAP_IF_EXP__WMAP_OCL_EXPRESSION, false);
					final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_25.getWmapOclExpression();
					final /*@NonInvalid*/ boolean symbol_0 = wmapOclExpression != null;
					/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression;
					if (symbol_0) {
						if (wmapOclExpression == null) {
						...
						objectManager.getting(trace_25, trace_ATL2QVTrPackage.Literals.TMAP_IF_EXP__WMAP_OCL_EXPRESSION1, false);
						final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression1 = trace_25.getWmapOclExpression1();
						final /*@NonInvalid*/ boolean symbol_1 = wmapOclExpression1 != null;
						/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression1;
						if (symbol_1) {
							if (wmapOclExpression1 == null) {
								throw new InvalidEvaluationException("Null where non-null value required");
							}
							objectManager.getting(trace_25, trace_ATL2QVTrPackage.Literals.TMAP_IF_EXP__WMAP_OCL_EXPRESSION2, false);
							final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression2 = trace_25.getWmapOclExpression2();
							...
							if (symbol_2) {
								...
								// mapping statements
								dispatcher_0.setResult(trace_25);
			...
			trace_25.setSuccess(symbol_6);
			objectManager.assigned(trace_25, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, symbol_6);
			return symbol_6;
		}

		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_25, thoseValues[0]);
		}
	}
	 ...
	 *   ;
	 * var isEmpty : Boolean[1] := atlAttributes->isEmpty()
	 *   ;
	 * check isEmpty;
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Property trace_26;
		...
		public MAP_mmapNavigationOrAttributeCallExp__Property__qvtr__g(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_26 = (@NonNull TmapNavigationOrAttributeCallExp_Property)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapNavigationOrAttributeCallExp_Property domapNavigationOrAttributeCallExp_Property = dispatcher_0.getDomapNavigationOrAttributeCallExp_Property();
			final /*@NonInvalid*/ boolean eq = trace_26.equals(domapNavigationOrAttributeCallExp_Property);
			/*@Thrown*/ @Nullable Boolean symbol_8;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					final /*@NonInvalid*/ @NonNull NavigationOrAttributeCallExp symbol_1 = (NavigationOrAttributeCallExp)temp1_atlExpression;
					objectManager.getting(trace_26, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_PROPERTY__LOCAL_SUCCESS, false);
					...
					/*@Thrown*/ @Nullable Boolean symbol_6;
					if (localSuccess) {
						objectManager.getting(trace_26, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_PROPERTY__WMAP_OCL_EXPRESSION, false);
						final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_26.getWmapOclExpression();
						...
						if (symbol_2) {
							...
							objectManager.getting(trace_26, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_PROPERTY__T0PROPERTY_NAME, false);
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull String t0propertyName = trace_26.getT0propertyName();
							...
							if (isEmpty) {
								// mapping statements
								dispatcher_0.setResult(trace_26);
			...
			trace_26.setSuccess(symbol_8);
			objectManager.assigned(trace_26, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, symbol_8);
			return symbol_8;
		}

		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_26, thoseValues[0]);
		}
	}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapHelper_Operation trace_27;
		...
		public MAP_mmapHelper__Operation__qvtr__global__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_27 = (@NonNull TmapHelper_Operation)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapHelper_Operation domapHelper_Operation = dispatcher_0.getDomapHelper_Operation();
			final /*@NonInvalid*/ boolean eq = trace_27.equals(domapHelper_Operation);
			/*@Thrown*/ @Nullable Boolean symbol_4;
			if (eq) {
				objectManager.getting(trace_27, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_OPERATION__LOCAL_SUCCESS, false);
				...
				/*@Thrown*/ @Nullable Boolean symbol_3;
				if (localSuccess) {
					objectManager.getting(trace_27, trace_ATL2QVTrPackage.Literals.TMAP_HELPER_OPERATION__WMAP_OCL_EXPRESSION, false);
					final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_27.getWmapOclExpression();
					final /*@NonInvalid*/ boolean symbol_0 = wmapOclExpression != null;
					/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression;
					if (symbol_0) {
						if (wmapOclExpression == null) {
						...
						// mapping statements
						dispatcher_0.setResult(trace_27);
			...
			trace_27.setSuccess(symbol_4);
			objectManager.assigned(trace_27, trace_ATL2QVTrPackage.Literals.IMAP_HELPER__SUCCESS, symbol_4);
			return symbol_4;
		}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Helper trace_28;
		...
		public MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__glo(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_28 = (@NonNull TmapNavigationOrAttributeCallExp_Helper)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapNavigationOrAttributeCallExp_Helper domapNavigationOrAttributeCallExp_Helper = dispatcher_0.getDomapNavigationOrAttributeCallExp_Helper();
			final /*@NonInvalid*/ boolean eq = trace_28.equals(domapNavigationOrAttributeCallExp_Helper);
			/*@Thrown*/ @Nullable Boolean symbol_12;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					final /*@NonInvalid*/ @NonNull NavigationOrAttributeCallExp symbol_1 = (NavigationOrAttributeCallExp)temp1_atlExpression;
					objectManager.getting(trace_28, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_HELPER__LOCAL_SUCCESS, false);
					...
					/*@Thrown*/ @Nullable Boolean symbol_10;
					if (localSuccess) {
						objectManager.getting(trace_28, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_HELPER__WMAP_OCL_EXPRESSION, false);
						final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_28.getWmapOclExpression();
						final /*@NonInvalid*/ boolean symbol_2 = wmapOclExpression != null;
						/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression;
						if (symbol_2) {
							if (wmapOclExpression == null) {
							...
							objectManager.getting(trace_28, trace_ATL2QVTrPackage.Literals.TMAP_NAVIGATION_OR_ATTRIBUTE_CALL_EXP_HELPER__T0PROPERTY_NAME, false);
							@SuppressWarnings("null")
							...
							if (symbol_3) {
								...
								if (notEmpty) {
									...
									if (symbol_4) {
										...
										trace_28.setWmapHelper(safe_d1atlHelper_source);
										trace_28.setWmapModule(TmapModule);
									...
									symbol_9 = raw_when_mapHelper_Attribute;
								}
								else {
									symbol_9 = ValueUtil.FALSE_VALUE;
								}
								raw_when_mapModule = symbol_9;
							}
							else {
								raw_when_mapModule = ValueUtil.FALSE_VALUE;
							}
						...
						symbol_10 = raw_when_mapOclExpression;
					}
					else {
						symbol_10 = ValueUtil.FALSE_VALUE;
					}
			...
			trace_28.setSuccess(symbol_12);
			objectManager.assigned(trace_28, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, symbol_12);
			return symbol_12;
		}

		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_28, thoseValues[0]);
		}
	}
	 ...
	 * observe trace_ATL2QVTr::TmapOperationCallExp_Helper::t0operationName var operationName : String[1] := trace.t0operationName;
	 * var oclIsKindOf : Boolean[1] := atlExpression.oclIsKindOf(OCL::OperatorCallExp)
	 *   ;
	 * var _'not' : Boolean[?] := not oclIsKindOf;
	 * check _'not';
	 * var atlModule : ATL::Module[1] := this.getModule(atlExpression)
	 *   ;
	 * var when_mapModule : trace_ATL2QVTr::TmapModule[1] := atlModule.TmapModule;
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Helper trace_29;
		...
		public MAP_mmapOperationCallExp__Helper__qvtr__global__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_29 = (@NonNull TmapOperationCallExp_Helper)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapOperationCallExp_Helper domapOperationCallExp_Helper = dispatcher_0.getDomapOperationCallExp_Helper();
			final /*@NonInvalid*/ boolean eq = trace_29.equals(domapOperationCallExp_Helper);
			/*@Thrown*/ @Nullable Boolean symbol_13;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					final /*@NonInvalid*/ @NonNull OperationCallExp symbol_1 = (OperationCallExp)temp1_atlExpression;
					objectManager.getting(trace_29, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_HELPER__LOCAL_SUCCESS, false);
					...
					/*@Thrown*/ @Nullable Boolean symbol_11;
					if (localSuccess) {
						objectManager.getting(trace_29, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_HELPER__WMAP_OCL_EXPRESSION, false);
						final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_29.getWmapOclExpression();
						final /*@NonInvalid*/ boolean symbol_2 = wmapOclExpression != null;
						/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression;
						if (symbol_2) {
							if (wmapOclExpression == null) {
							...
							objectManager.getting(trace_29, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_HELPER__T0OPERATION_NAME, false);
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull String t0operationName = trace_29.getT0operationName();
							...
							if (not) {
								...
								if (symbol_3) {
									...
									if (notEmpty) {
										...
										if (symbol_4) {
											...
											// mapping statements
											dispatcher_0.setResult(trace_29);
											trace_29.setWmapHelper(safe_d1atlHelper_source);
										...
										symbol_9 = raw_when_mapHelper_Operation;
									}
									else {
										symbol_9 = ValueUtil.FALSE_VALUE;
									}
								...
								symbol_10 = raw_when_mapModule;
							}
							else {
								symbol_10 = ValueUtil.FALSE_VALUE;
							}
							raw_when_mapOclExpression = symbol_10;
						}
						else {
							raw_when_mapOclExpression = ValueUtil.FALSE_VALUE;
						}
						symbol_11 = raw_when_mapOclExpression;
					}
					else {
						symbol_11 = ValueUtil.FALSE_VALUE;
					}
			...
			trace_29.setSuccess(symbol_13);
			objectManager.assigned(trace_29, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, symbol_13);
			return symbol_13;
		}

		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_29, thoseValues[0]);
		}
	}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperatorCallExp trace_30;
		...
		public MAP_mmapOperatorCallExp__qvtr__global__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_30 = (@NonNull TmapOperatorCallExp)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapOperatorCallExp domapOperatorCallExp = dispatcher_0.getDomapOperatorCallExp();
			final /*@NonInvalid*/ boolean eq = trace_30.equals(domapOperatorCallExp);
			/*@Thrown*/ @Nullable Boolean symbol_9;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					final /*@NonInvalid*/ @NonNull OperatorCallExp symbol_1 = (OperatorCallExp)temp1_atlExpression;
					objectManager.getting(trace_30, trace_ATL2QVTrPackage.Literals.TMAP_OPERATOR_CALL_EXP__LOCAL_SUCCESS, false);
					...
					/*@Thrown*/ @Nullable Boolean symbol_7;
					if (localSuccess) {
						objectManager.getting(trace_30, trace_ATL2QVTrPackage.Literals.TMAP_OPERATOR_CALL_EXP__WMAP_OCL_EXPRESSION, false);
						final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_30.getWmapOclExpression();
						final /*@NonInvalid*/ boolean symbol_2 = wmapOclExpression != null;
						/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression;
						if (symbol_2) {
							if (wmapOclExpression == null) {
							...
							if (symbol_3) {
								...
								trace_30.setWmapModule(TmapModule);
								final /*@Thrown*/ @Nullable Boolean mmapOperatorCallExp__qvtr__global__ = ValueUtil.TRUE_VALUE;
								raw_when_mapModule = mmapOperatorCallExp__qvtr__global__;
							}
							else {
								raw_when_mapModule = ValueUtil.FALSE_VALUE;
							}
						...
						symbol_7 = raw_when_mapOclExpression;
					}
					else {
						symbol_7 = ValueUtil.FALSE_VALUE;
					}
			...
			trace_30.setSuccess(symbol_9);
			objectManager.assigned(trace_30, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, symbol_9);
			return symbol_9;
		}
	 ...
	 * var atlOperations : Sequence(OCL::Operation) := selectByKind1->select(_'1_' | _'1_'.name = operationName)
	 *   ;
	 * var isEmpty : Boolean[1] := atlOperations->isEmpty()
	 *   ;
	 * check isEmpty;
	 * var collect1 : Sequence(OCL::OclFeature) := collect->collect(_'1_' | _'1_'.feature);
	 * set dispatcher.result := trace;
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Operation trace_31;
		...
		public MAP_mmapOperationCallExp__Operation__qvtr__global__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_31 = (@NonNull TmapOperationCallExp_Operation)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapOperationCallExp_Operation domapOperationCallExp_Operation = dispatcher_0.getDomapOperationCallExp_Operation();
			final /*@NonInvalid*/ boolean eq = trace_31.equals(domapOperationCallExp_Operation);
			/*@Thrown*/ @Nullable Boolean symbol_9;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OclExpression temp1_atlExpression = dispatcher_0.getD1atlExpression();
				...
				if (symbol_0) {
					final /*@NonInvalid*/ @NonNull OperationCallExp symbol_1 = (OperationCallExp)temp1_atlExpression;
					objectManager.getting(trace_31, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_OPERATION__LOCAL_SUCCESS, false);
					...
					/*@Thrown*/ @Nullable Boolean symbol_7;
					if (localSuccess) {
						objectManager.getting(trace_31, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_OPERATION__WMAP_OCL_EXPRESSION, false);
						final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_31.getWmapOclExpression();
						final /*@NonInvalid*/ boolean symbol_2 = wmapOclExpression != null;
						/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression;
						if (symbol_2) {
							if (wmapOclExpression == null) {
							...
							objectManager.getting(trace_31, trace_ATL2QVTrPackage.Literals.TMAP_OPERATION_CALL_EXP_OPERATION__T0OPERATION_NAME, false);
							@SuppressWarnings("null")
							...
							if (not) {
								...
								if (isEmpty) {
									...
									symbol_5 = mmapOperationCallExp__Operation__qvtr__global__;
								}
								else {
									symbol_5 = ValueUtil.FALSE_VALUE;
								}
							...
							raw_when_mapOclExpression = symbol_6;
						}
						else {
							raw_when_mapOclExpression = ValueUtil.FALSE_VALUE;
						}
			...
			trace_31.setSuccess(symbol_9);
			objectManager.assigned(trace_31, trace_ATL2QVTrPackage.Literals.IMAP_OCL_EXPRESSION__SUCCESS, symbol_9);
			return symbol_9;
		}
	 ...
	 *
	 */
	protected boolean MAP_mmapOperationCallExp__Helper__qvtr__edge8__referred(final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Helper trace_32)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOperationCallExp__Helper__qvtr__edge8__referred" +
					"\n\t\"trace\":" + toDebugString(trace_32) +
					"\n\t\"dispatcher\":" + toDebugString(trace_32.getDispatcher()) +
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_32.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_32.getDispatcher().getD2qvtrExpression()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_32.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapOperationCallExp_Helper domapOperationCallExp_Helper = dispatcher_0.getDomapOperationCallExp_Helper();
		final /*@NonInvalid*/ boolean eq = trace_32.equals(domapOperationCallExp_Helper);
		/*@Thrown*/ @Nullable Boolean symbol_9;
		if (eq) {
			@SuppressWarnings("null")
			...
			if (symbol_0) {
				...
				if (localSuccess) {
					...
					/*@Thrown*/ @Nullable Boolean symbol_6;
					if (success) {
						final /*@NonInvalid*/ @Nullable DmapHelper wmapHelper = trace_32.getWmapHelper();
						...
						if (symbol_2) {
							...
							// mapping statements
							trace_32.setT2qvtrOperation(d2qvtrFunction);
	 ...
	 *
	 */
	protected boolean MAP_mmapHelper__Attribute__qvtr__edge4__type__(final /*@NonInvalid*/ @NonNull TmapHelper_Attribute trace_34)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapHelper__Attribute__qvtr__edge4__type__" +
					...
					"\n\t\"dispatcher\":" + toDebugString(trace_34.getDispatcher()) +
					"\n\t\"dispatcher.d1atlHelper\":" + toDebugString(trace_34.getDispatcher().getD1atlHelper()) +
					"\n\t\"dispatcher.d2qvtrFunction\":" + toDebugString(trace_34.getDispatcher().getD2qvtrFunction()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapHelper dispatcher_0 = trace_34.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapHelper_Attribute domapHelper_Attribute = dispatcher_0.getDomapHelper_Attribute();
		final /*@NonInvalid*/ boolean eq = trace_34.equals(domapHelper_Attribute);
		/*@Thrown*/ @Nullable Boolean symbol_4;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull Function d2qvtrFunction = dispatcher_0.getD2qvtrFunction();
			final /*@NonInvalid*/ @Nullable Boolean localSuccess = trace_34.getLocalSuccess();
			if (localSuccess == null) {
				throw new InvalidEvaluationException("Null if condition");
			}
			/*@Thrown*/ @Nullable Boolean symbol_3;
			if (localSuccess) {
				final /*@NonInvalid*/ @Nullable Boolean success = trace_34.getSuccess();
				if (success == null) {
					throw new InvalidEvaluationException("Null if condition");
				}
				...
				if (success) {
					@SuppressWarnings("null")
					final /*@NonInvalid*/ @NonNull OclType t1atlType = trace_34.getT1atlType();
	 ...
	 *
	 */
	protected boolean MAP_mmapMatchedRule__super__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapMatchedRule_super trace_35)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapMatchedRule__super__qvtr__residue__" +
					"\n\t\"trace\":" + toDebugString(trace_35));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull MatchedRule t1atlChildRule = trace_35.getT1atlChildRule();
				...
				if (symbol_1) {
					...
					if (symbol_2) {
						...
						if (success_0) {
							...
							trace_35.setT1atlSuperRule(superRule);
							trace_35.setT2qvtrOverriddenRelation(t2qvtrRelation_0);
							trace_35.setT2qvtrOverridesRelation(t2qvtrRelation);
							trace_35.setWmapMatchedRule1(TmapMatchedRule);
							trace_35.setWmapMatchedRule(TmapMatchedRule_0);
	 ...
	 *
	 */
	protected boolean MAP_mmapHelper__Context__qvtr(final @NonNull Connection jm_TmapVariable, final /*@NonInvalid*/ @NonNull TmapHelper_Context trace_36)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapHelper__Context__qvtr" +
					"\n\t\"trace\":" + toDebugString(trace_36));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull Helper t1atlHelper = trace_36.getT1atlHelper();
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull Function t2qvtrFunction = trace_36.getT2qvtrFunction();
		@SuppressWarnings("null")
		...
		if (symbol_0) {
			...
			trace_36.setT1atlContext(context_);
			trace_36.setT1atlDefinition(definition);
			trace_36.setT1atlReturnType(context__0);
			trace_36.setT2qvtrParameter(qvtrParameter);
	...
	/**
	 *
	 * map mmapOperatorCallExp__qvtr__edge7__t2qvtrTransformat in ATL2QVTr {
	 * guard:middle trace : trace_ATL2QVTr::TmapOperatorCallExp[1];
	 * check trace.localSuccess;
	 * check trace.success;
	 ...
	 *
	 */
	protected boolean MAP_mmapOperatorCallExp__qvtr__edge7__t2qvtrTransformat(final /*@NonInvalid*/ @NonNull TmapOperatorCallExp trace_37)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOperatorCallExp__qvtr__edge7__t2qvtrTransformat" +
					"\n\t\"trace\":" + toDebugString(trace_37) +
					"\n\t\"dispatcher\":" + toDebugString(trace_37.getDispatcher()) +
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_37.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_37.getDispatcher().getD2qvtrExpression()));
		}
		final /*@NonInvalid*/ @Nullable Boolean localSuccess = trace_37.getLocalSuccess();
		if (localSuccess == null) {
			throw new InvalidEvaluationException("Null if condition");
		}
		/*@Thrown*/ @Nullable Boolean symbol_4;
		if (localSuccess) {
			final /*@NonInvalid*/ @Nullable Boolean success = trace_37.getSuccess();
			if (success == null) {
				throw new InvalidEvaluationException("Null if condition");
			}
			/*@Thrown*/ @Nullable Boolean symbol_3;
			if (success) {
				final /*@NonInvalid*/ @Nullable TmapModule wmapModule = trace_37.getWmapModule();
				...
				if (symbol_0) {
					...
					// mapping statements
					trace_37.setT2qvtrTransformation(t2qvtrTransformation);
					final /*@Thrown*/ @Nullable Boolean mmapOperatorCallExp__qvtr__edge7__t2qvtrTransformat = ValueUtil.TRUE_VALUE;
					raw_when_mapModule = mmapOperatorCallExp__qvtr__edge7__t2qvtrTransformat;
				}
				else {
					raw_when_mapModule = ValueUtil.FALSE_VALUE;
				}
		...
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((symbol_4 ? "done "  : "fail ") + "MAP_mmapOperatorCallExp__qvtr__edge7__t2qvtrTransformat");
		}
		return symbol_4;
	}
	 ...
	 *
	 */
	protected boolean MAP_mmapInPattern__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapInPattern trace_38)  {
		if (debugInvocations) {
		...
		final /*@NonInvalid*/ @NonNull IdResolver idResolver = executor.getIdResolver();
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull InPattern t1atlPattern = trace_38.getT1atlPattern();
		@SuppressWarnings("null")
		...
		if (symbol_0) {
			...
			if (success) {
				...
				while (true) {
					...
					@SuppressWarnings("null")
					/*@NonInvalid*/ @NonNull InPatternElement _1_0 = (@NonNull InPatternElement)ITERATOR__1_0.next();
					/**
					 * _'1_'.type
					 */
				...
				final /*@Thrown*/ @NonNull BagValue selectByKind = (@Nullable BagValue)CollectionSelectByKindOperation.INSTANCE.evaluate(executor, collect_0, TYP_OCL_c_c_OclModelElement_0);
				...
				while (true) {
					...
					@SuppressWarnings("null")
					/*@NonInvalid*/ @NonNull OclModelElement _1_1 = (@NonNull OclModelElement)ITERATOR__1_1.next();
					/**
					 * true
					 */
					//
				...
				if (symbol_1) {
					...
					trace_38.setT1atlModel(model);
					trace_38.setT1atlRule(rule);
		...
		trace_38.setSuccess(raw_when_mapMatchedRule);
		objectManager.assigned(trace_38, trace_ATL2QVTrPackage.Literals.TMAP_IN_PATTERN__SUCCESS, raw_when_mapMatchedRule);
		if (debugInvocations) {
	...
	/**
	 *
	 * map mmapOutPattern__qvtr__residue__ in ATL2QVTr {
	 *
	 ...
	 *   ->selectByKind(OCL::OclModelElement)
	 *   ;
	 * var collect : Sequence(OCL::OclType[*|?]) := elements->collect(_'1_' | _'1_'.type)
	 *   ;
	 * var any : OCL::OclModelElement[1] := selectByKind->any(_'1_' | true);
	 * var model : OCL::OclModel[1] := any.model;
	 ...
	 *
	 */
	protected boolean MAP_mmapOutPattern__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapOutPattern trace_39)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOutPattern__qvtr__residue__" +
					"\n\t\"trace\":" + toDebugString(trace_39));
		}
		final /*@NonInvalid*/ @NonNull IdResolver idResolver = executor.getIdResolver();
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull OutPattern t1atlPattern = trace_39.getT1atlPattern();
		@SuppressWarnings("null")
			...
			if (symbol_2) {
				...
				if (success) {
					...
					while (true) {
						...
						@SuppressWarnings("null")
						/*@NonInvalid*/ @NonNull OutPatternElement _1_0 = (@NonNull OutPatternElement)ITERATOR__1_0.next();
						/**
						 * _'1_'.type
						 */
						final /*@NonInvalid*/ @Nullable OclType type_3 = _1_0.getType();
					...
					final /*@Thrown*/ @NonNull SequenceValue selectByKind = (@Nullable SequenceValue)CollectionSelectByKindOperation.INSTANCE.evaluate(executor, collect_0, TYP_OCL_c_c_OclModelElement_0);
					@NonNull Iterator<Object> ITERATOR__1_1 = selectByKind.iterator();
					/*@Thrown*/ @NonNull OclModelElement any;
					while (true) {
						if (!ITERATOR__1_1.hasNext()) {
					...
					if (symbol_3) {
						...
						qvtrDomain.setRule(t2qvtrRelation);
						qvtrDomain.setTypedModel(t2qvtrTypedModel);
						trace_39.setT1atlRule(symbol_1);
						trace_39.setT2qvtrDomain(qvtrDomain);
						trace_39.setT2qvtrRelation(t2qvtrRelation);
						trace_39.setT2qvtrTypedModel(t2qvtrTypedModel);
						trace_39.setWmapMatchedRule(TmapMatchedRule);
						trace_39.setWmapOclMetamodel(TmapOclMetamodel);
						final /*@Thrown*/ @Nullable Boolean mmapOutPattern__qvtr__residue__ = ValueUtil.TRUE_VALUE;
						raw_when_mapOclMetamodel = mmapOutPattern__qvtr__residue__;
					}
					else {
						raw_when_mapOclMetamodel = ValueUtil.FALSE_VALUE;
					}
		...
		trace_39.setSuccess(symbol_16);
		objectManager.assigned(trace_39, trace_ATL2QVTrPackage.Literals.TMAP_OUT_PATTERN__SUCCESS, symbol_16);
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((symbol_16 ? "done "  : "fail ") + "MAP_mmapOutPattern__qvtr__residue__");
		}
		return symbol_16;
	}
	 ...
	 *
	 */
	protected boolean MAP_mmapHelper__Operation__qvtr__edge4__type__(final /*@NonInvalid*/ @NonNull TmapHelper_Operation trace_40)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapHelper__Operation__qvtr__edge4__type__" +
					...
					"\n\t\"dispatcher.d1atlHelper\":" + toDebugString(trace_40.getDispatcher().getD1atlHelper()) +
					"\n\t\"dispatcher.d2qvtrFunction\":" + toDebugString(trace_40.getDispatcher().getD2qvtrFunction()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapHelper dispatcher_0 = trace_40.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapHelper_Operation domapHelper_Operation = dispatcher_0.getDomapHelper_Operation();
		final /*@NonInvalid*/ boolean eq = trace_40.equals(domapHelper_Operation);
		/*@Thrown*/ @Nullable Boolean symbol_4;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull Function d2qvtrFunction = dispatcher_0.getD2qvtrFunction();
			...
			if (localSuccess) {
				...
				if (success) {
					@SuppressWarnings("null")
					final /*@NonInvalid*/ @NonNull OclType t1atlType = trace_40.getT1atlType();
					final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class getType = ((FUN_getType)FTOR_getType.getUniqueComputation(this, t1atlType)).instance;
					// mapping statements
					d2qvtrFunction.setType(getType);
	 ...
	 *
	 */
	protected boolean MAP_mmapSimpleInPatternElement__qvtr__residue__(final @NonNull Connection jm_TmapVariable_0, final /*@NonInvalid*/ @NonNull TmapSimpleInPatternElement trace_41)  {
		if (debugInvocations) {
		...
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull SimpleInPatternElement t1atlElement = trace_41.getT1atlElement();
		@SuppressWarnings("null")
			...
			if (success) {
				...
				if (symbol_1) {
					...
					if (success_0) {
						...
						trace_41.setT0elementName(varName);
						...
						trace_41.setT1atlPattern(inPattern);
						trace_41.setT1atlRule(rule);
						trace_41.setT2qvtrDomain(t2qvtrDomain);
						trace_41.setT2qvtrPattern(qvtrPattern);
						trace_41.setT2qvtrRelation(t2qvtrRelation);
						trace_41.setT2qvtrTemplate(qvtrTemplate);
						trace_41.setT2qvtrVariable(qvtrVariable);
						trace_41.setWmapInPattern(TmapInPattern);
						trace_41.setWmapMatchedRule(TmapMatchedRule);
						trace_41.setWmapVariable(where_mapVariable);
	 ...
	 *
	 */
	protected boolean MAP_mmapSimpleOutPatternElement__qvtr__residue__(final @NonNull Connection jm_TmapVariable_1, final /*@NonInvalid*/ @NonNull TmapSimpleOutPatternElement trace_42)  {
		if (debugInvocations) {
		...
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull SimpleOutPatternElement t1atlElement = trace_42.getT1atlElement();
		@SuppressWarnings("null")
		...
		final /*@NonInvalid*/ boolean symbol_0 = TmapOutPattern != null;
		...
		if (symbol_0) {
			...
			if (success) {
				...
				if (symbol_1) {
					final /*@NonInvalid*/ @NonNull MatchedRule symbol_2 = (MatchedRule)temp1_atlRule;
					final /*@NonInvalid*/ @Nullable TmapMatchedRule TmapMatchedRule = OPPOSITE_OF_TmapMatchedRule_t1matchedRule.get(symbol_2);
					...
					if (symbol_3) {
						...
						if (success_0) {
							...
							// mapping statements
							qvtrVariable.setName(varName);
							trace_42.setT0elementName(varName);
							t2qvtrDomain.getPattern().add(qvtrPattern);
							qvtrPattern.setTemplateExpression(qvtrTemplate);
							qvtrTemplate.setBindsTo(qvtrVariable);
							qvtrTemplate.setReferredClass(getType);
							...
							qvtrVariable.setType(getType);
							objectManager.assigned(qvtrVariable, PivotPackage.Literals.TYPED_ELEMENT__TYPE, getType);
							trace_42.setT1atlPattern(outPattern);
							trace_42.setT1atlRule(symbol_2);
							trace_42.setT2qvtrDomain(t2qvtrDomain);
							trace_42.setT2qvtrPattern(qvtrPattern);
							trace_42.setT2qvtrRelation(t2qvtrRelation);
							trace_42.setT2qvtrTemplate(qvtrTemplate);
							trace_42.setT2qvtrVariable(qvtrVariable);
							trace_42.setWmapMatchedRule(TmapMatchedRule);
							trace_42.setWmapOutPattern(TmapOutPattern);
							trace_42.setWmapVariable(where_mapVariable);
							OPPOSITE_OF_TmapVariable_t1atlVariable.put(t1atlElement, where_mapVariable);
							where_mapVariable.setT1atlVariable(t1atlElement);
							where_mapVariable.setT2qvtrVariable(qvtrVariable);
							...
							symbol_28 = mmapSimpleOutPatternElement__qvtr__residue__;
						}
						else {
			...
			raw_when_mapOutPattern = symbol_30;
		}
		else {
			raw_when_mapOutPattern = ValueUtil.FALSE_VALUE;
		}
		trace_42.setSuccess(raw_when_mapOutPattern);
		objectManager.assigned(trace_42, trace_ATL2QVTrPackage.Literals.TMAP_SIMPLE_OUT_PATTERN_ELEMENT__SUCCESS, raw_when_mapOutPattern);
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((raw_when_mapOutPattern ? "done "  : "fail ") + "MAP_mmapSimpleOutPatternElement__qvtr__residue__");
		}
		return raw_when_mapOutPattern;
	}
	 ...
	 *
	 */
	protected boolean MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_1(final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Helper trace_43)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_1" +
					...
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_43.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_43.getDispatcher().getD2qvtrExpression()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_43.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapNavigationOrAttributeCallExp_Helper domapNavigationOrAttributeCallExp_Helper = dispatcher_0.getDomapNavigationOrAttributeCallExp_Helper();
		final /*@NonInvalid*/ boolean eq = trace_43.equals(domapNavigationOrAttributeCallExp_Helper);
		/*@Thrown*/ @Nullable Boolean symbol_7;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
			...
			if (symbol_0) {
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull OperationCallExp symbol_1 = (org.eclipse.ocl.pivot.OperationCallExp)temp1_qvtrExpression;
				final /*@NonInvalid*/ @Nullable Boolean localSuccess = trace_43.getLocalSuccess();
				if (localSuccess == null) {
					throw new InvalidEvaluationException("Null if condition");
				}
				/*@Thrown*/ @Nullable Boolean symbol_5;
				if (localSuccess) {
					...
					if (success) {
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull Operation t2qvtrOperation = trace_43.getT2qvtrOperation();
	 ...
	 *
	 */
	protected boolean MAP_mmapOperationCallExp__Helper__qvtr__edge9__type__(final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Helper trace_44)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOperationCallExp__Helper__qvtr__edge9__type__" +
					...
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_44.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_44.getDispatcher().getD2qvtrExpression()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_44.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapOperationCallExp_Helper domapOperationCallExp_Helper = dispatcher_0.getDomapOperationCallExp_Helper();
		final /*@NonInvalid*/ boolean eq = trace_44.equals(domapOperationCallExp_Helper);
		/*@Thrown*/ @Nullable Boolean symbol_7;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
			...
			if (symbol_0) {
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull OperationCallExp symbol_1 = (org.eclipse.ocl.pivot.OperationCallExp)temp1_qvtrExpression;
				final /*@NonInvalid*/ @Nullable Boolean localSuccess = trace_44.getLocalSuccess();
				if (localSuccess == null) {
					throw new InvalidEvaluationException("Null if condition");
				}
				/*@Thrown*/ @Nullable Boolean symbol_5;
				if (localSuccess) {
					...
					if (success) {
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull Operation t2qvtrOperation = trace_44.getT2qvtrOperation();
						final /*@NonInvalid*/ @Nullable Type type_2 = t2qvtrOperation.getType();
						// mapping statements
						symbol_1.setType(type_2);
						objectManager.assigned(symbol_1, PivotPackage.Literals.TYPED_ELEMENT__TYPE, type_2);
	 ...
	 *
	 */
	protected boolean MAP_mmapOperationCallExp__Helper__qvtr__edge7__ownedArg(final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Helper trace_45)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOperationCallExp__Helper__qvtr__edge7__ownedArg" +
					...
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_45.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_45.getDispatcher().getD2qvtrExpression()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_45.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapOperationCallExp_Helper domapOperationCallExp_Helper = dispatcher_0.getDomapOperationCallExp_Helper();
		final /*@NonInvalid*/ boolean eq = trace_45.equals(domapOperationCallExp_Helper);
		/*@Thrown*/ @Nullable Boolean symbol_9;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
				...
				if (localSuccess) {
					...
					if (success) {
						...
						if (symbol_2) {
							...
							// mapping statements
							trace_45.setT2qvtrSourceArgument(d2qvtrExpression);
	 ...
	 *
	 */
	protected boolean MAP_mmapHelper__Attribute__qvtr__edge5__queryExpression(final /*@NonInvalid*/ @NonNull TmapHelper_Attribute trace_46)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapHelper__Attribute__qvtr__edge5__queryExpression" +
					...
					"\n\t\"dispatcher.d1atlHelper\":" + toDebugString(trace_46.getDispatcher().getD1atlHelper()) +
					"\n\t\"dispatcher.d2qvtrFunction\":" + toDebugString(trace_46.getDispatcher().getD2qvtrFunction()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapHelper dispatcher_0 = trace_46.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapHelper_Attribute domapHelper_Attribute = dispatcher_0.getDomapHelper_Attribute();
		final /*@NonInvalid*/ boolean eq = trace_46.equals(domapHelper_Attribute);
		/*@Thrown*/ @Nullable Boolean symbol_6;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull Function d2qvtrFunction = dispatcher_0.getD2qvtrFunction();
			...
			if (localSuccess) {
				...
				if (success) {
					...
					if (symbol_0) {
						...
						final /*@Thrown*/ @NonNull OCLExpression d2qvtrExpression = wmapOclExpression.getD2qvtrExpression();
						// mapping statements
						trace_46.setT2qvtrExpression(d2qvtrExpression);
	 ...
	 *
	 */
	protected boolean MAP_mmapVariable__qvtr(final /*@NonInvalid*/ @NonNull TmapVariable trace_47)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapVariable__qvtr" +
					"\n\t\"trace\":" + toDebugString(trace_47));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull LocatedElement t1atlVariable = trace_47.getT1atlVariable();
		@SuppressWarnings("null")
		final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull VariableDeclaration t2qvtrVariable = trace_47.getT2qvtrVariable();
		// mapping statements
		final /*@Thrown*/ @Nullable Boolean mmapVariable__qvtr = ValueUtil.TRUE_VALUE;
		trace_47.setSuccess(mmapVariable__qvtr);
		objectManager.assigned(trace_47, trace_ATL2QVTrPackage.Literals.TMAP_VARIABLE__SUCCESS, mmapVariable__qvtr);
		if (debugInvocations) {
	 ...
	 *
	 */
	protected boolean MAP_mmapInPattern__filter__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapInPattern_filter trace_48)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapInPattern__filter__qvtr__residue__" +
					"\n\t\"trace\":" + toDebugString(trace_48));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull InPattern t1atlPattern = trace_48.getT1atlPattern();
						...
						if (success_0) {
							...
							if (symbol_3) {
								...
								if (success_1) {
									...
									trace_48.setT1atlExpression(filter);
									trace_48.setT1atlRule(rule);
									trace_48.setT2p(p);
									trace_48.setT2qvtrDomain(t2qvtrDomain);
									trace_48.setT2qvtrExpression(d2qvtrExpression);
									trace_48.setT2qvtrRelation(t2qvtrRelation);
									trace_48.setT2w(w);
									trace_48.setWmapInPattern(TmapInPattern);
									trace_48.setWmapMatchedRule(TmapMatchedRule);
									trace_48.setWmapOclExpression(DmapOclExpression);
	 ...
	 *
	 */
	protected boolean MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_2(final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Helper trace_49)  {
		if (debugInvocations) {
		...
		if (localSuccess) {
			...
			if (success) {
				...
				if (symbol_0) {
					...
					// mapping statements
					trace_49.setT2qvtrTransformation(t2qvtrTransformation);
					...
					raw_when_mapModule = mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_2;
				}
				else {
					raw_when_mapModule = ValueUtil.FALSE_VALUE;
				}
				symbol_4 = raw_when_mapModule;
			}
			else {
				symbol_4 = ValueUtil.FALSE_VALUE;
			}
		...
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((symbol_5 ? "done "  : "fail ") + "MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_2");
		}
		return symbol_5;
	}
	 ...
	 *
	 */
	protected boolean MAP_mmapOperationCallExp__argument__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapOperationCallExp_argument trace_50)  {
		if (debugInvocations) {
		...
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull OclExpression t1atlArgument = trace_50.getT1atlArgument();
					...
					if (symbol_2) {
						...
						if (success_0) {
							...
							if (symbol_3) {
								...
								trace_50.setT1atlParent(parentOperation);
								trace_50.setT2qvtrArgument(d2qvtrExpression);
								trace_50.setT2qvtrParent(symbol_4);
								trace_50.setWmapOclExpression1(DmapOclExpression);
								trace_50.setWmapOclExpression(DmapOclExpression_0);
	 ...
	 *
	 */
	protected boolean MAP_mmapIfExp__qvtr__edge5__ownedThen__edge4__ownedCond(final /*@NonInvalid*/ @NonNull TmapIfExp trace_51)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapIfExp__qvtr__edge5__ownedThen__edge4__ownedCond" +
					...
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_51.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_51.getDispatcher().getD2qvtrExpression()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_51.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapIfExp domapIfExp = dispatcher_0.getDomapIfExp();
		final /*@NonInvalid*/ boolean eq = trace_51.equals(domapIfExp);
		/*@Thrown*/ @Nullable Boolean symbol_15;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
				...
				if (localSuccess) {
					...
					if (success) {
						...
						if (symbol_2) {
							...
							final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression1 = trace_51.getWmapOclExpression1();
							...
							if (symbol_3) {
								...
								final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression2 = trace_51.getWmapOclExpression2();
								...
								if (symbol_4) {
									...
									// mapping statements
									trace_51.setT2qvtrCondition(d2qvtrExpression);
									trace_51.setT2qvtrElse(d2qvtrExpression_0);
									trace_51.setT2qvtrThen(d2qvtrExpression_1);
	 ...
	 *
	 */
	protected boolean MAP_mmapBinding__qvtr__residue__(final /*@NonInvalid*/ @NonNull TmapBinding trace_52)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapBinding__qvtr__residue__" +
					"\n\t\"trace\":" + toDebugString(trace_52));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull Binding t1atlBinding = trace_52.getT1atlBinding();
		@SuppressWarnings("null")
				...
				if (success) {
					...
					if (symbol_3) {
						...
						if (success_0) {
							...
							// mapping statements
							trace_52.setT0propertyName(propertyName);
							qvtrPart.setObjContainer(t2qvtrTemplate);
							qvtrPart.setReferredProperty(getProperty);
							qvtrPart.setValue(d2qvtrExpression);
							trace_52.setT1atlExpression(value);
							trace_52.setT1atlOutPatternElement(symbol_1);
							trace_52.setT2qvtrExpression(d2qvtrExpression);
							trace_52.setT2qvtrPart(qvtrPart);
							trace_52.setT2qvtrTemplate(t2qvtrTemplate);
							trace_52.setWmapOclExpression(DmapOclExpression);
							trace_52.setWmapSimpleOutPatternElement(TmapSimpleOutPatternElement);
	 ...
	 *
	 */
	protected boolean MAP_mmapOperationCallExp__Helper__qvtr__edge4__referred(final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Helper trace_53)  {
		if (debugInvocations) {
		...
		if (localSuccess) {
			...
			if (success) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull VariableExp t2qvtrSource = trace_53.getT2qvtrSource();
				final /*@NonInvalid*/ @Nullable TmapModule wmapModule = trace_53.getWmapModule();
				final /*@NonInvalid*/ boolean symbol_0 = wmapModule != null;
				/*@Thrown*/ @Nullable Boolean raw_when_mapModule;
				if (symbol_0) {
					if (wmapModule == null) {
					...
					final /*@Thrown*/ @Nullable Variable ownedContext = t2qvtrTransformation.getOwnedContext();
					// mapping statements
					trace_53.setT2qvtrTransformation(t2qvtrTransformation);
					t2qvtrSource.setReferredVariable(ownedContext);
					final /*@Thrown*/ @Nullable Boolean mmapOperationCallExp__Helper__qvtr__edge4__referred = ValueUtil.TRUE_VALUE;
					raw_when_mapModule = mmapOperationCallExp__Helper__qvtr__edge4__referred;
				}
				else {
					raw_when_mapModule = ValueUtil.FALSE_VALUE;
				}
		...
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((symbol_5 ? "done "  : "fail ") + "MAP_mmapOperationCallExp__Helper__qvtr__edge4__referred");
		}
		return symbol_5;
	}
	...
	protected boolean MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_3(final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Helper trace_54)  {
		...
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_54.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapNavigationOrAttributeCallExp_Helper domapNavigationOrAttributeCallExp_Helper = dispatcher_0.getDomapNavigationOrAttributeCallExp_Helper();
		final /*@NonInvalid*/ boolean eq = trace_54.equals(domapNavigationOrAttributeCallExp_Helper);
		/*@Thrown*/ @Nullable Boolean symbol_9;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
			...
			if (symbol_0) {
				...
				if (localSuccess) {
					...
					/*@Thrown*/ @Nullable Boolean symbol_6;
					if (success) {
						final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_54.getWmapOclExpression();
						final /*@NonInvalid*/ boolean symbol_2 = wmapOclExpression != null;
						/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression;
						if (symbol_2) {
							if (wmapOclExpression == null) {
							...
							final /*@Thrown*/ @NonNull OCLExpression d2qvtrExpression = wmapOclExpression.getD2qvtrExpression();
							// mapping statements
							trace_54.setT2qvtrSourceArgument(d2qvtrExpression);
							symbol_1.getOwnedArguments().add(d2qvtrExpression);
							final /*@Thrown*/ @Nullable Boolean mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_3 = ValueUtil.TRUE_VALUE;
							raw_when_mapOclExpression = mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_3;
						}
						else {
							raw_when_mapOclExpression = ValueUtil.FALSE_VALUE;
						}
	 ...
	 *
	 */
	protected boolean MAP_mmapOperationCallExp__Operation__qvtr__edge4__owned(final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Operation trace_55)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOperationCallExp__Operation__qvtr__edge4__owned" +
					...
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_55.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_55.getDispatcher().getD2qvtrExpression()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_55.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapOperationCallExp_Operation domapOperationCallExp_Operation = dispatcher_0.getDomapOperationCallExp_Operation();
		final /*@NonInvalid*/ boolean eq = trace_55.equals(domapOperationCallExp_Operation);
		/*@Thrown*/ @Nullable Boolean symbol_9;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
			...
			if (symbol_0) {
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull OperationCallExp symbol_1 = (org.eclipse.ocl.pivot.OperationCallExp)temp1_qvtrExpression;
				final /*@NonInvalid*/ @Nullable Boolean localSuccess = trace_55.getLocalSuccess();
				if (localSuccess == null) {
					throw new InvalidEvaluationException("Null if condition");
				}
				/*@Thrown*/ @Nullable Boolean symbol_7;
				if (localSuccess) {
					...
					/*@Thrown*/ @Nullable Boolean symbol_6;
					if (success) {
						final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_55.getWmapOclExpression();
						final /*@NonInvalid*/ boolean symbol_2 = wmapOclExpression != null;
						/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression;
						if (symbol_2) {
							if (wmapOclExpression == null) {
							...
							final /*@Thrown*/ @NonNull OCLExpression d2qvtrExpression = wmapOclExpression.getD2qvtrExpression();
							// mapping statements
							trace_55.setT2qvtrSource(d2qvtrExpression);
	 ...
	 *
	 */
	protected boolean MAP_mmapOperatorCallExp__qvtr__edge4__ownedSource__(final /*@NonInvalid*/ @NonNull TmapOperatorCallExp trace_56)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOperatorCallExp__qvtr__edge4__ownedSource__" +
					...
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_56.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_56.getDispatcher().getD2qvtrExpression()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_56.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapOperatorCallExp domapOperatorCallExp = dispatcher_0.getDomapOperatorCallExp();
		final /*@NonInvalid*/ boolean eq = trace_56.equals(domapOperatorCallExp);
		/*@Thrown*/ @Nullable Boolean symbol_9;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
			...
			if (symbol_0) {
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull OperationCallExp symbol_1 = (org.eclipse.ocl.pivot.OperationCallExp)temp1_qvtrExpression;
				final /*@NonInvalid*/ @Nullable Boolean localSuccess = trace_56.getLocalSuccess();
				if (localSuccess == null) {
					throw new InvalidEvaluationException("Null if condition");
				}
				/*@Thrown*/ @Nullable Boolean symbol_7;
				if (localSuccess) {
					...
					/*@Thrown*/ @Nullable Boolean symbol_6;
					if (success) {
						final /*@NonInvalid*/ @Nullable DmapOclExpression wmapOclExpression = trace_56.getWmapOclExpression();
						final /*@NonInvalid*/ boolean symbol_2 = wmapOclExpression != null;
						/*@Thrown*/ @Nullable Boolean raw_when_mapOclExpression;
						if (symbol_2) {
							if (wmapOclExpression == null) {
							...
							final /*@Thrown*/ @NonNull OCLExpression d2qvtrExpression = wmapOclExpression.getD2qvtrExpression();
							// mapping statements
							trace_56.setT2qvtrSource(d2qvtrExpression);
							symbol_1.setOwnedSource(d2qvtrExpression);
	 ...
	 *
	 */
	protected boolean MAP_mmapHelper__Operation__qvtr__edge5__queryExpression(final /*@NonInvalid*/ @NonNull TmapHelper_Operation trace_58)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapHelper__Operation__qvtr__edge5__queryExpression" +
					...
					"\n\t\"dispatcher.d1atlHelper\":" + toDebugString(trace_58.getDispatcher().getD1atlHelper()) +
					"\n\t\"dispatcher.d2qvtrFunction\":" + toDebugString(trace_58.getDispatcher().getD2qvtrFunction()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapHelper dispatcher_0 = trace_58.getDispatcher();
		final /*@NonInvalid*/ @Nullable TmapHelper_Operation domapHelper_Operation = dispatcher_0.getDomapHelper_Operation();
		final /*@NonInvalid*/ boolean eq = trace_58.equals(domapHelper_Operation);
		/*@Thrown*/ @Nullable Boolean symbol_6;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull Function d2qvtrFunction = dispatcher_0.getD2qvtrFunction();
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Property trace_60;
		...
		public MAP_mmapNavigationOrAttributeCallExp__Property__qvtr__e_1(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_60 = (@NonNull TmapNavigationOrAttributeCallExp_Property)boundValues[0];
		}

		@Override
		public boolean execute()  {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_60.getDispatcher();
			final /*@NonInvalid*/ @Nullable TmapNavigationOrAttributeCallExp_Property domapNavigationOrAttributeCallExp_Property = dispatcher_0.getDomapNavigationOrAttributeCallExp_Property();
			final /*@NonInvalid*/ boolean eq = trace_60.equals(domapNavigationOrAttributeCallExp_Property);
			/*@Thrown*/ @Nullable Boolean symbol_7;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
				...
				if (symbol_0) {
					final /*@NonInvalid*/ @NonNull PropertyCallExp symbol_1 = (PropertyCallExp)temp1_qvtrExpression;
					final /*@NonInvalid*/ @Nullable Boolean localSuccess = trace_60.getLocalSuccess();
					if (localSuccess == null) {
						throw new InvalidEvaluationException("Null if condition");
					}
					/*@Thrown*/ @Nullable Boolean symbol_5;
					if (localSuccess) {
						...
						if (success) {
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull OCLExpression t2qvtrSource = trace_60.getT2qvtrSource();
							objectManager.getting(t2qvtrSource, PivotPackage.Literals.TYPED_ELEMENT__TYPE, false);
							final /*@NonInvalid*/ @Nullable Type type_2 = t2qvtrSource.getType();
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull String t0propertyName = trace_60.getT0propertyName();
		...
		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_60, thoseValues[0]);
		}
	}
			...
			if (symbol_0) {
				...
				if (success) {
					...
					if (eq_0) {
						...
						symbol_9 = mmapVariableExp__referredVariable__Helper__qvtr;
					}
					else {
						symbol_9 = ValueUtil.FALSE_VALUE;
					}
				...
				raw_when_mapVariable = symbol_10;
			}
			else {
				raw_when_mapVariable = ValueUtil.FALSE_VALUE;
			}
			symbol_11 = raw_when_mapVariable;
		}
		else {
			symbol_11 = ValueUtil.FALSE_VALUE;
		}
		trace_62.setSuccess(symbol_11);
		objectManager.assigned(trace_62, trace_ATL2QVTrPackage.Literals.IMAP_VARIABLE_EXP_REFERRED_VARIABLE__SUCCESS, symbol_11);
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((symbol_11 ? "done "  : "fail ") + "MAP_mmapVariableExp__referredVariable__Helper__qvtr");
		}
		return symbol_11;
	}
	 ...
	 *
	 */
	protected boolean MAP_mmapVariableExp__referredVariable__VariableDeclarat(final /*@NonInvalid*/ @NonNull TmapVariableExp_referredVariable_VariableDeclaration trace_63)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapVariableExp__referredVariable__VariableDeclarat" +
					"\n\t\"trace\":" + toDebugString(trace_63) +
					"\n\t\"dispatcher\":" + toDebugString(trace_63.getDispatcher()) +
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_63.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_63.getDispatcher().getD2qvtrExpression()));
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull DmapVariableExp_referredVariable dispatcher_0 = trace_63.getDispatcher();
		...
		final /*@NonInvalid*/ boolean eq = trace_63.equals(domapVariableExp_referredVariable_VariableDeclaration);
		/*@Thrown*/ @Nullable Boolean symbol_13;
		if (eq) {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull VariableExp d1atlExpression = dispatcher_0.getD1atlExpression();
			...
			if (symbol_0) {
				...
				if (symbol_2) {
					...
					if (success) {
						...
						dispatcher_0.setSuccess(ValueUtil.TRUE_VALUE);
						dispatcher_0.setResult(trace_63);
						d2qvtrExpression.setReferredVariable(t2qvtrVariable);
						d2qvtrExpression.setType(type_2);
						objectManager.assigned(d2qvtrExpression, PivotPackage.Literals.TYPED_ELEMENT__TYPE, type_2);
						trace_63.setT1atlVariable(symbol_1);
						trace_63.setT2qvtrVariable(t2qvtrVariable);
		...
		trace_63.setSuccess(symbol_13);
		objectManager.assigned(trace_63, trace_ATL2QVTrPackage.Literals.IMAP_VARIABLE_EXP_REFERRED_VARIABLE__SUCCESS, symbol_13);
		if (debugInvocations) {
	 ...
	 *
	 */
	protected boolean MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_4(final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Helper trace_64)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapNavigationOrAttributeCallExp__Helper__qvtr__edg_4" +
					"\n\t\"trace\":" + toDebugString(trace_64) +
					"\n\t\"dispatcher\":" + toDebugString(trace_64.getDispatcher()) +
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_64.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_64.getDispatcher().getD2qvtrExpression()));
		}
		...
		if (localSuccess) {
			...
			if (success) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull VariableExp t2qvtrSource = trace_64.getT2qvtrSource();
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull RelationalTransformation t2qvtrTransformation = trace_64.getT2qvtrTransformation();
				final /*@NonInvalid*/ @Nullable Variable ownedContext = t2qvtrTransformation.getOwnedContext();
				final /*@NonInvalid*/ @NonNull Object name_2 = ownedContext == null;
				...
				final /*@NonInvalid*/ @NonNull Object type_2 = ownedContext == null;
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Operation trace_65;
		...
		public MAP_mmapOperationCallExp__Operation__qvtr__edge5__refer(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_65 = (@NonNull TmapOperationCallExp_Operation)boundValues[0];
		}

		@Override
		public boolean execute()  {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_65.getDispatcher();
			final /*@NonInvalid*/ @Nullable TmapOperationCallExp_Operation domapOperationCallExp_Operation = dispatcher_0.getDomapOperationCallExp_Operation();
			final /*@NonInvalid*/ boolean eq = trace_65.equals(domapOperationCallExp_Operation);
			/*@Thrown*/ @Nullable Boolean symbol_7;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
				...
				if (symbol_0) {
					...
					if (localSuccess) {
						...
						if (success) {
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull OCLExpression t2qvtrSource = trace_65.getT2qvtrSource();
							objectManager.getting(t2qvtrSource, PivotPackage.Literals.TYPED_ELEMENT__TYPE, false);
							final /*@NonInvalid*/ @Nullable Type type_2 = t2qvtrSource.getType();
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull String t0operationName = trace_65.getT0operationName();
							final /*@Thrown*/ @NonNull Operation getOperation = ((FUN_getOperation)FTOR_getOperation.getUniqueComputation(ATL2QVTr.this, type_2, t0operationName)).instance;
							// mapping statements
							symbol_1.setReferredOperation(getOperation);
							objectManager.assigned(symbol_1, PivotPackage.Literals.OPERATION_CALL_EXP__REFERRED_OPERATION, getOperation);
		...
		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_65, thoseValues[0]);
		}
	}

	/**
	 *
	 * map mmapOperationCallExp__Helper__qvtr__edge5__type__ed in ATL2QVTr {
	 * guard:middle trace : trace_ATL2QVTr::TmapOperationCallExp_Helper[1];
	 * check trace.localSuccess;
	 * check trace.success;
	 * var qvtrSource : VariableExp[1] := trace.t2qvtrSource;
	 * check var qvtrThisVariable : Variable[?] := qvtrSource.referredVariable;
	 * var name : String[?] := qvtrThisVariable?.name;
	 * var type : Type[?] := qvtrThisVariable?.type;
	 * set qvtrSource.name := name;
	 * set qvtrSource.type := type;
	 *
	 */
	protected boolean MAP_mmapOperationCallExp__Helper__qvtr__edge5__type__ed(final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Helper trace_66)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_mmapOperationCallExp__Helper__qvtr__edge5__type__ed" +
					"\n\t\"trace\":" + toDebugString(trace_66) +
					"\n\t\"dispatcher\":" + toDebugString(trace_66.getDispatcher()) +
					"\n\t\"dispatcher.d1atlExpression\":" + toDebugString(trace_66.getDispatcher().getD1atlExpression()) +
					"\n\t\"dispatcher.d2qvtrExpression\":" + toDebugString(trace_66.getDispatcher().getD2qvtrExpression()));
		}
		...
		if (localSuccess) {
			...
			if (success) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull VariableExp t2qvtrSource = trace_66.getT2qvtrSource();
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.@Nullable VariableDeclaration temp1_qvtrThisVariable = t2qvtrSource.getReferredVariable();
				final /*@NonInvalid*/ boolean symbol_0 = temp1_qvtrThisVariable instanceof Variable;
				/*@Thrown*/ @Nullable Boolean symbol_5;
				if (symbol_0) {
					final /*@NonInvalid*/ @Nullable Variable symbol_1 = (Variable)temp1_qvtrThisVariable;
					final /*@NonInvalid*/ @NonNull Object name_2 = symbol_1 == null;
					/*@Thrown*/ @Nullable String safe_name_source;
					if (name_2 == Boolean.TRUE) {
						safe_name_source = null;
					}
					else {
						assert symbol_1 != null;
						final /*@Thrown*/ @Nullable String name_3 = symbol_1.getName();
						safe_name_source = name_3;
					}
					final /*@NonInvalid*/ @NonNull Object type_2 = symbol_1 == null;
					/*@Thrown*/ @Nullable Type safe_type_source;
					if (type_2 == Boolean.TRUE) {
						safe_type_source = null;
					}
						...
						assert symbol_1 != null;
						final /*@Thrown*/ @Nullable Type type_3 = symbol_1.getType();
						safe_type_source = type_3;
					}
					// mapping statements
					t2qvtrSource.setName(safe_name_source);
					t2qvtrSource.setType(safe_type_source);
					final /*@Thrown*/ @Nullable Boolean mmapOperationCallExp__Helper__qvtr__edge5__type__ed = ValueUtil.TRUE_VALUE;
					symbol_5 = mmapOperationCallExp__Helper__qvtr__edge5__type__ed;
				}
				else {
					symbol_5 = ValueUtil.FALSE_VALUE;
				}
		...
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((symbol_7 ? "done "  : "fail ") + "MAP_mmapOperationCallExp__Helper__qvtr__edge5__type__ed");
		}
		return symbol_7;
	}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperatorCallExp trace_67;
		...
		public MAP_mmapOperatorCallExp__qvtr__edge6__type__(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_67 = (@NonNull TmapOperatorCallExp)boundValues[0];
		}
		...
		public boolean execute()  {
			...
			final /*@NonInvalid*/ @Nullable TmapOperatorCallExp domapOperatorCallExp = dispatcher_0.getDomapOperatorCallExp();
			final /*@NonInvalid*/ boolean eq = trace_67.equals(domapOperatorCallExp);
			/*@Thrown*/ @Nullable Boolean symbol_8;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
				...
				if (symbol_0) {
					...
					if (localSuccess) {
						...
						if (success) {
							...
							final /*@NonInvalid*/ @Nullable Type type_2 = t2qvtrSource.getType();
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull String t0operationName = trace_67.getT0operationName();
							final /*@Thrown*/ @NonNull Operation getOperation = ((FUN_getOperation)FTOR_getOperation.getUniqueComputation(ATL2QVTr.this, type_2, t0operationName)).instance;
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapOperationCallExp_Operation trace_68;
		...
		public MAP_mmapOperationCallExp__Operation__qvtr__edge6__type_(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_68 = (@NonNull TmapOperationCallExp_Operation)boundValues[0];
		}

		@Override
		public boolean execute()  {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_68.getDispatcher();
			final /*@NonInvalid*/ @Nullable TmapOperationCallExp_Operation domapOperationCallExp_Operation = dispatcher_0.getDomapOperationCallExp_Operation();
			final /*@NonInvalid*/ boolean eq = trace_68.equals(domapOperationCallExp_Operation);
			/*@Thrown*/ @Nullable Boolean symbol_8;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
				...
				if (symbol_0) {
					...
					if (localSuccess) {
						...
						if (success) {
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull OCLExpression t2qvtrSource = trace_68.getT2qvtrSource();
							objectManager.getting(t2qvtrSource, PivotPackage.Literals.TYPED_ELEMENT__TYPE, false);
							final /*@NonInvalid*/ @Nullable Type type_2 = t2qvtrSource.getType();
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull String t0operationName = trace_68.getT0operationName();
							final /*@Thrown*/ @NonNull Operation getOperation = ((FUN_getOperation)FTOR_getOperation.getUniqueComputation(ATL2QVTr.this, type_2, t0operationName)).instance;
							objectManager.getting(symbol_1, PivotPackage.Literals.OPERATION_CALL_EXP__REFERRED_OPERATION, false);
							final /*@NonInvalid*/ @Nullable Operation referredOperation = symbol_1.getReferredOperation();
							final /*@Thrown*/ boolean eq_0 = getOperation.equals(referredOperation);
		...
		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_68, thoseValues[0]);
		}
	}
	...
	{
		protected final /*@NonInvalid*/ @NonNull TmapNavigationOrAttributeCallExp_Property trace_69;
		...
		public MAP_mmapNavigationOrAttributeCallExp__Property__qvtr__e_2(@NonNull InvocationConstructor constructor, @NonNull Object @NonNull [] boundValues) {
			super(constructor);
			trace_69 = (@NonNull TmapNavigationOrAttributeCallExp_Property)boundValues[0];
		}

		@Override
		public boolean execute()  {
			@SuppressWarnings("null")
			final /*@NonInvalid*/ @NonNull DmapOclExpression dispatcher_0 = trace_69.getDispatcher();
			final /*@NonInvalid*/ @Nullable TmapNavigationOrAttributeCallExp_Property domapNavigationOrAttributeCallExp_Property = dispatcher_0.getDomapNavigationOrAttributeCallExp_Property();
			final /*@NonInvalid*/ boolean eq = trace_69.equals(domapNavigationOrAttributeCallExp_Property);
			/*@Thrown*/ @Nullable Boolean symbol_8;
			if (eq) {
				@SuppressWarnings("null")
				final /*@NonInvalid*/ @NonNull OCLExpression temp1_qvtrExpression = dispatcher_0.getD2qvtrExpression();
				...
				if (symbol_0) {
					final /*@NonInvalid*/ @NonNull PropertyCallExp symbol_1 = (PropertyCallExp)temp1_qvtrExpression;
					final /*@NonInvalid*/ @Nullable Boolean localSuccess = trace_69.getLocalSuccess();
					if (localSuccess == null) {
						throw new InvalidEvaluationException("Null if condition");
					}
					/*@Thrown*/ @Nullable Boolean symbol_6;
					if (localSuccess) {
						final /*@NonInvalid*/ @Nullable Boolean success = trace_69.getSuccess();
						if (success == null) {
							throw new InvalidEvaluationException("Null if condition");
						}
						/*@Thrown*/ @Nullable Boolean symbol_5;
						if (success) {
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull OCLExpression t2qvtrSource = trace_69.getT2qvtrSource();
							objectManager.getting(t2qvtrSource, PivotPackage.Literals.TYPED_ELEMENT__TYPE, false);
							final /*@NonInvalid*/ @Nullable Type type_2 = t2qvtrSource.getType();
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull String t0propertyName = trace_69.getT0propertyName();
							final /*@Thrown*/ @NonNull Property getProperty = ((FUN_getProperty)FTOR_getProperty.getUniqueComputation(ATL2QVTr.this, type_2, t0propertyName)).instance;
		...
		@Override
		public boolean isEqual(@NonNull IdResolver idResolver, @NonNull Object @NonNull [] thoseValues) {
			return idResolver.oclEquals(trace_69, thoseValues[0]);
		}
	}
