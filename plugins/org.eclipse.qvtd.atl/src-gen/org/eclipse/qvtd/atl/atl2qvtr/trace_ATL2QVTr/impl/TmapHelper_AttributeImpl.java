 ...
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapHelper_AttributeImpl#getT1attributeName <em>T1attribute Name</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapHelper_AttributeImpl#getT3atlDefinition <em>T3atl Definition</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapHelper_AttributeImpl#getT3atlExpression <em>T3atl Expression</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapHelper_AttributeImpl#getT3atlFeature <em>T3atl Feature</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapHelper_AttributeImpl#getT3atlModule <em>T3atl Module</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapHelper_AttributeImpl#getT3atlType <em>T3atl Type</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapHelper_AttributeImpl#getT4qvtrExpression <em>T4qvtr Expression</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapHelper_AttributeImpl#getT4qvtrTransformation <em>T4qvtr Transformation</em>}</li>
 ...
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapHelper_AttributeImpl#getS0local <em>S0local</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TmapHelper_AttributeImpl extends ImapHelperImpl implements TmapHelper_Attribute {
	...
	/**
	 * The default value of the '{@link #getT1attributeName() <em>T1attribute Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String T1ATTRIBUTE_NAME_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getT1attributeName() <em>T1attribute Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getT1attributeName()
	 * @generated
	 * @ordered
	 */
	protected String t1attributeName = T1ATTRIBUTE_NAME_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected Attribute t3atlFeature;
	 ...
	 */
	@Override
	public String getT1attributeName() {
		return t1attributeName;
	}
	 ...
	 */
	@Override
	public void setT1attributeName(String newT1attributeName) {
		String oldT1attributeName = t1attributeName;
		t1attributeName = newT1attributeName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionImpl.EXECUTION_FEATURE_COUNT + 2, oldT1attributeName, t1attributeName));
	}
	 ...
	 * @generated
	 */
	public Attribute basicGetT3atlFeature() {
		return t3atlFeature;
	}
	 ...
	 */
	@Override
	public void setT3atlFeature(Attribute newT3atlFeature) {
		Attribute oldT3atlFeature = t3atlFeature;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 1:
				...
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 2:
				setT1attributeName((String)newValue);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 3:
			...
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 4:
				...
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 5:
				setT3atlFeature((Attribute)newValue);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 6:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 1:
				...
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 2:
				setT1attributeName(T1ATTRIBUTE_NAME_EDEFAULT);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 3:
			...
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 4:
				...
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 5:
				setT3atlFeature((Attribute)null);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 6:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 2:
				return T1ATTRIBUTE_NAME_EDEFAULT == null ? t1attributeName != null : !T1ATTRIBUTE_NAME_EDEFAULT.equals(t1attributeName);
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 3:
