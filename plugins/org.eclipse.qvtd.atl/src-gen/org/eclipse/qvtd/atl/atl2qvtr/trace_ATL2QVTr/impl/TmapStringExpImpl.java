 ...
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapStringExpImpl#getT1symbol <em>T1symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TmapStringExpImpl extends ImapOclExpressionImpl implements TmapStringExp {
	 ...
	 * @ordered
	 */
	public static final int TMAP_STRING_EXP_FEATURE_COUNT = ImapOclExpressionImpl.IMAP_OCL_EXPRESSION_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	public static final int TMAP_STRING_EXP_OPERATION_COUNT = ImapOclExpressionImpl.IMAP_OCL_EXPRESSION_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	protected static final String T1SYMBOL_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected String t1symbol = T1SYMBOL_EDEFAULT;
	 ...
	 */
	@Override
	public void setT1symbol(String newT1symbol) {
		String oldT1symbol = t1symbol;
