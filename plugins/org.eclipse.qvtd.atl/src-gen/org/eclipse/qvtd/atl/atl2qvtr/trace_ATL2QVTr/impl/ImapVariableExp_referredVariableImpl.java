...
public abstract class ImapVariableExp_referredVariableImpl extends ExecutionImpl implements ImapVariableExp_referredVariable {
	...
	public void setSuccess(Boolean newSuccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.IMAP_VARIABLE_EXP_REFERRED_VARIABLE__SUCCESS, oldSuccess, success));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case trace_ATL2QVTrPackage.IMAP_VARIABLE_EXP_REFERRED_VARIABLE__SUCCESS:
				return getSuccess();
		}
