 ...
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapMatchedRuleImpl#getT4qvtrContext <em>T4qvtr Context</em>}</li>
...
public class TmapMatchedRuleImpl extends ExecutionImpl implements TmapMatchedRule {
	...
	/**
	 * The cached value of the '{@link #getT4qvtrContext() <em>T4qvtr Context</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getT4qvtrContext()
	 * @generated
	 * @ordered
	 */
	protected SharedVariable t4qvtrContext;
	 ...
	 */
	@Override
	public SharedVariable getT4qvtrContext() {
		if (t4qvtrContext != null && t4qvtrContext.eIsProxy()) {
			InternalEObject oldT4qvtrContext = (InternalEObject)t4qvtrContext;
			t4qvtrContext = (SharedVariable)eResolveProxy(oldT4qvtrContext);
			if (t4qvtrContext != oldT4qvtrContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExecutionImpl.EXECUTION_FEATURE_COUNT + 5, oldT4qvtrContext, t4qvtrContext));
			}
		}
		return t4qvtrContext;
	}
	 ...
	 * @generated
	 */
	public SharedVariable basicGetT4qvtrContext() {
		return t4qvtrContext;
	}
	 ...
	 */
	@Override
	public void setT4qvtrContext(SharedVariable newT4qvtrContext) {
		SharedVariable oldT4qvtrContext = t4qvtrContext;
		t4qvtrContext = newT4qvtrContext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionImpl.EXECUTION_FEATURE_COUNT + 5, oldT4qvtrContext, t4qvtrContext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 5:
				if (resolve) return getT4qvtrContext();
				return basicGetT4qvtrContext();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 4:
				...
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 5:
				setT4qvtrContext((SharedVariable)newValue);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 6:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 4:
				...
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 5:
				setT4qvtrContext((SharedVariable)null);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 6:
