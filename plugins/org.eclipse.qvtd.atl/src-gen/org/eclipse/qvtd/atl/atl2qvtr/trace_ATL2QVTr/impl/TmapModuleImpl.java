 ...
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapModuleImpl#getT4_1 <em>T4 1</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapModuleImpl#getT4_2 <em>T4 2</em>}</li>
...
public class TmapModuleImpl extends ExecutionImpl implements TmapModule {
	...
	/**
	 * The cached value of the '{@link #getT4_1() <em>T4 1</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getT4_1()
	 * @generated
	 * @ordered
	 */
	protected org.eclipse.ocl.pivot.Package t4_1;

	/**
	 * The cached value of the '{@link #getT4_2() <em>T4 2</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getT4_2()
	 * @generated
	 ...
	 */
	@Override
	public org.eclipse.ocl.pivot.Package getT4_1() {
		if (t4_1 != null && t4_1.eIsProxy()) {
			InternalEObject oldT4_1 = (InternalEObject)t4_1;
			t4_1 = (org.eclipse.ocl.pivot.Package)eResolveProxy(oldT4_1);
			if (t4_1 != oldT4_1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExecutionImpl.EXECUTION_FEATURE_COUNT + 3, oldT4_1, t4_1));
			}
		}
		return t4_1;
	}
	 ...
	 * @generated
	 */
	public org.eclipse.ocl.pivot.Package basicGetT4_1() {
		return t4_1;
	}
	 ...
	 */
	@Override
	public void setT4_1(org.eclipse.ocl.pivot.Package newT4_1) {
		org.eclipse.ocl.pivot.Package oldT4_1 = t4_1;
		t4_1 = newT4_1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionImpl.EXECUTION_FEATURE_COUNT + 3, oldT4_1, t4_1));
	}
	 ...
	 */
	@Override
	public Parameter getT4_2() {
		if (t4_2 != null && t4_2.eIsProxy()) {
			InternalEObject oldT4_2 = (InternalEObject)t4_2;
			t4_2 = (Parameter)eResolveProxy(oldT4_2);
			if (t4_2 != oldT4_2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExecutionImpl.EXECUTION_FEATURE_COUNT + 4, oldT4_2, t4_2));
			}
		}
		return t4_2;
	}
	 ...
	 */
	@Override
	public void setT4_2(Parameter newT4_2) {
		Parameter oldT4_2 = t4_2;
		t4_2 = newT4_2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionImpl.EXECUTION_FEATURE_COUNT + 4, oldT4_2, t4_2));
	}
	 ...
	 */
	@Override
	public TypedModel getT4_3() {
		if (t4_3 != null && t4_3.eIsProxy()) {
			InternalEObject oldT4_3 = (InternalEObject)t4_3;
			t4_3 = (TypedModel)eResolveProxy(oldT4_3);
			if (t4_3 != oldT4_3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExecutionImpl.EXECUTION_FEATURE_COUNT + 5, oldT4_3, t4_3));
			}
		}
		return t4_3;
	}
	 ...
	 * @generated
	 */
	public TypedModel basicGetT4_3() {
		return t4_3;
	}
	 ...
	 */
	@Override
	public void setT4_3(TypedModel newT4_3) {
		TypedModel oldT4_3 = t4_3;
		t4_3 = newT4_3;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionImpl.EXECUTION_FEATURE_COUNT + 5, oldT4_3, t4_3));
	}
	...
	public RelationModel getT4_4() {
		if (t4_4 != null && t4_4.eIsProxy()) {
			...
			if (t4_4 != oldT4_4) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExecutionImpl.EXECUTION_FEATURE_COUNT + 6, oldT4_4, t4_4));
			}
		}
		return t4_4;
	}
	...
	public void setT4_4(RelationModel newT4_4) {
		...
		t4_4 = newT4_4;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionImpl.EXECUTION_FEATURE_COUNT + 6, oldT4_4, t4_4));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 3:
				if (resolve) return getT4_1();
				return basicGetT4_1();
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 4:
				if (resolve) return getT4_2();
				return basicGetT4_2();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 2:
				...
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 3:
				setT4_1((org.eclipse.ocl.pivot.Package)newValue);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 4:
				setT4_2((Parameter)newValue);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 5:
				setT4_3((TypedModel)newValue);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 6:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 2:
				...
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 3:
				setT4_1((org.eclipse.ocl.pivot.Package)null);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 4:
				setT4_2((Parameter)null);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 5:
				setT4_3((TypedModel)null);
				return;
			case ExecutionImpl.EXECUTION_FEATURE_COUNT + 6:
