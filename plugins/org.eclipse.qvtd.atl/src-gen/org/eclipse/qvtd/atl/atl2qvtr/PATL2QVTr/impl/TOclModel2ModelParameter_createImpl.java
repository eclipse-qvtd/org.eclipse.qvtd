...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TOcl Model2 Model Parameter create</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.PATL2QVTr.impl.TOclModel2ModelParameter_createImpl#getAModule <em>AModule</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.PATL2QVTr.impl.TOclModel2ModelParameter_createImpl#getOclModel <em>Ocl Model</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.PATL2QVTr.impl.TOclModel2ModelParameter_createImpl#getRelTM <em>Rel TM</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.PATL2QVTr.impl.TOclModel2ModelParameter_createImpl#getRelTx <em>Rel Tx</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.PATL2QVTr.impl.TOclModel2ModelParameter_createImpl#getTmName <em>Tm Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TOclModel2ModelParameter_createImpl extends MinimalEObjectImpl.Container implements TOclModel2ModelParameter_create {
	/**
	 ...
	 * @generated
	 */
	protected TOclModel2ModelParameter_createImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PATL2QVTrPackage.Literals.TOCL_MODEL2_MODEL_PARAMETER_CREATE;
	}
		...
		if (aModule != null && aModule.eIsProxy()) {
			...
			if (aModule != oldAModule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__AMODULE, oldAModule, aModule));
			}
		}
		return aModule;
	}
	...
	public void setAModule(Module newAModule) {
		...
		aModule = newAModule;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__AMODULE, oldAModule, aModule));
	}
	...
	public OclModel getOclModel() {
		if (oclModel != null && oclModel.eIsProxy()) {
			...
			if (oclModel != oldOclModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__OCL_MODEL, oldOclModel, oclModel));
			}
		}
		return oclModel;
	}
	...
	public void setOclModel(OclModel newOclModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__OCL_MODEL, oldOclModel, oclModel));
	}
	...
	public TypedModel getRelTM() {
		if (relTM != null && relTM.eIsProxy()) {
			...
			if (relTM != oldRelTM) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__REL_TM, oldRelTM, relTM));
			}
		}
		return relTM;
	}
	...
	public void setRelTM(TypedModel newRelTM) {
		...
		relTM = newRelTM;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__REL_TM, oldRelTM, relTM));
	}
	...
	public RelationalTransformation getRelTx() {
		if (relTx != null && relTx.eIsProxy()) {
			...
			if (relTx != oldRelTx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__REL_TX, oldRelTx, relTx));
			}
		}
		return relTx;
	}
	...
	public void setRelTx(RelationalTransformation newRelTx) {
		...
		relTx = newRelTx;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__REL_TX, oldRelTx, relTx));
	}
	...
	public void setTmName(String newTmName) {
		...
		tmName = newTmName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__TM_NAME, oldTmName, tmName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__AMODULE:
				if (resolve) return getAModule();
				return basicGetAModule();
			case PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__OCL_MODEL:
				if (resolve) return getOclModel();
				return basicGetOclModel();
			case PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__REL_TM:
				if (resolve) return getRelTM();
				return basicGetRelTM();
			case PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__REL_TX:
				if (resolve) return getRelTx();
				return basicGetRelTx();
			case PATL2QVTrPackage.TOCL_MODEL2_MODEL_PARAMETER_CREATE__TM_NAME:
				return getTmName();
		}
...
} //TOclModel2ModelParameter_createImpl
