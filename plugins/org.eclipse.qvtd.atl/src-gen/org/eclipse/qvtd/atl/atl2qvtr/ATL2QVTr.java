...
public class ATL2QVTr extends AbstractTransformer
{
	...
	private static final @NonNull ClassId @NonNull [] classIndex2classId = new @NonNull ClassId[]{
		...
		CLSSid_MatchedRule,                   // 1 => MatchedRule
		CLSSid_Module                         // 2 => Module
	};
	...
	public boolean run() {
		...
		final @NonNull Connection ji_MatchedRule = models[1/*atl*/].getConnection(1/*ATL::MatchedRule*/);
		final @NonNull Connection ji_Module = models[1/*atl*/].getConnection(2/*ATL::Module*/);
		return MAP___root__(ji_Helper, ji_MatchedRule, ji_Module) && invocationManager.flush();
	}
	 ...
	 * ::jm_THelper2Function : PATL2QVTr::THelper2Function[1]::jm_TMatchedRule2Relation : PATL2QVTr::TMatchedRule2Relation[1]install m_TModel2RelationalTransformation__3__4_module_relTx_r0 {
	 ...
	 * }
	 *   install m_THelper2Function_function_lc {
	 ...
	 * ;
	 * }
	 *   install m_TMatchedRule2Relation_rRule_lc {
	 * trace consumes ::jm_TMatchedRule2Relation : PATL2QVTr::TMatchedRule2Relation[1];
	 * }
	 */
	protected boolean MAP___root__(final @NonNull Connection ji_Helper, final @NonNull Connection ji_MatchedRule, final @NonNull Connection ji_Module)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP___root__" + ", " + ji_Helper + ", " + ji_MatchedRule + ", " + ji_Module);
		}
		...
		for (@NonNull THelper2Function trace_1 : jm_THelper2Function_1.typedIterable(THelper2Function.class)) {
			MAP_m_THelper2Function_function_lc(trace_1);
		}
		...
		for (@NonNull TMatchedRule2Relation trace_2 : jm_TMatchedRule2Relation_1.typedIterable(TMatchedRule2Relation.class)) {
			MAP_m_TMatchedRule2Relation_rRule_lc(trace_2);
		}
	...
	protected boolean MAP_m_TModel2RelationalTransformation__3__4_module_relTx_r0(final /*@NonInvalid*/ @NonNull Module module)  {
		...
		final @SuppressWarnings("null")@NonNull TModel2RelationalTransformation trace_1 = PATL2QVTrFactory.eINSTANCE.createTModel2RelationalTransformation();
		models[0/*middle*/].add(trace_1, false);
		// mapping statements
		_4.setName(null);
		_3.setName(null);
		...
		trace_1.set_3(_3);
		trace_1.set_4(_4);
		OPPOSITE_OF_TModel2RelationalTransformation_module.put(module, trace_1);
		trace_1.setModule(module);
		trace_1.setRelTx(relTx);
		relTx.setName(name);
		trace_1.setTxName(name);
	...
	protected boolean MAP_m_THelper2Function_aDef_aFeat_aModule_helper_opName_p0(final /*@NonInvalid*/ @NonNull Helper helper, final @NonNull Connection jm_THelper2Function)  {
		...
		if (symbol_0) {
			...
			if (symbol_1) {
				...
				// creations
				final @SuppressWarnings("null")@NonNull THelper2Function trace_1 = PATL2QVTrFactory.eINSTANCE.createTHelper2Function();
				models[0/*middle*/].add(trace_1, false);
				// mapping statements
				trace_1.setHelper(helper);
				trace_1.setADef(definition);
				trace_1.setAModule(module_0);
				trace_1.setAFeat(symbol_2);
				trace_1.setOpName(name);
				jm_THelper2Function.appendElement(trace_1);
	...
	/**
	 *
	 * map m_THelper2Function_function_lc in ATL2QVTr {
	 ...
	 *
	 */
	protected boolean MAP_m_THelper2Function_function_lc(final /*@NonInvalid*/ @NonNull THelper2Function trace)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_m_THelper2Function_function_lc" + ", " + trace);
		}
		@SuppressWarnings("null")
		...
		if (symbol_0) {
			...
			final /*@Thrown*/ @Nullable Boolean m_THelper2Function_function_lc = ValueUtil.TRUE_VALUE;
			raw_when_TModel2RelationalTransformation = m_THelper2Function_function_lc;
		}
		else {
			raw_when_TModel2RelationalTransformation = ValueUtil.FALSE_VALUE;
		}
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((raw_when_TModel2RelationalTransformation ? "done "  : "fail ") + "MAP_m_THelper2Function_function_lc");
		}
	...
	protected boolean MAP_m_TMatchedRule2Relation_aModule_matchedRule_ruleName_p0(final @NonNull Connection jm_TMatchedRule2Relation, final /*@NonInvalid*/ @NonNull MatchedRule matchedRule)  {
		...
		if (symbol_0) {
			...
			// creations
			final @SuppressWarnings("null")@NonNull TMatchedRule2Relation trace_1 = PATL2QVTrFactory.eINSTANCE.createTMatchedRule2Relation();
			models[0/*middle*/].add(trace_1, false);
			// mapping statements
			trace_1.setMatchedRule(matchedRule);
			trace_1.setRuleName(name);
			trace_1.setAModule(module_0);
			jm_TMatchedRule2Relation.appendElement(trace_1);
	...
	/**
	 *
	 * map m_TMatchedRule2Relation_rRule_lc in ATL2QVTr {
	 * guard:middle trace  : PATL2QVTr::TMatchedRule2Relation[1];
	 * var aModule : ATL::Module[1] := trace.aModule;
	 * var ruleName : String[1] := trace.ruleName;
	 * var when_TModel2RelationalTransformation : PATL2QVTr::TModel2RelationalTransformation[1] := aModule.TModel2RelationalTransformation;
	 * var relTx : qvtrelation::RelationalTransformation[1] := when_TModel2RelationalTransformation.relTx;
	 * new:qvtr rRule : qvtrelation::Relation[1];
	 * set trace.rRule := rRule;
	 * set rRule.name := ruleName;
	 * set rRule.transformation := relTx;
	 *
	 */
	protected boolean MAP_m_TMatchedRule2Relation_rRule_lc(final /*@NonInvalid*/ @NonNull TMatchedRule2Relation trace_0)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_m_TMatchedRule2Relation_rRule_lc" + ", " + trace_0);
		}
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull Module aModule = trace_0.getAModule();
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull String ruleName = trace_0.getRuleName();
		final /*@NonInvalid*/ @Nullable TModel2RelationalTransformation TModel2RelationalTransformation = OPPOSITE_OF_TModel2RelationalTransformation_module.get(aModule);
		final /*@NonInvalid*/ boolean symbol_0 = TModel2RelationalTransformation != null;
		/*@Thrown*/ @Nullable Boolean raw_when_TModel2RelationalTransformation;
		if (symbol_0) {
			...
			models[2/*qvtr*/].add(rRule, false);
			// mapping statements
			trace_0.setRRule(rRule);
			rRule.setName(ruleName);
			rRule.setTransformation(relTx);
			final /*@Thrown*/ @Nullable Boolean m_TMatchedRule2Relation_rRule_lc = ValueUtil.TRUE_VALUE;
			raw_when_TModel2RelationalTransformation = m_TMatchedRule2Relation_rRule_lc;
		}
		else {
			raw_when_TModel2RelationalTransformation = ValueUtil.FALSE_VALUE;
		}
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println((raw_when_TModel2RelationalTransformation ? "done "  : "fail ") + "MAP_m_TMatchedRule2Relation_rRule_lc");
		}
		return raw_when_TModel2RelationalTransformation;
	}
}
