...
public class ATL2QVTr extends AbstractTransformer
{
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Pattern = PACKid_http_c_s_s_www_eclipse_org_s_qvt_s_2017_s_QVTbase.getClassId("Pattern", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Predicate = PACKid_http_c_s_s_www_eclipse_org_s_qvt_s_2017_s_QVTbase.getClassId("Predicate", 0);
	 ...
	 * }
	 *   install m_TInPattern2RelationDomain__guard_aExpression_aPatt_p0 {
	...
	/**
	 *
	 * map m_TInPattern2RelationDomain__guard_aExpression_aPatt_p0 in ATL2QVTr {
	 ...
	 *
	 */
	protected boolean MAP_m_TInPattern2RelationDomain__guard_aExpression_aPatt_p0(final /*@NonInvalid*/ @NonNull InPattern aPattern, final @NonNull Connection jm_TInPattern2RelationDomain__guard)  {
		if (debugInvocations) {
			AbstractTransformer.INVOCATIONS.println("invoke MAP_m_TInPattern2RelationDomain__guard_aExpression_aPatt_p0" + ", " + aPattern + ", " + jm_TInPattern2RelationDomain__guard);
		}
