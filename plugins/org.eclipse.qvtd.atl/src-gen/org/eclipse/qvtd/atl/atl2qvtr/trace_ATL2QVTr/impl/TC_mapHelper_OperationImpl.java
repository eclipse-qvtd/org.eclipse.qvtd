...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TC map Helper Operation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TC_mapHelper_OperationImpl#getAtl_atlDefinition <em>Atl atl Definition</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TC_mapHelper_OperationImpl#getAtl_atlExpression <em>Atl atl Expression</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TC_mapHelper_OperationImpl#getAtl_atlFeature <em>Atl atl Feature</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TC_mapHelper_OperationImpl#getAtl_atlModule <em>Atl atl Module</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TC_mapHelper_OperationImpl#getAtl_atlType <em>Atl atl Type</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TC_mapHelper_OperationImpl#getInvocation_mapHelper_Context <em>Invocation map Helper Context</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TC_mapHelper_OperationImpl#getPrimitive_operationName <em>Primitive operation Name</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TC_mapHelper_OperationImpl#getQvtr_qvtrExpression <em>Qvtr qvtr Expression</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TC_mapHelper_OperationImpl#getQvtr_qvtrTransformation <em>Qvtr qvtr Transformation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TC_mapHelper_OperationImpl extends TI_mapHelper_OperationImpl implements TC_mapHelper_Operation {
	/**
	 ...
	 * @ordered
	 */
	protected Operation atl_atlFeature;
	 ...
	 * @generated
	 */
	protected TC_mapHelper_OperationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return trace_ATL2QVTrPackage.Literals.TC_MAP_HELPER_OPERATION;
	}
		...
		if (atl_atlDefinition != null && atl_atlDefinition.eIsProxy()) {
			...
			if (atl_atlDefinition != oldAtl_atlDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_DEFINITION, oldAtl_atlDefinition, atl_atlDefinition));
			}
		}
	...
	public void setAtl_atlDefinition(OclFeatureDefinition newAtl_atlDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_DEFINITION, oldAtl_atlDefinition, atl_atlDefinition));
	}
	...
	public OclExpression getAtl_atlExpression() {
		if (atl_atlExpression != null && atl_atlExpression.eIsProxy()) {
			...
			if (atl_atlExpression != oldAtl_atlExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_EXPRESSION, oldAtl_atlExpression, atl_atlExpression));
			}
		}
	...
	public void setAtl_atlExpression(OclExpression newAtl_atlExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_EXPRESSION, oldAtl_atlExpression, atl_atlExpression));
	}
	...
	public Operation getAtl_atlFeature() {
		if (atl_atlFeature != null && atl_atlFeature.eIsProxy()) {
			...
			if (atl_atlFeature != oldAtl_atlFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_FEATURE, oldAtl_atlFeature, atl_atlFeature));
			}
		}
	 ...
	 * @generated
	 */
	public Operation basicGetAtl_atlFeature() {
		return atl_atlFeature;
	}
	...
	public void setAtl_atlFeature(Operation newAtl_atlFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_FEATURE, oldAtl_atlFeature, atl_atlFeature));
	}
	...
	public OclType getAtl_atlType() {
		if (atl_atlType != null && atl_atlType.eIsProxy()) {
			...
			if (atl_atlType != oldAtl_atlType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_TYPE, oldAtl_atlType, atl_atlType));
			}
		}
		return atl_atlType;
	}
	...
	public void setAtl_atlType(OclType newAtl_atlType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_TYPE, oldAtl_atlType, atl_atlType));
	}
	...
	public NotificationChain basicSetInvocation_mapHelper_Context(TC_mapHelper_Context newInvocation_mapHelper_Context, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__INVOCATION_MAP_HELPER_CONTEXT, oldInvocation_mapHelper_Context, newInvocation_mapHelper_Context);
	...
	public void setInvocation_mapHelper_Context(TC_mapHelper_Context newInvocation_mapHelper_Context) {
		if (newInvocation_mapHelper_Context != invocation_mapHelper_Context) {
			...
			if (invocation_mapHelper_Context != null)
				msgs = ((InternalEObject)invocation_mapHelper_Context).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__INVOCATION_MAP_HELPER_CONTEXT, null, msgs);
			if (newInvocation_mapHelper_Context != null)
				msgs = ((InternalEObject)newInvocation_mapHelper_Context).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__INVOCATION_MAP_HELPER_CONTEXT, null, msgs);
			msgs = basicSetInvocation_mapHelper_Context(newInvocation_mapHelper_Context, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__INVOCATION_MAP_HELPER_CONTEXT, newInvocation_mapHelper_Context, newInvocation_mapHelper_Context));
	}
	...
	public void setPrimitive_operationName(String newPrimitive_operationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__PRIMITIVE_OPERATION_NAME, oldPrimitive_operationName, primitive_operationName));
	}
	...
	public OCLExpression getQvtr_qvtrExpression() {
		if (qvtr_qvtrExpression != null && qvtr_qvtrExpression.eIsProxy()) {
			...
			if (qvtr_qvtrExpression != oldQvtr_qvtrExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__QVTR_QVTR_EXPRESSION, oldQvtr_qvtrExpression, qvtr_qvtrExpression));
			}
		}
	...
	public void setQvtr_qvtrExpression(OCLExpression newQvtr_qvtrExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__QVTR_QVTR_EXPRESSION, oldQvtr_qvtrExpression, qvtr_qvtrExpression));
	}
	...
	public RelationalTransformation getQvtr_qvtrTransformation() {
		if (qvtr_qvtrTransformation != null && qvtr_qvtrTransformation.eIsProxy()) {
			...
			if (qvtr_qvtrTransformation != oldQvtr_qvtrTransformation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__QVTR_QVTR_TRANSFORMATION, oldQvtr_qvtrTransformation, qvtr_qvtrTransformation));
			}
		}
	...
	public void setQvtr_qvtrTransformation(RelationalTransformation newQvtr_qvtrTransformation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__QVTR_QVTR_TRANSFORMATION, oldQvtr_qvtrTransformation, qvtr_qvtrTransformation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__INVOCATION_MAP_HELPER_CONTEXT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_DEFINITION:
				if (resolve) return getAtl_atlDefinition();
				return basicGetAtl_atlDefinition();
			case trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_EXPRESSION:
				if (resolve) return getAtl_atlExpression();
				return basicGetAtl_atlExpression();
			case trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__ATL_ATL_FEATURE:
			...
			case trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__PRIMITIVE_OPERATION_NAME:
				return getPrimitive_operationName();
			case trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__QVTR_QVTR_EXPRESSION:
				if (resolve) return getQvtr_qvtrExpression();
				return basicGetQvtr_qvtrExpression();
			case trace_ATL2QVTrPackage.TC_MAP_HELPER_OPERATION__QVTR_QVTR_TRANSFORMATION:
