...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TOcl Expression2 OCL Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.PATL2QVTr.impl.TOclExpression2OCLExpressionImpl#getAExpression <em>AExpression</em>}</li>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.PATL2QVTr.impl.TOclExpression2OCLExpressionImpl#getRExpression <em>RExpression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TOclExpression2OCLExpressionImpl extends MinimalEObjectImpl.Container implements TOclExpression2OCLExpression {
	/**
	 ...
	 * @generated
	 */
	protected TOclExpression2OCLExpressionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PATL2QVTrPackage.Literals.TOCL_EXPRESSION2_OCL_EXPRESSION;
	}
		...
		if (aExpression != null && aExpression.eIsProxy()) {
			...
			if (aExpression != oldAExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PATL2QVTrPackage.TOCL_EXPRESSION2_OCL_EXPRESSION__AEXPRESSION, oldAExpression, aExpression));
			}
		}
		return aExpression;
	}
	...
	public void setAExpression(OclExpression newAExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PATL2QVTrPackage.TOCL_EXPRESSION2_OCL_EXPRESSION__AEXPRESSION, oldAExpression, aExpression));
	}
	...
	public OCLExpression getRExpression() {
		if (rExpression != null && rExpression.eIsProxy()) {
			...
			if (rExpression != oldRExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PATL2QVTrPackage.TOCL_EXPRESSION2_OCL_EXPRESSION__REXPRESSION, oldRExpression, rExpression));
			}
		}
		return rExpression;
	}
	...
	public void setRExpression(OCLExpression newRExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PATL2QVTrPackage.TOCL_EXPRESSION2_OCL_EXPRESSION__REXPRESSION, oldRExpression, rExpression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PATL2QVTrPackage.TOCL_EXPRESSION2_OCL_EXPRESSION__AEXPRESSION:
				if (resolve) return getAExpression();
				return basicGetAExpression();
			case PATL2QVTrPackage.TOCL_EXPRESSION2_OCL_EXPRESSION__REXPRESSION:
...
} //TOclExpression2OCLExpressionImpl
