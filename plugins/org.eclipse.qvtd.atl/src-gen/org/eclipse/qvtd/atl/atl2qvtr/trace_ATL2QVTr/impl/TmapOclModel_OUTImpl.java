 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvtd.atl.atl2qvtr.trace_ATL2QVTr.impl.TmapOclModel_OUTImpl#getT0tmName <em>T0tm Name</em>}</li>
...
public class TmapOclModel_OUTImpl extends ExecutionImpl implements TmapOclModel_OUT {
	...
	public void setT0tmName(String newT0tmName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T0TM_NAME, oldT0tmName, t0tmName));
	}
	...
	public org.eclipse.m2m.atl.common.ATL.Module getT1atlModule() {
		if (t1atlModule != null && t1atlModule.eIsProxy()) {
			...
			if (t1atlModule != oldT1atlModule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T1ATL_MODULE, oldT1atlModule, t1atlModule));
			}
		}
		return t1atlModule;
	}
	...
	public void setT1atlModule(org.eclipse.m2m.atl.common.ATL.Module newT1atlModule) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T1ATL_MODULE, oldT1atlModule, t1atlModule));
	}
	...
	public OclModel getT1oclMetamodel() {
		if (t1oclMetamodel != null && t1oclMetamodel.eIsProxy()) {
			...
			if (t1oclMetamodel != oldT1oclMetamodel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T1OCL_METAMODEL, oldT1oclMetamodel, t1oclMetamodel));
			}
		}
	...
	public void setT1oclMetamodel(OclModel newT1oclMetamodel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T1OCL_METAMODEL, oldT1oclMetamodel, t1oclMetamodel));
	}
	...
	public OclModel getT1oclModel() {
		if (t1oclModel != null && t1oclModel.eIsProxy()) {
			...
			if (t1oclModel != oldT1oclModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T1OCL_MODEL, oldT1oclModel, t1oclModel));
			}
		}
		return t1oclModel;
	}
	...
	public void setT1oclModel(OclModel newT1oclModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T1OCL_MODEL, oldT1oclModel, t1oclModel));
	}
	...
	public RelationalTransformation getT2qvtrTransformation() {
		if (t2qvtrTransformation != null && t2qvtrTransformation.eIsProxy()) {
			...
			if (t2qvtrTransformation != oldT2qvtrTransformation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T2QVTR_TRANSFORMATION, oldT2qvtrTransformation, t2qvtrTransformation));
			}
		}
	...
	public void setT2qvtrTransformation(RelationalTransformation newT2qvtrTransformation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T2QVTR_TRANSFORMATION, oldT2qvtrTransformation, t2qvtrTransformation));
	}
	...
	public TypedModel getT2qvtrTypedModel() {
		if (t2qvtrTypedModel != null && t2qvtrTypedModel.eIsProxy()) {
			...
			if (t2qvtrTypedModel != oldT2qvtrTypedModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T2QVTR_TYPED_MODEL, oldT2qvtrTypedModel, t2qvtrTypedModel));
			}
		}
	...
	public void setT2qvtrTypedModel(TypedModel newT2qvtrTypedModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T2QVTR_TYPED_MODEL, oldT2qvtrTypedModel, t2qvtrTypedModel));
	}
	...
	public TmapModule getWmapModule() {
		if (wmapModule != null && wmapModule.eIsProxy()) {
			...
			if (wmapModule != oldWmapModule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__WMAP_MODULE, oldWmapModule, wmapModule));
			}
		}
		return wmapModule;
	}
	...
	public void setWmapModule(TmapModule newWmapModule) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__WMAP_MODULE, oldWmapModule, wmapModule));
	}
	...
	public TmapOclMetamodel getWmapOclMetamodel() {
		if (wmapOclMetamodel != null && wmapOclMetamodel.eIsProxy()) {
			...
			if (wmapOclMetamodel != oldWmapOclMetamodel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__WMAP_OCL_METAMODEL, oldWmapOclMetamodel, wmapOclMetamodel));
			}
		}
	...
	public void setWmapOclMetamodel(TmapOclMetamodel newWmapOclMetamodel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__WMAP_OCL_METAMODEL, oldWmapOclMetamodel, wmapOclMetamodel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T0TM_NAME:
				return getT0tmName();
			case trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T1ATL_MODULE:
				if (resolve) return getT1atlModule();
				return basicGetT1atlModule();
			case trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T1OCL_METAMODEL:
				if (resolve) return getT1oclMetamodel();
				return basicGetT1oclMetamodel();
			case trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T1OCL_MODEL:
				if (resolve) return getT1oclModel();
				return basicGetT1oclModel();
			case trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T2QVTR_TRANSFORMATION:
				if (resolve) return getT2qvtrTransformation();
				return basicGetT2qvtrTransformation();
			case trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__T2QVTR_TYPED_MODEL:
				if (resolve) return getT2qvtrTypedModel();
				return basicGetT2qvtrTypedModel();
			case trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__WMAP_MODULE:
				if (resolve) return getWmapModule();
				return basicGetWmapModule();
			case trace_ATL2QVTrPackage.TMAP_OCL_MODEL_OUT__WMAP_OCL_METAMODEL:
