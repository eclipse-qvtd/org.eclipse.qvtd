		...
		try {
			...
			if (le) {
				...
				try {
					...
					final /*@NonInvalid*/ boolean ne = extends1 != null;
					final /*@Thrown*/ @Nullable Boolean result;
					if (!ne) {
						result = ValueUtil.TRUE_VALUE;
					}
				...
				try {
					...
					final @NonNull AbstractBinaryOperation BODY0_closure_1 = new AbstractBinaryOperation() {
						...
						public @Nullable Object evaluate(final @NonNull Executor executor, final @NonNull TypeId typeId, final @Nullable Object oclAsSet, final /*@NonInvalid*/ @Nullable Object _1) {
							...
							if (CAST_null == null) {
								throw new InvalidValueException("Null source for \'qvtbase::Transformation::extends : qvtbase::Transformation\'");
							}
							final /*@Thrown*/ @Nullable Transformation extends1_0 = CAST_null.getExtends();
							return extends1_0;
						}
					};
					final @NonNull ExecutorSingleIterationManager MGR_closure_0 = new ExecutorSingleIterationManager(executor, QVTbaseTables.SET_CLSSid_Transformation_0, BODY0_closure_1, oclAsSet, ACC_closure_0);
					@SuppressWarnings("null")
