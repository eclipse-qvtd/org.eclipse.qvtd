...
/**
 * An AbstractQVTbaseFlowAnalysisDeducerFromTrueVisitor provides a default implementation for each
 * visitXxx method that delegates to the visitYyy method of the first
 * super class, (or transitively its first super class' first super class
 * until a non-interface super-class is found). In the absence of any
 * suitable first super class, the method delegates to visiting().
 */
public abstract class AbstractQVTbaseFlowAnalysisDeducerFromTrueVisitor
	extends PivotFlowAnalysisDeducerFromTrueVisitor
	implements QVTbaseVisitor<Boolean>
{
	 ...
	 */
	protected AbstractQVTbaseFlowAnalysisDeducerFromTrueVisitor(@NonNull FlowAnalysis flowAnalysis) {
		super(flowAnalysis);
	}
