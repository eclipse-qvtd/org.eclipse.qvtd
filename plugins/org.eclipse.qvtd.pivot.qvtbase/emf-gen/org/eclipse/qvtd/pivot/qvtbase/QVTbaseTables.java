...
public class QVTbaseTables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final @NonNull Property _CompoundTargetElement__ownedTargetElements = LIBRARY.createProperty(Types._CompoundTargetElement, QVTbasePackage.Literals.COMPOUND_TARGET_ELEMENT__OWNED_TARGET_ELEMENTS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._SimpleTargetElement, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Pattern__bindsTo = LIBRARY.createProperty(Types._Pattern, QVTbasePackage.Literals.PATTERN__BINDS_TO, MODEL.getCollectionType(OCLstdlibTables.Types._Set, PivotTables.Types._Variable, false), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Pattern__predicate = LIBRARY.createProperty(Types._Pattern, QVTbasePackage.Literals.PATTERN__PREDICATE, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Predicate, false), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Rule__domain = LIBRARY.createProperty(Types._Rule, QVTbasePackage.Literals.RULE__DOMAIN, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Domain, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Rule__overrides = LIBRARY.createProperty(Types._Rule, QVTbasePackage.Literals.RULE__OVERRIDES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Rule, false), 3 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _SimpleTargetElement__iterates = LIBRARY.createProperty(Types._SimpleTargetElement, QVTbasePackage.Literals.SIMPLE_TARGET_ELEMENT__ITERATES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._TypedModel, false), 0 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Target__ownedTargetElements = LIBRARY.createProperty(Types._Target, QVTbasePackage.Literals.TARGET__OWNED_TARGET_ELEMENTS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._TargetElement, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Transformation__modelParameter = LIBRARY.createProperty(Types._Transformation, QVTbasePackage.Literals.TRANSFORMATION__MODEL_PARAMETER, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TypedModel, false), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Transformation__ownedTag = LIBRARY.createProperty(Types._Transformation, QVTbasePackage.Literals.TRANSFORMATION__OWNED_TAG, MODEL.getCollectionType(OCLstdlibTables.Types._Set, PivotTables.Types._Annotation, false), 3 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Transformation__ownedTargets = LIBRARY.createProperty(Types._Transformation, QVTbasePackage.Literals.TRANSFORMATION__OWNED_TARGETS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Target, false), 4 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Transformation__rule = LIBRARY.createProperty(Types._Transformation, QVTbasePackage.Literals.TRANSFORMATION__RULE, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Rule, false), 5 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TypedModel__dependsOn = LIBRARY.createProperty(Types._TypedModel, QVTbasePackage.Literals.TYPED_MODEL__DEPENDS_ON, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._TypedModel, false), 0 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TypedModel__iterates = LIBRARY.createProperty(Types._TypedModel, QVTbasePackage.Literals.TYPED_MODEL__ITERATES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._TypedModel, false), 4 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TypedModel__usedPackage = LIBRARY.createProperty(Types._TypedModel, QVTbasePackage.Literals.TYPED_MODEL__USED_PACKAGE, MODEL.getCollectionType(OCLstdlibTables.Types._Set, PivotTables.Types._Package, false), 7 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _TypedModel__Domain__typedModel = LIBRARY.createOppositeProperty(Types._TypedModel, "Domain", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Domain, false), 8 | IsImplicit | IsRequired | IsResolveProxies, QVTbasePackage.Literals.DOMAIN__TYPED_MODEL);
		public static final @NonNull Property _TypedModel__SimpleTargetElement__iterates = LIBRARY.createOppositeProperty(Types._TypedModel, "SimpleTargetElement", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._SimpleTargetElement, false), 9 | IsImplicit | IsRequired | IsResolveProxies, QVTbasePackage.Literals.SIMPLE_TARGET_ELEMENT__ITERATES);
		public static final @NonNull Property _TypedModel__SimpleTargetElement__typedModel = LIBRARY.createOppositeProperty(Types._TypedModel, "SimpleTargetElement", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._SimpleTargetElement, false), 10 | IsImplicit | IsRequired | IsResolveProxies, QVTbasePackage.Literals.SIMPLE_TARGET_ELEMENT__TYPED_MODEL);
		public static final @NonNull Property _TypedModel__TypedModel__iterates = LIBRARY.createOppositeProperty(Types._TypedModel, "TypedModel", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._TypedModel, false), 11 | IsImplicit | IsRequired | IsResolveProxies, QVTbasePackage.Literals.TYPED_MODEL__ITERATES);
