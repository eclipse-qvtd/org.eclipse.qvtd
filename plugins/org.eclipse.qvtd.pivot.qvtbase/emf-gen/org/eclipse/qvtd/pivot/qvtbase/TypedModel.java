...
public interface TypedModel extends NamedElement {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot body='if isPrimitive then 1 else 0 endif + if isThis then 1 else 0 endif + if isTrace then 1 else 0 endif &lt;= 1'"
	 * @generated
	 */
