...
public class QVTbaseMetamodel extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents.AbstractMetamodelContents
	{
		...
		private final org.eclipse.ocl.pivot.@NonNull Package qvtbase;
		private final org.eclipse.ocl.pivot.@NonNull Package local_orphanage;
		private final org.eclipse.ocl.pivot.@NonNull Package local_pivot;
		...
		private final org.eclipse.ocl.pivot.@NonNull Class _Class = getClass(pivot, "Class");
		...
		private final org.eclipse.ocl.pivot.@NonNull Class _ExpressionInOCL = getClass(pivot, "ExpressionInOCL");
		private final org.eclipse.ocl.pivot.@NonNull Class _Integer = getPrimitiveType(standardLibraryPackage, "Integer");
		private final org.eclipse.ocl.pivot.@NonNull Class _Model = getClass(pivot, "Model");
		private final org.eclipse.ocl.pivot.@NonNull Class _NamedElement = getClass(pivot, "NamedElement");
		...
		private final org.eclipse.ocl.pivot.@NonNull Class _Operation = getClass(pivot, "Operation");
		...
		private final org.eclipse.ocl.pivot.@NonNull Class _ReferringElement = getClass(pivot, "ReferringElement");
		...
		private void installPackages() {
			...
			local_orphanage.getOwnedPackages().add(local_pivot);
			root.getOwnedImports().add(createImport(null, standardLibraryPackage));
		}

		private final org.eclipse.ocl.pivot.@NonNull Class _BaseModel = createClass(QVTbasePackage.Literals.BASE_MODEL);
		private final org.eclipse.ocl.pivot.@NonNull Class _CompoundTargetElement = createClass(QVTbasePackage.Literals.COMPOUND_TARGET_ELEMENT);
		private final org.eclipse.ocl.pivot.@NonNull Class _Domain = createClass(QVTbasePackage.Literals.DOMAIN);
		private final org.eclipse.ocl.pivot.@NonNull Class _Function = createClass(QVTbasePackage.Literals.FUNCTION);
		private final org.eclipse.ocl.pivot.@NonNull Class _FunctionBody = createClass(QVTbasePackage.Literals.FUNCTION_BODY);
		private final org.eclipse.ocl.pivot.@NonNull Class _FunctionParameter = createClass(QVTbasePackage.Literals.FUNCTION_PARAMETER);
		private final org.eclipse.ocl.pivot.@NonNull Class _Pattern = createClass(QVTbasePackage.Literals.PATTERN);
		private final org.eclipse.ocl.pivot.@NonNull Class _Predicate = createClass(QVTbasePackage.Literals.PREDICATE);
		private final org.eclipse.ocl.pivot.@NonNull Class _Rule = createClass(QVTbasePackage.Literals.RULE);
		private final org.eclipse.ocl.pivot.@NonNull Class _SimpleTargetElement = createClass(QVTbasePackage.Literals.SIMPLE_TARGET_ELEMENT);
		private final org.eclipse.ocl.pivot.@NonNull Class _Target = createClass(QVTbasePackage.Literals.TARGET);
		private final org.eclipse.ocl.pivot.@NonNull Class _TargetElement = createClass(QVTbasePackage.Literals.TARGET_ELEMENT);
		...
		private final @NonNull CollectionType _Collection_SimpleTargetElement_F_L2 = createCollectionType(_Collection);
		...
		private final @NonNull CollectionType _OrderedCollection_SimpleTargetElement_F_L2 = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_TypedModel_F = createCollectionType(_OrderedCollection);
		private final @NonNull OrderedSetType _OrderedSet_Domain_F = createOrderedSetType(_OrderedSet);
		...
		private void installCollectionTypes() {
			...
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_SimpleTargetElement_F_L2;
			type.setLower(2);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			...
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_TargetElement_F_L2;
			type.setLower(2);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			...
			ownedClasses.add(type);
			type = _OrderedCollection_SimpleTargetElement_F_L2;
			type.setLower(2);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_SimpleTargetElement_F_L2);
			ownedClasses.add(type);
			type = _OrderedCollection_TypedModel_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_TypedModel_F);
			ownedClasses.add(type);
			type = _OrderedSet_Domain_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_Domain_F);
			superClasses.add(_UniqueCollection_Domain_F);
			ownedClasses.add(type);
			type = _OrderedSet_Rule_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_Rule_F);
			superClasses.add(_UniqueCollection_Rule_F);
			ownedClasses.add(type);
			type = _OrderedSet_SimpleTargetElement_F_L2;
			type.setLower(2);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_SimpleTargetElement_F_L2);
			superClasses.add(_UniqueCollection_SimpleTargetElement_F_L2);
			ownedClasses.add(type);
			type = _OrderedSet_TypedModel_F;
			superClasses = type.getSuperClasses();
			...
			ownedClasses.add(type);
			type = _Set_TargetElement_F_L2;
			type.setLower(2);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_TargetElement_F_L2);
			ownedClasses.add(type);
			type = _Set_TypedModel_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_TypedModel_F);
			ownedClasses.add(type);
			...
			superClasses.add(_Collection_Rule_F);
			ownedClasses.add(type);
			type = _UniqueCollection_SimpleTargetElement_F_L2;
			type.setLower(2);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_SimpleTargetElement_F_L2);
			ownedClasses.add(type);
			...
			ownedClasses.add(type);
			type = _UniqueCollection_TargetElement_F_L2;
			type.setLower(2);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_TargetElement_F_L2);
			ownedClasses.add(type);
		...
		private final @NonNull Property pr_CompoundTargetElement_ownedTargetElements = createProperty(QVTbasePackage.Literals.COMPOUND_TARGET_ELEMENT__OWNED_TARGET_ELEMENTS, _OrderedSet_SimpleTargetElement_F_L2);
		...
		private final @NonNull Property pr_Pattern_bindsTo = createProperty(QVTbasePackage.Literals.PATTERN__BINDS_TO, _Set_Variable_F);
		private final @NonNull Property pr_Pattern_predicate = createProperty(QVTbasePackage.Literals.PATTERN__PREDICATE, _Set_Predicate_F);
		...
		private final @NonNull Property pr_Rule_domain = createProperty(QVTbasePackage.Literals.RULE__DOMAIN, _OrderedSet_Domain_F);
		...
		private final @NonNull Property pr_Rule_overrides = createProperty(QVTbasePackage.Literals.RULE__OVERRIDES, _OrderedSet_Rule_F);
		...
		private final @NonNull Property pr_SimpleTargetElement_iterates = createProperty(QVTbasePackage.Literals.SIMPLE_TARGET_ELEMENT__ITERATES, _Set_TypedModel_F);
		...
		private final @NonNull Property pr_Target_ownedTargetElements = createProperty(QVTbasePackage.Literals.TARGET__OWNED_TARGET_ELEMENTS, _Set_TargetElement_F_L2);
		...
		private final @NonNull Property pr_Transformation_modelParameter = createProperty(QVTbasePackage.Literals.TRANSFORMATION__MODEL_PARAMETER, _OrderedSet_TypedModel_F);
		...
		private final @NonNull Property pr_Transformation_ownedTag = createProperty(QVTbasePackage.Literals.TRANSFORMATION__OWNED_TAG, _Set_Annotation_F);
		private final @NonNull Property pr_Transformation_ownedTargets = createProperty(QVTbasePackage.Literals.TRANSFORMATION__OWNED_TARGETS, _Set_Target_F);
		private final @NonNull Property pr_Transformation_rule = createProperty(QVTbasePackage.Literals.TRANSFORMATION__RULE, _Set_Rule_F);
		private final @NonNull Property pr_Transformation_extendedBy_extends = createProperty("extendedBy", _Transformation);
		private final @NonNull Property pr_TypedModel_dependsOn = createProperty(QVTbasePackage.Literals.TYPED_MODEL__DEPENDS_ON, _Set_TypedModel_F);
		...
		private final @NonNull Property pr_TypedModel_iterates = createProperty(QVTbasePackage.Literals.TYPED_MODEL__ITERATES, _Set_TypedModel_F);
		...
		private final @NonNull Property pr_TypedModel_usedPackage = createProperty(QVTbasePackage.Literals.TYPED_MODEL__USED_PACKAGE, _Set_Package_F);
		...
		private void installProperties() {
			...
			property.setOpposite(_OCLExpression_Function_queryExpression);

			ownedProperties = _Pattern.getOwnedProperties();
			ownedProperties.add(property = pr_Pattern_bindsTo);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(_Variable_Pattern_bindsTo);
			...
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(_OCLExpression_predicate_conditionExpression);
			...
			property.setIsComposite(true);
			property.setIsResolveProxies(true);
			property.setOpposite(_ParameterVariable_Rule_ownedContext);
			...
			property.setIsComposite(true);
			property.setIsResolveProxies(true);
			property.setOpposite(_Parameter_Transformation_ownedContext);
			ownedProperties.add(property = pr_Transformation_ownedTag);
			property.setIsComposite(true);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(_Annotation_Transformation_ownedTag);
			...
			property.setIsComposite(true);
			property.setIsResolveProxies(true);
			property.setOpposite(_Parameter_TypedModel_ownedContext);
			...
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(_Package_TypedModel_usedPackage);
		...
		private void installInvariants() {
			...
			ownedInvariants = _Domain.getOwnedInvariants();
			ownedInvariants.add(constraint = iv_Domain_NameIsTypedModelName);
			ownedInvariants.add(constraint = iv_Domain_TypedModelIsTransformationModelParameter);

			ownedInvariants = _Function.getOwnedInvariants();
			ownedInvariants.add(constraint = iv_Function_ParametersAreFunctionParameter);
			ownedInvariants.add(constraint = iv_Function_ReturnTypeIsQueryType);

			ownedInvariants = _Predicate.getOwnedInvariants();
			ownedInvariants.add(constraint = iv_Predicate_ConditionIsBoolean);

			ownedInvariants = _Rule.getOwnedInvariants();
			ownedInvariants.add(constraint = iv_Rule_AbstractRuleIsOverridden);
			ownedInvariants.add(constraint = iv_Rule_AtLeastOneDomainIsCheckableOrEnforceable);
			ownedInvariants.add(constraint = iv_Rule_DomainNameIsUnique);
			ownedInvariants.add(constraint = iv_Rule_NoOverridesCycle);
			ownedInvariants.add(constraint = iv_Rule_OverridingRuleOverridesAllDomains);

			ownedInvariants = _Transformation.getOwnedInvariants();
			ownedInvariants.add(constraint = iv_Transformation_ContextTypeIsTransformation);
			ownedInvariants.add(constraint = iv_Transformation_ExtendedTypedModelIsExtended);
			ownedInvariants.add(constraint = iv_Transformation_ModelParameterIsUnique);
			ownedInvariants.add(constraint = iv_Transformation_NoExtendsCycle);

			ownedInvariants = _TypedModel.getOwnedInvariants();
		...
		private void installTemplateBindings() {
			...
			addBinding(_Collection_SimpleTargetElement_F_L2, _SimpleTargetElement);
			addBinding(_Collection_TargetElement_F_L2, _TargetElement);
			...
			addBinding(_OrderedCollection_SimpleTargetElement_F_L2, _SimpleTargetElement);
			addBinding(_OrderedCollection_TypedModel_F, _TypedModel);
			addBinding(_OrderedSet_Domain_F, _Domain);
			addBinding(_OrderedSet_Rule_F, _Rule);
			addBinding(_OrderedSet_SimpleTargetElement_F_L2, _SimpleTargetElement);
			addBinding(_OrderedSet_TypedModel_F, _TypedModel);
			addBinding(_Set_Annotation_F, _Annotation);
			addBinding(_Set_Package_F, _Package);
			addBinding(_Set_Predicate_F, _Predicate);
			addBinding(_Set_Rule_F, _Rule);
			addBinding(_Set_TargetElement_F_L2, _TargetElement);
			addBinding(_Set_Target_F, _Target);
			addBinding(_Set_TypedModel_F, _TypedModel);
			addBinding(_Set_Variable_F, _Variable);
			...
			addBinding(_UniqueCollection_SimpleTargetElement_F_L2, _SimpleTargetElement);
			addBinding(_UniqueCollection_TargetElement_F_L2, _TargetElement);
