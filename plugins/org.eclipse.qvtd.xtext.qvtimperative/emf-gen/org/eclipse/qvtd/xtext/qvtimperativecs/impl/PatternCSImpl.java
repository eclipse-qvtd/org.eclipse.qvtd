 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtimperativecs.impl.PatternCSImpl#getOwnedUnrealizedVariables <em>Owned Unrealized Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PatternCSImpl extends ModelElementCSImpl implements PatternCS {
	...
	protected EClass eStaticClass() {
		return QVTimperativeCSPackage.Literals.PATTERN_CS;
	}
	...
	public EList<UnrealizedVariableCS> getOwnedUnrealizedVariables() {
		if (ownedUnrealizedVariables == null) {
			ownedUnrealizedVariables = new EObjectContainmentEList<UnrealizedVariableCS>(UnrealizedVariableCS.class, this, QVTimperativeCSPackage.PATTERN_CS__OWNED_UNREALIZED_VARIABLES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QVTimperativeCSPackage.PATTERN_CS__OWNED_UNREALIZED_VARIABLES:
