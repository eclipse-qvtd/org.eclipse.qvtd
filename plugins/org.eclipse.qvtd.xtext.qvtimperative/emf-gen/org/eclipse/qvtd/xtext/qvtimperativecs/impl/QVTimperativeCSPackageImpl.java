...
public class QVTimperativeCSPackageImpl extends EPackageImpl implements QVTimperativeCSPackage {
	...
	public static QVTimperativeCSPackage init() {
		...
		Object registeredQVTimperativeCSPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		QVTimperativeCSPackageImpl theQVTimperativeCSPackage = registeredQVTimperativeCSPackage instanceof QVTimperativeCSPackageImpl ? (QVTimperativeCSPackageImpl)registeredQVTimperativeCSPackage : new QVTimperativeCSPackageImpl();
	 ...
	 */
	@Override
	public EAttribute getDirectionCS_IsInput() {
	 ...
	 */
	@Override
	public EAttribute getDirectionCS_IsOutput() {
	 ...
	 */
	@Override
	public EReference getEntryPointCS_InputTypedModels() {
	 ...
	 */
	@Override
	public EReference getEntryPointCS_OutputTypedModels() {
	...
	public EAttribute getMappingCS_FirstPass() {
		return (EAttribute)mappingCSEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getTransformationCS_OwnedMappings() {
	...
	public void createPackageContents() {
		...
		createEAttribute(mappingCSEClass, NamedElementCSImpl.NAMED_ELEMENT_CS_FEATURE_COUNT + 3);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDirectionCS_IsInput(), ecorePackage.getEBoolean(), "isInput", null, 1, 1, DirectionCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDirectionCS_IsOutput(), ecorePackage.getEBoolean(), "isOutput", null, 1, 1, DirectionCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransformationCS_OwnedMappings(), this.getMappingCS(), null, "ownedMappings", null, 0, -1, TransformationCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
