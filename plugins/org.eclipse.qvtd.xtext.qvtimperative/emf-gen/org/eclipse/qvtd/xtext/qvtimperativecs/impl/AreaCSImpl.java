 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtimperativecs.impl.AreaCSImpl#getOwnedGuardPattern <em>Owned Guard Pattern</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtimperativecs.impl.AreaCSImpl#getOwnedBottomPattern <em>Owned Bottom Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AreaCSImpl extends NamedElementCSImpl implements AreaCS {
	...
	protected EClass eStaticClass() {
		return QVTimperativeCSPackage.Literals.AREA_CS;
	}
	...
	public NotificationChain basicSetOwnedGuardPattern(GuardPatternCS newOwnedGuardPattern, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QVTimperativeCSPackage.AREA_CS__OWNED_GUARD_PATTERN, oldOwnedGuardPattern, newOwnedGuardPattern);
	...
	public void setOwnedGuardPattern(GuardPatternCS newOwnedGuardPattern) {
		if (newOwnedGuardPattern != ownedGuardPattern) {
			...
			if (ownedGuardPattern != null)
				msgs = ((InternalEObject)ownedGuardPattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QVTimperativeCSPackage.AREA_CS__OWNED_GUARD_PATTERN, null, msgs);
			if (newOwnedGuardPattern != null)
				msgs = ((InternalEObject)newOwnedGuardPattern).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QVTimperativeCSPackage.AREA_CS__OWNED_GUARD_PATTERN, null, msgs);
			msgs = basicSetOwnedGuardPattern(newOwnedGuardPattern, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTimperativeCSPackage.AREA_CS__OWNED_GUARD_PATTERN, newOwnedGuardPattern, newOwnedGuardPattern));
	}
	...
	public NotificationChain basicSetOwnedBottomPattern(BottomPatternCS newOwnedBottomPattern, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QVTimperativeCSPackage.AREA_CS__OWNED_BOTTOM_PATTERN, oldOwnedBottomPattern, newOwnedBottomPattern);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOwnedBottomPattern(BottomPatternCS newOwnedBottomPattern) {
		if (newOwnedBottomPattern != ownedBottomPattern) {
			...
			if (ownedBottomPattern != null)
				msgs = ((InternalEObject)ownedBottomPattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QVTimperativeCSPackage.AREA_CS__OWNED_BOTTOM_PATTERN, null, msgs);
			if (newOwnedBottomPattern != null)
				msgs = ((InternalEObject)newOwnedBottomPattern).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QVTimperativeCSPackage.AREA_CS__OWNED_BOTTOM_PATTERN, null, msgs);
			msgs = basicSetOwnedBottomPattern(newOwnedBottomPattern, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTimperativeCSPackage.AREA_CS__OWNED_BOTTOM_PATTERN, newOwnedBottomPattern, newOwnedBottomPattern));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QVTimperativeCSPackage.AREA_CS__OWNED_GUARD_PATTERN:
				return basicSetOwnedGuardPattern(null, msgs);
			case QVTimperativeCSPackage.AREA_CS__OWNED_BOTTOM_PATTERN:
