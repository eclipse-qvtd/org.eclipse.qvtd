 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtimperativecs.impl.EnforcementOperationCSImpl#isIsDeletion <em>Is Deletion</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtimperativecs.impl.EnforcementOperationCSImpl#getOwnedOperationCall <em>Owned Operation Call</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnforcementOperationCSImpl extends ModelElementCSImpl implements EnforcementOperationCS {
	...
	protected EClass eStaticClass() {
		return QVTimperativeCSPackage.Literals.ENFORCEMENT_OPERATION_CS;
	}
	...
	public void setIsDeletion(boolean newIsDeletion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTimperativeCSPackage.ENFORCEMENT_OPERATION_CS__IS_DELETION, oldIsDeletion, isDeletion));
	}
	...
	public NotificationChain basicSetOwnedOperationCall(NameExpCS newOwnedOperationCall, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QVTimperativeCSPackage.ENFORCEMENT_OPERATION_CS__OWNED_OPERATION_CALL, oldOwnedOperationCall, newOwnedOperationCall);
	...
	public void setOwnedOperationCall(NameExpCS newOwnedOperationCall) {
		if (newOwnedOperationCall != ownedOperationCall) {
			...
			if (ownedOperationCall != null)
				msgs = ((InternalEObject)ownedOperationCall).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QVTimperativeCSPackage.ENFORCEMENT_OPERATION_CS__OWNED_OPERATION_CALL, null, msgs);
			if (newOwnedOperationCall != null)
				msgs = ((InternalEObject)newOwnedOperationCall).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QVTimperativeCSPackage.ENFORCEMENT_OPERATION_CS__OWNED_OPERATION_CALL, null, msgs);
			msgs = basicSetOwnedOperationCall(newOwnedOperationCall, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTimperativeCSPackage.ENFORCEMENT_OPERATION_CS__OWNED_OPERATION_CALL, newOwnedOperationCall, newOwnedOperationCall));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QVTimperativeCSPackage.ENFORCEMENT_OPERATION_CS__OWNED_OPERATION_CALL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QVTimperativeCSPackage.ENFORCEMENT_OPERATION_CS__IS_DELETION:
				return isIsDeletion();
			case QVTimperativeCSPackage.ENFORCEMENT_OPERATION_CS__OWNED_OPERATION_CALL:
	...
	public <R> R accept(@NonNull BaseCSVisitor<R> visitor) {
		return (R) ((QVTimperativeCSVisitor<?>)visitor).visitEnforcementOperationCS(this);
	}
