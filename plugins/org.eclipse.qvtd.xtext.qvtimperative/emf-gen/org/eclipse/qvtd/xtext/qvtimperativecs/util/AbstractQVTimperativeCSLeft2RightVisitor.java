	...
	implements QVTimperativeCSVisitor<Element>
{
	...
	@Override
	public @Nullable Element visitAccessStatementCS(org.eclipse.qvtd.xtext.qvtimperativecs.@NonNull AccessStatementCS csElement) {
	...
	@Override
	public @Nullable Element visitInitializeStatementCS(org.eclipse.qvtd.xtext.qvtimperativecs.@NonNull InitializeStatementCS csElement) {
		return visitStatementCS(csElement);
	}
