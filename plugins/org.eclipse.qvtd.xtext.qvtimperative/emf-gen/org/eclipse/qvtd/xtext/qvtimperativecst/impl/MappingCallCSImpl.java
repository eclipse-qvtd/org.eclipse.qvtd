 ...
 * <ul>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtimperativecst.impl.MappingCallCSImpl#getReferredMapping <em>Referred Mapping</em>}</li>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtimperativecst.impl.MappingCallCSImpl#getBindings <em>Bindings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingCallCSImpl extends ModelElementCSImpl implements MappingCallCS {
	...
	protected EClass eStaticClass() {
		return QVTimperativeCSTPackage.Literals.MAPPING_CALL_CS;
	}
		...
		if (referredMapping != null && referredMapping.eIsProxy()) {
			...
			if (referredMapping != oldReferredMapping) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QVTimperativeCSTPackage.MAPPING_CALL_CS__REFERRED_MAPPING, oldReferredMapping, referredMapping));
			}
		}
	...
	public void setReferredMapping(Mapping newReferredMapping) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTimperativeCSTPackage.MAPPING_CALL_CS__REFERRED_MAPPING, oldReferredMapping, referredMapping));
	}
	...
	public EList<MappingCallBindingCS> getBindings() {
		if (bindings == null) {
			bindings = new EObjectContainmentWithInverseEList<MappingCallBindingCS>(MappingCallBindingCS.class, this, QVTimperativeCSTPackage.MAPPING_CALL_CS__BINDINGS, QVTimperativeCSTPackage.MAPPING_CALL_BINDING_CS__MAPPING_CALL);
		}
		return bindings;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QVTimperativeCSTPackage.MAPPING_CALL_CS__BINDINGS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QVTimperativeCSTPackage.MAPPING_CALL_CS__REFERRED_MAPPING:
	...
	public <R> R accept(@NonNull BaseCSVisitor<R> visitor) {
		return ((QVTimperativeCSVisitor<R>)visitor).visitMappingCallCS(this);
	}
} //MappingCallCSImpl
