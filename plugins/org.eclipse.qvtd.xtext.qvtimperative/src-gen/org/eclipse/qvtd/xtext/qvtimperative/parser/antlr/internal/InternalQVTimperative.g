...
(
    ...
    { 
        newCompositeNode(grammarAccess.getGuardStatementCSAccess().getIfStatementCSParserRuleCall_4()); 
    }
    this_IfStatementCS_4=ruleIfStatementCS
    { 
        $current = $this_IfStatementCS_4.current; 
        afterParserOrEnumRuleCall();
    }
)
;
