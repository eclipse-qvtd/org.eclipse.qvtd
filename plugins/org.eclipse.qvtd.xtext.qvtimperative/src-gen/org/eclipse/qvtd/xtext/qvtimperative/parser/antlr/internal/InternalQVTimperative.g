...
(
		{ 
	        newCompositeNode(grammarAccess.getMiddleBottomPatternCSAccess().getConstraintsPredicateOrAssignmentCSParserRuleCall_2_0()); 
	    }
		lv_constraints_2_0=rulePredicateOrAssignmentCS		{
	        if ($current==null) {
