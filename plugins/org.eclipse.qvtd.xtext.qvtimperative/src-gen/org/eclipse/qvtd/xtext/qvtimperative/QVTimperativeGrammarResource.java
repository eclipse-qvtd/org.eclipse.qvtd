...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	protected QVTimperativeGrammarResource() {
		...
		contents.add(_QVTcoreBase.initGrammar());
	...
	private static class _QVTimperative
	{
		...
		private static final @NonNull ReferencedMetamodel MM_qvtcorebasecs = createReferencedMetamodel(org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.eINSTANCE, "qvtcorebasecs"); // http://www.eclipse.org/qvt/2015/QVTcoreBaseCS
		...
		private static final @NonNull ParserRule PR_ConnectionStatementCS = createParserRule("ConnectionStatementCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.CONNECTION_STATEMENT_CS));
		private static final @NonNull ParserRule PR_DirectionCS = createParserRule("DirectionCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.DIRECTION_CS));
		private static final @NonNull ParserRule PR_ImperativePredicateOrAssignmentCS = createParserRule("ImperativePredicateOrAssignmentCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.IMPERATIVE_PREDICATE_OR_ASSIGNMENT_CS));
		...
		private static final @NonNull ParserRule PR_MappingCallBindingCS = createParserRule("MappingCallBindingCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.MAPPING_CALL_BINDING_CS));
		...
		private static final @NonNull ParserRule PR_MiddleBottomPatternCS = createParserRule("MiddleBottomPatternCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.BOTTOM_PATTERN_CS));
		private static final @NonNull ParserRule PR_MiddleDomainCS = createParserRule("MiddleDomainCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.IMPERATIVE_DOMAIN_CS));
		private static final @NonNull ParserRule PR_MiddleGuardPatternCS = createParserRule("MiddleGuardPatternCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.GUARD_PATTERN_CS));
		private static final @NonNull ParserRule PR_RealizedVariableCS = createParserRule("RealizedVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.IMPERATIVE_REALIZED_VARIABLE_CS));
		private static final @NonNull ParserRule PR_SourceBottomPatternCS = createParserRule("SourceBottomPatternCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.BOTTOM_PATTERN_CS));
		private static final @NonNull ParserRule PR_SourceDomainCS = createParserRule("SourceDomainCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.IMPERATIVE_DOMAIN_CS));
		private static final @NonNull ParserRule PR_SourceGuardPatternCS = createParserRule("SourceGuardPatternCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.GUARD_PATTERN_CS));
		private static final @NonNull ParserRule PR_TargetBottomPatternCS = createParserRule("TargetBottomPatternCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.BOTTOM_PATTERN_CS));
		private static final @NonNull ParserRule PR_TargetDomainCS = createParserRule("TargetDomainCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.IMPERATIVE_DOMAIN_CS));
		private static final @NonNull ParserRule PR_TargetGuardPatternCS = createParserRule("TargetGuardPatternCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.GUARD_PATTERN_CS));
		...
		private static void initParserRules() {
			PR_ConnectionStatementCS.setAlternatives(createGroup(createAssignment("targetVariable", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.VARIABLE), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), createKeyword("+="), createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			PR_DirectionCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.DIRECTION_CS)), createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("imports"), createAssignment("imports", "+=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PACKAGE), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("imports", "+=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PACKAGE), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))))))), setCardinality("?", createGroup(createKeyword("uses"), createAssignment("uses", "+=", createCrossReference(createTypeRef(MM_qvtcorebase, org.eclipse.qvtd.pivot.qvtcorebase.QVTcoreBasePackage.Literals.CORE_DOMAIN), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("uses", "+=", createCrossReference(createTypeRef(MM_qvtcorebase, org.eclipse.qvtd.pivot.qvtcorebase.QVTcoreBasePackage.Literals.CORE_DOMAIN), createRuleCall(_QVTcoreBase.PR_UnrestrictedName)))))))));
			PR_ImperativePredicateOrAssignmentCS.setAlternatives(createGroup(setCardinality("?", createAssignment("isDefault", "?=", createKeyword("default"))), createAssignment("ownedTarget", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), setCardinality("?", createGroup(createAlternatives(createKeyword(":="), createAssignment("isAccumulate", "?=", createKeyword("+="))), createAssignment("ownedInitExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)))), createKeyword(";")));
			PR_MappingCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.MAPPING_CS)), setCardinality("?", createAssignment("isDefault", "?=", createKeyword("default"))), createKeyword("map"), createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("in"), createAssignment("ownedInPathName", "=", createRuleCall(_Base.PR_PathNameCS)))), setCardinality("?", createGroup(createKeyword("uses"), createAssignment("ownedUsesPathNames", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedUsesPathNames", "+=", createRuleCall(_Base.PR_PathNameCS)))))), setCardinality("?", createGroup(createKeyword("key"), createAssignment("ownedKeyExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";"))), createKeyword("{"), setCardinality("*", createAssignment("ownedDomains", "+=", createAlternatives(createRuleCall(PR_SourceDomainCS), createRuleCall(PR_TargetDomainCS)))), setCardinality("?", createGroup(createKeyword("where"), createAssignment("ownedMiddle", "=", createRuleCall(PR_MiddleDomainCS)))), setCardinality("?", createAssignment("ownedMappingSequence", "=", createRuleCall(PR_MappingSequenceCS))), createKeyword("}")));
			PR_MappingCallBindingCS.setAlternatives(createGroup(createAssignment("referredVariable", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.VARIABLE), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), createAlternatives(createKeyword(":="), createAssignment("isPolled", "?=", createKeyword("?="))), createAssignment("ownedValue", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			...
			PR_MappingIteratorCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS))))));
			...
			PR_MiddleGuardPatternCS.setAlternatives(createRuleCall(_QVTcoreBase.PR_GuardPatternCS));
			PR_RealizedVariableCS.setAlternatives(createGroup(createKeyword("realize"), createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword(":="), createAssignment("ownedInitExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS))))));
			PR_SourceBottomPatternCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.BOTTOM_PATTERN_CS)), createKeyword("{"), setCardinality("?", createGroup(createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS)))))), createKeyword("}")));
			PR_SourceDomainCS.setAlternatives(createGroup(createAssignment("isCheck", "?=", createKeyword("check")), createAssignment("direction", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createGroup(createKeyword("check"), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), setCardinality("?", createGroup(createKeyword("enforce"), createAssignment("enforcedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("enforcedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("}"))), createAssignment("ownedGuardPattern", "=", createRuleCall(PR_SourceGuardPatternCS)), createAssignment("ownedBottomPattern", "=", createRuleCall(PR_SourceBottomPatternCS))));
			PR_SourceGuardPatternCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.GUARD_PATTERN_CS)), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS)))))), createKeyword(")")));
			PR_TargetBottomPatternCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.BOTTOM_PATTERN_CS)), createKeyword("{"), setCardinality("?", createGroup(createAlternatives(createAssignment("ownedRealizedVariables", "+=", createRuleCall(PR_RealizedVariableCS)), createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS))), setCardinality("*", createGroup(createKeyword(","), createAlternatives(createAssignment("ownedRealizedVariables", "+=", createRuleCall(PR_RealizedVariableCS)), createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS))))))), createKeyword("}")));
			PR_TargetDomainCS.setAlternatives(createGroup(createAssignment("isEnforce", "?=", createKeyword("enforce")), createAssignment("direction", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createGroup(createKeyword("check"), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), setCardinality("?", createGroup(createKeyword("enforce"), createAssignment("enforcedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("enforcedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("}"))), createAssignment("ownedGuardPattern", "=", createRuleCall(PR_TargetGuardPatternCS)), createAssignment("ownedBottomPattern", "=", createRuleCall(PR_TargetBottomPatternCS))));
			PR_TargetGuardPatternCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.GUARD_PATTERN_CS)), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS)))))), createKeyword(")")));
			PR_TopLevelCS.setAlternatives(createGroup(setCardinality("*", createAssignment("ownedImports", "+=", createRuleCall(_QVTcoreBase.PR_ImportCS))), setCardinality("*", createAlternatives(createAssignment("ownedPackages", "+=", createRuleCall(_QVTcoreBase.PR_QualifiedPackageCS)), createAssignment("ownedTransformations", "+=", createRuleCall(_QVTcoreBase.PR_TransformationCS)), createAssignment("ownedMappings", "+=", createRuleCall(PR_MappingCS)), createAssignment("ownedQueries", "+=", createRuleCall(_QVTcoreBase.PR_QueryCS))))));
		}
		...
		private static @NonNull Grammar initGrammar() {
			...
			}
			{
				...
				rules.add(PR_ImperativePredicateOrAssignmentCS);
				...
				rules.add(PR_MiddleGuardPatternCS);
				rules.add(PR_TargetDomainCS);
				rules.add(PR_TargetBottomPatternCS);
				rules.add(PR_TargetGuardPatternCS);
			}
			{
				List<Grammar> usedGrammars = grammar.getUsedGrammars();
				usedGrammars.add(G_QVTcoreBase);
			}
			return grammar;
		}
	}
	
	private static class _QVTcoreBase
	{
		private static final @NonNull ReferencedMetamodel MM = createReferencedMetamodel(org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.eINSTANCE, null); // http://www.eclipse.org/qvt/2015/QVTcoreBaseCS
		private static final @NonNull ReferencedMetamodel MM_base = createReferencedMetamodel(org.eclipse.ocl.xtext.basecs.BaseCSPackage.eINSTANCE, "base"); // http://www.eclipse.org/ocl/2015/BaseCS
		private static final @NonNull ReferencedMetamodel MM_ecore = createReferencedMetamodel(org.eclipse.emf.ecore.EcorePackage.eINSTANCE, "ecore"); // http://www.eclipse.org/emf/2002/Ecore
		private static final @NonNull ReferencedMetamodel MM_essentialocl = createReferencedMetamodel(org.eclipse.ocl.xtext.essentialoclcs.EssentialOCLCSPackage.eINSTANCE, "essentialocl"); // http://www.eclipse.org/ocl/2015/EssentialOCLCS
		private static final @NonNull ReferencedMetamodel MM_pivot = createReferencedMetamodel(org.eclipse.ocl.pivot.PivotPackage.eINSTANCE, "pivot"); // http://www.eclipse.org/ocl/2015/Pivot
		...
		private static final @NonNull ParserRule PR_DirectionCS = createParserRule("DirectionCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.DIRECTION_CS));
		private static final @NonNull ParserRule PR_GuardPatternCS = createParserRule("GuardPatternCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.GUARD_PATTERN_CS));
		private static final @NonNull ParserRule PR_GuardVariableCS = createParserRule("GuardVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.UNREALIZED_VARIABLE_CS));
		...
		private static final @NonNull ParserRule PR_NamedDomainCS = createParserRule("NamedDomainCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.DOMAIN_CS));
		...
		private static final @NonNull ParserRule PR_TransformationCS = createParserRule("TransformationCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.TRANSFORMATION_CS));
		private static final @NonNull ParserRule PR_UnnamedDomainCS = createParserRule("UnnamedDomainCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.DOMAIN_CS));
		private static final @NonNull ParserRule PR_UnrealizedVariableCS = createParserRule("UnrealizedVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.UNREALIZED_VARIABLE_CS));
		...
		private static void initParserRules() {
			PR_BottomPatternCS.setAlternatives(createAlternatives(createGroup(createKeyword("{"), createAlternatives(createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(PR_UnrealizedVariableCS)), createAssignment("ownedRealizedVariables", "+=", createRuleCall(_QVTimperative.PR_RealizedVariableCS))), setCardinality("*", createGroup(createKeyword(","), createAlternatives(createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(PR_UnrealizedVariableCS)), createAssignment("ownedRealizedVariables", "+=", createRuleCall(_QVTimperative.PR_RealizedVariableCS))))), createKeyword("|"), setCardinality("*", createAssignment("ownedConstraints", "+=", createRuleCall(PR_PredicateOrAssignmentCS))), createKeyword("}")), createGroup(createKeyword("{"), createAlternatives(createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(PR_UnrealizedVariableCS)), createAssignment("ownedRealizedVariables", "+=", createRuleCall(_QVTimperative.PR_RealizedVariableCS))), setCardinality("*", createGroup(createKeyword(","), createAlternatives(createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(PR_UnrealizedVariableCS)), createAssignment("ownedRealizedVariables", "+=", createRuleCall(_QVTimperative.PR_RealizedVariableCS))))), createKeyword("}")), createGroup(createKeyword("{"), setCardinality("+", createAssignment("ownedConstraints", "+=", createRuleCall(PR_PredicateOrAssignmentCS))), createKeyword("}")), createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.BOTTOM_PATTERN_CS)), createKeyword("{"), createKeyword("}"))));
			...
			PR_TransformationCS.setAlternatives(createGroup(createKeyword("transformation"), setCardinality("?", createAssignment("ownedPathName", "=", createRuleCall(PR_ScopeNameCS))), createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnreservedName)), createKeyword("{"), setCardinality("*", createGroup(createAssignment("ownedDirections", "+=", createRuleCall(_QVTimperative.PR_DirectionCS)), createKeyword(";"))), createKeyword("}")));
			PR_UnnamedDomainCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.DOMAIN_CS)), createAssignment("ownedGuardPattern", "=", createRuleCall(PR_GuardPatternCS)), createAssignment("ownedBottomPattern", "=", createRuleCall(PR_BottomPatternCS))));
	...
	private static class _QVTbase
	{
		...
		private static void initParserRules() {
			...
			PR_StructuredClassCS.setAlternatives(createGroup(setCardinality("?", createAssignment("isAbstract", "?=", createKeyword("abstract"))), createKeyword("class"), createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(_Base.PR_TemplateSignatureCS))), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedSuperTypes", "+=", createRuleCall(_Base.PR_TypedRefCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedSuperTypes", "+=", createRuleCall(_Base.PR_TypedRefCS)))))), setCardinality("?", createGroup(createKeyword(":"), createAssignment("instanceClassName", "=", createRuleCall(_Base.TR_SINGLE_QUOTED_STRING)))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createAssignment("isInterface", "?=", createKeyword("interface"))), createKeyword("}"))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedOperations", "+=", createRuleCall(PR_OperationCS)), createAssignment("ownedProperties", "+=", createRuleCall(PR_StructuralFeatureCS)))), createKeyword("}")), createKeyword(";"))));
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_EssentialOCLUnreservedName.setAlternatives(createAlternatives(createRuleCall(_QVTcoreBase.PR_UnrestrictedName), createRuleCall(PR_CollectionTypeIdentifier), createRuleCall(PR_PrimitiveTypeIdentifier), createKeyword("Map"), createKeyword("Tuple")));
			...
			PR_LetVariableCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createAssignment("ownedRoundBracketedClause", "=", createRuleCall(PR_RoundBracketedClauseCS))), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))), createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))));
			...
			PR_PatternExpCS.setAlternatives(createGroup(setCardinality("?", createAssignment("patternVariableName", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), createKeyword(":"), createAssignment("ownedPatternType", "=", createRuleCall(PR_TypeExpCS))));
			...
			PR_TupleLiteralPartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))), createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS))));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			PR_FirstPathElementCS.setAlternatives(createAssignment("referredElement", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.NAMED_ELEMENT), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))));
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(PR_TypedRefCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(PR_TypedRefCS))))))));
			...
			PR_UnreservedName.setAlternatives(createRuleCall(_QVTcoreBase.PR_UnrestrictedName));
