...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static void initParserRules() {
			...
			PR_GuardStatementCS.setAlternatives(createAlternatives(createRuleCall(PR_BufferStatementCS), createRuleCall(PR_DeclareStatementCS), createRuleCall(PR_DeclareStatementCS), createRuleCall(PR_CheckStatementCS)));
			...
			PR_QVTimperativeUnrestrictedName.setAlternatives(createAlternatives(createKeyword("add"), createKeyword("append"), createKeyword("appendsTo"), createKeyword("buffer"), createKeyword("call"), createKeyword("check"), createKeyword("contained"), createKeyword("entry"), createKeyword("for"), createKeyword("implementedby"), createKeyword("imports"), createKeyword("input"), createKeyword("install"), createKeyword("invoke"), createKeyword("iterates"), createKeyword("map"), createKeyword("new"), createKeyword("notify"), createKeyword("observe"), createKeyword("output"), createKeyword("package"), createKeyword("query"), createKeyword("set"), createKeyword("strict"), createKeyword("success"), createKeyword("target"), createKeyword("transformation"), createKeyword("transient"), createKeyword("uses"), createKeyword("var"), createKeyword("via")));
