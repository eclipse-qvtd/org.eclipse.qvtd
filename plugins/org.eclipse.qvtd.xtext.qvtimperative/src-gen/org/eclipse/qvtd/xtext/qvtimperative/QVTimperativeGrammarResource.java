...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static void initParserRules() {
			...
			PR_GuardStatementCS.setAlternatives(createAlternatives(createRuleCall(PR_OutVariableCS), createRuleCall(PR_DeclareStatementCS), createRuleCall(PR_DeclareStatementCS), createRuleCall(PR_CheckStatementCS), createRuleCall(PR_IfStatementCS)));
