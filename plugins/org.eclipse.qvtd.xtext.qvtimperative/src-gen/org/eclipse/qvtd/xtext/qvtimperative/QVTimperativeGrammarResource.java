...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static final @NonNull ParserRule PR_AddStatementCS = createParserRule("AddStatementCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.CONNECTION_STATEMENT_CS));
		...
		private static final @NonNull ParserRule PR_RealizedVariableCS = createParserRule("RealizedVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.REALIZED_VARIABLE_CS));
		...
		private static void initParserRules() {
			...
			PR_BottomStatementCS.setAlternatives(createRuleCall(PR_SetStatementCS));
			...
			PR_PredicateOrAssignmentCS.setAlternatives(createGroup(createAssignment("ownedTarget", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), setCardinality("?", createGroup(createKeyword(":="), createAssignment("ownedInitExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)))), createKeyword(";")));
