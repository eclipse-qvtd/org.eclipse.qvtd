...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static final @NonNull ParserRule PR_PredicateVariableCS = createParserRule("PredicateVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.PREDICATE_VARIABLE_CS));
		...
		private static void initParserRules() {
			...
			PR_PredicateVariableCS.setAlternatives(createGroup(createAlternatives(createKeyword("var"), createAssignment("isChecked", "?=", createKeyword("check"))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)))), createKeyword(":="), createAssignment("ownedInit", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
		...
		private static @NonNull Grammar initGrammar() {
			...
			}
			{
				...
				rules.add(PR_PredicateVariableCS);
