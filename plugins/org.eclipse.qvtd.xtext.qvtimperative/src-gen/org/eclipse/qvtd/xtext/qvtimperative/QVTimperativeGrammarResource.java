...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static void initParserRules() {
			...
			PR_AppendParameterCS.setAlternatives(createGroup(createKeyword("append"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), createKeyword(";")));
			PR_BufferStatementCS.setAlternatives(createGroup(setCardinality("?", createAssignment("isStrict", "?=", createKeyword("strict"))), createKeyword("buffer"), setCardinality("?", createGroup(createKeyword(":"), createAssignment("firstPass", "=", createRuleCall(_Base.PR_LOWER)), setCardinality("?", createGroup(createKeyword(".."), createAssignment("lastPass", "=", createRuleCall(_Base.PR_LOWER)))))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)))), setCardinality("?", createGroup(createKeyword(":="), createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)))), createKeyword(";")));
			PR_CheckStatementCS.setAlternatives(createGroup(setCardinality("?", createGroup(createKeyword("observe"), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("check"), createAssignment("ownedCondition", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			PR_CommitStatementCS.setAlternatives(createAlternatives(createRuleCall(PR_NewStatementCS), createRuleCall(PR_SetStatementCS)));
			PR_ControlStatementCS.setAlternatives(createAlternatives(createRuleCall(PR_AddStatementCS), createRuleCall(PR_MappingCallCS), createRuleCall(PR_MappingLoopCS)));
			PR_DeclareStatementCS.setAlternatives(createGroup(setCardinality("?", createGroup(createKeyword("observe"), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), setCardinality("?", createAssignment("isCheck", "?=", createKeyword("check"))), createKeyword("var"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)))), createKeyword(":="), createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			PR_DirectionCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.DIRECTION_CS)), setCardinality("?", createAssignment("name", "=", createRuleCall(_Base.PR_Identifier))), setCardinality("?", createGroup(createKeyword("imports"), createAssignment("imports", "+=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PACKAGE), createRuleCall(PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("imports", "+=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PACKAGE), createRuleCall(PR_UnrestrictedName)))))))));
			PR_EntryPointCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.ENTRY_POINT_CS)), setCardinality("?", createAssignment("isStrict", "?=", createKeyword("strict"))), createKeyword("entry"), setCardinality("?", createGroup(createKeyword(":"), createAssignment("targetName", "=", createRuleCall(PR_UnrestrictedName)))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("input"), createAssignment("inputTypedModels", "+=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("inputTypedModels", "+=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(PR_UnrestrictedName))))))), setCardinality("?", createGroup(createKeyword("output"), createAssignment("outputTypedModels", "+=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("outputTypedModels", "+=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(PR_UnrestrictedName))))))), createKeyword("{"), setCardinality("*", createAssignment("ownedParameters", "+=", createRuleCall(PR_MappingParameterCS))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_GuardStatementCS))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_CommitStatementCS))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_ControlStatementCS))), createKeyword("}")));
			PR_GuardParameterBindingCS.setAlternatives(createGroup(setCardinality("?", createAssignment("isCheck", "?=", createKeyword("check"))), createAssignment("referredVariable", "=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.GUARD_PARAMETER), createRuleCall(PR_UnrestrictedName))), createKeyword("consumes"), createAssignment("value", "=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.CONNECTION_VARIABLE), createRuleCall(PR_UnrestrictedName))), createKeyword(";")));
			PR_GuardParameterCS.setAlternatives(createGroup(createKeyword("guard"), createKeyword(":"), createAssignment("referredTypedModel", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword("success"), createAssignment("successProperty", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PROPERTY), createRuleCall(PR_UnrestrictedName))))), createKeyword(";")));
			PR_GuardStatementCS.setAlternatives(createAlternatives(createRuleCall(PR_BufferStatementCS), createRuleCall(PR_DeclareStatementCS), createRuleCall(PR_DeclareStatementCS), createRuleCall(PR_CheckStatementCS), createRuleCall(PR_SpeculateStatementCS)));
			...
			PR_MappingLoopCS.setAlternatives(createGroup(setCardinality("?", createGroup(createKeyword("observe"), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("for"), createAssignment("ownedIterator", "=", createRuleCall(PR_MappingIteratorCS)), createKeyword("in"), createAssignment("ownedInExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword("{"), setCardinality("+", createAssignment("ownedMappingStatements", "+=", createRuleCall(PR_ControlStatementCS))), createKeyword("}")));
			PR_MappingParameterBindingCS.setAlternatives(createAlternatives(createRuleCall(PR_AppendParameterBindingCS), createRuleCall(PR_GuardParameterBindingCS), createRuleCall(PR_LoopParameterBindingCS), createRuleCall(PR_SimpleParameterBindingCS)));
			PR_MappingParameterCS.setAlternatives(createAlternatives(createRuleCall(PR_AppendParameterCS), createRuleCall(PR_GuardParameterCS), createRuleCall(PR_SimpleParameterCS)));
			PR_NewStatementCS.setAlternatives(createGroup(setCardinality("?", createGroup(createKeyword("observe"), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), setCardinality("?", createAssignment("isContained", "?=", createKeyword("contained"))), createKeyword("new"), createKeyword(":"), createAssignment("referredTypedModel", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword(":="), createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)))), createKeyword(";")));
			...
			PR_QVTimperativeUnrestrictedName.setAlternatives(createAlternatives(createKeyword("add"), createKeyword("append"), createKeyword("appendsTo"), createKeyword("buffer"), createKeyword("call"), createKeyword("check"), createKeyword("contained"), createKeyword("entry"), createKeyword("for"), createKeyword("implementedby"), createKeyword("imports"), createKeyword("input"), createKeyword("install"), createKeyword("invoke"), createKeyword("iterates"), createKeyword("map"), createKeyword("new"), createKeyword("notify"), createKeyword("observe"), createKeyword("output"), createKeyword("package"), createKeyword("query"), createKeyword("set"), createKeyword("speculate"), createKeyword("strict"), createKeyword("success"), createKeyword("target"), createKeyword("transformation"), createKeyword("transient"), createKeyword("uses"), createKeyword("var"), createKeyword("via")));
			...
			PR_SetStatementCS.setAlternatives(createGroup(setCardinality("?", createGroup(createKeyword("observe"), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), setCardinality("?", createAssignment("isNotify", "?=", createKeyword("notify"))), createKeyword("set"), createAssignment("referredVariable", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.VARIABLE_DECLARATION), createRuleCall(PR_UnrestrictedName))), createKeyword("."), createAssignment("referredProperty", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PROPERTY), createRuleCall(PR_UnrestrictedName))), createAlternatives(createKeyword(":="), createAssignment("isPartial", "?=", createKeyword("+="))), createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			PR_SimpleParameterBindingCS.setAlternatives(createGroup(setCardinality("?", createAssignment("isCheck", "?=", createKeyword("check"))), createAssignment("referredVariable", "=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.SIMPLE_PARAMETER), createRuleCall(PR_UnrestrictedName))), createKeyword("uses"), createAssignment("ownedValue", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			PR_SimpleParameterCS.setAlternatives(createGroup(createKeyword("in"), createKeyword(":"), createAssignment("referredTypedModel", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), createKeyword(";")));
			PR_SpeculateStatementCS.setAlternatives(createGroup(createKeyword("speculate"), createAssignment("ownedConditions", "+=", createRuleCall(_EssentialOCL.PR_ExpCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedConditions", "+=", createRuleCall(_EssentialOCL.PR_ExpCS)))), createKeyword(";")));
			PR_TopLevelCS.setAlternatives(createGroup(setCardinality("*", createAssignment("ownedImports", "+=", createRuleCall(PR_ImportCS))), setCardinality("*", createAlternatives(createAssignment("ownedPackages", "+=", createRuleCall(PR_QualifiedPackageCS)), createAssignment("ownedTransformations", "+=", createRuleCall(PR_TransformationCS))))));
			PR_TransformationCS.setAlternatives(createGroup(createKeyword("transformation"), setCardinality("?", createAssignment("ownedPathName", "=", createRuleCall(PR_ScopeNameCS))), createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnreservedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedContextType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)))), createKeyword("{"), setCardinality("*", createGroup(createAssignment("ownedDirections", "+=", createRuleCall(PR_DirectionCS)), createKeyword(";"))), setCardinality("*", createAlternatives(createAssignment("ownedMappings", "+=", createAlternatives(createRuleCall(PR_EntryPointCS), createRuleCall(PR_MappingCS))), createAssignment("ownedQueries", "+=", createRuleCall(PR_QueryCS)))), createKeyword("}")));
			PR_UnrestrictedName.setAlternatives(createAlternatives(createRuleCall(_EssentialOCL.PR_EssentialOCLUnrestrictedName), createRuleCall(_QVTbase.PR_QVTbaseUnrestrictedName), createRuleCall(PR_QVTimperativeUnrestrictedName)));
		}
	...
	private static class _QVTbase
	{
		...
		private static void initParserRules() {
			...
			PR_StructuredClassCS.setAlternatives(createGroup(setCardinality("?", createAssignment("isAbstract", "?=", createKeyword("abstract"))), createKeyword("class"), createAssignment("name", "=", createRuleCall(_QVTimperative.PR_UnrestrictedName)), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(_Base.PR_TemplateSignatureCS))), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedSuperTypes", "+=", createRuleCall(PR_TypedRefCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedSuperTypes", "+=", createRuleCall(PR_TypedRefCS)))))), setCardinality("?", createGroup(createKeyword(":"), createAssignment("instanceClassName", "=", createRuleCall(_Base.TR_SINGLE_QUOTED_STRING)))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createAssignment("isInterface", "?=", createKeyword("interface"))), createKeyword("}"))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedOperations", "+=", createRuleCall(PR_OperationCS)), createAssignment("ownedProperties", "+=", createRuleCall(PR_StructuralFeatureCS)))), createKeyword("}")), createKeyword(";"))));
			PR_TargetCS.setAlternatives(createGroup(createKeyword("target"), createAssignment("name", "=", createRuleCall(_QVTimperative.PR_UnrestrictedName)), createKeyword("{"), setCardinality("*", createAssignment("ownedTargetElements", "+=", createAlternatives(createRuleCall(PR_SimpleTargetElementCS), createRuleCall(PR_CompoundTargetElementCS)))), createKeyword("}"), setCardinality("?", createKeyword(";"))));
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_CoIteratorVariableCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTimperative.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS))))));
			...
			PR_EssentialOCLUnreservedName.setAlternatives(createAlternatives(createRuleCall(_QVTimperative.PR_UnrestrictedName), createRuleCall(PR_CollectionTypeIdentifier), createRuleCall(PR_PrimitiveTypeIdentifier), createKeyword("Map"), createKeyword("Tuple")));
			...
			PR_PatternExpCS.setAlternatives(createGroup(setCardinality("?", createAssignment("patternVariableName", "=", createRuleCall(_QVTimperative.PR_UnrestrictedName))), createKeyword(":"), createAssignment("ownedPatternType", "=", createRuleCall(PR_TypeExpCS))));
			...
			PR_TupleLiteralPartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTimperative.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))), createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTimperative.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS))));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTimperative.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_QVTbase.PR_TypedRefCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_QVTbase.PR_TypedRefCS))))))));
			PR_TypeRefCS.setAlternatives(createAlternatives(createRuleCall(_QVTbase.PR_TypedRefCS), createRuleCall(PR_WildcardTypeRefCS)));
			...
			PR_UnreservedName.setAlternatives(createRuleCall(_QVTimperative.PR_UnrestrictedName));
			PR_UnrestrictedName.setAlternatives(createRuleCall(PR_Identifier));
			PR_WildcardTypeRefCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS)), createKeyword("?"), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "=", createRuleCall(_QVTbase.PR_TypedRefCS))))));
		}
