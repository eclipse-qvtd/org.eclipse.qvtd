...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static final @NonNull ParserRule PR_AccessStatementCS = createParserRule("AccessStatementCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.ACCESS_STATEMENT_CS));
		...
		private static final @NonNull ParserRule PR_GuardVariableCS = createParserRule("GuardVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.GUARD_VARIABLE_CS));
		private static final @NonNull ParserRule PR_IfStatementCS = createParserRule("IfStatementCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.IF_STATEMENT_CS));
		...
		private static final @NonNull ParserRule PR_InitializeStatementCS = createParserRule("InitializeStatementCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.INITIALIZE_STATEMENT_CS));
		private static final @NonNull ParserRule PR_InoutVariableCS = createParserRule("InoutVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.INOUT_VARIABLE_CS));
		...
		private static final @NonNull ParserRule PR_OutVariableCS = createParserRule("OutVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.OUT_VARIABLE_CS));
		...
		private static void initParserRules() {
			PR_AccessStatementCS.setAlternatives(createGroup(createKeyword("access"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)))), createKeyword(":="), createAssignment("sourceVariable", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.VARIABLE_DECLARATION), createRuleCall(PR_UnrestrictedName))), createKeyword("."), createAssignment("sourceProperty", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PROPERTY), createRuleCall(PR_UnrestrictedName))), createKeyword(";")));
			PR_AddStatementCS.setAlternatives(createGroup(createKeyword("add"), createAssignment("targetVariable", "=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.CONNECTION_VARIABLE), createRuleCall(PR_UnrestrictedName))), createKeyword("+="), createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			...
			PR_DeclareStatementCS.setAlternatives(createGroup(setCardinality("?", createAssignment("isChecked", "?=", createKeyword("check"))), createKeyword("var"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)))), setCardinality("?", createGroup(createKeyword(":="), createAssignment("ownedInit", "=", createRuleCall(_EssentialOCL.PR_ExpCS)))), createKeyword(";")));
			...
			PR_GuardStatementCS.setAlternatives(createAlternatives(createRuleCall(PR_OutVariableCS), createRuleCall(PR_DeclareStatementCS), createRuleCall(PR_DeclareStatementCS), createRuleCall(PR_InitializeStatementCS), createRuleCall(PR_CheckStatementCS), createRuleCall(PR_AccessStatementCS), createRuleCall(PR_IfStatementCS)));
			PR_GuardVariableCS.setAlternatives(createGroup(createKeyword("in"), createKeyword(":"), createAssignment("referredTypedModel", "=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.IMPERATIVE_TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), createKeyword(";")));
			PR_IfStatementCS.setAlternatives(createGroup(createKeyword("if"), createAssignment("ownedCondition", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword("{"), setCardinality("*", createAssignment("ownedThenStatements", "+=", createRuleCall(PR_GuardStatementCS))), createKeyword("}"), setCardinality("?", createGroup(createKeyword("else"), createKeyword("{"), setCardinality("*", createAssignment("ownedThenStatements", "+=", createRuleCall(PR_GuardStatementCS))), createKeyword("}")))));
			...
			PR_InitializeStatementCS.setAlternatives(createGroup(setCardinality("?", createAssignment("isChecked", "?=", createKeyword("check"))), createKeyword("init"), createAssignment("targetVariable", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.VARIABLE_DECLARATION), createRuleCall(PR_UnrestrictedName))), createKeyword(":="), createAssignment("ownedInit", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			PR_InoutVariableCS.setAlternatives(createGroup(createKeyword("inout"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), createKeyword(";")));
			PR_MappingCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.MAPPING_CS)), createKeyword("map"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("in"), createAssignment("ownedInPathName", "=", createRuleCall(_Base.PR_PathNameCS)))), createKeyword("{"), setCardinality("*", createAssignment("ownedDomains", "+=", createAlternatives(createRuleCall(PR_SourceDomainCS), createRuleCall(PR_TargetDomainCS)))), setCardinality("*", createAlternatives(createAssignment("ownedGuardVariables", "+=", createRuleCall(PR_GuardVariableCS)), createAssignment("ownedInoutVariables", "+=", createRuleCall(PR_InoutVariableCS)))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_GuardStatementCS))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_CommitStatementCS))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_ControlStatementCS))), createKeyword("}")));
			...
			PR_OutVariableCS.setAlternatives(createGroup(createKeyword("out"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), createKeyword(";")));
			...
			PR_SetStatementCS.setAlternatives(createGroup(createAlternatives(createKeyword("set"), createAssignment("isEmit", "?=", createKeyword("emit"))), createAssignment("referredVariable", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.VARIABLE_DECLARATION), createRuleCall(PR_UnrestrictedName))), createKeyword("."), createAssignment("referredProperty", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PROPERTY), createRuleCall(PR_UnrestrictedName))), createKeyword(":="), createAssignment("ownedInit", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			PR_SourceDomainCS.setAlternatives(createGroup(createAssignment("isCheck", "?=", createKeyword("check")), createAssignment("direction", "=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.IMPERATIVE_TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createGroup(createKeyword("check"), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("}"))), createKeyword("("), createKeyword(")"), createKeyword("{"), createKeyword("}")));
		...
		private static @NonNull Grammar initGrammar() {
			...
			}
			{
				...
				rules.add(PR_AccessStatementCS);
				...
				rules.add(PR_IfStatementCS);
				rules.add(PR_ImportCS);
				rules.add(PR_InitializeStatementCS);
				rules.add(PR_InoutVariableCS);
