...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static void initParserRules() {
			...
			PR_EntryPointCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.ENTRY_POINT_CS)), setCardinality("?", createAssignment("isStrict", "?=", createKeyword("strict"))), createKeyword("entry"), setCardinality("?", createGroup(createKeyword(":"), createAssignment("firstPass", "=", createRuleCall(_Base.PR_LOWER)), setCardinality("?", createGroup(createKeyword(".."), createAssignment("lastPass", "=", createRuleCall(_Base.PR_LOWER)))))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("check"), createAssignment("checkedDirections", "+=", createRuleCall(PR_DirectionCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("checkedDirections", "+=", createRuleCall(PR_DirectionCS)))))), setCardinality("?", createGroup(createKeyword("enforce"), createAssignment("enforcedDirections", "+=", createRuleCall(PR_DirectionCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("enforcedDirections", "+=", createRuleCall(PR_DirectionCS)))))), setCardinality("?", createGroup(createKeyword("in"), createAssignment("ownedInPathName", "=", createRuleCall(_Base.PR_PathNameCS)))), createKeyword("{"), setCardinality("*", createAssignment("ownedParameters", "+=", createRuleCall(PR_MappingParameterCS))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_GuardStatementCS))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_CommitStatementCS))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_ControlStatementCS))), createKeyword("}")));
			...
			PR_QVTimperativeUnrestrictedName.setAlternatives(createAlternatives(createKeyword("add"), createKeyword("append"), createKeyword("appendsTo"), createKeyword("buffer"), createKeyword("call"), createKeyword("check"), createKeyword("contained"), createKeyword("enforce"), createKeyword("for"), createKeyword("implementedby"), createKeyword("imports"), createKeyword("install"), createKeyword("invoke"), createKeyword("iterates"), createKeyword("map"), createKeyword("new"), createKeyword("notify"), createKeyword("observe"), createKeyword("package"), createKeyword("query"), createKeyword("set"), createKeyword("strict"), createKeyword("success"), createKeyword("transformation"), createKeyword("transient"), createKeyword("uses"), createKeyword("var")));
