...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static final @NonNull ParserRule PR_MiddleDomainCS = createParserRule("MiddleDomainCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.DOMAIN_CS));
		...
		private static final @NonNull ParserRule PR_SourceDomainCS = createParserRule("SourceDomainCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.DOMAIN_CS));
		...
		private static final @NonNull ParserRule PR_TargetDomainCS = createParserRule("TargetDomainCS", createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.DOMAIN_CS));
		...
		private static void initParserRules() {
			...
			PR_MappingCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.MAPPING_CS)), setCardinality("?", createAssignment("isDefault", "?=", createKeyword("default"))), createKeyword("map"), createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("in"), createAssignment("ownedInPathName", "=", createRuleCall(_Base.PR_PathNameCS)))), createKeyword("{"), setCardinality("*", createAssignment("ownedDomains", "+=", createAlternatives(createRuleCall(PR_SourceDomainCS), createRuleCall(PR_TargetDomainCS)))), setCardinality("?", createGroup(createKeyword("where"), createAssignment("ownedMiddle", "=", createRuleCall(PR_MiddleDomainCS)))), setCardinality("?", createAssignment("ownedMappingSequence", "=", createRuleCall(PR_MappingSequenceCS))), createKeyword("}")));
			...
			PR_MappingCallCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.MAPPING_CALL_CS)), setCardinality("?", createAssignment("isInfinite", "?=", createKeyword("infinite"))), createKeyword("call"), createAssignment("referredMapping", "=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.MAPPING), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), createKeyword("{"), setCardinality("*", createAssignment("ownedBindings", "+=", createRuleCall(PR_MappingCallBindingCS))), createKeyword("}")));
			PR_MappingIteratorCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_ComplexTypeCS))))));
			...
			PR_SourceDomainCS.setAlternatives(createGroup(createAssignment("isCheck", "?=", createKeyword("check")), createAssignment("direction", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), createAssignment("ownedGuardPattern", "=", createRuleCall(PR_SourceGuardPatternCS)), createAssignment("ownedBottomPattern", "=", createRuleCall(PR_SourceBottomPatternCS))));
			...
			PR_TargetBottomPatternCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.BOTTOM_PATTERN_CS)), createKeyword("{"), setCardinality("?", createGroup(createAssignment("ownedRealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_RealizedVariableCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedRealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_RealizedVariableCS)))))), createKeyword("}")));
			PR_TargetDomainCS.setAlternatives(createGroup(createAssignment("isEnforce", "?=", createKeyword("enforce")), createAssignment("direction", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), createAssignment("ownedGuardPattern", "=", createRuleCall(PR_TargetGuardPatternCS)), createAssignment("ownedBottomPattern", "=", createRuleCall(PR_TargetBottomPatternCS))));
	...
	private static class _QVTcoreBase
	{
		...
		private static void initParserRules() {
			...
			PR_GuardVariableCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_ComplexTypeCS))));
			...
			PR_ParamDeclarationCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_ComplexTypeCS))));
	...
	private static class _EssentialOCL
	{
		...
		private static final @NonNull ParserRule PR_CollectionTypeWithMultiplicityCS = createParserRule("CollectionTypeWithMultiplicityCS", createTypeRef(MM, org.eclipse.ocl.xtext.essentialoclcs.EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS));
		private static final @NonNull ParserRule PR_ComplexTypeCS = createParserRule("ComplexTypeCS", createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.TYPED_REF_CS));
		...
		private static final @NonNull ParserRule PR_IfThenExpCS = createParserRule("IfThenExpCS", createTypeRef(MM, org.eclipse.ocl.xtext.essentialoclcs.EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS));
		...
		private static final @NonNull ParserRule PR_PathExpCS = createParserRule("PathExpCS", createTypeRef(MM, org.eclipse.ocl.xtext.essentialoclcs.EssentialOCLCSPackage.Literals.PATH_EXP_CS));
		...
		private static void initParserRules() {
			...
			PR_CollectionLiteralExpCS.setAlternatives(createGroup(createAssignment("ownedType", "=", createRuleCall(PR_CollectionTypeWithMultiplicityCS)), createKeyword("{"), setCardinality("?", createGroup(createAssignment("ownedParts", "+=", createRuleCall(PR_CollectionLiteralPartCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParts", "+=", createRuleCall(PR_CollectionLiteralPartCS)))))), createKeyword("}")));
			...
			PR_CollectionTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_CollectionTypeIdentifier)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS)), createKeyword(")")))));
			...
			PR_CollectionTypeWithMultiplicityCS.setAlternatives(createGroup(createRuleCall(PR_CollectionTypeCS), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS)))));
			PR_ComplexTypeCS.setAlternatives(createAlternatives(createRuleCall(PR_TypeLiteralWithMultiplicityCS), createGroup(createRuleCall(_Base.PR_PathTypeCS), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS))))));
			PR_CurlyBracketedClauseCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.ocl.xtext.essentialoclcs.EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS)), createKeyword("{"), setCardinality("?", createAlternatives(createAssignment("value", "=", createRuleCall(_Base.PR_StringLiteral)), createGroup(createAssignment("ownedParts", "+=", createRuleCall(PR_ShadowPartCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParts", "+=", createRuleCall(PR_ShadowPartCS))))))), createKeyword("}")));
			...
			PR_IfExpCS.setAlternatives(createGroup(createKeyword("if"), createAssignment("ownedIfThenExpressions", "+=", createRuleCall(PR_IfThenExpCS)), setCardinality("*", createGroup(createKeyword("elseif"), createAssignment("ownedIfThenExpressions", "+=", createRuleCall(PR_IfThenExpCS)))), createKeyword("else"), createAssignment("ownedElseExpression", "=", createRuleCall(PR_ExpCS)), createKeyword("endif")));
			PR_IfThenExpCS.setAlternatives(createGroup(setCardinality("?", createGroup(createAssignment("ownedPattern", "=", createRuleCall(PR_PatternExpCS)), createKeyword("="))), createAssignment("ownedCondition", "=", createRuleCall(PR_ExpCS)), createKeyword("then"), createAssignment("ownedThenExpression", "=", createRuleCall(PR_ExpCS))));
			...
			PR_LambdaLiteralExpCS.setAlternatives(createGroup(createAssignment("name", "=", createKeyword("Lambda")), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedParameters", "+=", createRuleCall(PR_LambdaParameterCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParameters", "+=", createRuleCall(PR_LambdaParameterCS)))))), createKeyword(")"), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS)), createKeyword("{"), createAssignment("ownedExpression", "=", createRuleCall(PR_ExpCS)), createKeyword("}")));
			PR_LambdaParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS))));
			PR_LambdaTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createKeyword("Lambda")), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(_Base.PR_TemplateSignatureCS))), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedParameterTypes", "+=", createRuleCall(PR_ComplexTypeCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParameterTypes", "+=", createRuleCall(PR_ComplexTypeCS)))))), createKeyword(")"), createKeyword(":"), createAssignment("ownedResultType", "=", createRuleCall(PR_ComplexTypeCS))));
			...
			PR_MapTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createKeyword("Map")), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedKeyType", "=", createRuleCall(PR_ComplexTypeCS)), createKeyword(","), createAssignment("ownedValueType", "=", createRuleCall(PR_ComplexTypeCS)), createKeyword(")")))));
			...
			PR_PathExpCS.setAlternatives(createGroup(createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedBinding", "=", createRuleCall(_Base.PR_TemplateBindingCS)), createKeyword(")"))), setCardinality("?", createGroup(createAssignment("ownedCurlyBracketedClause", "=", createRuleCall(PR_CurlyBracketedClauseCS)), setCardinality("?", createGroup(createKeyword("{"), createAssignment("ownedPatternGuard", "=", createRuleCall(PR_ExpCS)), createKeyword("}"))))), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS)))));
			...
			PR_TupleLiteralPartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS)))), createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_ComplexTypeCS))));
			...
			PR_TypeExpCS.setAlternatives(createAlternatives(createRuleCall(PR_PathExpCS), createRuleCall(PR_TypeLiteralWithMultiplicityCS), createRuleCall(PR_CollectionPatternCS)));
			...
			PR_TypeLiteralWithMultiplicityCS.setAlternatives(createAlternatives(createRuleCall(PR_CollectionTypeWithMultiplicityCS), createRuleCall(PR_LambdaTypeCS), createGroup(createAlternatives(createRuleCall(PR_PrimitiveTypeCS), createRuleCall(PR_MapTypeCS), createRuleCall(PR_TupleTypeCS)), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS))))));
		...
		private static @NonNull Grammar initGrammar() {
			...
			}
			{
				...
				rules.add(PR_CollectionTypeWithMultiplicityCS);
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_EssentialOCL.PR_SimpleTypeCS))))))));
			...
			PR_WildcardTypeRefCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS)), createKeyword("?"), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "=", createRuleCall(_EssentialOCL.PR_SimpleTypeCS))))));
		}
