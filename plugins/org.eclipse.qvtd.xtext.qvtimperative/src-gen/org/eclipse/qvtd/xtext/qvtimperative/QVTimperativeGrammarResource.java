...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static void initParserRules() {
			...
			PR_QVTimperativeUnrestrictedName.setAlternatives(createAlternatives(createKeyword("add"), createKeyword("append"), createKeyword("appendsTo"), createKeyword("buffer"), createKeyword("call"), createKeyword("check"), createKeyword("contained"), createKeyword("enforce"), createKeyword("for"), createKeyword("imports"), createKeyword("install"), createKeyword("invoke"), createKeyword("iterates"), createKeyword("map"), createKeyword("new"), createKeyword("notify"), createKeyword("observe"), createKeyword("package"), createKeyword("query"), createKeyword("set"), createKeyword("strict"), createKeyword("success"), createKeyword("transformation"), createKeyword("transient"), createKeyword("uses"), createKeyword("var")));
