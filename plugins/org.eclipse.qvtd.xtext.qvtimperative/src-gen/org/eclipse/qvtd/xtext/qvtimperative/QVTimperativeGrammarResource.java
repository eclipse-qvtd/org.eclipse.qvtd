...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static void initParserRules() {
			...
			PR_GuardStatementCS.setAlternatives(createAlternatives(createRuleCall(PR_BufferStatementCS), createRuleCall(PR_CheckStatementCS), createRuleCall(PR_DeclareStatementCS), createRuleCall(PR_IfStatementCS)));
			PR_IfStatementCS.setAlternatives(createGroup(setCardinality("?", createGroup(createKeyword("observe"), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("if"), createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword("then"), createKeyword("{"), setCardinality("*", createAssignment("ownedThenStatements", "+=", createRuleCall(PR_GuardStatementCS))), createKeyword("}"), createKeyword("else"), createKeyword("{"), setCardinality("*", createAssignment("ownedElseStatements", "+=", createRuleCall(PR_GuardStatementCS))), createKeyword("}")));
			...
			PR_NewStatementCS.setAlternatives(createGroup(setCardinality("?", createGroup(createKeyword("observe"), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("observedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("new"), createKeyword(":"), createAssignment("referredTypedModel", "=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.IMPERATIVE_TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword(":="), createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)))), createKeyword(";")));
