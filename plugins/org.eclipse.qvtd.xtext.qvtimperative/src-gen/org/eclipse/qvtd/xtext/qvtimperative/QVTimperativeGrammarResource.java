...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static void initParserRules() {
			...
			PR_MappingCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.MAPPING_CS)), setCardinality("?", createAssignment("isDefault", "?=", createKeyword("default"))), createKeyword("map"), createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("in"), createAssignment("ownedInPathName", "=", createRuleCall(_Base.PR_PathNameCS)))), setCardinality("?", createGroup(createKeyword("uses"), createAssignment("ownedUsesPathNames", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedUsesPathNames", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("{"), setCardinality("*", createAssignment("ownedDomains", "+=", createAlternatives(createRuleCall(PR_SourceDomainCS), createRuleCall(PR_TargetDomainCS)))), setCardinality("?", createGroup(createKeyword("where"), createAssignment("ownedMiddle", "=", createRuleCall(PR_MiddleDomainCS)))), setCardinality("?", createAssignment("ownedMappingSequence", "=", createRuleCall(PR_MappingSequenceCS))), createKeyword("}")));
			...
			PR_TargetBottomPatternCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM_qvtcorebasecs, org.eclipse.qvtd.xtext.qvtcorebasecs.QVTcoreBaseCSPackage.Literals.BOTTOM_PATTERN_CS)), createKeyword("{"), setCardinality("?", createGroup(createAlternatives(createAssignment("ownedRealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_RealizedVariableCS)), createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS))), setCardinality("*", createGroup(createKeyword(","), createAlternatives(createAssignment("ownedRealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_RealizedVariableCS)), createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(_QVTcoreBase.PR_UnrealizedVariableCS))))))), createKeyword("}")));
