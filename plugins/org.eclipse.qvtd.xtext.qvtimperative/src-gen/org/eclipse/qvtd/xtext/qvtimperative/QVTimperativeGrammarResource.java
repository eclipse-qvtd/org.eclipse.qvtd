...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static final @NonNull ParserRule PR_BottomPatternCS = createParserRule("BottomPatternCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.BOTTOM_PATTERN_CS));
		private static final @NonNull ParserRule PR_BottomStatementCS = createParserRule("BottomStatementCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.STATEMENT_CS));
		private static final @NonNull ParserRule PR_ConstraintCS = createParserRule("ConstraintCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.PREDICATE_OR_ASSIGNMENT_CS));
		...
		private static final @NonNull ParserRule PR_GuardPatternCS = createParserRule("GuardPatternCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.GUARD_PATTERN_CS));
		private static final @NonNull ParserRule PR_GuardVariableCS = createParserRule("GuardVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.UNREALIZED_VARIABLE_CS));
		...
		private static final @NonNull ParserRule PR_NamedDomainCS = createParserRule("NamedDomainCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.DOMAIN_CS));
		...
		private static final @NonNull ParserRule PR_PredicateCS = createParserRule("PredicateCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.PREDICATE_CS));
		...
		private static final @NonNull ParserRule PR_UnnamedDomainCS = createParserRule("UnnamedDomainCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.DOMAIN_CS));
		private static final @NonNull ParserRule PR_UnrealizedVariableCS = createParserRule("UnrealizedVariableCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.UNREALIZED_VARIABLE_CS));
		...
		private static final @NonNull ParserRule PR_VariablePredicateCS = createParserRule("VariablePredicateCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.UNREALIZED_VARIABLE_CS));
		
		private static void initParserRules() {
			PR_AddStatementCS.setAlternatives(createGroup(createKeyword("add"), createAssignment("targetVariable", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.VARIABLE), createRuleCall(PR_UnrestrictedName))), createKeyword("+="), createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			PR_BottomPatternCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.BOTTOM_PATTERN_CS)), createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(PR_UnrealizedVariableCS)), createAssignment("ownedConstraints", "+=", createRuleCall(PR_ConstraintCS)))), createKeyword("}")));
			PR_BottomStatementCS.setAlternatives(createAlternatives(createRuleCall(PR_NewStatementCS), createRuleCall(PR_SetStatementCS)));
			PR_ConstraintCS.setAlternatives(createGroup(createKeyword("check"), createAssignment("ownedTarget", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), setCardinality("?", createGroup(createKeyword(":="), createAssignment("ownedInitExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)))), createKeyword(";")));
			...
			PR_DirectionCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.DIRECTION_CS)), setCardinality("?", createAssignment("name", "=", createRuleCall(PR_UnrestrictedName))), createKeyword("imports"), createAssignment("imports", "+=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PACKAGE), createRuleCall(PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("imports", "+=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PACKAGE), createRuleCall(PR_UnrestrictedName))))), setCardinality("?", createGroup(createKeyword("uses"), createAssignment("uses", "+=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.IMPERATIVE_DOMAIN), createRuleCall(PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("uses", "+=", createCrossReference(createTypeRef(MM_qvtimperative, org.eclipse.qvtd.pivot.qvtimperative.QVTimperativePackage.Literals.IMPERATIVE_DOMAIN), createRuleCall(PR_UnrestrictedName)))))))));
			PR_GuardPatternCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.GUARD_PATTERN_CS)), createKeyword("("), setCardinality("*", createAlternatives(createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(PR_GuardVariableCS)), createAssignment("ownedUnrealizedVariables", "+=", createRuleCall(PR_VariablePredicateCS)), createAssignment("ownedPredicates", "+=", createRuleCall(PR_PredicateCS)))), createKeyword(")")));
			PR_GuardVariableCS.setAlternatives(createGroup(createAlternatives(createKeyword("in"), createAssignment("isConnection", "?=", createKeyword("inout"))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), createKeyword(";")));
			...
			PR_MappingCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.MAPPING_CS)), createKeyword("map"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("in"), createAssignment("ownedInPathName", "=", createRuleCall(_Base.PR_PathNameCS)))), createKeyword("{"), setCardinality("*", createAssignment("ownedDomains", "+=", createAlternatives(createRuleCall(PR_SourceDomainCS), createRuleCall(PR_TargetDomainCS)))), setCardinality("?", createGroup(createKeyword("where"), createAssignment("ownedMiddle", "=", createRuleCall(PR_MiddleDomainCS)))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_BottomStatementCS))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_ControlStatementCS))), createKeyword("}")));
			...
			PR_MiddleDomainCS.setAlternatives(createGroup(setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createGroup(createKeyword("check"), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), setCardinality("?", createGroup(createKeyword("enforce"), createAssignment("enforcedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("enforcedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("}"))), createAssignment("ownedGuardPattern", "=", createRuleCall(PR_GuardPatternCS)), createAssignment("ownedBottomPattern", "=", createRuleCall(PR_BottomPatternCS))));
			...
			PR_PredicateCS.setAlternatives(createGroup(createKeyword("check"), createAssignment("ownedCondition", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			...
			PR_SetStatementCS.setAlternatives(createGroup(createKeyword("set"), createAssignment("referredVariable", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.VARIABLE), createRuleCall(PR_UnrestrictedName))), createKeyword("."), createAssignment("referredProperty", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PROPERTY), createRuleCall(PR_UnrestrictedName))), createKeyword(":="), createAssignment("ownedInitExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
			PR_SourceDomainCS.setAlternatives(createGroup(createAssignment("isCheck", "?=", createKeyword("check")), createAssignment("direction", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createGroup(createKeyword("check"), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), setCardinality("?", createGroup(createKeyword("enforce"), createAssignment("enforcedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("enforcedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("}"))), createAssignment("ownedGuardPattern", "=", createRuleCall(PR_GuardPatternCS)), createAssignment("ownedBottomPattern", "=", createRuleCall(PR_BottomPatternCS))));
			PR_StatementCS.setAlternatives(createRuleCall(PR_ControlStatementCS));
			...
			PR_UnnamedDomainCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.DOMAIN_CS)), createAssignment("ownedGuardPattern", "=", createRuleCall(PR_GuardPatternCS)), createAssignment("ownedBottomPattern", "=", createRuleCall(PR_BottomPatternCS))));
			PR_UnrealizedVariableCS.setAlternatives(createGroup(createAlternatives(createKeyword("var"), createAssignment("isConnection", "?=", createKeyword("out"))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)))), setCardinality("?", createGroup(createKeyword(":="), createAssignment("ownedInitExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)))), createKeyword(";")));
			...
			PR_VariablePredicateCS.setAlternatives(createGroup(createKeyword("invar"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)))), createKeyword(":="), createAssignment("ownedInitExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createKeyword(";")));
		}
		...
		private static @NonNull Grammar initGrammar() {
			...
			}
			{
				...
				rules.add(PR_BottomStatementCS);
				...
				rules.add(PR_VariablePredicateCS);
