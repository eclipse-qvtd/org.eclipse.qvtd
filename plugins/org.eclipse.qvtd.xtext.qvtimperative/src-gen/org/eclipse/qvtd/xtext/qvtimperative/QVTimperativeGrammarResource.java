...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static void initParserRules() {
			...
			PR_MappingCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtimperativecs.QVTimperativeCSPackage.Literals.MAPPING_CS)), createKeyword("map"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("in"), createAssignment("ownedInPathName", "=", createRuleCall(_Base.PR_PathNameCS)))), createKeyword("{"), setCardinality("*", createAssignment("ownedInoutVariables", "+=", createRuleCall(PR_InoutVariableCS))), setCardinality("*", createAssignment("ownedDomains", "+=", createAlternatives(createRuleCall(PR_SourceDomainCS), createRuleCall(PR_TargetDomainCS)))), setCardinality("*", createAlternatives(createAssignment("ownedStatements", "+=", createRuleCall(PR_OutVariableCS)), createAssignment("ownedStatements", "+=", createRuleCall(PR_PredicateVariableCS)), createAssignment("ownedStatements", "+=", createRuleCall(PR_CheckStatementCS)))), setCardinality("*", createAlternatives(createAssignment("ownedStatements", "+=", createRuleCall(PR_NewStatementCS)), createAssignment("ownedStatements", "+=", createRuleCall(PR_SetStatementCS)))), setCardinality("*", createAssignment("ownedStatements", "+=", createRuleCall(PR_ControlStatementCS))), createKeyword("}")));
			...
			PR_SourceDomainCS.setAlternatives(createGroup(createAssignment("isCheck", "?=", createKeyword("check")), createAssignment("direction", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(PR_UnrestrictedName))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createGroup(createKeyword("check"), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("checkedProperties", "+=", createRuleCall(_Base.PR_PathNameCS)))))), createKeyword("}"))), createKeyword("("), setCardinality("*", createAssignment("ownedGuardVariables", "+=", createRuleCall(PR_GuardVariableCS))), createKeyword(")"), createKeyword("{"), createKeyword("}")));
