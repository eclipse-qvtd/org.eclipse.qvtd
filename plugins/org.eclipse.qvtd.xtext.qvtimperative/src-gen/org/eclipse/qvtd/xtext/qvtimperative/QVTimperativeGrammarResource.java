...
public class QVTimperativeGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTimperative
	{
		...
		private static void initParserRules() {
			...
			PR_ControlStatementCS.setAlternatives(createAlternatives(createRuleCall(PR_ConnectionStatementCS), createRuleCall(PR_MappingCallCS), createRuleCall(PR_MappingLoopCS)));
