...
public class QVTimperativeCSResource extends QVTbaseCSResource
{
	...
	public @NonNull CS2AS getCS2AS() {
		...
		if (environmentFactory == null) {
			environmentFactory = new QVTimperativeEnvironmentFactory(BasicProjectManager.createDefaultProjectManager(), getResourceSet(), QVTimperativeEnvironmentStrategy.INSTANCE);
		}
