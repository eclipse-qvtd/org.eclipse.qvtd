...
public class AbstractQVTimperativePostOrderVisitor extends QVTcoreBasePostOrderVisitor implements QVTimperativeCSVisitor<Continuation<?>>
{
	//
	//	This file is maintained by copying from AbstractExtendingQVTcoreCSVisitor and changing R to Continuation<?>.
	//
	public AbstractQVTimperativePostOrderVisitor(@NonNull CS2PivotConversion context) {
		super(context);
	}	
