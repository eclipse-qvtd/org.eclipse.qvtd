...
public class QVTimperativeAS2CS extends EssentialOCLAS2CS
{
	...
	public QVTimperativeAS2CS(@NonNull Map<@NonNull ? extends BaseCSResource, @NonNull ? extends ASResource> cs2asResourceMap, @NonNull EnvironmentFactory environmentFactory) {
