...
import org.eclipse.qvtd.xtext.qvtcorebase.cs2pivot.QVTcoreBasePreOrderVisitor;
import org.eclipse.qvtd.xtext.qvtimperativecst.util.QVTimperativeCSVisitor;

public class AbstractQVTimperativePreOrderVisitor extends QVTcoreBasePreOrderVisitor implements QVTimperativeCSVisitor<Continuation<?>>
{
	//
	//	This file is maintained by copying from AbstractExtendingQVTcoreCSVisitor and changing R to Continuation<?>.
	//
	public AbstractQVTimperativePreOrderVisitor(@NonNull CS2PivotConversion context) {
		super(context);
	}	
