...
public class InternalQVTbaseLexer extends Lexer {
    ...
    public final void mRULE_LETTER_CHARACTER() throws RecognitionException {
        try {
            // InternalQVTbase.g:22070:32: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) )
            // InternalQVTbase.g:22070:34: ( 'a' .. 'z' | 'A' .. 'Z' | '_' )
            {
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTbase.g:22082:10: ( ( '0' .. '9' )+ )
            // InternalQVTbase.g:22082:12: ( '0' .. '9' )+
            {
            // InternalQVTbase.g:22082:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalQVTbase.g:22088:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalQVTbase.g:22088:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalQVTbase.g:22088:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
