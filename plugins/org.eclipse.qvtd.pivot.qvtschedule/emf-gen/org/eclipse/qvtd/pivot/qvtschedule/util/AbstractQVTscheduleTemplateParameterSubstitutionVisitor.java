	...
	implements QVTscheduleVisitor<Object>
{
	 ...
	 */
	protected AbstractQVTscheduleTemplateParameterSubstitutionVisitor(@NonNull EnvironmentFactory environmentFactory, @Nullable Type selfType, @Nullable Type selfTypeValue) {
