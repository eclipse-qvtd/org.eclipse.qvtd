...
public class QVTscheduleTables extends AbstractTables
{
	...
	public static class Types {
		...
		private static final org.eclipse.ocl.pivot.@NonNull Class @NonNull [] eClassifierID2asClass = {
			...
			/* 1 */ _ArgumentEdge,
			/* 2 */ _BasicPartition,
			/* 3 */ _BooleanLiteralNode,
			/* 4 */ _CastEdge,
			/* 5 */ _ClassDatum,
			/* 6 */ _Cluster,
			/* 7 */ _CollectionClassDatum,
			/* 8 */ _CollectionLiteralNode,
			/* 9 */ _CollectionPartEdge,
			/* 10 */ _CollectionRangeNode,
			/* 11 */ _ComposedNode,
			/* 12 */ _CompositePartition,
			/* 13 */ _Connection,
			/* 14 */ _ConnectionEnd,
			/* 15 */ _CyclicMappingRegion,
			/* 16 */ _CyclicPartition,
			/* 17 */ _DependencyEdge,
			/* 18 */ _DependencyNode,
			/* 19 */ _DispatchRegion,
			...
			/* 30 */ _KeyPartEdge,
			/* 31 */ _KeyedValueNode,
			/* 32 */ _LoadingPartition,
			/* 33 */ _LoadingRegion,
			/* 34 */ _MapLiteralNode,
			/* 35 */ _MapPartEdge,
			/* 36 */ _MapPartNode,
			/* 37 */ _MappingNode,
			/* 38 */ _MappingPartition,
			/* 39 */ _MappingRegion,
			/* 40 */ _MergedPartition,
			/* 41 */ _NavigableEdge,
			/* 42 */ _NavigationEdge,
			...
			/* 45 */ _NonPartition,
			/* 46 */ _NullLiteralNode,
			/* 47 */ _NumericLiteralNode,
			/* 48 */ _OperationCallNode,
			/* 49 */ _OperationNode,
			/* 50 */ _OperationRegion,
			/* 51 */ _OperationParameterEdge,
			/* 52 */ _OperationSelfEdge,
			/* 53 */ _Partition,
			/* 54 */ _PatternTypedNode,
			/* 55 */ _PatternVariableNode,
			/* 56 */ _PredicateEdge,
			/* 57 */ _PropertyDatum,
			/* 58 */ _RecursionEdge,
			/* 59 */ _Region,
			...
			/* 64 */ _ShadowNode,
			/* 65 */ _ShadowPartEdge,
			/* 66 */ _StringLiteralNode,
			/* 67 */ _SuccessEdge,
			/* 68 */ _SuccessNode,
			/* 69 */ _Symbolable,
			/* 70 */ _TupleLiteralNode,
			/* 71 */ _TuplePartEdge,
			/* 72 */ _TypeLiteralNode,
			/* 73 */ _UnknownNode,
			/* 74 */ _VariableNode,
	...
	public static class Properties {
		...
		public static final @NonNull Property _BasicPartition__constantEdges = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__CONSTANT_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Edge, false), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__constantNodes = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__CONSTANT_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 1 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__constantSuccessFalseNodes = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__CONSTANT_SUCCESS_FALSE_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 2 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__constantSuccessTrueNodes = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__CONSTANT_SUCCESS_TRUE_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 3 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__explicitPredecessors = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__EXPLICIT_PREDECESSORS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._MappingPartition, false), 4 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__headNodes = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__HEAD_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Node, false), 5 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__loadedEdges = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__LOADED_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Edge, false), 6 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__loadedNodes = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__LOADED_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 7 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _BasicPartition__predicatedEdges = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__PREDICATED_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Edge, false), 9 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__predicatedNodes = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__PREDICATED_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 10 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__realizedEdges = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__REALIZED_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Edge, false), 11 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__realizedNodes = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__REALIZED_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 12 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__speculatedEdges = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__SPECULATED_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Edge, false), 13 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__speculatedNodes = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__SPECULATED_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 14 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _BasicPartition__speculationNodes = LIBRARY.createProperty(Types._BasicPartition, QVTschedulePackage.Literals.BASIC_PARTITION__SPECULATION_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 15 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _ClassDatum__completeClasses = LIBRARY.createProperty(Types._ClassDatum, QVTschedulePackage.Literals.CLASS_DATUM__COMPLETE_CLASSES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, PivotTables.Types._CompleteClass, false), 0 | IsDerived | IsRequired | IsResolveProxies | IsTransient);
		public static final @NonNull Property _ClassDatum__ownedPropertyDatums = LIBRARY.createProperty(Types._ClassDatum, QVTschedulePackage.Literals.CLASS_DATUM__OWNED_PROPERTY_DATUMS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._PropertyDatum, false), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _ClassDatum__superClassDatums = LIBRARY.createProperty(Types._ClassDatum, QVTschedulePackage.Literals.CLASS_DATUM__SUPER_CLASS_DATUMS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._ClassDatum, false), 5 | IsRequired | IsResolveProxies | IsTransient);
		public static final @NonNull Property _ClassDatum__CastEdge__referredClassDatum = LIBRARY.createOppositeProperty(Types._ClassDatum, "CastEdge", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._CastEdge, false), 6 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.CAST_EDGE__REFERRED_CLASS_DATUM);
		public static final @NonNull Property _ClassDatum__ClassDatum__superClassDatums = LIBRARY.createOppositeProperty(Types._ClassDatum, "ClassDatum", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._ClassDatum, false), 7 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.CLASS_DATUM__SUPER_CLASS_DATUMS);
		public static final @NonNull Property _ClassDatum__CollectionClassDatum__elementalClassDatum = LIBRARY.createOppositeProperty(Types._ClassDatum, "CollectionClassDatum", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._CollectionClassDatum, false), 8 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.COLLECTION_CLASS_DATUM__ELEMENTAL_CLASS_DATUM);
		public static final @NonNull Property _ClassDatum__KeyedValueNode__classDatumValue = LIBRARY.createOppositeProperty(Types._ClassDatum, "KeyedValueNode", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._KeyedValueNode, false), 9 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.KEYED_VALUE_NODE__CLASS_DATUM_VALUE);
		public static final @NonNull Property _ClassDatum__Node__classDatum = LIBRARY.createOppositeProperty(Types._ClassDatum, "Node", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Node, false), 10 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NODE__CLASS_DATUM);
		public static final @NonNull Property _ClassDatum__NodeConnection__classDatum = LIBRARY.createOppositeProperty(Types._ClassDatum, "NodeConnection", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._NodeConnection, false), 11 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NODE_CONNECTION__CLASS_DATUM);
		public static final @NonNull Property _ClassDatum__PropertyDatum__targetClassDatum = LIBRARY.createOppositeProperty(Types._ClassDatum, "PropertyDatum", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._PropertyDatum, false), 12 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.PROPERTY_DATUM__TARGET_CLASS_DATUM);
		...
		public static final @NonNull Property _Cluster__memberEdges = LIBRARY.createProperty(Types._Cluster, QVTschedulePackage.Literals.CLUSTER__MEMBER_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Edge, false), 1 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Cluster__memberNodes = LIBRARY.createProperty(Types._Cluster, QVTschedulePackage.Literals.CLUSTER__MEMBER_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Node, false), 2 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Cluster__precedingClusters = LIBRARY.createProperty(Types._Cluster, QVTschedulePackage.Literals.CLUSTER__PRECEDING_CLUSTERS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Cluster, false), 4 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Cluster__succeedingClusters = LIBRARY.createProperty(Types._Cluster, QVTschedulePackage.Literals.CLUSTER__SUCCEEDING_CLUSTERS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Cluster, false), 5 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Connection__intermediatePartitions = LIBRARY.createProperty(Types._Connection, QVTschedulePackage.Literals.CONNECTION__INTERMEDIATE_PARTITIONS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Partition, false), 2 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Connection__sourceEnds = LIBRARY.createProperty(Types._Connection, QVTschedulePackage.Literals.CONNECTION__SOURCE_ENDS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._ConnectionEnd, false), 5 | IsRequired | IsResolveProxies);

		public static final @NonNull Property _ConnectionEnd__Connection__sourceEnds = LIBRARY.createOppositeProperty(Types._ConnectionEnd, "Connection", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Connection, false), 0 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.CONNECTION__SOURCE_ENDS);

		public static final @NonNull Property _CyclicMappingRegion__elementRegions = LIBRARY.createProperty(Types._CyclicMappingRegion, QVTschedulePackage.Literals.CYCLIC_MAPPING_REGION__ELEMENT_REGIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._MappingRegion, false), 0 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Edge__BasicPartition__constantEdges = LIBRARY.createOppositeProperty(Types._Edge, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 7 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__CONSTANT_EDGES);
		public static final @NonNull Property _Edge__BasicPartition__loadedEdges = LIBRARY.createOppositeProperty(Types._Edge, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 8 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__LOADED_EDGES);
		public static final @NonNull Property _Edge__BasicPartition__predicatedEdges = LIBRARY.createOppositeProperty(Types._Edge, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 9 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__PREDICATED_EDGES);
		public static final @NonNull Property _Edge__BasicPartition__realizedEdges = LIBRARY.createOppositeProperty(Types._Edge, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 10 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__REALIZED_EDGES);
		public static final @NonNull Property _Edge__BasicPartition__speculatedEdges = LIBRARY.createOppositeProperty(Types._Edge, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 11 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__SPECULATED_EDGES);

		public static final @NonNull Property _EdgeConnection__mandatoryTargetEdges = LIBRARY.createProperty(Types._EdgeConnection, QVTschedulePackage.Literals.EDGE_CONNECTION__MANDATORY_TARGET_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._NavigableEdge, false), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _EdgeConnection__preferredTargetEdges = LIBRARY.createProperty(Types._EdgeConnection, QVTschedulePackage.Literals.EDGE_CONNECTION__PREFERRED_TARGET_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._NavigableEdge, false), 1 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _EdgeConnection__NavigableEdge__incomingConnection = LIBRARY.createOppositeProperty(Types._EdgeConnection, "NavigableEdge", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._NavigableEdge, false), 3 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NAVIGABLE_EDGE__INCOMING_CONNECTION);
		public static final @NonNull Property _EdgeConnection__NavigableEdge__outgoingConnections = LIBRARY.createOppositeProperty(Types._EdgeConnection, "NavigableEdge", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._NavigableEdge, false), 4 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NAVIGABLE_EDGE__OUTGOING_CONNECTIONS);
		...
		public static final @NonNull Property _LoadingPartition__RootPartition__loadingPartition = LIBRARY.createOppositeProperty(Types._LoadingPartition, "RootPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._RootPartition, false), 1 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.ROOT_PARTITION__LOADING_PARTITION);
		...
		public static final @NonNull Property _MappingPartition__explicitSuccessors = LIBRARY.createProperty(Types._MappingPartition, QVTschedulePackage.Literals.MAPPING_PARTITION__EXPLICIT_SUCCESSORS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._BasicPartition, false), 0 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _MappingRegion__headNodes = LIBRARY.createProperty(Types._MappingRegion, QVTschedulePackage.Literals.MAPPING_REGION__HEAD_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Node, false), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _MappingRegion__mappingPartitions = LIBRARY.createProperty(Types._MappingRegion, QVTschedulePackage.Literals.MAPPING_REGION__MAPPING_PARTITIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._MappingPartition, false), 1 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _NavigableEdge__outgoingConnections = LIBRARY.createProperty(Types._NavigableEdge, QVTschedulePackage.Literals.NAVIGABLE_EDGE__OUTGOING_CONNECTIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._EdgeConnection, false), 1 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _NavigableEdge__EdgeConnection__mandatoryTargetEdges = LIBRARY.createOppositeProperty(Types._NavigableEdge, "EdgeConnection", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._EdgeConnection, false), 2 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.EDGE_CONNECTION__MANDATORY_TARGET_EDGES);
		public static final @NonNull Property _NavigableEdge__EdgeConnection__preferredTargetEdges = LIBRARY.createOppositeProperty(Types._NavigableEdge, "EdgeConnection", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._EdgeConnection, false), 3 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.EDGE_CONNECTION__PREFERRED_TARGET_EDGES);
		...
		public static final @NonNull Property _NavigationEdge__NavigationEdge__oppositeEdge = LIBRARY.createOppositeProperty(Types._NavigationEdge, "NavigationEdge", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._NavigationEdge, false), 4 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NAVIGATION_EDGE__OPPOSITE_EDGE);
		...
		public static final @NonNull Property _Node__incomingEdges = LIBRARY.createProperty(Types._Node, QVTschedulePackage.Literals.NODE__INCOMING_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Edge, false), 3 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Node__outgoingConnections = LIBRARY.createProperty(Types._Node, QVTschedulePackage.Literals.NODE__OUTGOING_CONNECTIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._NodeConnection, false), 6 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Node__outgoingEdges = LIBRARY.createProperty(Types._Node, QVTschedulePackage.Literals.NODE__OUTGOING_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Edge, false), 7 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Node__BasicPartition__constantNodes = LIBRARY.createOppositeProperty(Types._Node, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 10 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__CONSTANT_NODES);
		public static final @NonNull Property _Node__BasicPartition__constantSuccessFalseNodes = LIBRARY.createOppositeProperty(Types._Node, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 11 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__CONSTANT_SUCCESS_FALSE_NODES);
		public static final @NonNull Property _Node__BasicPartition__constantSuccessTrueNodes = LIBRARY.createOppositeProperty(Types._Node, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 12 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__CONSTANT_SUCCESS_TRUE_NODES);
		public static final @NonNull Property _Node__BasicPartition__headNodes = LIBRARY.createOppositeProperty(Types._Node, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 13 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__HEAD_NODES);
		public static final @NonNull Property _Node__BasicPartition__loadedNodes = LIBRARY.createOppositeProperty(Types._Node, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 14 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__LOADED_NODES);
		public static final @NonNull Property _Node__BasicPartition__predicatedNodes = LIBRARY.createOppositeProperty(Types._Node, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 15 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__PREDICATED_NODES);
		public static final @NonNull Property _Node__BasicPartition__realizedNodes = LIBRARY.createOppositeProperty(Types._Node, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 16 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__REALIZED_NODES);
		public static final @NonNull Property _Node__BasicPartition__speculatedNodes = LIBRARY.createOppositeProperty(Types._Node, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 17 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__SPECULATED_NODES);
		public static final @NonNull Property _Node__BasicPartition__speculationNodes = LIBRARY.createOppositeProperty(Types._Node, "BasicPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._BasicPartition, false), 18 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.BASIC_PARTITION__SPECULATION_NODES);
		public static final @NonNull Property _Node__MappingRegion__headNodes = LIBRARY.createOppositeProperty(Types._Node, "MappingRegion", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._MappingRegion, false), 19 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.MAPPING_REGION__HEAD_NODES);
		public static final @NonNull Property _Node__NodeConnection__mandatoryTargetNodes = LIBRARY.createOppositeProperty(Types._Node, "NodeConnection", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._NodeConnection, false), 20 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NODE_CONNECTION__MANDATORY_TARGET_NODES);
		public static final @NonNull Property _Node__NodeConnection__passedTargetNodes = LIBRARY.createOppositeProperty(Types._Node, "NodeConnection", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._NodeConnection, false), 21 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NODE_CONNECTION__PASSED_TARGET_NODES);
		public static final @NonNull Property _Node__NodeConnection__preferredTargetNodes = LIBRARY.createOppositeProperty(Types._Node, "NodeConnection", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._NodeConnection, false), 22 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NODE_CONNECTION__PREFERRED_TARGET_NODES);
		public static final @NonNull Property _Node__OperationRegion__dependencyNodes = LIBRARY.createOppositeProperty(Types._Node, "OperationRegion", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._OperationRegion, false), 23 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.OPERATION_REGION__DEPENDENCY_NODES);
		public static final @NonNull Property _Node__OperationRegion__headNodes = LIBRARY.createOppositeProperty(Types._Node, "OperationRegion", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._OperationRegion, false), 24 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.OPERATION_REGION__HEAD_NODES);
		public static final @NonNull Property _Node__OperationRegion__resultNode = LIBRARY.createOppositeProperty(Types._Node, "OperationRegion", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._OperationRegion, false), 25 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.OPERATION_REGION__RESULT_NODE);
		...
		public static final @NonNull Property _NodeConnection__mandatoryTargetNodes = LIBRARY.createProperty(Types._NodeConnection, QVTschedulePackage.Literals.NODE_CONNECTION__MANDATORY_TARGET_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 1 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _NodeConnection__passedTargetNodes = LIBRARY.createProperty(Types._NodeConnection, QVTschedulePackage.Literals.NODE_CONNECTION__PASSED_TARGET_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 2 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _NodeConnection__preferredTargetNodes = LIBRARY.createProperty(Types._NodeConnection, QVTschedulePackage.Literals.NODE_CONNECTION__PREFERRED_TARGET_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Node, false), 3 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _NodeConnection__Node__incomingConnection = LIBRARY.createOppositeProperty(Types._NodeConnection, "Node", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Node, false), 4 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NODE__INCOMING_CONNECTION);
		public static final @NonNull Property _NodeConnection__Node__outgoingConnections = LIBRARY.createOppositeProperty(Types._NodeConnection, "Node", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Node, false), 5 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.NODE__OUTGOING_CONNECTIONS);
		public static final @NonNull Property _NodeConnection__Partition__intermediateConnections = LIBRARY.createOppositeProperty(Types._NodeConnection, "Partition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Partition, false), 6 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.PARTITION__INTERMEDIATE_CONNECTIONS);
		public static final @NonNull Property _NodeConnection__Partition__rootConnections = LIBRARY.createOppositeProperty(Types._NodeConnection, "Partition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Partition, false), 7 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.PARTITION__ROOT_CONNECTIONS);
		...
		public static final @NonNull Property _OperationRegion__dependencyNodes = LIBRARY.createProperty(Types._OperationRegion, QVTschedulePackage.Literals.OPERATION_REGION__DEPENDENCY_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Node, false), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _OperationRegion__headNodes = LIBRARY.createProperty(Types._OperationRegion, QVTschedulePackage.Literals.OPERATION_REGION__HEAD_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Node, false), 1 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Partition__intermediateConnections = LIBRARY.createProperty(Types._Partition, QVTschedulePackage.Literals.PARTITION__INTERMEDIATE_CONNECTIONS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._NodeConnection, false), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Partition__passes = LIBRARY.createProperty(Types._Partition, QVTschedulePackage.Literals.PARTITION__PASSES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, OCLstdlibTables.Types._Integer, false), 1 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Partition__rootConnections = LIBRARY.createProperty(Types._Partition, QVTschedulePackage.Literals.PARTITION__ROOT_CONNECTIONS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._NodeConnection, false), 2 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Partition__Connection__commonPartition = LIBRARY.createOppositeProperty(Types._Partition, "Connection", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Connection, false), 3 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.CONNECTION__COMMON_PARTITION);
		public static final @NonNull Property _Partition__Connection__intermediatePartitions = LIBRARY.createOppositeProperty(Types._Partition, "Connection", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Connection, false), 4 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.CONNECTION__INTERMEDIATE_PARTITIONS);
		...
		public static final @NonNull Property _PropertyDatum__superPropertyDatums = LIBRARY.createProperty(Types._PropertyDatum, QVTschedulePackage.Literals.PROPERTY_DATUM__SUPER_PROPERTY_DATUMS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._PropertyDatum, false), 4 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _PropertyDatum__KeyPartEdge__referredPart = LIBRARY.createOppositeProperty(Types._PropertyDatum, "KeyPartEdge", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._KeyPartEdge, false), 6 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.KEY_PART_EDGE__REFERRED_PART);
		public static final @NonNull Property _PropertyDatum__PropertyDatum__opposite = LIBRARY.createOppositeProperty(Types._PropertyDatum, "PropertyDatum", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._PropertyDatum, false), 7 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.PROPERTY_DATUM__OPPOSITE);
		public static final @NonNull Property _PropertyDatum__PropertyDatum__superPropertyDatums = LIBRARY.createOppositeProperty(Types._PropertyDatum, "PropertyDatum", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._PropertyDatum, false), 8 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.PROPERTY_DATUM__SUPER_PROPERTY_DATUMS);
		...
		public static final @NonNull Property _Region__ownedClusters = LIBRARY.createProperty(Types._Region, QVTschedulePackage.Literals.REGION__OWNED_CLUSTERS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Cluster, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Region__ownedEdges = LIBRARY.createProperty(Types._Region, QVTschedulePackage.Literals.REGION__OWNED_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Edge, false), 1 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Region__ownedNodes = LIBRARY.createProperty(Types._Region, QVTschedulePackage.Literals.REGION__OWNED_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Node, false), 2 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Region__MappingPartition__region = LIBRARY.createOppositeProperty(Types._Region, "MappingPartition", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._MappingPartition, false), 4 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.MAPPING_PARTITION__REGION);
		...
		public static final @NonNull Property _RootRegion__activeRegions = LIBRARY.createProperty(Types._RootRegion, QVTschedulePackage.Literals.ROOT_REGION__ACTIVE_REGIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Region, false), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _RootRegion__ownedConnections = LIBRARY.createProperty(Types._RootRegion, QVTschedulePackage.Literals.ROOT_REGION__OWNED_CONNECTIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Connection, false), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _RuleRegion__DispatchRegion__referredRuleRegion = LIBRARY.createOppositeProperty(Types._RuleRegion, "DispatchRegion", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._DispatchRegion, false), 1 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.DISPATCH_REGION__REFERRED_RULE_REGION);
		public static final @NonNull Property _RuleRegion__VerdictRegion__referredRuleRegion = LIBRARY.createOppositeProperty(Types._RuleRegion, "VerdictRegion", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._VerdictRegion, false), 2 | IsImplicit | IsRequired | IsResolveProxies, QVTschedulePackage.Literals.VERDICT_REGION__REFERRED_RULE_REGION);

		public static final @NonNull Property _ScheduleModel__ownedClassDatums = LIBRARY.createProperty(Types._ScheduleModel, QVTschedulePackage.Literals.SCHEDULE_MODEL__OWNED_CLASS_DATUMS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._ClassDatum, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _ScheduleModel__ownedMappingRegions = LIBRARY.createProperty(Types._ScheduleModel, QVTschedulePackage.Literals.SCHEDULE_MODEL__OWNED_MAPPING_REGIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._MappingRegion, false), 1 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _ScheduleModel__ownedOperationRegions = LIBRARY.createProperty(Types._ScheduleModel, QVTschedulePackage.Literals.SCHEDULE_MODEL__OWNED_OPERATION_REGIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._OperationRegion, false), 2 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _ScheduleModel__ownedRootRegions = LIBRARY.createProperty(Types._ScheduleModel, QVTschedulePackage.Literals.SCHEDULE_MODEL__OWNED_ROOT_REGIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._RootRegion, false), 3 | IsComposite | IsRequired | IsResolveProxies);
