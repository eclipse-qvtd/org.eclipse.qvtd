...
public class DispatchRegionImpl extends RuleRegionImpl implements DispatchRegion {
		...
		if (referredRuleRegion != null && referredRuleRegion.eIsProxy()) {
			...
			if (referredRuleRegion != oldReferredRuleRegion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QVTschedulePackage.DISPATCH_REGION__REFERRED_RULE_REGION, oldReferredRuleRegion, referredRuleRegion));
			}
		}
	...
	public void setReferredRuleRegion(RuleRegion newReferredRuleRegion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTschedulePackage.DISPATCH_REGION__REFERRED_RULE_REGION, oldReferredRuleRegion, referredRuleRegion));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QVTschedulePackage.DISPATCH_REGION__REFERRED_RULE_REGION:
