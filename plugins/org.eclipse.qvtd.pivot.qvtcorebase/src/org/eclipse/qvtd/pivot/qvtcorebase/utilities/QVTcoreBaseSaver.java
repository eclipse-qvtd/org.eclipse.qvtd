...
import org.eclipse.qvtd.pivot.qvtcorebase.util.AbstractNullQVTcoreBaseVisitor;

/**
 * PivotSaver ensures that all references to specialized types are terminated
 * by local copies of the specialization.
 */
public class QVTcoreBaseSaver extends QVTbaseSaver
{
	 ...
	 */
	public static class LocateVisitor extends AbstractNullQVTcoreBaseVisitor<Object, AbstractPivotSaver> implements AbstractPivotSaver.LocateVisitor
	{
	 ...
	 */
	public static class ResolveVisitor extends AbstractNullQVTcoreBaseVisitor<Object, AbstractPivotSaver> implements AbstractPivotSaver.ResolveVisitor
	{
	...
	protected QVTcoreBaseSaver(Resource resource) {
		super(resource);
	}
}