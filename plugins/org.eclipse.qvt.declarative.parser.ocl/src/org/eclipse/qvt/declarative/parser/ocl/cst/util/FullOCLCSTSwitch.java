 ...
 * </copyright>
 *
 * $Id: FullOCLCSTSwitch.java,v 1.1 2008/10/24 15:20:35 ewillink Exp $
 */
 ...
 * @generated
 */
public class FullOCLCSTSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FullOCLCSTPackage.TOP_LEVEL_CS: {
