...
import org.eclipse.qvtd.codegen.qvticgmodel.util.AbstractQVTiCGModelFieldingAnalysisVisitor;
import org.eclipse.qvtd.pivot.qvtimperative.BufferStatement;
import org.eclipse.qvtd.pivot.qvtimperative.NewStatement;

public class QVTiCGModelFieldingAnalysisVisitor extends AbstractQVTiCGModelFieldingAnalysisVisitor
{
	public QVTiCGModelFieldingAnalysisVisitor(@NonNull FieldingAnalyzer context, @NonNull ReturnState requiredReturn) {
		super(context, requiredReturn);
	}

	@Override
	protected @NonNull QVTiCGModelFieldingAnalysisVisitor getMustBeThrownVisitor() {
		return (QVTiCGModelFieldingAnalysisVisitor)super.getMustBeThrownVisitor();
	}
	...
	public @NonNull ReturnState visitCGMappingCall(@NonNull CGMappingCall cgMappingCall) {
		QVTiCGModelFieldingAnalysisVisitor mustBeThrownVisitor = getMustBeThrownVisitor();
