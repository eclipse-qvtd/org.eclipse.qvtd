...
import org.eclipse.qvtd.codegen.qvticgmodel.util.AbstractQVTiCGModelReferencesVisitor;
 ...
 */
public class QVTiCGModelReferencesVisitor extends AbstractQVTiCGModelReferencesVisitor
{
	public static final @NonNull QVTiCGModelReferencesVisitor INSTANCE = new QVTiCGModelReferencesVisitor(new Object());

	protected QVTiCGModelReferencesVisitor(@Nullable Object context) {
		super(context);
	}
