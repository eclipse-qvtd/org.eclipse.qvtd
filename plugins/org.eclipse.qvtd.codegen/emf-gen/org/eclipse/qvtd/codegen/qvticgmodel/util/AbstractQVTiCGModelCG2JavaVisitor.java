...
import org.eclipse.ocl.examples.codegen.cgmodel.utilities.CGModelCG2JavaVisitor;

/**
 * An AbstractQVTiCGModelCG2JavaVisitor provides a default implementation for each
 * visitXxx method that delegates to the visitYyy method of the first
 * super class, (or transitively its first super class' first super class
 * until a non-interface super-class is found). In the absence of any
 * suitable first super class, the method delegates to visiting().
 */
public abstract class AbstractQVTiCGModelCG2JavaVisitor
	extends CGModelCG2JavaVisitor
	implements QVTiCGModelVisitor<@NonNull Boolean>
{
	protected AbstractQVTiCGModelCG2JavaVisitor(@NonNull JavaCodeGenerator codeGenerator, @NonNull CGPackage cgPackage, @Nullable Iterable<@NonNull CGValuedElement> sortedGlobals) {
