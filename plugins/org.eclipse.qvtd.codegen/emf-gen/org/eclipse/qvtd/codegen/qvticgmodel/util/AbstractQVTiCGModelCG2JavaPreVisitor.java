...
import org.eclipse.ocl.examples.codegen.cgmodel.utilities.CGModelCG2JavaPreVisitor;

/**
 * An AbstractQVTiCGModelCG2JavaPreVisitor provides a default implementation for each
 * visitXxx method that delegates to the visitYyy method of the first
 * super class, (or transitively its first super class' first super class
 * until a non-interface super-class is found). In the absence of any
 * suitable first super class, the method delegates to visiting().
 */
public abstract class AbstractQVTiCGModelCG2JavaPreVisitor
	extends CGModelCG2JavaPreVisitor
	implements QVTiCGModelVisitor<@Nullable Object>
{
	protected AbstractQVTiCGModelCG2JavaPreVisitor(@NonNull JavaCodeGenerator codeGenerator) {
		super(codeGenerator);
	}
