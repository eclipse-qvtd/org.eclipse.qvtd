...
import org.eclipse.ocl.examples.codegen.cgmodel.utilities.CGModelAnalysisVisitor;

/**
 * An AbstractQVTiCGModelAnalysisVisitor provides a default implementation for each
 * visitXxx method that delegates to the visitYyy method of the first
 * super class, (or transitively its first super class' first super class
 * until a non-interface super-class is found). In the absence of any
 * suitable first super class, the method delegates to visiting().
 */
public abstract class AbstractQVTiCGModelAnalysisVisitor
	extends CGModelAnalysisVisitor
	implements QVTiCGModelVisitor<@Nullable Object>
{
	protected AbstractQVTiCGModelAnalysisVisitor(@NonNull CodeGenAnalyzer analyzer) {
		super(analyzer);
	}
