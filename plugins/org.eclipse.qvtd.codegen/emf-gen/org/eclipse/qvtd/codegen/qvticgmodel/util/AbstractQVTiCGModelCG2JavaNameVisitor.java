...
import org.eclipse.ocl.examples.codegen.cgmodel.utilities.CGModelCG2JavaNameVisitor;

/**
 * An AbstractQVTiCGModelCG2JavaNameVisitor provides a default implementation for each
 * visitXxx method that delegates to the visitYyy method of the first
 * super class, (or transitively its first super class' first super class
 * until a non-interface super-class is found). In the absence of any
 * suitable first super class, the method delegates to visiting().
 */
public abstract class AbstractQVTiCGModelCG2JavaNameVisitor
	extends CGModelCG2JavaNameVisitor
	implements QVTiCGModelVisitor<@Nullable Object>
{
	protected AbstractQVTiCGModelCG2JavaNameVisitor(@NonNull JavaCodeGenerator codeGenerator) {
		super(codeGenerator);
	}
