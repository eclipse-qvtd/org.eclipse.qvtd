...
{	
	...
	protected AbstractNature(ICreationFactory creationFactory) {
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(creationFactory.getBuilderId())) {
				return;
			}
		}
		...
		command.setBuilderName(creationFactory.getBuilderId());
