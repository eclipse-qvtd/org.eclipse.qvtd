 ...
 */
public class QVTcoreExecutableExtensionFactoryOverload extends QVTcoreExecutableExtensionFactory
{
	@Override
	public Object create() throws CoreException {
		...
		Object object = extensionToFactoryMap.get("qvtc");
		if (object instanceof Resource.Factory.Descriptor) {	// OOPS EcorePlugin.ExtensionProcessor has installed an object requiring OSGI getBundle() support.
			new QVTcoreStandaloneSetup().register(getInjector());
			object = extensionToFactoryMap.get("qvtc");
		}
		return object;
	}
	...
	protected Injector getInjector() {
		...
		if (injector == null) {
			injector = QVTcoreStandaloneSetup.getInjector();
		}
		return injector;
	}
