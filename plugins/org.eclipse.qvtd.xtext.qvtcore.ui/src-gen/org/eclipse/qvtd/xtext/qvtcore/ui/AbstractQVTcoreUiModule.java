...
import org.eclipse.qvtd.xtext.qvtcore.ide.contentassist.antlr.PartialQVTcoreContentAssistParser;
import org.eclipse.qvtd.xtext.qvtcore.ide.contentassist.antlr.QVTcoreParser;
import org.eclipse.qvtd.xtext.qvtcore.ide.contentassist.antlr.internal.InternalQVTcoreLexer;
...
/**
 * Manual modifications go to {@link QVTcoreUiModule}.
 */
...
public abstract class AbstractQVTcoreUiModule extends DefaultUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.eclipse.qvtd.xtext.qvtcore.parser.antlr.internal.InternalQVTcoreLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalQVTcoreLexer.class).toProvider(LexerProvider.create(InternalQVTcoreLexer.class));
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialQVTcoreContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("QVTcore Compare");
	}
