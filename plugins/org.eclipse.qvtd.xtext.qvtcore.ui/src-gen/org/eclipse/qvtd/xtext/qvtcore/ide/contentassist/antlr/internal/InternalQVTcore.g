...
:
	(
		...
		(
			...
			RULE_SINGLE_QUOTED_STRING
			{ after(grammarAccess.getQueryCSAccess().getImplementationJavaClassCSSINGLE_QUOTED_STRINGTerminalRuleCall_9_2_1_0_1()); }
		)
...
:
	(
		...
		ruleTargetCS
		{ after(grammarAccess.getTransformationCSAccess().getOwnedTargetsTargetCSParserRuleCall_5_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleStructuralFeatureCS
		{ after(grammarAccess.getTransformationCSAccess().getOwnedPropertiesStructuralFeatureCSParserRuleCall_6_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleUnrestrictedName
		{ after(grammarAccess.getTargetCSAccess().getNameUnrestrictedNameParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
