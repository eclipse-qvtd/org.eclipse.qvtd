...
public class AbstractQVTcorePostOrderVisitor extends EssentialOCLPostOrderVisitor implements QVTcoreCSVisitor<Continuation<?>>
{
	//
	//	This file is maintained by copying from AbstractExtendingQVTcoreCSVisitor and changing R to Continuation<?>.
	//
	public AbstractQVTcorePostOrderVisitor(CS2PivotConversion context) {
		super(context);
	}	
