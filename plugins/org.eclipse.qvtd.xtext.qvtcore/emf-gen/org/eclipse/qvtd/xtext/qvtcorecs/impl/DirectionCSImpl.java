...
public class DirectionCSImpl extends NamedElementCSImpl implements DirectionCS {
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.qvtd.pivot.qvtcore.CoreDomain> uses;
	 ...
	 */
	@Override
	public EList<org.eclipse.qvtd.pivot.qvtcore.CoreDomain> getUses() {
		if (uses == null) {
			uses = new EObjectResolvingEList<org.eclipse.qvtd.pivot.qvtcore.CoreDomain>(org.eclipse.qvtd.pivot.qvtcore.CoreDomain.class, this, QVTcoreCSPackage.DIRECTION_CS__USES);
		}
		return uses;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case QVTcoreCSPackage.DIRECTION_CS__USES:
				getUses().clear();
				getUses().addAll((Collection<? extends org.eclipse.qvtd.pivot.qvtcore.CoreDomain>)newValue);
				return;
		}
