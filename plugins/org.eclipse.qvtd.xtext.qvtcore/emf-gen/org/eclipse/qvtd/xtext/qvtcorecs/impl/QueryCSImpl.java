 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.qvtd.xtext.qvtcorecs.impl.QueryCSImpl#getImplementation <em>Implementation</em>}</li>
...
public class QueryCSImpl extends TypedElementCSImpl implements QueryCS {
		...
		if (implementation != null && implementation.eIsProxy()) {
			...
			if (implementation != oldImplementation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QVTcoreCSPackage.QUERY_CS__IMPLEMENTATION, oldImplementation, implementation));
			}
		}
	...
	public void setImplementation(JavaClassCS newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTcoreCSPackage.QUERY_CS__IMPLEMENTATION, oldImplementation, implementation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QVTcoreCSPackage.QUERY_CS__IMPLEMENTATION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == JavaImplementationCS.class) {
			switch (derivedFeatureID) {
				case QVTcoreCSPackage.QUERY_CS__IMPLEMENTATION: return QVTbaseCSPackage.JAVA_IMPLEMENTATION_CS__IMPLEMENTATION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == JavaImplementationCS.class) {
			switch (baseFeatureID) {
				case QVTbaseCSPackage.JAVA_IMPLEMENTATION_CS__IMPLEMENTATION: return QVTcoreCSPackage.QUERY_CS__IMPLEMENTATION;
				default: return -1;
			}
		}
