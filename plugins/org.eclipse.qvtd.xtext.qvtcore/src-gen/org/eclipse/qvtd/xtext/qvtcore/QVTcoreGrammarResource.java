...
public class QVTcoreGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTcore
	{
		...
		private static void initParserRules() {
			...
			PR_QVTcoreUnrestrictedName.setAlternatives(createAlternatives(createKeyword("abstract"), createKeyword("check"), createKeyword("enforce"), createKeyword("implementedby"), createKeyword("import"), createKeyword("imports"), createKeyword("map"), createKeyword("package"), createKeyword("query"), createKeyword("realize"), createKeyword("refines"), createKeyword("transformation"), createKeyword("transient"), createKeyword("uses")));
			...
			PR_TransformationCS.setAlternatives(createGroup(createKeyword("transformation"), setCardinality("?", createAssignment("ownedPathName", "=", createRuleCall(PR_ScopeNameCS))), createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnreservedName)), createKeyword("{"), setCardinality("*", createGroup(createAssignment("ownedDirections", "+=", createRuleCall(PR_DirectionCS)), createKeyword(";"))), setCardinality("*", createAssignment("ownedProperties", "+=", createRuleCall(_QVTbase.PR_StructuralFeatureCS))), createKeyword("}")));
