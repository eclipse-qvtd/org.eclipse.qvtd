...
public class QVTcoreGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTcore
	{
		...
		private static void initParserRules() {
			PR_MappingCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorecs.QVTcoreCSPackage.Literals.MAPPING_CS)), createKeyword("map"), setCardinality("?", createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), setCardinality("?", createGroup(createKeyword("in"), createAssignment("in", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TRANSFORMATION), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))))), setCardinality("?", createGroup(createKeyword("refines"), createAssignment("refines", "+=", createCrossReference(createTypeRef(MM_qvtcore, org.eclipse.qvtd.pivot.qvtcore.QVTcorePackage.Literals.MAPPING), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("refines", "+=", createCrossReference(createTypeRef(MM_qvtcore, org.eclipse.qvtd.pivot.qvtcore.QVTcorePackage.Literals.MAPPING), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))))))), createKeyword("{"), setCardinality("*", createAssignment("ownedDomains", "+=", createRuleCall(_QVTcoreBase.PR_NamedDomainCS))), setCardinality("?", createGroup(createKeyword("where"), createAssignment("ownedMiddle", "=", createRuleCall(_QVTcoreBase.PR_UnnamedDomainCS)))), setCardinality("*", createAssignment("ownedComposedMappings", "+=", createRuleCall(PR_MappingCS))), createKeyword("}")));
			PR_TopLevelCS.setAlternatives(createGroup(setCardinality("*", createAlternatives(createAssignment("ownedImports", "+=", createRuleCall(_QVTcoreBase.PR_ImportCS)), createAssignment("ownedLibraries", "+=", createRuleCall(_QVTcoreBase.PR_LibraryCS)))), setCardinality("*", createAlternatives(createAssignment("ownedMappings", "+=", createRuleCall(PR_MappingCS)), createAssignment("ownedTransformations", "+=", createRuleCall(_QVTcoreBase.PR_TransformationCS)), createAssignment("ownedQueries", "+=", createRuleCall(_QVTcoreBase.PR_QueryCS))))));
		}
