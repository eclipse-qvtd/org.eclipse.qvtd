...
public class QVTcoreGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTcore
	{
		...
		private static void initParserRules() {
			...
			PR_QVTcoreUnrestrictedName.setAlternatives(createAlternatives(createKeyword("abstract"), createKeyword("check"), createKeyword("enforce"), createKeyword("import"), createKeyword("imports"), createKeyword("map"), createKeyword("package"), createKeyword("query"), createKeyword("realize"), createKeyword("refines"), createKeyword("transformation"), createKeyword("transient"), createKeyword("uses")));
