 ...
 * from: E:\GIT\org.eclipse.qvtd\plugins..\..\plugins\org.eclipse.qvtd.xtext.qvtcore\src-gen\org\eclipse\qvtd\xtext\qvtcore\QVTcore.xtextbin
...
/**
 * QVTcoreGrammarResource provides a programmatically initialized org.eclipse.qvtd.xtext.qvtcore.QVTcore Grammar model avoiding
...
public class QVTcoreGrammarResource extends AbstractGrammarResource
{
	...
	/**
	 *	The shared immutable instance of the org.eclipse.qvtd.xtext.qvtcore.QVTcore Grammar resource.
	 */
	public static final @NonNull QVTcoreGrammarResource INSTANCE = new QVTcoreGrammarResource();

	/**
	 *	The shared immutable instance of the org.eclipse.qvtd.xtext.qvtcore.QVTcore Grammar model.
	 */
	 ...
	 */
	public static final @NonNull String LANGUAGE_NAME = "org.eclipse.qvtd.xtext.qvtcore.QVTcore";

	protected QVTcoreGrammarResource() {
		super(URI.createURI(LANGUAGE_NAME));
		List<EObject> contents = getContents();
		contents.add(_QVTcore.initGrammar());
	...
	private static class _QVTcore
	{
		...
		private static final @NonNull ParserRule PR_MappingCS = createParserRule("MappingCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorecs.QVTcoreCSPackage.Literals.MAPPING_CS));
		private static final @NonNull ParserRule PR_TopLevelCS = createParserRule("TopLevelCS", createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorecs.QVTcoreCSPackage.Literals.TOP_LEVEL_CS));
		
		private static void initParserRules() {
			PR_MappingCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtcorecs.QVTcoreCSPackage.Literals.MAPPING_CS)), setCardinality("?", createAssignment("isDefault", "?=", createKeyword("default"))), createKeyword("map"), setCardinality("?", createAssignment("name", "=", createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), setCardinality("?", createGroup(createKeyword("in"), createAssignment("ownedInPathName", "=", createRuleCall(_Base.PR_PathNameCS)))), setCardinality("?", createGroup(createKeyword("refines"), createAssignment("refines", "+=", createCrossReference(createTypeRef(MM_qvtcore, org.eclipse.qvtd.pivot.qvtcore.QVTcorePackage.Literals.MAPPING), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("refines", "+=", createCrossReference(createTypeRef(MM_qvtcore, org.eclipse.qvtd.pivot.qvtcore.QVTcorePackage.Literals.MAPPING), createRuleCall(_QVTcoreBase.PR_UnrestrictedName))))))), createKeyword("{"), setCardinality("*", createAssignment("ownedDomains", "+=", createRuleCall(_QVTcoreBase.PR_NamedDomainCS))), setCardinality("?", createGroup(createKeyword("where"), createAssignment("ownedMiddle", "=", createRuleCall(_QVTcoreBase.PR_UnnamedDomainCS)))), setCardinality("*", createAssignment("ownedComposedMappings", "+=", createRuleCall(PR_MappingCS))), createKeyword("}")));
			PR_TopLevelCS.setAlternatives(createGroup(setCardinality("*", createAssignment("ownedImports", "+=", createRuleCall(_QVTcoreBase.PR_ImportCS))), setCardinality("*", createAlternatives(createAssignment("ownedMappings", "+=", createRuleCall(PR_MappingCS)), createAssignment("ownedTransformations", "+=", createRuleCall(_QVTcoreBase.PR_TransformationCS)), createAssignment("ownedQueries", "+=", createRuleCall(_QVTcoreBase.PR_QueryCS))))));
		}
