...
public class CollectionTemplateCSAttribution extends AbstractAttribution
{
	public static final CollectionTemplateCSAttribution INSTANCE = new CollectionTemplateCSAttribution();

	@Override
	public ScopeView computeLookup(@NonNull EObject target, @NonNull EnvironmentView environmentView, @NonNull ScopeView scopeView) {
		String name = environmentView.getName();
		if ((scopeView.getContainmentFeature() == QVTrelationCSPackage.Literals.COLLECTION_TEMPLATE_CS__REST_IDENTIFIER) && "_".equals(name)) {
