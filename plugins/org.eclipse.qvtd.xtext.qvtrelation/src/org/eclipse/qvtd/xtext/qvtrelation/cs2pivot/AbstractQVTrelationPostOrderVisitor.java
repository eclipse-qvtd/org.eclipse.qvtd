...
public class AbstractQVTrelationPostOrderVisitor extends EssentialOCLPostOrderVisitor implements QVTrelationCSVisitor<Continuation<?>>
{
	//
	//	This file is maintained by copying from AbstractExtendingQVTrelationCSVisitor and changing R to Continuation<?>.
	//
	public AbstractQVTrelationPostOrderVisitor(@NonNull CS2PivotConversion context) {
		super(context);
	}
