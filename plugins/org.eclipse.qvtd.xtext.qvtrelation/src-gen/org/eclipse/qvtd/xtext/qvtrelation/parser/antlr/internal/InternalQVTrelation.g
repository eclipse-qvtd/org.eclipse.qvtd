...
(
		{ 
	        newCompositeNode(grammarAccess.getObjectTemplateCSAccess().getOwnedTypeSimpleTypeCSParserRuleCall_2_0()); 
	    }
		lv_ownedType_2_0=ruleSimpleTypeCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getObjectTemplateCSRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getPrimitiveTypeDomainCSAccess().getOwnedTypeSimpleTypeCSParserRuleCall_4_0()); 
	    }
		lv_ownedType_4_0=ruleSimpleTypeCS		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getPrimitiveTypeDomainCSRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getQueryCSAccess().getOwnedTypeComplexTypeCSParserRuleCall_6_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getVarDeclarationCSAccess().getOwnedTypeComplexTypeCSParserRuleCall_2_1_0()); 
	    }
