...
public abstract class AbstractQVTrelationSemanticSequencer extends EssentialOCLSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == BaseCSPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case BaseCSPackage.TYPED_TYPE_REF_CS:
				if(context == grammarAccess.getTypedRefCSRule() ||
			...
			case EssentialOCLCSPackage.NAME_EXP_CS:
				if(context == grammarAccess.getNameExpCSRule()) {
					sequence_NameExpCS(context, (NameExpCS) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getPrimaryExpCSAccess().getConstructorExpCSNameExpAction_7_2_1_0() ||
	...
	/**
	 * Constraint:
	 *     ((ownedImport+=UnitCS | ownedLibrary+=LibraryCS)* transformations+=TransformationCS*)
	 */
