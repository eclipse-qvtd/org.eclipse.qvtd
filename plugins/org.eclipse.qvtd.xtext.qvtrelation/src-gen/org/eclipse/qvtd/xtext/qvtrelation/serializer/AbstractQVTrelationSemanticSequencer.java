...
public abstract class AbstractQVTrelationSemanticSequencer extends EssentialOCLSemanticSequencer {
	...
	/**
	 * Constraint:
	 *     (name=UnrestrictedName? ownedType=SimpleTypeCS (ownedPropertyTemplates+=PropertyTemplateCS ownedPropertyTemplates+=PropertyTemplateCS*)?)
	 */
	...
	/**
	 * Constraint:
	 *     (name=UnrestrictedName ownedType=SimpleTypeCS)
	 */
	...
	/**
	 * Constraint:
	 *     (ownedVarDeclarationIds+=VarDeclarationIdCS ownedVarDeclarationIds+=VarDeclarationIdCS* ownedType=ComplexTypeCS? ownedInitExpression=ExpCS?)
	 */
