...
public class QVTrelationGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTrelation
	{
		...
		private static void initParserRules() {
			...
			PR_PrimitiveTypeDomainCS.setAlternatives(createGroup(createKeyword("primitive"), createKeyword("domain"), createAssignment("ownedPatterns", "+=", createRuleCall(PR_PrimitiveTypeDomainPatternCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedPatterns", "+=", createRuleCall(PR_PrimitiveTypeDomainPatternCS)))), createKeyword(";")));
			PR_PrimitiveTypeDomainPatternCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS))));
			...
			PR_QVTrelationUnrestrictedName.setAlternatives(createAlternatives(createKeyword("abstract"), createKeyword("checkonly"), createKeyword("default_values"), createKeyword("dependsOn"), createKeyword("domain"), createKeyword("enforce"), createKeyword("extends"), createKeyword("implementedby"), createKeyword("import"), createKeyword("input"), createKeyword("iterates"), createKeyword("library"), createKeyword("key"), createKeyword("opposite"), createKeyword("output"), createKeyword("overrides"), createKeyword("package"), createKeyword("primitive"), createKeyword("query"), createKeyword("relation"), createKeyword("replace"), createKeyword("target"), createKeyword("top"), createKeyword("transformation"), createKeyword("via"), createKeyword("when"), createKeyword("where")));
			...
			PR_TopLevelCS.setAlternatives(createGroup(setCardinality("*", createAssignment("ownedImports", "+=", createRuleCall(PR_UnitCS))), setCardinality("*", createAlternatives(createAssignment("ownedPackages", "+=", createRuleCall(PR_QualifiedPackageCS)), createAssignment("ownedTransformations", "+=", createRuleCall(PR_TransformationCS))))));
			PR_TransformationCS.setAlternatives(createGroup(createKeyword("transformation"), setCardinality("?", createAssignment("ownedPathName", "=", createRuleCall(PR_ScopeNameCS))), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword("("), createAssignment("ownedModelDecls", "+=", createRuleCall(PR_ModelDeclCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedModelDecls", "+=", createRuleCall(PR_ModelDeclCS)))), createKeyword(")"), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("extends", "+=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TRANSFORMATION), createRuleCall(PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("extends", "+=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TRANSFORMATION), createRuleCall(PR_UnrestrictedName))))))), createKeyword("{"), setCardinality("*", createAssignment("ownedTargets", "+=", createRuleCall(_QVTbase.PR_TargetCS))), setCardinality("*", createAssignment("ownedKeyDecls", "+=", createRuleCall(PR_KeyDeclCS))), setCardinality("*", createAlternatives(createAssignment("ownedRelations", "+=", createRuleCall(PR_RelationCS)), createAssignment("ownedQueries", "+=", createRuleCall(PR_QueryCS)), createAssignment("ownedProperties", "+=", createRuleCall(_QVTbase.PR_StructuralFeatureCS)))), createKeyword("}")));
			PR_TypedRefCS.setAlternatives(createAlternatives(createGroup(createRuleCall(_EssentialOCL.PR_PrimitiveTypeCS), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS)))), createGroup(createRuleCall(_EssentialOCL.PR_CollectionTypeCS), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS)))), createGroup(createRuleCall(PR_TypedTypeRefCS), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS))))));
			...
			PR_UnrestrictedName.setAlternatives(createAlternatives(createRuleCall(_EssentialOCL.PR_EssentialOCLUnrestrictedName), createRuleCall(_QVTbase.PR_QVTbaseUnrestrictedName), createRuleCall(PR_QVTrelationUnrestrictedName)));
	...
	private static class _QVTbase
	{
		...
		private static void initParserRules() {
			...
			PR_SimpleTargetElementCS.setAlternatives(createGroup(createAlternatives(createAssignment("input", "?=", createKeyword("input")), createAssignment("output", "?=", createKeyword("output")), createAssignment("via", "?=", createKeyword("via"))), createAssignment("typedModel", "=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(_QVTrelation.PR_UnrestrictedName))), setCardinality("?", createGroup(createKeyword("iterates"), createAlternatives(createAssignment("iterates", "+=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(_QVTrelation.PR_UnrestrictedName))), createGroup(createKeyword("{"), setCardinality("?", createGroup(createAssignment("iterates", "+=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(_QVTrelation.PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("iterates", "+=", createCrossReference(createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(_QVTrelation.PR_UnrestrictedName))))))), createKeyword("}"))))), createKeyword(";")));
			...
			PR_TargetCS.setAlternatives(createGroup(createKeyword("target"), createAssignment("name", "=", createRuleCall(_QVTrelation.PR_UnrestrictedName)), createKeyword("{"), setCardinality("*", createAssignment("ownedTargetElements", "+=", createAlternatives(createRuleCall(PR_SimpleTargetElementCS), createRuleCall(PR_CompoundTargetElementCS)))), createKeyword("}"), setCardinality("?", createKeyword(";"))));
			...
			PR_TypedRefCS.setAlternatives(createAlternatives(createRuleCall(_EssentialOCL.PR_TypeLiteralCS), createRuleCall(_QVTrelation.PR_TypedTypeRefCS)));
		}
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_CoIteratorVariableCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTrelation.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS))))));
