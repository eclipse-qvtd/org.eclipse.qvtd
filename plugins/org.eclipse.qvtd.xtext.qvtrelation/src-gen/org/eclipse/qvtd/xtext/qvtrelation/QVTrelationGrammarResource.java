...
public class QVTrelationGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTrelation
	{
		...
		private static void initParserRules() {
			...
			PR_QVTrelationUnrestrictedName.setAlternatives(createAlternatives(createKeyword("abstract"), createKeyword("checkonly"), createKeyword("default_values"), createKeyword("dependsOn"), createKeyword("domain"), createKeyword("enforce"), createKeyword("extends"), createKeyword("implementedby"), createKeyword("import"), createKeyword("iterates"), createKeyword("library"), createKeyword("key"), createKeyword("opposite"), createKeyword("overrides"), createKeyword("package"), createKeyword("primitive"), createKeyword("query"), createKeyword("relation"), createKeyword("replace"), createKeyword("top"), createKeyword("transformation"), createKeyword("when"), createKeyword("where")));
