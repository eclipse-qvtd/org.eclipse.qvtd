...
public class QVTrelationGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTrelation
	{
		...
		private static void initParserRules() {
			...
			PR_QVTrelationUnrestrictedName.setAlternatives(createAlternatives(createKeyword("checkonly"), createKeyword("default"), createKeyword("default_values"), createKeyword("domain"), createKeyword("enforce"), createKeyword("extends"), createKeyword("implementedby"), createKeyword("import"), createKeyword("inplace"), createKeyword("library"), createKeyword("key"), createKeyword("opposite"), createKeyword("overrides"), createKeyword("package"), createKeyword("primitive"), createKeyword("query"), createKeyword("relation"), createKeyword("replace"), createKeyword("top"), createKeyword("transformation"), createKeyword("uses"), createKeyword("when"), createKeyword("where")));
