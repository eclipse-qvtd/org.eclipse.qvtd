...
public class QVTrelationGrammarResource extends AbstractGrammarResource
{
	...
	private static class _QVTrelation
	{
		...
		private static void initParserRules() {
			...
			PR_ElementTemplateCS.setAlternatives(createAlternatives(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.qvtd.xtext.qvtrelationcs.QVTrelationCSPackage.Literals.ELEMENT_TEMPLATE_CS)), createKeyword("_"))));
			...
			PR_UnrestrictedName.setAlternatives(createAlternatives(createRuleCall(_EssentialOCL.PR_EssentialOCLUnrestrictedName), createKeyword("checkonly"), createKeyword("default_values"), createKeyword("domain"), createKeyword("enforce"), createKeyword("extends"), createKeyword("implementedby"), createKeyword("import"), createKeyword("library"), createKeyword("key"), createKeyword("opposite"), createKeyword("overrides"), createKeyword("primitive"), createKeyword("query"), createKeyword("relation"), createKeyword("replace"), createKeyword("top"), createKeyword("transformation"), createKeyword("when"), createKeyword("where")));
			PR_VarDeclarationCS.setAlternatives(createGroup(createAssignment("ownedVarDeclarationIds", "+=", createRuleCall(PR_VarDeclarationIdCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedVarDeclarationIds", "+=", createRuleCall(PR_VarDeclarationIdCS)))), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedRefCS)), createKeyword(";")));
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_EssentialOCLUnreservedName.setAlternatives(createAlternatives(createRuleCall(_QVTrelation.PR_UnrestrictedName), createRuleCall(PR_CollectionTypeIdentifier), createRuleCall(PR_PrimitiveTypeIdentifier), createKeyword("Tuple")));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_QVTrelation.PR_UnrestrictedName)), setCardinality("?", createAlternatives(createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_QVTrelation.PR_TypedRefCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_QVTrelation.PR_TypedRefCS))))), createGroup(createKeyword("super"), createAssignment("ownedSuper", "=", createRuleCall(_QVTrelation.PR_TypedRefCS)))))));
			...
			PR_WildcardTypeRefCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS)), createKeyword("?"), setCardinality("?", createAlternatives(createGroup(createKeyword("extends"), createAssignment("ownedExtends", "=", createRuleCall(_QVTrelation.PR_TypedRefCS))), createGroup(createKeyword("super"), createAssignment("ownedSuper", "=", createRuleCall(_QVTrelation.PR_TypedRefCS)))))));
		}
