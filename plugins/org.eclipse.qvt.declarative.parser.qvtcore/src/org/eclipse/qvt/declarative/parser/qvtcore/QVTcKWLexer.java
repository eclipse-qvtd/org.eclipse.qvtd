...
* </copyright>
*
* $Id: QVTcKWLexer.java,v 1.5 2008/10/10 07:27:22 ewillink Exp $
*/
...
public class QVTcKWLexer extends QVTcKWLexerprs implements QVTcParsersym
{
    ...
    public QVTcKWLexer(char[] inputChars, int identifierKind)
    {
        ...
        //
        // Rule 64:  KeyWord ::= c h e c k
        //
		keywordKind[64] = (TK_check);
	  
	
        //
        // Rule 65:  KeyWord ::= c r e a t i o n
        //
		keywordKind[65] = (TK_creation);
	  
	
        //
        // Rule 66:  KeyWord ::= d e f a u l t
        //
		keywordKind[66] = (TK_default);
	  
	
        //
        // Rule 67:  KeyWord ::= d e l e t i o n
        //
		keywordKind[67] = (TK_deletion);
	  
	
        //
        // Rule 68:  KeyWord ::= e n f o r c e
        //
		keywordKind[68] = (TK_enforce);
	  
	
        //
        // Rule 69:  KeyWord ::= i m p o r t s
        //
		keywordKind[69] = (TK_imports);
	  
	
        //
        // Rule 70:  KeyWord ::= m a p
        //
		keywordKind[70] = (TK_map);
	  
	
        //
        // Rule 71:  KeyWord ::= q u e r y
        //
		keywordKind[71] = (TK_query);
	  
	
        //
        // Rule 72:  KeyWord ::= r e a l i z e
        //
		keywordKind[72] = (TK_realize);
	  
	
        //
        // Rule 73:  KeyWord ::= r e f i n e s
        //
		keywordKind[73] = (TK_refines);
	  
	
        //
        // Rule 74:  KeyWord ::= t r a n s f o r m a t i o n
        //
		keywordKind[74] = (TK_transformation);
	  
	
        //
        // Rule 75:  KeyWord ::= u s e s
        //
		keywordKind[75] = (TK_uses);
	  
	
        //
        // Rule 76:  KeyWord ::= w h e r e
        //
		keywordKind[76] = (TK_where);
