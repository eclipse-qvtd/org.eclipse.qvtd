		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPrimitiveTypeDomainCSAccess().getOwnedTypeAssignment_4(), "rule__PrimitiveTypeDomainCS__OwnedTypeAssignment_4");
					...
					put(grammarAccess.getQueryCSAccess().getOwnedParametersAssignment_3_0(), "rule__QueryCS__OwnedParametersAssignment_3_0");
					put(grammarAccess.getQueryCSAccess().getOwnedParametersAssignment_3_1_1(), "rule__QueryCS__OwnedParametersAssignment_3_1_1");
					put(grammarAccess.getQueryCSAccess().getOwnedTypeAssignment_6(), "rule__QueryCS__OwnedTypeAssignment_6");
					put(grammarAccess.getQueryCSAccess().getOwnedExpressionAssignment_7_1_1(), "rule__QueryCS__OwnedExpressionAssignment_7_1_1");
