		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSimpleTypeCSAccess().getAlternatives(), "rule__SimpleTypeCS__Alternatives");
					put(grammarAccess.getComplexTypeCSAccess().getAlternatives(), "rule__ComplexTypeCS__Alternatives");
					...
					put(grammarAccess.getTypeLiteralWithMultiplicityCSAccess().getAlternatives(), "rule__TypeLiteralWithMultiplicityCS__Alternatives");
					put(grammarAccess.getTypeLiteralWithMultiplicityCSAccess().getAlternatives_2_0(), "rule__TypeLiteralWithMultiplicityCS__Alternatives_2_0");
					...
					put(grammarAccess.getCollectionTypeWithMultiplicityCSAccess().getGroup(), "rule__CollectionTypeWithMultiplicityCS__Group__0");
					put(grammarAccess.getLambdaTypeCSAccess().getGroup(), "rule__LambdaTypeCS__Group__0");
					put(grammarAccess.getLambdaTypeCSAccess().getGroup_3(), "rule__LambdaTypeCS__Group_3__0");
					put(grammarAccess.getLambdaTypeCSAccess().getGroup_3_1(), "rule__LambdaTypeCS__Group_3_1__0");
					...
					put(grammarAccess.getComplexTypeCSAccess().getGroup_1(), "rule__ComplexTypeCS__Group_1__0");
					...
					put(grammarAccess.getPathExpCSAccess().getGroup(), "rule__PathExpCS__Group__0");
					put(grammarAccess.getPathExpCSAccess().getGroup_1(), "rule__PathExpCS__Group_1__0");
					put(grammarAccess.getPathExpCSAccess().getGroup_2(), "rule__PathExpCS__Group_2__0");
					put(grammarAccess.getPathExpCSAccess().getGroup_2_1(), "rule__PathExpCS__Group_2_1__0");
					...
					put(grammarAccess.getPathTypeCSAccess().getGroup(), "rule__PathTypeCS__Group__0");
					put(grammarAccess.getPathTypeCSAccess().getGroup_1(), "rule__PathTypeCS__Group_1__0");
					...
					put(grammarAccess.getCollectionTypeWithMultiplicityCSAccess().getOwnedMultiplicityAssignment_1(), "rule__CollectionTypeWithMultiplicityCS__OwnedMultiplicityAssignment_1");
					...
					put(grammarAccess.getLambdaTypeCSAccess().getOwnedParameterTypesAssignment_3_0(), "rule__LambdaTypeCS__OwnedParameterTypesAssignment_3_0");
					put(grammarAccess.getLambdaTypeCSAccess().getOwnedParameterTypesAssignment_3_1_1(), "rule__LambdaTypeCS__OwnedParameterTypesAssignment_3_1_1");
					put(grammarAccess.getLambdaTypeCSAccess().getOwnedResultTypeAssignment_6(), "rule__LambdaTypeCS__OwnedResultTypeAssignment_6");
					...
					put(grammarAccess.getComplexTypeCSAccess().getOwnedMultiplicityAssignment_1_1(), "rule__ComplexTypeCS__OwnedMultiplicityAssignment_1_1");
					...
					put(grammarAccess.getPathExpCSAccess().getOwnedPathNameAssignment_0(), "rule__PathExpCS__OwnedPathNameAssignment_0");
					put(grammarAccess.getPathExpCSAccess().getOwnedBindingAssignment_1_1(), "rule__PathExpCS__OwnedBindingAssignment_1_1");
					put(grammarAccess.getPathExpCSAccess().getOwnedCurlyBracketedClauseAssignment_2_0(), "rule__PathExpCS__OwnedCurlyBracketedClauseAssignment_2_0");
					put(grammarAccess.getPathExpCSAccess().getOwnedPatternGuardAssignment_2_1_1(), "rule__PathExpCS__OwnedPatternGuardAssignment_2_1_1");
					put(grammarAccess.getPathExpCSAccess().getOwnedMultiplicityAssignment_3(), "rule__PathExpCS__OwnedMultiplicityAssignment_3");
					...
					put(grammarAccess.getPathTypeCSAccess().getOwnedPathNameAssignment_0(), "rule__PathTypeCS__OwnedPathNameAssignment_0");
					put(grammarAccess.getPathTypeCSAccess().getOwnedBindingAssignment_1_1(), "rule__PathTypeCS__OwnedBindingAssignment_1_1");
