		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCollectionTemplateCSAccess().getOwnedMemberIdentifiersAlternatives_3_1_0_0(), "rule__CollectionTemplateCS__OwnedMemberIdentifiersAlternatives_3_1_0_0");
					put(grammarAccess.getCollectionTemplateCSAccess().getOwnedMemberIdentifiersAlternatives_3_1_1_1_0(), "rule__CollectionTemplateCS__OwnedMemberIdentifiersAlternatives_3_1_1_1_0");
					...
					put(grammarAccess.getTransformationCSAccess().getAlternatives_11(), "rule__TransformationCS__Alternatives_11");
					...
					put(grammarAccess.getSimpleTargetElementCSAccess().getAlternatives_0(), "rule__SimpleTargetElementCS__Alternatives_0");
					put(grammarAccess.getSimpleTargetElementCSAccess().getAlternatives_2_1(), "rule__SimpleTargetElementCS__Alternatives_2_1");
					...
					put(grammarAccess.getTargetCSAccess().getOwnedTargetElementsAlternatives_3_0(), "rule__TargetCS__OwnedTargetElementsAlternatives_3_0");
					...
					put(grammarAccess.getCollectionTemplateCSAccess().getGroup_3(), "rule__CollectionTemplateCS__Group_3__0");
					put(grammarAccess.getCollectionTemplateCSAccess().getGroup_3_1(), "rule__CollectionTemplateCS__Group_3_1__0");
					put(grammarAccess.getCollectionTemplateCSAccess().getGroup_3_1_1(), "rule__CollectionTemplateCS__Group_3_1_1__0");
					...
					put(grammarAccess.getDomainCSAccess().getGroup_3(), "rule__DomainCS__Group_3__0");
					put(grammarAccess.getDomainCSAccess().getGroup_3_1(), "rule__DomainCS__Group_3_1__0");
					...
					put(grammarAccess.getObjectTemplateCSAccess().getGroup_3_1_1(), "rule__ObjectTemplateCS__Group_3_1_1__0");
					...
					put(grammarAccess.getCompoundTargetElementCSAccess().getGroup(), "rule__CompoundTargetElementCS__Group__0");
					...
					put(grammarAccess.getSimpleTargetElementCSAccess().getGroup(), "rule__SimpleTargetElementCS__Group__0");
					put(grammarAccess.getSimpleTargetElementCSAccess().getGroup_2(), "rule__SimpleTargetElementCS__Group_2__0");
					put(grammarAccess.getSimpleTargetElementCSAccess().getGroup_2_1_1(), "rule__SimpleTargetElementCS__Group_2_1_1__0");
					put(grammarAccess.getSimpleTargetElementCSAccess().getGroup_2_1_1_1(), "rule__SimpleTargetElementCS__Group_2_1_1_1__0");
					put(grammarAccess.getSimpleTargetElementCSAccess().getGroup_2_1_1_1_1(), "rule__SimpleTargetElementCS__Group_2_1_1_1_1__0");
					...
					put(grammarAccess.getTargetCSAccess().getGroup(), "rule__TargetCS__Group__0");
					...
					put(grammarAccess.getCollectionTemplateCSAccess().getOwnedMemberIdentifiersAssignment_3_1_0(), "rule__CollectionTemplateCS__OwnedMemberIdentifiersAssignment_3_1_0");
					put(grammarAccess.getCollectionTemplateCSAccess().getOwnedMemberIdentifiersAssignment_3_1_1_1(), "rule__CollectionTemplateCS__OwnedMemberIdentifiersAssignment_3_1_1_1");
					put(grammarAccess.getCollectionTemplateCSAccess().getOwnedRestIdentifierAssignment_3_1_3(), "rule__CollectionTemplateCS__OwnedRestIdentifierAssignment_3_1_3");
					...
					put(grammarAccess.getDomainCSAccess().getOwnedPatternsAssignment_3_0(), "rule__DomainCS__OwnedPatternsAssignment_3_0");
					put(grammarAccess.getDomainCSAccess().getOwnedPatternsAssignment_3_1_1(), "rule__DomainCS__OwnedPatternsAssignment_3_1_1");
					...
					put(grammarAccess.getObjectTemplateCSAccess().getOwnedPropertyTemplatesAssignment_3_1_1_1(), "rule__ObjectTemplateCS__OwnedPropertyTemplatesAssignment_3_1_1_1");
					...
					put(grammarAccess.getTransformationCSAccess().getOwnedTargetsAssignment_9(), "rule__TransformationCS__OwnedTargetsAssignment_9");
					put(grammarAccess.getTransformationCSAccess().getOwnedKeyDeclsAssignment_10(), "rule__TransformationCS__OwnedKeyDeclsAssignment_10");
					put(grammarAccess.getTransformationCSAccess().getOwnedRelationsAssignment_11_0(), "rule__TransformationCS__OwnedRelationsAssignment_11_0");
					put(grammarAccess.getTransformationCSAccess().getOwnedQueriesAssignment_11_1(), "rule__TransformationCS__OwnedQueriesAssignment_11_1");
					put(grammarAccess.getTransformationCSAccess().getOwnedPropertiesAssignment_11_2(), "rule__TransformationCS__OwnedPropertiesAssignment_11_2");
					...
					put(grammarAccess.getCompoundTargetElementCSAccess().getOwnedTargetElementsAssignment_1(), "rule__CompoundTargetElementCS__OwnedTargetElementsAssignment_1");
					...
					put(grammarAccess.getSimpleTargetElementCSAccess().getInputAssignment_0_0(), "rule__SimpleTargetElementCS__InputAssignment_0_0");
					put(grammarAccess.getSimpleTargetElementCSAccess().getOutputAssignment_0_1(), "rule__SimpleTargetElementCS__OutputAssignment_0_1");
					put(grammarAccess.getSimpleTargetElementCSAccess().getViaAssignment_0_2(), "rule__SimpleTargetElementCS__ViaAssignment_0_2");
					put(grammarAccess.getSimpleTargetElementCSAccess().getTypedModelAssignment_1(), "rule__SimpleTargetElementCS__TypedModelAssignment_1");
					put(grammarAccess.getSimpleTargetElementCSAccess().getIteratesAssignment_2_1_0(), "rule__SimpleTargetElementCS__IteratesAssignment_2_1_0");
					put(grammarAccess.getSimpleTargetElementCSAccess().getIteratesAssignment_2_1_1_1_0(), "rule__SimpleTargetElementCS__IteratesAssignment_2_1_1_1_0");
					put(grammarAccess.getSimpleTargetElementCSAccess().getIteratesAssignment_2_1_1_1_1_1(), "rule__SimpleTargetElementCS__IteratesAssignment_2_1_1_1_1_1");
					...
					put(grammarAccess.getTargetCSAccess().getNameAssignment_1(), "rule__TargetCS__NameAssignment_1");
					put(grammarAccess.getTargetCSAccess().getOwnedTargetElementsAssignment_3(), "rule__TargetCS__OwnedTargetElementsAssignment_3");
