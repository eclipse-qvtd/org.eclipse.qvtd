		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRelationCSAccess().getOwnedVarDeclarationsAssignment_5(), "rule__RelationCS__OwnedVarDeclarationsAssignment_5");
					put(grammarAccess.getRelationCSAccess().getOwnedDomainsAssignment_6_0(), "rule__RelationCS__OwnedDomainsAssignment_6_0");
					put(grammarAccess.getRelationCSAccess().getOwnedDomainsAssignment_6_1(), "rule__RelationCS__OwnedDomainsAssignment_6_1");
					put(grammarAccess.getRelationCSAccess().getOwnedWhenAssignment_7(), "rule__RelationCS__OwnedWhenAssignment_7");
					put(grammarAccess.getRelationCSAccess().getOwnedWhereAssignment_8(), "rule__RelationCS__OwnedWhereAssignment_8");
