		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTransformationCSAccess().getOwnedModelDeclsAssignment_3(), "rule__TransformationCS__OwnedModelDeclsAssignment_3");
					put(grammarAccess.getTransformationCSAccess().getOwnedModelDeclsAssignment_4_1(), "rule__TransformationCS__OwnedModelDeclsAssignment_4_1");
					...
					put(grammarAccess.getTransformationCSAccess().getOwnedKeyDeclsAssignment_8(), "rule__TransformationCS__OwnedKeyDeclsAssignment_8");
					put(grammarAccess.getTransformationCSAccess().getOwnedRelationsAssignment_9_0(), "rule__TransformationCS__OwnedRelationsAssignment_9_0");
					put(grammarAccess.getTransformationCSAccess().getOwnedQueriesAssignment_9_1(), "rule__TransformationCS__OwnedQueriesAssignment_9_1");
