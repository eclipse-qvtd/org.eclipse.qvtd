 ...
 */
public class QVTrelationExecutableExtensionFactoryOverload extends QVTrelationExecutableExtensionFactory
{
	@Override
	public Object create() throws CoreException {
		...
		Object object = extensionToFactoryMap.get("qvtr");
		if (object instanceof Resource.Factory.Descriptor) {	// OOPS EcorePlugin.ExtensionProcessor has installed an object requiring OSGI getBundle() support.
			new QVTrelationStandaloneSetup().register(getInjector());
			object = extensionToFactoryMap.get("qvtr");
		}
		return object;
	}
	...
	protected Injector getInjector() {
		...
		if (injector == null) {
			injector = QVTrelationStandaloneSetup.getInjector();
		}
		return injector;
	}
}
