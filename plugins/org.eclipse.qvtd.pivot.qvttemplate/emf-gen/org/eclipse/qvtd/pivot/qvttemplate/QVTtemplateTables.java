...
public class QVTtemplateTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Annotation = QVTtemplateTables.PACKid_$metamodel$.getClassId("Annotation", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_CallExp = QVTtemplateTables.PACKid_$metamodel$.getClassId("CallExp", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Class = QVTtemplateTables.PACKid_$metamodel$.getClassId("Class", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_CollectionItem = QVTtemplateTables.PACKid_$metamodel$.getClassId("CollectionItem", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_CollectionRange = QVTtemplateTables.PACKid_$metamodel$.getClassId("CollectionRange", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Comment = QVTtemplateTables.PACKid_$metamodel$.getClassId("Comment", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Constraint = QVTtemplateTables.PACKid_$metamodel$.getClassId("Constraint", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Element = QVTtemplateTables.PACKid_$metamodel$.getClassId("Element", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ElementExtension = QVTtemplateTables.PACKid_$metamodel$.getClassId("ElementExtension", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ExpressionInOCL = QVTtemplateTables.PACKid_$metamodel$.getClassId("ExpressionInOCL", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_IfExp = QVTtemplateTables.PACKid_$metamodel$.getClassId("IfExp", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_LetExp = QVTtemplateTables.PACKid_$metamodel$.getClassId("LetExp", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_LoopExp = QVTtemplateTables.PACKid_$metamodel$.getClassId("LoopExp", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_MapLiteralPart = QVTtemplateTables.PACKid_$metamodel$.getClassId("MapLiteralPart", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_MessageExp = QVTtemplateTables.PACKid_$metamodel$.getClassId("MessageExp", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_NavigationCallExp = QVTtemplateTables.PACKid_$metamodel$.getClassId("NavigationCallExp", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OclComparable = QVTtemplateTables.PACKid_$metamodel$.getClassId("OclComparable", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OclElement = QVTtemplateTables.PACKid_$metamodel$.getClassId("OclElement", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OclState = QVTtemplateTables.PACKid_$metamodel$.getClassId("OclState", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OclStereotype = QVTtemplateTables.PACKid_$metamodel$.getClassId("OclStereotype", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OclType = QVTtemplateTables.PACKid_$metamodel$.getClassId("OclType", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OperationCallExp = QVTtemplateTables.PACKid_$metamodel$.getClassId("OperationCallExp", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ReferringElement = QVTtemplateTables.PACKid_$metamodel$.getClassId("ReferringElement", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ShadowPart = QVTtemplateTables.PACKid_$metamodel$.getClassId("ShadowPart", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_TupleLiteralPart = QVTtemplateTables.PACKid_$metamodel$.getClassId("TupleLiteralPart", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Type = QVTtemplateTables.PACKid_$metamodel$.getClassId("Type", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_TypedElement = QVTtemplateTables.PACKid_$metamodel$.getClassId("TypedElement", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ValueSpecification = QVTtemplateTables.PACKid_$metamodel$.getClassId("ValueSpecification", 0);
	...
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_Annotation = TypeId.BAG.getSpecializedId(QVTtemplateTables.CLSSid_Annotation, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_Constraint = TypeId.BAG.getSpecializedId(QVTtemplateTables.CLSSid_Constraint, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_NavigationCallExp = TypeId.BAG.getSpecializedId(QVTtemplateTables.CLSSid_NavigationCallExp, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_OclElement = TypeId.BAG.getSpecializedId(QVTtemplateTables.CLSSid_OclElement, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId ORD_CLSSid_Element = TypeId.ORDERED_SET.getSpecializedId(QVTtemplateTables.CLSSid_Element, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Comment = TypeId.SET.getSpecializedId(QVTtemplateTables.CLSSid_Comment, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Element = TypeId.SET.getSpecializedId(QVTtemplateTables.CLSSid_Element, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_ElementExtension = TypeId.SET.getSpecializedId(QVTtemplateTables.CLSSid_ElementExtension, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_OclElement = TypeId.SET.getSpecializedId(QVTtemplateTables.CLSSid_OclElement, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
