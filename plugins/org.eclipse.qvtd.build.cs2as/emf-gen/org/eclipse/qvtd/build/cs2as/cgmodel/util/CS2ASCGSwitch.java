...
import org.eclipse.qvtd.build.cs2as.cgmodel.*;
 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.qvtd.build.cs2as.cgmodel.CS2ASCGPackage
 * @generated
 */
public class CS2ASCGSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CS2ASCGPackage.CG_LOOKUP_CALL_EXP: {
				...
				if (result == null) result = caseCGCallExp(cgLookupCallExp);
				if (result == null) result = caseCGValuedElement(cgLookupCallExp);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>CG Lookup Call Exp</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>CG Lookup Call Exp</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCGLookupCallExp(CGLookupCallExp object) {
		return null;
	}
