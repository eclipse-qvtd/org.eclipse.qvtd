...
public class GuardParameterBindingAttribution extends EmptyAttribution
{
	public static final @NonNull GuardParameterBindingAttribution INSTANCE = new GuardParameterBindingAttribution();

	@Override
	public ScopeView computeLookup(@NonNull EObject target, @NonNull EnvironmentView environmentView, @NonNull ScopeView scopeView) {
		GuardParameterBinding mappingParameterBinding = (GuardParameterBinding)target;
