...
public class LoopParameterBindingAttribution extends EmptyAttribution
{
	public static final @NonNull LoopParameterBindingAttribution INSTANCE = new LoopParameterBindingAttribution();

	@Override
	public ScopeView computeLookup(@NonNull EObject target, @NonNull EnvironmentView environmentView, @NonNull ScopeView scopeView) {
		LoopParameterBinding mappingParameterBinding = (LoopParameterBinding)target;
