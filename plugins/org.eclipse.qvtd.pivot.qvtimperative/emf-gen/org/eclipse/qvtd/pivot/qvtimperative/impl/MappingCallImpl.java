...
public class MappingCallImpl extends MappingStatementImpl implements MappingCall {
	...
	public EList<String> getBindingNames() {
		...
		while (true) {
			 ...
			 */
			if (_1 == null) {
				throw new InvalidValueException("Null source for \'qvtimperative::MappingParameterBinding::boundVariable : qvtimperative::MappingParameter[1]\'");
			}
			@SuppressWarnings("null")
		...
		final org.eclipse.ocl.pivot.@NonNull Class TYPE_sortedBy_0 = executor.getStaticClassOf(asSet);
