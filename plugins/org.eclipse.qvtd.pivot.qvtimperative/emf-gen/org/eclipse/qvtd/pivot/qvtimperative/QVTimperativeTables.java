...
public class QVTimperativeTables extends AbstractTables
{
	...
	public static class Parameters {
		...
		public static final @NonNull ParameterTypes _OrderedSet__String__ = new ParameterTypes(MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, OCLstdlibTables.Types._String));
	...
	public static class Properties {
		...
		public static final @NonNull Property _ConnectionVariable__AddStatement__targetVariable = LIBRARY.createOppositeProperty(Types._ConnectionVariable, "AddStatement", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._AddStatement), 1 | IsImplicit | IsRequired | IsResolveProxies, QVTimperativePackage.Literals.ADD_STATEMENT__TARGET_VARIABLE);
		...
		public static final @NonNull Property _ConnectionVariable__GuardParameterBinding__value = LIBRARY.createOppositeProperty(Types._ConnectionVariable, "GuardParameterBinding", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._GuardParameterBinding), 3 | IsImplicit | IsRequired | IsResolveProxies, QVTimperativePackage.Literals.GUARD_PARAMETER_BINDING__VALUE);
		...
		public static final @NonNull Property _EntryPoint__inputTypedModels = LIBRARY.createProperty(Types._EntryPoint, QVTimperativePackage.Literals.ENTRY_POINT__INPUT_TYPED_MODELS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, QVTbaseTables.Types._TypedModel), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _EntryPoint__outputTypedModels = LIBRARY.createProperty(Types._EntryPoint, QVTimperativePackage.Literals.ENTRY_POINT__OUTPUT_TYPED_MODELS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, QVTbaseTables.Types._TypedModel), 1 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _LoopVariable__LoopParameterBinding__value = LIBRARY.createOppositeProperty(Types._LoopVariable, "LoopParameterBinding", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._LoopParameterBinding), 1 | IsImplicit | IsRequired | IsResolveProxies, QVTimperativePackage.Literals.LOOP_PARAMETER_BINDING__VALUE);
		...
		public static final @NonNull Property _Mapping__ownedMappingParameters = LIBRARY.createProperty(Types._Mapping, QVTimperativePackage.Literals.MAPPING__OWNED_MAPPING_PARAMETERS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._MappingParameter), 3 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Mapping__ownedStatements = LIBRARY.createProperty(Types._Mapping, QVTimperativePackage.Literals.MAPPING__OWNED_STATEMENTS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Statement), 4 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Mapping__MappingCall__referredMapping = LIBRARY.createOppositeProperty(Types._Mapping, "MappingCall", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._MappingCall), 5 | IsImplicit | IsRequired | IsResolveProxies, QVTimperativePackage.Literals.MAPPING_CALL__REFERRED_MAPPING);

		public static final @NonNull Property _MappingCall__bindingNames = LIBRARY.createProperty(Types._MappingCall, QVTimperativePackage.Literals.MAPPING_CALL__BINDING_NAMES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, OCLstdlibTables.Types._String), 0 | IsDerived | IsReadOnly | IsRequired | IsResolveProxies | IsTransient | IsVolatile);
		...
		public static final @NonNull Property _MappingCall__ownedMappingParameterBindings = LIBRARY.createProperty(Types._MappingCall, QVTimperativePackage.Literals.MAPPING_CALL__OWNED_MAPPING_PARAMETER_BINDINGS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._MappingParameterBinding), 3 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _MappingCall__referredNames = LIBRARY.createProperty(Types._MappingCall, QVTimperativePackage.Literals.MAPPING_CALL__REFERRED_NAMES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, OCLstdlibTables.Types._String), 5 | IsDerived | IsReadOnly | IsRequired | IsResolveProxies | IsTransient | IsVolatile);
		...
		public static final @NonNull Property _MappingLoop__ownedIterators = LIBRARY.createProperty(Types._MappingLoop, QVTimperativePackage.Literals.MAPPING_LOOP__OWNED_ITERATORS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._LoopVariable), 1 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _MappingLoop__ownedMappingStatements = LIBRARY.createProperty(Types._MappingLoop, QVTimperativePackage.Literals.MAPPING_LOOP__OWNED_MAPPING_STATEMENTS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._MappingStatement), 2 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _MappingParameter__MappingParameterBinding__boundVariable = LIBRARY.createOppositeProperty(Types._MappingParameter, "MappingParameterBinding", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._MappingParameterBinding), 1 | IsImplicit | IsRequired | IsResolveProxies, QVTimperativePackage.Literals.MAPPING_PARAMETER_BINDING__BOUND_VARIABLE);
		...
		public static final @NonNull Property _NewStatement__ownedParts = LIBRARY.createProperty(Types._NewStatement, QVTimperativePackage.Literals.NEW_STATEMENT__OWNED_PARTS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._NewStatementPart), 2 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _ObservableStatement__observedProperties = LIBRARY.createProperty(Types._ObservableStatement, QVTimperativePackage.Literals.OBSERVABLE_STATEMENT__OBSERVED_PROPERTIES, MODEL.getCollectionType(OCLstdlibTables.Types._Set, PivotTables.Types._Property), 0 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _SpeculateStatement__ownedExpressions = LIBRARY.createProperty(Types._SpeculateStatement, QVTimperativePackage.Literals.SPECULATE_STATEMENT__OWNED_EXPRESSIONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, PivotTables.Types._OCLExpression), 0 | IsComposite | IsRequired | IsResolveProxies);
