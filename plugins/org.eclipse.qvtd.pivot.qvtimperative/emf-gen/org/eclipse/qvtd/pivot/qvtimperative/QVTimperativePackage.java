...
public interface QVTimperativePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int IMPERATIVE_MODEL__XMIID_VERSION = QVTbasePackage.BASE_MODEL__XMIID_VERSION;
	 ...
	 * @ordered
	 */
	int IMPERATIVE_TRANSFORMATION___VALIDATE_NAME_IS_NOT_NULL__DIAGNOSTICCHAIN_MAP = QVTbasePackage.TRANSFORMATION___VALIDATE_NAME_IS_NOT_NULL__DIAGNOSTICCHAIN_MAP;
	 ...
	 * @ordered
	 */
	int NEW_STATEMENT___VALIDATE_NON_DATA_TYPE_FOR_TYPE__DIAGNOSTICCHAIN_MAP = VARIABLE_STATEMENT_OPERATION_COUNT + 1;
	 ...
	 * @ordered
	 */
	int NEW_STATEMENT_OPERATION_COUNT = VARIABLE_STATEMENT_OPERATION_COUNT + 2;
