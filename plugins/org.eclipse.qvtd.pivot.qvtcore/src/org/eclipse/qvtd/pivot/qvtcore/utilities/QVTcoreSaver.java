...
import org.eclipse.qvtd.pivot.qvtcore.util.AbstractNullQVTcoreVisitor;

/**
 * PivotSaver ensures that all references to specialized types are terminated
 * by local copies of the specialization.
 */
public class QVTcoreSaver extends QVTbaseSaver
{
	 ...
	 */
	public static class LocateVisitor extends AbstractNullQVTcoreVisitor<Object, AbstractPivotSaver> implements AbstractPivotSaver.LocateVisitor
	{
	 ...
	 */
	public static class ResolveVisitor extends AbstractNullQVTcoreVisitor<Object, AbstractPivotSaver> implements AbstractPivotSaver.ResolveVisitor
	{
	...
	protected QVTcoreSaver(Resource resource) {
		super(resource);
	}
}