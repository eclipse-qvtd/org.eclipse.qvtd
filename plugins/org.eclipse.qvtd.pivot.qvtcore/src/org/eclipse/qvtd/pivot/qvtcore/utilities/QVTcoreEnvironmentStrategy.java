...
public class QVTcoreEnvironmentStrategy extends EnvironmentStrategy
{
	public static final @NonNull EnvironmentStrategy INSTANCE = new QVTcoreEnvironmentStrategy();
