...
public class QVTcoreTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Annotation = QVTcoreTables.PACKid_$metamodel$.getClassId("Annotation", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Comment = QVTcoreTables.PACKid_$metamodel$.getClassId("Comment", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_CompleteModel = QVTcoreTables.PACKid_$metamodel$.getClassId("CompleteModel", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Constraint = QVTcoreTables.PACKid_$metamodel$.getClassId("Constraint", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Element = QVTcoreTables.PACKid_$metamodel$.getClassId("Element", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ElementExtension = QVTcoreTables.PACKid_$metamodel$.getClassId("ElementExtension", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ExpressionInOCL = QVTcoreTables.PACKid_$metamodel$.getClassId("ExpressionInOCL", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Import = QVTcoreTables.PACKid_$metamodel$.getClassId("Import", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_InvalidType = QVTcoreTables.PACKid_$metamodel$.getClassId("InvalidType", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_IterateExp = QVTcoreTables.PACKid_$metamodel$.getClassId("IterateExp", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_LetExp = QVTcoreTables.PACKid_$metamodel$.getClassId("LetExp", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_LoopExp = QVTcoreTables.PACKid_$metamodel$.getClassId("LoopExp", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OclElement = QVTcoreTables.PACKid_$metamodel$.getClassId("OclElement", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OclEnumeration = QVTcoreTables.PACKid_$metamodel$.getClassId("OclEnumeration", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OclState = QVTcoreTables.PACKid_$metamodel$.getClassId("OclState", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_OclStereotype = QVTcoreTables.PACKid_$metamodel$.getClassId("OclStereotype", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Package = QVTcoreTables.PACKid_$metamodel$.getClassId("Package", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Parameter = QVTcoreTables.PACKid_$metamodel$.getClassId("Parameter", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ParameterVariable = QVTcoreTables.PACKid_$metamodel$.getClassId("ParameterVariable", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Predicate = QVTcoreTables.PACKid_http_c_s_s_www_eclipse_org_s_qvt_s_2015_s_QVTbase.getClassId("Predicate", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ReferringElement = QVTcoreTables.PACKid_$metamodel$.getClassId("ReferringElement", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Rule = QVTcoreTables.PACKid_http_c_s_s_www_eclipse_org_s_qvt_s_2015_s_QVTbase.getClassId("Rule", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_TypedElement = QVTcoreTables.PACKid_$metamodel$.getClassId("TypedElement", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_TypedModel = QVTcoreTables.PACKid_http_c_s_s_www_eclipse_org_s_qvt_s_2015_s_QVTbase.getClassId("TypedModel", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_ValueSpecification = QVTcoreTables.PACKid_$metamodel$.getClassId("ValueSpecification", 0);
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_Variable = QVTcoreTables.PACKid_$metamodel$.getClassId("Variable", 0);
	...
	public static final /*@NonInvalid*/ @NonNull ClassId CLSSid_VariableExp = QVTcoreTables.PACKid_$metamodel$.getClassId("VariableExp", 0);
	...
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_Annotation = TypeId.BAG.getSpecializedId(QVTcoreTables.CLSSid_Annotation, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_CompleteModel = TypeId.BAG.getSpecializedId(QVTcoreTables.CLSSid_CompleteModel, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_Constraint = TypeId.BAG.getSpecializedId(QVTcoreTables.CLSSid_Constraint, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_Import = TypeId.BAG.getSpecializedId(QVTcoreTables.CLSSid_Import, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_OclElement = TypeId.BAG.getSpecializedId(QVTcoreTables.CLSSid_OclElement, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId BAG_CLSSid_VariableExp = TypeId.BAG.getSpecializedId(QVTcoreTables.CLSSid_VariableExp, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId ORD_CLSSid_Element = TypeId.ORDERED_SET.getSpecializedId(QVTcoreTables.CLSSid_Element, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId ORD_CLSSid_Import = TypeId.ORDERED_SET.getSpecializedId(QVTcoreTables.CLSSid_Import, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId ORD_CLSSid_Rule = TypeId.ORDERED_SET.getSpecializedId(QVTcoreTables.CLSSid_Rule, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId ORD_CLSSid_TypedModel = TypeId.ORDERED_SET.getSpecializedId(QVTcoreTables.CLSSid_TypedModel, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Comment = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_Comment, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Constraint = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_Constraint, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Element = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_Element, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_ElementExtension = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_ElementExtension, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_OclElement = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_OclElement, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Package = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_Package, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Predicate = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_Predicate, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Rule = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_Rule, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Rule_0 = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_Rule, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ @NonNull CollectionTypeId SET_CLSSid_Variable = TypeId.SET.getSpecializedId(QVTcoreTables.CLSSid_Variable, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
