...
public class UMLXTables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final @NonNull Property _RelDiagram__ownedRelDomainNodes = LIBRARY.createProperty(Types._RelDiagram, UMLXPackage.Literals.REL_DIAGRAM__OWNED_REL_DOMAIN_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._RelDomainNode), 2 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _RelDiagram__ownedRelInvocationNodes = LIBRARY.createProperty(Types._RelDiagram, UMLXPackage.Literals.REL_DIAGRAM__OWNED_REL_INVOCATION_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._RelInvocationNode), 3 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _RelDiagram__RelInvocationNode__referredRelDiagram = LIBRARY.createOppositeProperty(Types._RelDiagram, "RelInvocationNode", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._RelInvocationNode), 5 | IsImplicit | IsRequired | IsResolveProxies, UMLXPackage.Literals.REL_INVOCATION_NODE__REFERRED_REL_DIAGRAM);
		...
		public static final @NonNull Property _RelDomainNode__ownedRelPatternEdges = LIBRARY.createProperty(Types._RelDomainNode, UMLXPackage.Literals.REL_DOMAIN_NODE__OWNED_REL_PATTERN_EDGES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._RelPatternEdge), 1 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _RelDomainNode__ownedRelPatternNodes = LIBRARY.createProperty(Types._RelDomainNode, UMLXPackage.Literals.REL_DOMAIN_NODE__OWNED_REL_PATTERN_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._RelPatternNode), 2 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _RelPatternNode__incoming = LIBRARY.createProperty(Types._RelPatternNode, UMLXPackage.Literals.REL_PATTERN_NODE__INCOMING, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._RelPatternEdge), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _RelPatternNode__initExpressionLines = LIBRARY.createProperty(Types._RelPatternNode, UMLXPackage.Literals.REL_PATTERN_NODE__INIT_EXPRESSION_LINES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, OCLstdlibTables.Types._String), 1 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _RelPatternNode__outgoing = LIBRARY.createProperty(Types._RelPatternNode, UMLXPackage.Literals.REL_PATTERN_NODE__OUTGOING, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._RelPatternEdge), 5 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TxDiagram__ownedRelDiagrams = LIBRARY.createProperty(Types._TxDiagram, UMLXPackage.Literals.TX_DIAGRAM__OWNED_REL_DIAGRAMS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._RelDiagram), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _TxDiagram__ownedTxKeyNodes = LIBRARY.createProperty(Types._TxDiagram, UMLXPackage.Literals.TX_DIAGRAM__OWNED_TX_KEY_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxKeyNode), 1 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _TxDiagram__ownedTxPackageNodes = LIBRARY.createProperty(Types._TxDiagram, UMLXPackage.Literals.TX_DIAGRAM__OWNED_TX_PACKAGE_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxPackageNode), 2 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _TxDiagram__ownedTxQueryNodes = LIBRARY.createProperty(Types._TxDiagram, UMLXPackage.Literals.TX_DIAGRAM__OWNED_TX_QUERY_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxQueryNode), 3 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _TxDiagram__ownedTxTypedModelNodes = LIBRARY.createProperty(Types._TxDiagram, UMLXPackage.Literals.TX_DIAGRAM__OWNED_TX_TYPED_MODEL_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxTypedModelNode), 4 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TxKeyNode__ownedTxPartNodes = LIBRARY.createProperty(Types._TxKeyNode, UMLXPackage.Literals.TX_KEY_NODE__OWNED_TX_PART_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxPartNode), 0 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TxPackageNode__importAliases = LIBRARY.createProperty(Types._TxPackageNode, UMLXPackage.Literals.TX_PACKAGE_NODE__IMPORT_ALIASES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, OCLstdlibTables.Types._String), 0 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TxPackageNode__TxTypedModelNode__usedTxPackageNodes = LIBRARY.createOppositeProperty(Types._TxPackageNode, "TxTypedModelNode", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._TxTypedModelNode), 3 | IsImplicit | IsRequired | IsResolveProxies, UMLXPackage.Literals.TX_TYPED_MODEL_NODE__USED_TX_PACKAGE_NODES);
		...
		public static final @NonNull Property _TxQueryNode__initExpressionLines = LIBRARY.createProperty(Types._TxQueryNode, UMLXPackage.Literals.TX_QUERY_NODE__INIT_EXPRESSION_LINES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, OCLstdlibTables.Types._String), 0 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _TxQueryNode__ownedTxParameterNodes = LIBRARY.createProperty(Types._TxQueryNode, UMLXPackage.Literals.TX_QUERY_NODE__OWNED_TX_PARAMETER_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxParameterNode), 1 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TxTypedModelNode__dependsOns = LIBRARY.createProperty(Types._TxTypedModelNode, UMLXPackage.Literals.TX_TYPED_MODEL_NODE__DEPENDS_ONS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxTypedModelNode), 1 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TxTypedModelNode__iterates = LIBRARY.createProperty(Types._TxTypedModelNode, UMLXPackage.Literals.TX_TYPED_MODEL_NODE__ITERATES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxTypedModelNode), 3 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _TxTypedModelNode__usedTxPackageNodes = LIBRARY.createProperty(Types._TxTypedModelNode, UMLXPackage.Literals.TX_TYPED_MODEL_NODE__USED_TX_PACKAGE_NODES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxPackageNode), 5 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _TxTypedModelNode__RelDomainNode__referredTxTypedModelNode = LIBRARY.createOppositeProperty(Types._TxTypedModelNode, "RelDomainNode", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._RelDomainNode), 6 | IsImplicit | IsRequired | IsResolveProxies, UMLXPackage.Literals.REL_DOMAIN_NODE__REFERRED_TX_TYPED_MODEL_NODE);
		public static final @NonNull Property _TxTypedModelNode__TxTypedModelNode__dependsOns = LIBRARY.createOppositeProperty(Types._TxTypedModelNode, "TxTypedModelNode", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._TxTypedModelNode), 7 | IsImplicit | IsRequired | IsResolveProxies, UMLXPackage.Literals.TX_TYPED_MODEL_NODE__DEPENDS_ONS);
		public static final @NonNull Property _TxTypedModelNode__TxTypedModelNode__iterates = LIBRARY.createOppositeProperty(Types._TxTypedModelNode, "TxTypedModelNode", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._TxTypedModelNode), 8 | IsImplicit | IsRequired | IsResolveProxies, UMLXPackage.Literals.TX_TYPED_MODEL_NODE__ITERATES);

		public static final @NonNull Property _UMLXElement__comments = LIBRARY.createProperty(Types._UMLXElement, UMLXPackage.Literals.UMLX_ELEMENT__COMMENTS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, OCLstdlibTables.Types._String), 0 | IsRequired | IsResolveProxies);

		public static final @NonNull Property _UMLXModel__ownedTxDiagrams = LIBRARY.createProperty(Types._UMLXModel, UMLXPackage.Literals.UMLX_MODEL__OWNED_TX_DIAGRAMS, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._TxDiagram), 0 | IsComposite | IsRequired | IsResolveProxies);
