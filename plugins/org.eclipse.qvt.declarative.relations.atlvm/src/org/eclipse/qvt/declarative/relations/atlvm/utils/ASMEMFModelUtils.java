 ...
 *
 * $Id: ASMEMFModelUtils.java,v 1.8 2009/02/19 14:28:27 qglineur Exp $
 */
...
//				metamodel = new EMFModelLoader().getMOF();
//			} else {
//				metamodel = new EMFModelLoader().loadModel(metamodelName,
//						new EMFModelLoader().getMOF(),
//						getManageableURI(metamodelURI.toString()));
//			}
//		}
//
