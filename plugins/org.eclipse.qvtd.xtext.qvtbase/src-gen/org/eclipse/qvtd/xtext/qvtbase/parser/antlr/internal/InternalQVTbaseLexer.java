...
public class InternalQVTbaseLexer extends Lexer {
	...
	public final void mRULE_UNQUOTED_STRING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalQVTbase.g:8361:22: ( '\\u00A3$%^\\u00A3$%^' )
			// InternalQVTbase.g:8361:24: '\\u00A3$%^\\u00A3$%^'
			{
				match("\u00A3$%^\u00A3$%^");
	...
	public final void mRULE_ESCAPED_CHARACTER() throws RecognitionException {
		try {
			// InternalQVTbase.g:8363:33: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) )
			// InternalQVTbase.g:8363:35: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
			{
				match('\\');
	...
	public final void mRULE_LETTER_CHARACTER() throws RecognitionException {
		try {
			// InternalQVTbase.g:8365:32: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) )
			// InternalQVTbase.g:8365:34: ( 'a' .. 'z' | 'A' .. 'Z' | '_' )
			{
	...
	public final void mRULE_DOUBLE_QUOTED_STRING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalQVTbase.g:8367:27: ( '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
			// InternalQVTbase.g:8367:29: '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
			{
				match('\"');
				// InternalQVTbase.g:8367:33: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )*
				loop1:
					do {
						int alt1=3;
						...
						switch (alt1) {
							case 1 :
								// InternalQVTbase.g:8367:34: RULE_ESCAPED_CHARACTER
							{
	...
	public final void mRULE_SINGLE_QUOTED_STRING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalQVTbase.g:8369:27: ( '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
			// InternalQVTbase.g:8369:29: '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
			{
				match('\'');
				// InternalQVTbase.g:8369:34: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )*
				loop2:
					do {
						int alt2=3;
						...
						switch (alt2) {
							case 1 :
								// InternalQVTbase.g:8369:35: RULE_ESCAPED_CHARACTER
							{
								mRULE_ESCAPED_CHARACTER();
	...
	public final void mRULE_ML_SINGLE_QUOTED_STRING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalQVTbase.g:8371:30: ( '/\\'' ( options {greedy=false; } : . )* '\\'/' )
			// InternalQVTbase.g:8371:32: '/\\'' ( options {greedy=false; } : . )* '\\'/'
			{
				match("/'");

				// InternalQVTbase.g:8371:38: ( options {greedy=false; } : . )*
				loop3:
					do {
						int alt3=2;
	...
	public final void mRULE_SIMPLE_ID() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalQVTbase.g:8373:16: ( RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )* )
			// InternalQVTbase.g:8373:18: RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )*
			{
				mRULE_LETTER_CHARACTER();
				// InternalQVTbase.g:8373:40: ( RULE_LETTER_CHARACTER | '0' .. '9' )*
				loop4:
					do {
						int alt4=2;
	...
	public final void mRULE_ESCAPED_ID() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalQVTbase.g:8375:17: ( '_' RULE_SINGLE_QUOTED_STRING )
			// InternalQVTbase.g:8375:19: '_' RULE_SINGLE_QUOTED_STRING
			{
				match('_');
	...
	public final void mRULE_INT() throws RecognitionException {
		try {
			int _type = RULE_INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalQVTbase.g:8377:10: ( ( '0' .. '9' )+ )
			// InternalQVTbase.g:8377:12: ( '0' .. '9' )+
			{
				// InternalQVTbase.g:8377:12: ( '0' .. '9' )+
				int cnt5=0;
				loop5:
	...
	public final void mRULE_ML_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalQVTbase.g:8379:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// InternalQVTbase.g:8379:19: '/*' ( options {greedy=false; } : . )* '*/'
			{
				match("/*");

				// InternalQVTbase.g:8379:24: ( options {greedy=false; } : . )*
				loop6:
					do {
						int alt6=2;
