 ...
 * from: C:\Users\ed\ocl-6-17-0\git\org.eclipse.qvtd\plugins..\..\plugins\org.eclipse.qvtd.xtext.qvtbase\src-gen\org\eclipse\qvtd\xtext\qvtbase\QVTbase.xtextbin
				...
				createGroup(
					...
					setCardinality("?", createGroup(
						...
						createAssignment("referredOpposite", "=", createCrossReference(
							createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PROPERTY), createRuleCall(_EssentialOCL.PR_UnrestrictedName))))),
					setCardinality("?", createGroup(
						createKeyword(":"),
						createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS)))),
					setCardinality("?", createGroup(
			...
			PR_SimpleTargetElementCS.setAlternatives(
				createGroup(
					...
					createAssignment("typedModel", "=", createCrossReference(
						createTypeRef(MM_qvtbase, org.eclipse.qvtd.pivot.qvtbase.QVTbasePackage.Literals.TYPED_MODEL), createRuleCall(_EssentialOCL.PR_UnrestrictedName))),
					setCardinality("?", createGroup(
