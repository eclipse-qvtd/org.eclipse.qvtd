...
/*
 * An AbstractQVTbaseCSVisitor provides a default implementation of the visitor framework
 * but n implementations of the visitXXX methods..
 */
public abstract class AbstractQVTbaseCSVisitor<R, C>
	...
	implements QVTbaseCSVisitor<R>
{
	 ...
	 */
	protected AbstractQVTbaseCSVisitor(C context) {
		super(context);
	}
}
