...
public class QVTrelationTables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final @NonNull Property _Key__oppositePart = LIBRARY.createProperty(Types._Key, QVTrelationPackage.Literals.KEY__OPPOSITE_PART, MODEL.getCollectionType(OCLstdlibTables.Types._Set, PivotTables.Types._Property), 1 | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Key__part = LIBRARY.createProperty(Types._Key, QVTrelationPackage.Literals.KEY__PART, MODEL.getCollectionType(OCLstdlibTables.Types._Set, PivotTables.Types._Property), 2 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Relation__operationalImpl = LIBRARY.createProperty(Types._Relation, QVTrelationPackage.Literals.RELATION__OPERATIONAL_IMPL, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._RelationImplementation), 1 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Relation__variable = LIBRARY.createProperty(Types._Relation, QVTrelationPackage.Literals.RELATION__VARIABLE, MODEL.getCollectionType(OCLstdlibTables.Types._Set, PivotTables.Types._Variable), 2 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _RelationCallExp__argument = LIBRARY.createProperty(Types._RelationCallExp, QVTrelationPackage.Literals.RELATION_CALL_EXP__ARGUMENT, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, PivotTables.Types._OCLExpression), 0 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _RelationDomain__defaultAssignment = LIBRARY.createProperty(Types._RelationDomain, QVTrelationPackage.Literals.RELATION_DOMAIN__DEFAULT_ASSIGNMENT, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._RelationDomainAssignment), 0 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _RelationDomain__pattern = LIBRARY.createProperty(Types._RelationDomain, QVTrelationPackage.Literals.RELATION_DOMAIN__PATTERN, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._DomainPattern), 1 | IsComposite | IsRequired | IsResolveProxies);
		public static final @NonNull Property _RelationDomain__rootVariable = LIBRARY.createProperty(Types._RelationDomain, QVTrelationPackage.Literals.RELATION_DOMAIN__ROOT_VARIABLE, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, PivotTables.Types._Variable), 2 | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _RelationalTransformation__ownedKeys = LIBRARY.createProperty(Types._RelationalTransformation, QVTrelationPackage.Literals.RELATIONAL_TRANSFORMATION__OWNED_KEYS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Key), 0 | IsComposite | IsRequired | IsResolveProxies);
