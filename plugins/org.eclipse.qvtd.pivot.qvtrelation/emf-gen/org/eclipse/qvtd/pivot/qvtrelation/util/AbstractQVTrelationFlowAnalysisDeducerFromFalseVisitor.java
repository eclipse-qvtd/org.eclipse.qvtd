...
import org.eclipse.qvtd.pivot.qvttemplate.utilities.QVTtemplateFlowAnalysisDeducerFromFalseVisitor;

/**
 * An AbstractQVTrelationFlowAnalysisDeducerFromFalseVisitor provides a default implementation for each
 * visitXxx method that delegates to the visitYyy method of the first
 * super class, (or transitively its first super class' first super class
 * until a non-interface super-class is found). In the absence of any
 * suitable first super class, the method delegates to visiting().
 */
public abstract class AbstractQVTrelationFlowAnalysisDeducerFromFalseVisitor
	extends QVTtemplateFlowAnalysisDeducerFromFalseVisitor
	implements QVTrelationVisitor<Boolean>
{
	 ...
	 */
	protected AbstractQVTrelationFlowAnalysisDeducerFromFalseVisitor(@NonNull FlowAnalysis flowAnalysis) {
		super(flowAnalysis);
	}
