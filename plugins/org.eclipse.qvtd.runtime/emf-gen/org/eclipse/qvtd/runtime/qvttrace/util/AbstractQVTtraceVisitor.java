...
/*
 * An AbstractQVTtraceVisitor provides a default implementation of the visitor framework
 * but n implementations of the visitXXX methods..
 */
public abstract class AbstractQVTtraceVisitor<R, C>
	implements QVTtraceVisitor<R>
{
	 ...
	 */
	protected AbstractQVTtraceVisitor(C context) {
	 ...
	 */
	public @Nullable R safeVisit(org.eclipse.qvtd.runtime.qvttrace.util.@Nullable TraceVisitable v) {
	 ...
	 *	 otherwise, the result of visiting it
	 */
	public R visit(org.eclipse.qvtd.runtime.qvttrace.util.@NonNull TraceVisitable v) {
