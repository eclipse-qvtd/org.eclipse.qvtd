...
or installing new software from e.g. http://download.eclipse.org/mmt/qvtd/updates/milestones/0.15.0/S201408191819
...
cd downloads/mmt/qvtd/updates/milestones/0.15.0
ant -f /shared/modeling/tools/promotion/manage-composite.xml add -Dchild.repository=S201408191819 -Dcomposite.name="QVTd 0.15.0 milestones"

(This can be checked by installing new software from e.g. http://download.eclipse.org/mmt/qvtd/updates/milestones/0.15.0)
...
location="http://download.eclipse.org/mmt/qvtd/updates/milestones/0.15.0/S201408191819"
...
location="http://download.eclipse.org/mmt/qvtd/updates/releases/0.15.0"

After each first repo contribution, remember to update the aggregates e.g.
cd downloads/mmt/qvtd/updates/milestones
ant -f /shared/modeling/tools/promotion/manage-composite.xml add -Dchild.repository=0.15.0
